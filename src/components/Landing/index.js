    ...
    <Carousel>
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p>You can add your Module Code, Module Name, what you achieved in your exam and what you achieved through Continious Assessment</p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
        <Image
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          <h3>Add your grades and manage your time.</h3>
