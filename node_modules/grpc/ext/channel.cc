...
***REMOVED***
  ...
  ***REMOVED*** else if (value->IsString()) {
...
Channel::Channel(grpc_channel *channel) : wrapped_channel(channel) {***REMOVED***
...
grpc_channel *Channel::GetWrappedChannel() { return this->wrapped_channel; ***REMOVED***
...
***REMOVED*** else {
    const int argc = 3;
    Local<Value> argv[argc] = {info[0], info[1], info[2]***REMOVED***;
...
***REMOVED*** else if (!(info[3]->IsUndefined() || info[3]->IsNull())) {
    return Nan::ThrowTypeError(
...
***REMOVED*** else if (!(info[4]->IsUndefined() || info[4]->IsNull())) {
    return Nan::ThrowTypeError(
...
***REMOVED***
  ...
  if (info[2]->IsString()) {
    ...
    *host =
    ...
    delete host;
***REMOVED*** else if (info[2]->IsUndefined() || info[2]->IsNull()) {
    wrapped_call = grpc_channel_create_call(
        wrapped_channel, parent_call, propagate_flags, GetCompletionQueue(),
