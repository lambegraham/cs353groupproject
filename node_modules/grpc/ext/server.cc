...
class ServerShutdownOp : public Op {
 public:
  ServerShutdownOp(Server *server) : server(server) {***REMOVED***

  ~ServerShutdownOp() {***REMOVED***
...
***REMOVED***
 ...
 protected:
  std::string GetTypeString() const { return "try_shutdown"; ***REMOVED***
***REMOVED***;
...
***REMOVED***
 ...
 protected:
  std::string GetTypeString() const { return "new_call"; ***REMOVED***
***REMOVED***;
...
Server::Server(grpc_server *server) :
    wrapped_server(server), is_shutdown(false) {***REMOVED***

Server::~Server() { grpc_server_destroy(this->wrapped_server); ***REMOVED***
...
NAN_METHOD(Server::New) {
  ...
  if (!info.IsConstructCall()) {
    const int argc = 1;
    Local<Value> argv[argc] = {info[0]***REMOVED***;
