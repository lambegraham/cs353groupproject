...
class SendMetadataOp : public Op {
 public:
  SendMetadataOp() { grpc_metadata_array_init(&send_metadata); ***REMOVED***
  ~SendMetadataOp() { DestroyMetadataArray(&send_metadata); ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
    ...
    return true;
***REMOVED***
  bool IsFinalOp() { return false; ***REMOVED***
  void OnComplete(bool success) {***REMOVED***

 protected:
  std::string GetTypeString() const { return "send_metadata"; ***REMOVED***
...
class SendMessageOp : public Op {
 public:
  SendMessageOp() { send_message = NULL; ***REMOVED***
  ~SendMessageOp() {
...
***REMOVED***
 ...
 protected:
  std::string GetTypeString() const { return "send_message"; ***REMOVED***
...
***REMOVED***
  ...
  bool ParseOp(Local<Value> value, grpc_op *out) { return true; ***REMOVED***
  bool IsFinalOp() { return false; ***REMOVED***
  void OnComplete(bool success) {***REMOVED***

 protected:
  std::string GetTypeString() const { return "client_close"; ***REMOVED***
***REMOVED***;
...
***REMOVED***
  ...
  ***REMOVED***
    ...
    return true;
***REMOVED***
  bool IsFinalOp() { return true; ***REMOVED***
  void OnComplete(bool success) {***REMOVED***

 protected:
  std::string GetTypeString() const { return "send_status"; ***REMOVED***
...
class GetMetadataOp : public Op {
 public:
  GetMetadataOp() { grpc_metadata_array_init(&recv_metadata); ***REMOVED***

  ~GetMetadataOp() { grpc_metadata_array_destroy(&recv_metadata); ***REMOVED***
...
***REMOVED***
 ...
 protected:
  std::string GetTypeString() const { return "metadata"; ***REMOVED***
...
class ReadMessageOp : public Op {
 public:
  ReadMessageOp() { recv_message = NULL; ***REMOVED***
  ~ReadMessageOp() {
...
***REMOVED***
 ...
 protected:
  std::string GetTypeString() const { return "read"; ***REMOVED***
...
***REMOVED***
 ...
 protected:
  std::string GetTypeString() const { return "status"; ***REMOVED***
...
***REMOVED***
 ...
 protected:
  std::string GetTypeString() const { return "cancelled"; ***REMOVED***
...
void CompleteTag(void *tag, const char *error_message) {
  ...
  ***REMOVED***
    Local<Value> argv[] = {Nan::Null(), tag_obj***REMOVED***;
    callback->Call(2, argv, tag_struct->async_resource);
***REMOVED*** else {
    Local<Value> argv[] = {Nan::Error(error_message)***REMOVED***;
...
grpc_call *Call::GetWrappedCall() { return this->wrapped_call; ***REMOVED***
