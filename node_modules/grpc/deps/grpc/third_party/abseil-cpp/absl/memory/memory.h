...
***REMOVED***
inline std::nullptr_t RawPtr(std::nullptr_t) { return nullptr; ***REMOVED***
...
***REMOVED***
  ...
  static size_type max_size(const Alloc& a) { return max_size_impl(0, a); ***REMOVED***
...
struct allocator_is_nothrow
    : memory_internal::ExtractOrT<memory_internal::GetIsNothrow, Alloc,
                                  std::false_type> {***REMOVED***;

#if defined(ABSL_ALLOCATOR_NOTHROW) && ABSL_ALLOCATOR_NOTHROW
template <typename T>
struct allocator_is_nothrow<std::allocator<T>> : std::true_type {***REMOVED***;
struct default_allocator_is_nothrow : std::true_type {***REMOVED***;
#else
struct default_allocator_is_nothrow : std::false_type {***REMOVED***;
#endif
