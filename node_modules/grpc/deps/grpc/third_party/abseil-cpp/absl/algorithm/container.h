...
template <typename C>
ContainerIter<C> c_begin(C& c) { return begin(c); ***REMOVED***

template <typename C>
ContainerIter<C> c_end(C& c) { return end(c); ***REMOVED***

template <typename T>
struct IsUnorderedContainer : std::false_type {***REMOVED***;

template <class Key, class T, class Hash, class KeyEqual, class Allocator>
struct IsUnorderedContainer<
    std::unordered_map<Key, T, Hash, KeyEqual, Allocator>> : std::true_type {***REMOVED***;
