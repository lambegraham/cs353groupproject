 ...
 public:
  constexpr Flag(const char* name, const flags_internal::HelpGenFunc help_gen,
      ...
      : internal(name, flags_internal::HelpText::FromFunctionPointer(help_gen),
                 ...
                 /*cur_arg=*/nullptr) {***REMOVED***

  // Not copyable/assignable.
  Flag(const Flag<T>&) = delete;
  Flag<T>& operator=(const Flag<T>&) = delete;

  absl::string_view Name() const { return internal.Name(); ***REMOVED***
  std::string Help() const { return internal.Help(); ***REMOVED***
  std::string Filename() const { return internal.Filename(); ***REMOVED***
...
***REMOVED***
  ...
  operator bool() const { return true; ***REMOVED***  // NOLINT
...
// facilitate usage of {***REMOVED*** as default value in ABSL_FLAG macro.
struct EmptyBraces {***REMOVED***;
