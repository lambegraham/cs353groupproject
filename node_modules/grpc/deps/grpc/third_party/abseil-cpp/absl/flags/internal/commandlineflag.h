...
***REMOVED***
 ...
 private:
  explicit constexpr HelpText(const HelpGenFunc fn, const char* msg)
      : help_function_(fn), help_message_(msg) {***REMOVED***
...
struct CommandLineFlag {
  constexpr CommandLineFlag(
      ...
      : name(name_arg),
        ...
        counter(0),
        atomic(kAtomicInit),
        locks(nullptr) {***REMOVED***

  // Not copyable/assignable.
  CommandLineFlag(const CommandLineFlag&) = delete;
  CommandLineFlag& operator=(const CommandLineFlag&) = delete;

  absl::string_view Name() const { return name; ***REMOVED***
  std::string Help() const { return help.GetHelpText(); ***REMOVED***
  bool IsRetired() const { return this->retired; ***REMOVED***
  bool IsSpecifiedOnCommandLine() const { return on_command_line; ***REMOVED***
...
***REMOVED***
 ...
 public:
  ...
  ABSL_DEPRECATED(
      ...
      "changed")
  const char* NameAsCString() const { return name; ***REMOVED***
...
***REMOVED***  // namespace flags_internal
