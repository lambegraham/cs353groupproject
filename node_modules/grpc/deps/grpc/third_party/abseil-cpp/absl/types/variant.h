...
struct variant_size<variant<Ts...>>
    : std::integral_constant<std::size_t, sizeof...(Ts)> {***REMOVED***;

// Specialization of `variant_size` for const qualified variants.
template <class T>
struct variant_size<const T> : variant_size<T>::type {***REMOVED***;

// Specialization of `variant_size` for volatile qualified variants.
template <class T>
struct variant_size<volatile T> : variant_size<T>::type {***REMOVED***;

// Specialization of `variant_size` for const volatile qualified variants.
template <class T>
struct variant_size<const volatile T> : variant_size<T>::type {***REMOVED***;
  ...
  return variant_internal::
      VisitIndices<variant_size<absl::decay_t<Variants> >::value...>::Run(
          variant_internal::PerformVisitation<Visitor, Variants...>{
              ...
              absl::forward<Visitor>(vis)***REMOVED***,
          vars.index()...);
***REMOVED***
...
struct monostate {***REMOVED***;

// `absl::monostate` Relational Operators

constexpr bool operator<(monostate, monostate) noexcept { return false; ***REMOVED***
constexpr bool operator>(monostate, monostate) noexcept { return false; ***REMOVED***
constexpr bool operator<=(monostate, monostate) noexcept { return true; ***REMOVED***
constexpr bool operator>=(monostate, monostate) noexcept { return true; ***REMOVED***
constexpr bool operator==(monostate, monostate) noexcept { return true; ***REMOVED***
constexpr bool operator!=(monostate, monostate) noexcept { return false; ***REMOVED***
...
class variant<T0, Tn...> : private variant_internal::VariantBase<T0, Tn...> {
 ...
 public:
  ...
  constexpr variant(T&& t) noexcept(std::is_nothrow_constructible<Tj, T>::value)
      : Base(variant_internal::EmplaceTag<I>(), absl::forward<T>(t)) {***REMOVED***
  ...
  constexpr explicit variant(in_place_type_t<T>, Args&&... args)
      : Base(variant_internal::EmplaceTag<
             ...
             absl::forward<Args>(args)...) {***REMOVED***
  ...
  constexpr explicit variant(in_place_type_t<T>, std::initializer_list<U> il,
      ...
      : Base(variant_internal::EmplaceTag<
                 variant_internal::UnambiguousIndexOf<variant, T>::value>(),
             il, absl::forward<Args>(args)...) {***REMOVED***
  ...
  constexpr explicit variant(in_place_index_t<I>, Args&&... args)
      : Base(variant_internal::EmplaceTag<I>(), absl::forward<Args>(args)...) {***REMOVED***
...
***REMOVED***
  ...
  //
  //   absl::variant<std::vector<int>, int, std::string> v;
  //   v.emplace<std::vector<int>>({0, 1, 2***REMOVED***);
  template <
...
***REMOVED***
  ...
  // type.
  constexpr std::size_t index() const noexcept { return this->index_; ***REMOVED***
  ...
  void swap(variant& rhs) noexcept(
    ...
    return variant_internal::VisitIndices<sizeof...(Tn) + 1>::Run(
        variant_internal::Swap<T0, Tn...>{this, &rhs***REMOVED***, rhs.index());
***REMOVED***
***REMOVED***;
...
constexpr variant_internal::RequireAllHaveEqualT<Types...> operator==(
  ...
  return (a.index() == b.index()) &&
         variant_internal::VisitIndices<sizeof...(Types)>::Run(
             variant_internal::EqualsOp<Types...>{&a, &b***REMOVED***, a.index());
***REMOVED***
...
constexpr variant_internal::RequireAllHaveNotEqualT<Types...> operator!=(
  ...
  return (a.index() != b.index()) ||
         variant_internal::VisitIndices<sizeof...(Types)>::Run(
             variant_internal::NotEqualsOp<Types...>{&a, &b***REMOVED***, a.index());
***REMOVED***
...
constexpr variant_internal::RequireAllHaveLessThanT<Types...> operator<(
  ...
  return (a.index() != b.index())
             ? (a.index() + 1) < (b.index() + 1)
             : variant_internal::VisitIndices<sizeof...(Types)>::Run(
                   variant_internal::LessThanOp<Types...>{&a, &b***REMOVED***, a.index());
***REMOVED***
...
constexpr variant_internal::RequireAllHaveGreaterThanT<Types...> operator>(
  ...
  return (a.index() != b.index())
             ? (a.index() + 1) > (b.index() + 1)
             : variant_internal::VisitIndices<sizeof...(Types)>::Run(
                   variant_internal::GreaterThanOp<Types...>{&a, &b***REMOVED***,
                   a.index());
***REMOVED***
...
constexpr variant_internal::RequireAllHaveLessThanOrEqualT<Types...> operator<=(
  ...
  return (a.index() != b.index())
             ? (a.index() + 1) < (b.index() + 1)
             : variant_internal::VisitIndices<sizeof...(Types)>::Run(
                   variant_internal::LessThanOrEqualsOp<Types...>{&a, &b***REMOVED***,
                   a.index());
***REMOVED***
...
operator>=(const variant<Types...>& a, const variant<Types...>& b) {
  return (a.index() != b.index())
             ? (a.index() + 1) > (b.index() + 1)
             : variant_internal::VisitIndices<sizeof...(Types)>::Run(
                   variant_internal::GreaterThanOrEqualsOp<Types...>{&a, &b***REMOVED***,
                   a.index());
***REMOVED***
...
To ConvertVariantTo(Variant&& variant) {
  return absl::visit(variant_internal::ConversionVisitor<To>{***REMOVED***,
