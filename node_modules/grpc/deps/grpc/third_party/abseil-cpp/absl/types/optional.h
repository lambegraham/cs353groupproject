...
struct nullopt_t {
  // It must not be default-constructible to avoid ambiguity for opt = {***REMOVED***.
  explicit constexpr nullopt_t(optional_internal::init_t) noexcept {***REMOVED***
***REMOVED***;
...
class optional : private optional_internal::optional_data<T>,
 ...
 public:
  ...
  // `T`.
  constexpr optional() noexcept {***REMOVED***

  // Constructs an `optional` initialized with `nullopt` to hold an empty value.
  constexpr optional(nullopt_t) noexcept {***REMOVED***  // NOLINT(runtime/explicit)
  ...
  constexpr explicit optional(InPlaceT, Args&&... args)
      : data_base(in_place_t(), absl::forward<Args>(args)...) {***REMOVED***
...
***REMOVED***
  ...
  template <
      ...
      typename std::enable_if<
          ...
          bool>::type = false>
  constexpr optional(U&& v) : data_base(in_place_t(), absl::forward<U>(v)) {***REMOVED***
  ...
  explicit constexpr optional(U&& v)
      : data_base(in_place_t(), absl::forward<U>(v)) {***REMOVED***
...
***REMOVED***
  ...
  // Example:
  //
  //   struct S { int value; ***REMOVED***;
  //   optional<S> opt = absl::nullopt;  // Could also use opt = { ***REMOVED***;
...
***REMOVED***
  ...
  ABSL_ATTRIBUTE_REINITIALIZES void reset() noexcept { this->destruct(); ***REMOVED***
...
***REMOVED***
  ...
  //
  //   optional<Foo> opt;
  //   opt.emplace({1,2,3***REMOVED***);  // Constructs Foo({1,2,3***REMOVED***)
  template <typename U, typename... Args,
            typename = typename std::enable_if<std::is_constructible<
                T, std::initializer_list<U>&, Args&&...>::value>::type>
...
***REMOVED***
  ...
  // ***REMOVED***
  //
  constexpr explicit operator bool() const noexcept { return this->engaged_; ***REMOVED***

  // optional::has_value()
  //
  // Determines whether the `optional` contains a value. Returns `false` if and
  // only if `*this` is empty.
  constexpr bool has_value() const noexcept { return this->engaged_; ***REMOVED***
...
***REMOVED***
 ...
 private:
  ...
  constexpr const T& reference() const { return this->data_; ***REMOVED***
  T& reference() { return this->data_; ***REMOVED***
...
struct hash<absl::optional<T> >
    : absl::optional_internal::optional_hash_base<T> {***REMOVED***;
