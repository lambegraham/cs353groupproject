...
//   std::vector<int> v = {1, 2, 3, 4, 5***REMOVED***;
//   auto span = absl::Span<const int>(v);
//
//   // Construct a Span explicitly from a C-style array:
//   int a[5] =  {1, 2, 3, 4, 5***REMOVED***;
...
//     ...
// ***REMOVED***
//   std::vector v = {1,2,3,4,5***REMOVED***;
...
class Span {
 ...
 public:
  ...
  constexpr Span() noexcept : Span(nullptr, 0) {***REMOVED***
  constexpr Span(pointer array, size_type length) noexcept
      : ptr_(array), len_(length) {***REMOVED***
  ...
  explicit Span(V& v) noexcept  // NOLINT(runtime/references)
      : Span(span_internal::GetData(v), v.size()) {***REMOVED***
  ...
  //   Process({ 17, 19 ***REMOVED***);
  //
  //   // Not okay: the storage used by the std::initializer_list<int> is not
  //   // allowed to be referenced after the first line.
  //   absl::Span<const int> ints = { 17, 19 ***REMOVED***;
  //   Process(ints);
  //
  ...
  //   const int foo = 17;
  //   absl::Span<const int> ints = { foo ***REMOVED***;
  //   Process(ints);
  //
  ...
  // outside the span).
  constexpr pointer data() const noexcept { return ptr_; ***REMOVED***

  // Span::size()
  //
  // Returns the size of this span.
  constexpr size_type size() const noexcept { return len_; ***REMOVED***

  // Span::length()
  //
  // Returns the length (size) of this span.
  constexpr size_type length() const noexcept { return size(); ***REMOVED***

  // Span::empty()
  //
  // Returns a boolean indicating whether or not this span is considered empty.
  constexpr bool empty() const noexcept { return size() == 0; ***REMOVED***
...
***REMOVED***
  ...
  constexpr iterator begin() const noexcept { return data(); ***REMOVED***

  // Span::cbegin()
  //
  // Returns a const iterator to the first element of this span.
  constexpr const_iterator cbegin() const noexcept { return begin(); ***REMOVED***

  // Span::end()
  //
  // Returns an iterator to the last element of this span.
  constexpr iterator end() const noexcept { return data() + size(); ***REMOVED***

  // Span::cend()
  //
  // Returns a const iterator to the last element of this span.
  constexpr const_iterator cend() const noexcept { return end(); ***REMOVED***
...
***REMOVED***
  ...
  constexpr const_reverse_iterator crbegin() const noexcept { return rbegin(); ***REMOVED***
...
***REMOVED***
  ...
  //
  // Returns a reverse iterator starting at the first element of this span.
  constexpr const_reverse_iterator crend() const noexcept { return rend(); ***REMOVED***
...
***REMOVED***
  ...
  // Examples:
  //
  //   std::vector<int> vec = {10, 11, 12, 13***REMOVED***;
  //   absl::MakeSpan(vec).subspan(1, 2);  // {11, 12***REMOVED***
  //   absl::MakeSpan(vec).subspan(2, 8);  // {12, 13***REMOVED***
  //   absl::MakeSpan(vec).subspan(1);     // {11, 12, 13***REMOVED***
  //   absl::MakeSpan(vec).subspan(4);     // {***REMOVED***
...
***REMOVED***
  ...
  //
  //   std::vector<int> vec = {10, 11, 12, 13***REMOVED***;
  //   absl::MakeSpan(vec).first(1);  // {10***REMOVED***
  //   absl::MakeSpan(vec).first(3);  // {10, 11, 12***REMOVED***
...
***REMOVED***
  ...
  //
  //   std::vector<int> vec = {10, 11, 12, 13***REMOVED***;
  //   absl::MakeSpan(vec).last(1);  // {13***REMOVED***
  //   absl::MakeSpan(vec).last(3);  // {11, 12, 13***REMOVED***
...
//   ProcessInts(absl::MakeConstSpan(std::vector<int>{ 0, 0, 0 ***REMOVED***));
//
template <int&... ExplicitArgumentBarrier, typename T>
