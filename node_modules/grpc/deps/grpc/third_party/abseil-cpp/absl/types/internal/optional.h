...
//   int t;
//   template <typename T>
//   constexpr Base(T t_) : t(t_) {***REMOVED***
// ***REMOVED***;
// struct Foo : Base {
//   using Base::Base;
// ***REMOVED***
...
***REMOVED***
  ...
  constexpr optional_data_dtor_base() noexcept : engaged_(false), dummy_{{***REMOVED******REMOVED*** {***REMOVED***

  template <typename... Args>
  constexpr explicit optional_data_dtor_base(in_place_t, Args&&... args)
      : engaged_(true), data_(absl::forward<Args>(args)...) {***REMOVED***

  ~optional_data_dtor_base() { destruct(); ***REMOVED***
***REMOVED***;
...
***REMOVED***
 ...
 protected:
  ...
  union {
    ...
    T data_;
***REMOVED***
  void destruct() noexcept { engaged_ = false; ***REMOVED***
...
class optional_data_base : public optional_data_dtor_base<T> {
 protected:
  ...
  constexpr explicit optional_data_base(in_place_t t, Args&&... args)
      : base(t, absl::forward<Args>(args)...) {***REMOVED***
#endif
...
class optional_data<T, true> : public optional_data_base<T> {
 protected:
  ...
  constexpr explicit optional_data(in_place_t t, Args&&... args)
      : optional_data_base<T>(t, absl::forward<Args>(args)...) {***REMOVED***
#endif
***REMOVED***;
...
enum class copy_traits { copyable = 0, movable = 1, non_movable = 2 ***REMOVED***;
...
struct is_constructible_convertible_from_optional
    : std::integral_constant<
          bool, std::is_constructible<T, optional<U>&>::value ||
                    ...
                    std::is_convertible<const optional<U>&&, T>::value> {***REMOVED***;
...
struct is_constructible_convertible_assignable_from_optional
    : std::integral_constant<
          bool, is_constructible_convertible_from_optional<T, U>::value ||
                    ...
                    std::is_assignable<T&, const optional<U>&&>::value> {***REMOVED***;
