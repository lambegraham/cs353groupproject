...
template <std::size_t I, class T>
struct VariantAlternativeSfinae {***REMOVED***;
...
struct VariantAlternativeSfinae<I, variant<T0, Tn...>>
    : VariantAlternativeSfinae<I - 1, variant<Tn...>> {***REMOVED***;
...
struct IndexOfConstructedType {***REMOVED***;
...
struct MakeVisitationMatrixImpl<
  ...
  static constexpr ResultType Run() {
    return {{MakeVisitationMatrix<ReturnType, FunctionObject,
                                  ...
                                  BoundIndices..., CurrIndices>::Run()...***REMOVED******REMOVED***;
***REMOVED***
***REMOVED***;
...
struct MakeVisitationMatrix<ReturnType, FunctionObject,
    ...
    : MakeVisitationMatrixImpl<
          ...
          absl::make_index_sequence<HeadEndIndex>, BoundIndices...> {***REMOVED***;
...
template <>
struct FlattenIndices<> {
  static constexpr std::size_t Run() { return 0; ***REMOVED***
***REMOVED***;
...
***REMOVED***
  ...
  static VisitIndicesResultT<Op, decltype(EndIndices)...> Run(
    ...
    return VisitIndicesSwitch<NumCasesOfSwitch<EndIndices...>::value>::Run(
        FlattenedOp<Op>{absl::forward<Op>(op)***REMOVED***,
        FlattenIndices<(EndIndices + std::size_t{1***REMOVED***)...>::Run(
            (i + std::size_t{1***REMOVED***)...));
***REMOVED***
***REMOVED***;
  ...
  static void InitFrom(Variant& self, Variant&& other) {  // NOLINT
    VisitIndices<absl::variant_size<Variant>::value>::Run(
        InitFromVisitor<Variant, Variant&&>{&self,
                                            std::forward<Variant>(other)***REMOVED***,
        other.index());
...
***REMOVED***
  ...
  struct CopyAssignVisitor {
    ...
    ***REMOVED*** else if (std::is_nothrow_copy_constructible<New>::value ||
...
***REMOVED***
  ...
  MakeConversionAssignVisitor(Left* left, QualifiedNew&& qual) {
    return {left, absl::forward<QualifiedNew>(qual)***REMOVED***;
***REMOVED***
...
struct UnambiguousIndexOfImpl<variant<>, T, CurrIndex> : SizeT<CurrIndex> {***REMOVED***;
...
struct UnambiguousIndexOfImpl<variant<Head, Tail...>, T, CurrIndex>
    : UnambiguousIndexOfImpl<variant<Tail...>, T, CurrIndex + 1>::type {***REMOVED***;
...
struct UnambiguousIndexOfImpl<variant<Head, Tail...>, Head, CurrIndex>
    : SizeT<UnambiguousIndexOfImpl<variant<Tail...>, Head, 0>::value ==
                    sizeof...(Tail)
                ? CurrIndex
                : CurrIndex + sizeof...(Tail) + 1> {***REMOVED***;
...
struct IsNeitherSelfNorInPlace : std::true_type {***REMOVED***;

template <class Self>
struct IsNeitherSelfNorInPlace<Self, Self> : std::false_type {***REMOVED***;

template <class Self, class T>
struct IsNeitherSelfNorInPlace<Self, in_place_type_t<T>> : std::false_type {***REMOVED***;

template <class Self, std::size_t I>
struct IsNeitherSelfNorInPlace<Self, in_place_index_t<I>> : std::false_type {***REMOVED***;

template <class Variant, class T, class = void>
struct ConversionIsPossibleImpl : std::false_type {***REMOVED***;

template <class Variant, class T>
struct ConversionIsPossibleImpl<
    Variant, T,
    void_t<decltype(ImaginaryFun<Variant>::Run(std::declval<T>(), {***REMOVED***))>>
    : std::true_type {***REMOVED***;

template <class Variant, class T>
struct ConversionIsPossible : ConversionIsPossibleImpl<Variant, T>::type {***REMOVED***;

template <class Variant, class T>
struct IndexOfConstructedType<
    Variant, T,
    void_t<decltype(ImaginaryFun<Variant>::Run(std::declval<T>(), {***REMOVED***))>>
    : decltype(ImaginaryFun<Variant>::Run(std::declval<T>(), {***REMOVED***)) {***REMOVED***;

template <std::size_t... Is>
struct ContainsVariantNPos
    : absl::negation<std::is_same<  // NOLINT
          absl::integer_sequence<bool, 0 <= Is...>,
          absl::integer_sequence<bool, Is != absl::variant_npos...>>> {***REMOVED***;
...
struct PerformVisitation {
  ...
  constexpr ReturnType operator()(SizeT<Is>... indices) const {
    return Run(typename ContainsVariantNPos<Is...>::type{***REMOVED***,
...
struct NoopConstructorTag {***REMOVED***;

template <std::size_t I>
struct EmplaceTag {***REMOVED***;

template <>
union Union<> {
  constexpr explicit Union(NoopConstructorTag) noexcept {***REMOVED***
***REMOVED***;
...
union Union<Head, Tail...> {
  ...
  explicit constexpr Union(NoopConstructorTag /*tag*/) noexcept
      : tail(NoopConstructorTag()) {***REMOVED***

  template <class... P>
  explicit constexpr Union(EmplaceTag<0>, P&&... args)
      : head(absl::forward<P>(args)...) {***REMOVED***

  template <std::size_t I, class... P>
  explicit constexpr Union(EmplaceTag<I>, P&&... args)
      : tail(EmplaceTag<I - 1>{***REMOVED***, absl::forward<P>(args)...) {***REMOVED***
...
template <>
union DestructibleUnionImpl<> {
  constexpr explicit DestructibleUnionImpl(NoopConstructorTag) noexcept {***REMOVED***
***REMOVED***;
...
class VariantStateBase {
 protected:
  ...
  constexpr VariantStateBase() noexcept(
      ...
      : state_(EmplaceTag<0>()), index_(0) {***REMOVED***

  template <std::size_t I, class... P>
  explicit constexpr VariantStateBase(EmplaceTag<I> tag, P&&... args)
      : state_(tag, absl::forward<P>(args)...), index_(I) {***REMOVED***

  explicit constexpr VariantStateBase(NoopConstructorTag)
      : state_(NoopConstructorTag()), index_(variant_npos) {***REMOVED***

  void destroy() {***REMOVED***  // Does nothing (shadowed in child if non-trivial)
...
struct VariantHelper<variant<Ts...>> {
  ...
  template <typename U>
  struct CanAccept :
      std::integral_constant<bool, !std::is_void<BestMatch<U>>::value> {***REMOVED***;
  ...
  struct CanConvertFrom<variant<Us...>>
      : public absl::conjunction<CanAccept<Us>...> {***REMOVED***;
***REMOVED***;
...
struct IsTriviallyMoveConstructible:
  std::is_move_constructible<Union<T, TrivialMoveOnly>> {***REMOVED***;
...
***REMOVED***
  ...
  void destroy() { VisitIndices<sizeof...(T)>::Run(Destroyer{this***REMOVED***, index_); ***REMOVED***

  ~VariantStateBaseDestructorNontrivial() { destroy(); ***REMOVED***
...
class VariantMoveBaseNontrivial : protected VariantStateBaseDestructor<T...> {
  ...
  ***REMOVED***
    ...
    void operator()(SizeT<absl::variant_npos> /*i*/) const {***REMOVED***
...
***REMOVED***
  ...
  VariantMoveBaseNontrivial(VariantMoveBaseNontrivial&& other) noexcept(
    ...
    VisitIndices<sizeof...(T)>::Run(Construct{this, &other***REMOVED***, other.index_);
    index_ = other.index_;
***REMOVED***
...
***REMOVED***
  ...
  void operator()(SizeT<variant_npos>) const {***REMOVED***
***REMOVED***;
...
***REMOVED***
  ...
  void operator()(SizeT<Wi> /*w_i*/) {
    if (v->index() == Wi) {
      VisitIndices<sizeof...(Types)>::Run(SwapSameIndex<Types...>{v, w***REMOVED***, Wi);
  ***REMOVED*** else {
      generic_swap();
  ***REMOVED***
***REMOVED***
  ...
  ***REMOVED***
    size_t result = VisitIndices<variant_size<Variant>::value>::Run(
        PerformVisitation<VariantHashVisitor, const Variant&>{
            std::forward_as_tuple(var), VariantHashVisitor{***REMOVED******REMOVED***,
        var.index());
...
***REMOVED***  // namespace variant_internal
