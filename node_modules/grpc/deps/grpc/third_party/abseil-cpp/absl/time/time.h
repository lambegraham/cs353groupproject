...
class Duration {
 public:
  // Value semantics.
  constexpr Duration() : rep_hi_(0), rep_lo_(0) {***REMOVED***  // zero-length duration

  // Copyable.
#if !defined(__clang__) && defined(_MSC_VER) && _MSC_VER < 1910
  // Explicitly defining the constexpr copy constructor avoids an MSVC bug.
  constexpr Duration(const Duration& d)
      : rep_hi_(d.rep_hi_), rep_lo_(d.rep_lo_) {***REMOVED***
#else
...
***REMOVED***
  ...
  Duration& operator/=(T r) {
    ...
    return *this /= x;
***REMOVED***
  Duration& operator*=(float r) { return *this *= static_cast<double>(r); ***REMOVED***
  Duration& operator/=(float r) { return *this /= static_cast<double>(r); ***REMOVED***
...
***REMOVED***
 ...
 private:
  ...
  friend constexpr Duration time_internal::MakeDuration(int64_t hi,
                                                        uint32_t lo);
  constexpr Duration(int64_t hi, uint32_t lo) : rep_hi_(hi), rep_lo_(lo) {***REMOVED***
  int64_t rep_hi_;
  uint32_t rep_lo_;
***REMOVED***;
...
constexpr bool operator>(Duration lhs, Duration rhs) { return rhs < lhs; ***REMOVED***
constexpr bool operator>=(Duration lhs, Duration rhs) { return !(lhs < rhs); ***REMOVED***
constexpr bool operator<=(Duration lhs, Duration rhs) { return !(rhs < lhs); ***REMOVED***
constexpr bool operator==(Duration lhs, Duration rhs);
constexpr bool operator!=(Duration lhs, Duration rhs) { return !(lhs == rhs); ***REMOVED***
...
inline Duration operator+(Duration lhs, Duration rhs) { return lhs += rhs; ***REMOVED***
inline Duration operator-(Duration lhs, Duration rhs) { return lhs -= rhs; ***REMOVED***
...
constexpr Duration ZeroDuration() { return Duration(); ***REMOVED***
...
***REMOVED***
 ...
 private:
  ...
  constexpr explicit Time(Duration rep) : rep_(rep) {***REMOVED***
  Duration rep_;
***REMOVED***;

// Relational Operators
constexpr bool operator<(Time lhs, Time rhs) { return lhs.rep_ < rhs.rep_; ***REMOVED***
constexpr bool operator>(Time lhs, Time rhs) { return rhs < lhs; ***REMOVED***
constexpr bool operator>=(Time lhs, Time rhs) { return !(lhs < rhs); ***REMOVED***
constexpr bool operator<=(Time lhs, Time rhs) { return !(rhs < lhs); ***REMOVED***
constexpr bool operator==(Time lhs, Time rhs) { return lhs.rep_ == rhs.rep_; ***REMOVED***
constexpr bool operator!=(Time lhs, Time rhs) { return !(lhs == rhs); ***REMOVED***

// Additive Operators
inline Time operator+(Time lhs, Duration rhs) { return lhs += rhs; ***REMOVED***
inline Time operator+(Duration lhs, Time rhs) { return rhs += lhs; ***REMOVED***
inline Time operator-(Time lhs, Duration rhs) { return lhs -= rhs; ***REMOVED***
inline Duration operator-(Time lhs, Time rhs) { return lhs.rep_ - rhs.rep_; ***REMOVED***

// UnixEpoch()
//
// Returns the `absl::Time` representing "1970-01-01 00:00:00.0 +0000".
constexpr Time UnixEpoch() { return Time(); ***REMOVED***
...
constexpr Time UniversalEpoch() {
  ...
  return Time(time_internal::MakeDuration(-24 * 719162 * int64_t{3600***REMOVED***, 0U));
***REMOVED***
...
// over/underflow in ToTime{T,val,spec***REMOVED***() on 32-bit platforms.
...
class TimeZone {
 public:
  explicit TimeZone(time_internal::cctz::time_zone tz) : cz_(tz) {***REMOVED***
  ...
  explicit operator time_internal::cctz::time_zone() const { return cz_; ***REMOVED***

  std::string name() const { return cz_.name(); ***REMOVED***
...
***REMOVED***
 ...
 private:
  friend bool operator==(TimeZone a, TimeZone b) { return a.cz_ == b.cz_; ***REMOVED***
  friend bool operator!=(TimeZone a, TimeZone b) { return a.cz_ != b.cz_; ***REMOVED***
...
constexpr int64_t GetRepHi(Duration d) { return d.rep_hi_; ***REMOVED***
constexpr uint32_t GetRepLo(Duration d) { return d.rep_lo_; ***REMOVED***

// Returns true iff d is positive or negative infinity.
constexpr bool IsInfiniteDuration(Duration d) { return GetRepLo(d) == ~0U; ***REMOVED***
...
constexpr Time FromUnixDuration(Duration d) { return Time(d); ***REMOVED***
constexpr Duration ToUnixDuration(Time t) { return t.rep_; ***REMOVED***
...
// IsValidRep64<T>(0) is true if the expression `int64_t{std::declval<T>()***REMOVED***` is
// valid. That is, if a T can be assigned to an int64_t without narrowing.
template <typename T>
constexpr auto IsValidRep64(int)
    -> decltype(int64_t{std::declval<T>()***REMOVED***, bool()) {
  return true;
***REMOVED***
template <typename T>
...
constexpr Duration FromChrono(const std::chrono::duration<Rep, Period>& d) {
  ...
  return FromInt64(int64_t{d.count()***REMOVED***, Period{***REMOVED***);
***REMOVED***
...
T ToChronoDuration(Duration d) {
  ...
  const auto v = ToInt64(d, Period{***REMOVED***);
...
constexpr Duration Nanoseconds(int64_t n) {
  return time_internal::FromInt64(n, std::nano{***REMOVED***);
***REMOVED***
constexpr Duration Microseconds(int64_t n) {
  return time_internal::FromInt64(n, std::micro{***REMOVED***);
***REMOVED***
constexpr Duration Milliseconds(int64_t n) {
  return time_internal::FromInt64(n, std::milli{***REMOVED***);
***REMOVED***
constexpr Duration Seconds(int64_t n) {
  return time_internal::FromInt64(n, std::ratio<1>{***REMOVED***);
***REMOVED***
constexpr Duration Minutes(int64_t n) {
  return time_internal::FromInt64(n, std::ratio<60>{***REMOVED***);
***REMOVED***
constexpr Duration Hours(int64_t n) {
  return time_internal::FromInt64(n, std::ratio<3600>{***REMOVED***);
***REMOVED***
