...
struct fields {
  CONSTEXPR_M fields(year_t year, month_t month, day_t day,
      ...
      : y(year), m(month), d(day), hh(hour), mm(minute), ss(second) {***REMOVED***
  std::int_least64_t y;
  std::int_least8_t m;
  std::int_least8_t d;
  std::int_least8_t hh;
...
struct second_tag {***REMOVED***;
struct minute_tag : second_tag {***REMOVED***;
struct hour_tag : minute_tag {***REMOVED***;
struct day_tag : hour_tag {***REMOVED***;
struct month_tag : day_tag {***REMOVED***;
struct year_tag : month_tag {***REMOVED***;
...
CONSTEXPR_F diff_t day_difference(year_t y1, month_t m1, day_t d1,
  ...
  if (c4_diff > 0 && delta < 0) {
    delta += 2 * 146097;
    c4_diff -= 2 * 400;
***REMOVED*** else if (c4_diff < 0 && delta > 0) {
    delta -= 2 * 146097;
    c4_diff += 2 * 400;
***REMOVED***
...
CONSTEXPR_F diff_t difference(month_tag, fields f1, fields f2) noexcept {
  return impl::scale_add(difference(year_tag{***REMOVED***, f1, f2), 12, (f1.m - f2.m));
***REMOVED***
...
CONSTEXPR_F diff_t difference(hour_tag, fields f1, fields f2) noexcept {
  return impl::scale_add(difference(day_tag{***REMOVED***, f1, f2), 24, (f1.hh - f2.hh));
***REMOVED***
CONSTEXPR_F diff_t difference(minute_tag, fields f1, fields f2) noexcept {
  return impl::scale_add(difference(hour_tag{***REMOVED***, f1, f2), 60, (f1.mm - f2.mm));
***REMOVED***
CONSTEXPR_F diff_t difference(second_tag, fields f1, fields f2) noexcept {
  return impl::scale_add(difference(minute_tag{***REMOVED***, f1, f2), 60, f1.ss - f2.ss);
***REMOVED***
...
class civil_time {
 public:
  explicit CONSTEXPR_M civil_time(year_t y, diff_t m = 1, diff_t d = 1,
      ...
      : civil_time(impl::n_sec(y, m, d, hh, mm, ss)) {***REMOVED***

  CONSTEXPR_M civil_time() noexcept : f_{1970, 1, 1, 0, 0, 0***REMOVED*** {***REMOVED***
...
***REMOVED***
  ...
  CONSTEXPR_M year_t year() const noexcept { return f_.y; ***REMOVED***
  CONSTEXPR_M int month() const noexcept { return f_.m; ***REMOVED***
  CONSTEXPR_M int day() const noexcept { return f_.d; ***REMOVED***
  CONSTEXPR_M int hour() const noexcept { return f_.hh; ***REMOVED***
  CONSTEXPR_M int minute() const noexcept { return f_.mm; ***REMOVED***
  CONSTEXPR_M int second() const noexcept { return f_.ss; ***REMOVED***

  // Assigning arithmetic.
  CONSTEXPR_M civil_time& operator+=(diff_t n) noexcept {
    f_ = step(T{***REMOVED***, f_, n);
    return *this;
***REMOVED***
  CONSTEXPR_M civil_time& operator-=(diff_t n) noexcept {
    if (n != (std::numeric_limits<diff_t>::min)()) {
      f_ = step(T{***REMOVED***, f_, -n);
  ***REMOVED*** else {
      f_ = step(T{***REMOVED***, step(T{***REMOVED***, f_, -(n + 1)), 1);
  ***REMOVED***
    return *this;
***REMOVED***
...
***REMOVED***
  friend CONSTEXPR_F diff_t operator-(civil_time lhs, civil_time rhs) noexcept {
    return difference(T{***REMOVED***, lhs.f_, rhs.f_);
***REMOVED***

  template <typename H>
  friend H AbslHashValue(H h, civil_time a) {
    return impl::AbslHashValueImpl(T{***REMOVED***, std::move(h), a.f_);
***REMOVED***
 ...
 private:
  ...
  explicit CONSTEXPR_M civil_time(fields f) noexcept : f_(align(T{***REMOVED***, f)) {***REMOVED***
