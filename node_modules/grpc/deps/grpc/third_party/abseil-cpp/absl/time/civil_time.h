...
struct second_tag : cctz::detail::second_tag {***REMOVED***;
struct minute_tag : second_tag, cctz::detail::minute_tag {***REMOVED***;
struct hour_tag : minute_tag, cctz::detail::hour_tag {***REMOVED***;
struct day_tag : hour_tag, cctz::detail::day_tag {***REMOVED***;
struct month_tag : day_tag, cctz::detail::month_tag {***REMOVED***;
struct year_tag : month_tag, cctz::detail::year_tag {***REMOVED***;
