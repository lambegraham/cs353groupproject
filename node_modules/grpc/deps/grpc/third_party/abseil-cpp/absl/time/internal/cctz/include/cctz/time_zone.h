...
//   cctz::time_zone lax;
//   if (!cctz::load_time_zone("America/Los_Angeles", &lax)) { ... ***REMOVED***
//
// See also:
...
class time_zone {
 public:
  time_zone() : time_zone(nullptr) {***REMOVED***  // Equivalent to UTC
...
***REMOVED***
  ...
  // Example:
  //   cctz::time_zone nyc;
  //   if (!cctz::load_time_zone("America/New_York", &nyc)) { ... ***REMOVED***
...
***REMOVED***
 ...
 private:
  explicit time_zone(const Impl* impl) : impl_(impl) {***REMOVED***
