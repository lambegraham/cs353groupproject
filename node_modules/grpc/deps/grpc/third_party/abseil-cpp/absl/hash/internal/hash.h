...
class HashStateBase {
 public:
  ...
  static H combine(H state) { return state; ***REMOVED***
...
struct is_uniquely_represented : std::false_type {***REMOVED***;
...
template <>
struct is_uniquely_represented<unsigned char> : std::true_type {***REMOVED***;
...
//
template <>
struct is_uniquely_represented<bool> : std::false_type {***REMOVED***;
...
AbslHashValue(H hash_state, const absl::variant<T...>& v) {
  if (!v.valueless_by_exception()) {
    hash_state = absl::visit(VariantVisitor<H>{std::move(hash_state)***REMOVED***, v);
***REMOVED***
  ...
  struct LegacyHashProbe {
    ...
    static auto Invoke(H state, const T& value) -> absl::enable_if_t<
      ...
      return hash_internal::hash_bytes(
          std::move(state),
          ABSL_INTERNAL_LEGACY_HASH_NAMESPACE::hash<T>{***REMOVED***(value));
  ***REMOVED***
...
***REMOVED***
  ...
  struct StdHashProbe {
    ...
    static auto Invoke(H state, const T& value)
      ...
      return hash_internal::hash_bytes(std::move(state), std::hash<T>{***REMOVED***(value));
  ***REMOVED***
***REMOVED***
...
template <typename T>
struct is_hashable
    : std::integral_constant<bool, HashSelect::template Apply<T>::value> {***REMOVED***;
...
class CityHashState : public HashStateBase<CityHashState> {
  ...
  static constexpr uint64_t kMul =
      sizeof(size_t) == 4 ? uint64_t{0xcc9e2d51***REMOVED*** : uint64_t{0x9ddfea08eb382d69***REMOVED***;
  ...
  static CityHashState combine_contiguous(CityHashState hash_state,
    ...
    return CityHashState(
        CombineContiguousImpl(hash_state.state_, first, size,
                              std::integral_constant<int, sizeof(size_t)>{***REMOVED***));
***REMOVED***
...
***REMOVED***
  ...
  static size_t hash(const T& value) {
    return static_cast<size_t>(combine(CityHashState{***REMOVED***, value).state_);
***REMOVED***

 private:
  // Invoked only once for a given argument; that plus the fact that this is
  // move-only ensures that there is only one non-moved-from object.
  CityHashState() : state_(Seed()) {***REMOVED***
  ...
  explicit CityHashState(uint64_t state) : state_(state) {***REMOVED***
  ...
  static std::pair<uint64_t, uint64_t> Read9To16(const unsigned char* p,
    ...
    return {little_endian::Load64(p), high >> (128 - len * 8)***REMOVED***;
***REMOVED***
...
***REMOVED*** else if (len >= 4) {
    v = Read4To8(first, len);
***REMOVED*** else if (len > 0) {
...
struct AggregateBarrier {***REMOVED***;
...
template <typename T>
struct HashImpl {
  size_t operator()(const T& value) const { return CityHashState::hash(value); ***REMOVED***
***REMOVED***;

template <typename T>
struct Hash
    : absl::conditional_t<is_hashable<T>::value, HashImpl<T>, PoisonedHash> {***REMOVED***;
...
***REMOVED***
***REMOVED***  // namespace hash_internal
