...
//
//   EXPECT_TRUE(absl::VerifyTypeImplementsAbslHashCorrectly(
//       std::make_tuple(v1, v2, ..., vN), MyCustomEq{***REMOVED***));
//
...
VerifyTypeImplementsAbslHashCorrectly(const Container& values, Eq equals) {
  ...
  struct Info {
    ...
    std::string ToString() const {
      return absl::visit(PrintVisitor{index***REMOVED***, value);
  ***REMOVED***
    SpyHashState expand() const { return absl::visit(ExpandVisitor{***REMOVED***, value); ***REMOVED***
***REMOVED***
  ...
  for (const auto& value : values) {
    ...
    for (auto& eqclass : classes) {
      if (absl::visit(EqVisitor<Eq>{equals***REMOVED***, value, eqclass[0].value)) {
        c = &eqclass;
        break;
    ***REMOVED***
  ***REMOVED***
...
template <typename... T>
struct MakeTypeSet : TypeSet<> {***REMOVED***;
template <typename T, typename... Ts>
struct MakeTypeSet<T, Ts...> : MakeTypeSet<Ts...>::template Insert<T>::type {***REMOVED***;
...
struct ContainerAsVector<std::tuple<T...>> {
  ...
  static Out DoImpl(const std::tuple<T...>& tuple, absl::index_sequence<I...>) {
    return Out{&std::get<I>(tuple)...***REMOVED***;
***REMOVED***
...
struct ContainerAsVector<std::tuple<>> {
  static std::vector<VariantForTypes<int>> Do(std::tuple<>) { return {***REMOVED***; ***REMOVED***
***REMOVED***;
...
VerifyTypeImplementsAbslHashCorrectly(const Container& values) {
  return hash_internal::VerifyTypeImplementsAbslHashCorrectly(
      ...
      hash_internal::DefaultEquals{***REMOVED***);
***REMOVED***
