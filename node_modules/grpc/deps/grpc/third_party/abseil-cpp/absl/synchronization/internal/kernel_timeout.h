...
// Constructible from a absl::Time (for a timeout to be respected) or {***REMOVED***
// (for "no timeout".)
...
class KernelTimeout {
 public:
  ...
  // respected.
  explicit KernelTimeout(absl::Time t) : ns_(MakeNs(t)) {***REMOVED***
  // No timeout.
  KernelTimeout() : ns_(0) {***REMOVED***

  // A more explicit factory for those who prefer it.  Equivalent to {***REMOVED***.
  static KernelTimeout Never() { return {***REMOVED***; ***REMOVED***

  // We explicitly do not support other custom formats: timespec, int64_t nanos.
  // Unify on this and absl::Time, please.

  bool has_timeout() const { return ns_ != 0; ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
    ...
    int64_t seconds = (std::min)(n / kNanosPerSecond,
                               int64_t{(std::numeric_limits<time_t>::max)()***REMOVED***);
