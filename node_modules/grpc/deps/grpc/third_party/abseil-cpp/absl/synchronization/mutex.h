...
class LOCKABLE Mutex {
 public:
  ...
  void WriterLock() EXCLUSIVE_LOCK_FUNCTION() { this->Lock(); ***REMOVED***

  void WriterUnlock() UNLOCK_FUNCTION() { this->Unlock(); ***REMOVED***
...
***REMOVED***
  ...
  // simultaneously:
  //   - either `cond` is true or the {timeout has expired, deadline has passed***REMOVED***
  //     and
...
***REMOVED***
 ...
 private:
  ...
  synchronization_internal::MutexImpl *impl() { return impl_.get(); ***REMOVED***
  ...
  Mutex(const volatile Mutex * /*ignored*/) {***REMOVED***  // NOLINT(runtime/explicit)
...
***REMOVED***
  ...
  ~MutexLock() UNLOCK_FUNCTION() { this->mu_->Unlock(); ***REMOVED***
...
//
//   mu_.LockWhen(Condition(+[](int* count) { return *count == 0; ***REMOVED***,
//         &count_));
//
...
class Condition {
 public:
  ...
  //     Condition(+[](T* t) { return ...; ***REMOVED***, arg).
  //
  ...
  explicit Condition(const T *obj)
      : Condition(obj, static_cast<bool (T::*)() const>(&T::operator())) {***REMOVED***
...
//       mu.Lock();
//       while (!C) { cv->Wait(&mu); ***REMOVED***        // releases and reacquires mu
...
class CondVar {
 ...
 private:
#ifdef ABSL_INTERNAL_USE_NONPROD_MUTEX
  synchronization_internal::CondVarImpl *impl() { return impl_.get(); ***REMOVED***
  synchronization_internal::SynchronizationStorage<
...
class SCOPED_LOCKABLE MutexLockMaybe {
 public:
  explicit MutexLockMaybe(Mutex *mu) EXCLUSIVE_LOCK_FUNCTION(mu)
      : mu_(mu) { if (this->mu_ != nullptr) { this->mu_->Lock(); ***REMOVED*** ***REMOVED***
  ~MutexLockMaybe() UNLOCK_FUNCTION() {
    if (this->mu_ != nullptr) { this->mu_->Unlock(); ***REMOVED***
***REMOVED***
 private:
  Mutex *const mu_;
...
#ifdef ABSL_INTERNAL_USE_NONPROD_MUTEX
inline constexpr Mutex::Mutex(absl::ConstInitType) : impl_(absl::kConstInit) {***REMOVED***
...
inline constexpr Mutex::Mutex(absl::ConstInitType) : mu_(0) {***REMOVED***

inline CondVar::CondVar() : cv_(0) {***REMOVED***
#endif
...
inline Condition::Condition(bool (*func)(T *), T *arg)
    : eval_(&CastAndCallFunction<T>),
      ...
      method_(nullptr),
      arg_(const_cast<void *>(static_cast<const void *>(arg))) {***REMOVED***
...
inline Condition::Condition(const T *object,
    ...
    : eval_(&CastAndCallMethod<T>),
      function_(nullptr),
      method_(reinterpret_cast<InternalMethodType>(method)),
      arg_(reinterpret_cast<void *>(const_cast<T *>(object))) {***REMOVED***
