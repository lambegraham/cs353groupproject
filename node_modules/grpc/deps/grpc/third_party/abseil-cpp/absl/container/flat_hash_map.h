...
***REMOVED***
  ...
  static size_t space_used(const slot_type*) { return 0; ***REMOVED***

  static std::pair<const K, V>& element(slot_type* slot) { return slot->value; ***REMOVED***

  static V& value(std::pair<const K, V>* kv) { return kv->second; ***REMOVED***
  static const V& value(const std::pair<const K, V>* kv) { return kv->second; ***REMOVED***
***REMOVED***;
...
struct IsUnorderedContainer<
    absl::flat_hash_map<Key, T, Hash, KeyEqual, Allocator>> : std::true_type {***REMOVED***;
