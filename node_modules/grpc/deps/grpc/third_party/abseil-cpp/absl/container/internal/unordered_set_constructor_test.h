...
class ConstructorTest : public ::testing::Test {***REMOVED***;
...
template <typename T>
struct is_std_unordered_set : std::false_type {***REMOVED***;

template <typename... T>
struct is_std_unordered_set<std::unordered_set<T...>> : std::true_type {***REMOVED***;
...
void BucketCountAllocTest(std::false_type) {***REMOVED***
...
template <typename TypeParam>
void BucketCountHashAllocTest(std::false_type) {***REMOVED***
...
template <typename TypeParam>
void AllocTest(std::false_type) {***REMOVED***
...
template <typename TypeParam>
void InputIteratorBucketAllocTest(std::false_type) {***REMOVED***
...
template <typename TypeParam>
void InputIteratorBucketHashAllocTest(std::false_type) {***REMOVED***
...
template <typename TypeParam>
void CopyConstructorAllocTest(std::false_type) {***REMOVED***
...
template <typename TypeParam>
void MoveConstructorAllocTest(std::false_type) {***REMOVED***
...
TYPED_TEST_P(ConstructorTest, InitializerListBucketHashEqualAlloc) {
  ...
  std::initializer_list<T> values = {gen(), gen(), gen(), gen(), gen()***REMOVED***;
  using H = typename TypeParam::hasher;
  using E = typename TypeParam::key_equal;
  using A = typename TypeParam::allocator_type;
  H hasher;
...
template <typename TypeParam>
void InitializerListBucketAllocTest(std::false_type) {***REMOVED***
...
template <typename TypeParam>
void InitializerListBucketHashAllocTest(std::false_type) {***REMOVED***
...
TYPED_TEST_P(ConstructorTest, CopyAssignment) {
  ...
  A alloc(0);
  hash_internal::Generator<T> gen;
  TypeParam m({gen(), gen(), gen()***REMOVED***, 123, hasher, equal, alloc);
  TypeParam n;
  n = m;
  EXPECT_EQ(m.hash_function(), n.hash_function());
  EXPECT_EQ(m.key_eq(), n.key_eq());
...
TYPED_TEST_P(ConstructorTest, AssignmentOverwritesExisting) {
  using T = hash_internal::GeneratedType<TypeParam>;
  hash_internal::Generator<T> gen;
  TypeParam m({gen(), gen(), gen()***REMOVED***);
  TypeParam n({gen()***REMOVED***);
  n = m;
  EXPECT_EQ(m, n);
***REMOVED***
