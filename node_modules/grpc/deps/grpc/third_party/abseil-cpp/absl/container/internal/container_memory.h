...
void* Allocate(Alloc* alloc, size_t n) {
  ...
  struct alignas(Alignment) M {***REMOVED***;
...
decltype(std::declval<F>()(std::declval<T>())) WithConstructedImpl(
  ...
  return WithConstructedImplF<T, F>{std::forward<F>(f)***REMOVED***(
...
inline std::pair<std::tuple<>, std::tuple<>> PairArgs() { return {***REMOVED***; ***REMOVED***
template <class F, class S>
std::pair<std::tuple<F&&>, std::tuple<S&&>> PairArgs(F&& f, S&& s) {
  return {std::piecewise_construct, std::forward_as_tuple(std::forward<F>(f)),
          std::forward_as_tuple(std::forward<S>(s))***REMOVED***;
***REMOVED***
template <class F, class S>
...
***REMOVED***
 ...
 public:
  static value_type& element(slot_type* slot) { return slot->value; ***REMOVED***
