...
//
// This library supports std::unordered_{set,map***REMOVED***, dense_hash_{set,map***REMOVED*** and
// absl::{flat,node,string***REMOVED***_hash_{set,map***REMOVED***.
...
HashtableDebugProbeSummary GetHashtableDebugProbeSummary(const C& container) {
  ...
  HashtableDebugProbeSummary summary = {***REMOVED***;
