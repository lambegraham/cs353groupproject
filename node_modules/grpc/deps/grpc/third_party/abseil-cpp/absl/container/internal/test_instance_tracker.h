...
***REMOVED***
  ...
  int moves() const { return BaseCountedInstance::num_moves_ - start_moves_; ***REMOVED***
...
***REMOVED***
  ...
  // construction or the last call to ResetCopiesMovesSwaps().
  int swaps() const { return BaseCountedInstance::num_swaps_ - start_swaps_; ***REMOVED***
...
class CopyableOnlyInstance : public BaseCountedInstance {
 public:
  explicit CopyableOnlyInstance(int x) : BaseCountedInstance(x) {***REMOVED***
...
***REMOVED***
  ...
  static bool supports_move() { return false; ***REMOVED***
***REMOVED***;

// Copyable and movable.
class CopyableMovableInstance : public BaseCountedInstance {
 public:
  explicit CopyableMovableInstance(int x) : BaseCountedInstance(x) {***REMOVED***
...
***REMOVED***
  ...
  static bool supports_move() { return true; ***REMOVED***
***REMOVED***;

// Only movable, not default-constructible.
class MovableOnlyInstance : public BaseCountedInstance {
 public:
  explicit MovableOnlyInstance(int x) : BaseCountedInstance(x) {***REMOVED***
