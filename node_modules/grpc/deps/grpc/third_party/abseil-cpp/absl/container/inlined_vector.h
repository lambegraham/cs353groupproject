...
class InlinedVector {
 ...
 public:
  ...
  InlinedVector() noexcept(noexcept(allocator_type())) : storage_() {***REMOVED***

  // Creates an empty inlined vector with a specified allocator.
  explicit InlinedVector(const allocator_type& alloc) noexcept
      : storage_(alloc) {***REMOVED***
...
***REMOVED***
  ...
  InlinedVector(std::initializer_list<value_type> list,
                const allocator_type& alloc = allocator_type())
      : InlinedVector(list.begin(), list.end(), alloc) {***REMOVED***
...
***REMOVED***
  ...
  InlinedVector(const InlinedVector& other)
      : InlinedVector(other, *other.storage_.GetAllocPtr()) {***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED*** else if (other.storage_.GetIsAllocated()) {
...
***REMOVED***
  ...
  InlinedVector(InlinedVector&& other, const allocator_type& alloc) noexcept(
    ...
    if (IsMemcpyOk::value) {
      storage_.MemcpyFrom(other.storage_);
      other.storage_.SetInlinedSize(0);
  ***REMOVED*** else if ((*storage_.GetAllocPtr() == *other.storage_.GetAllocPtr()) &&
...
***REMOVED***
  ...
  bool empty() const noexcept { return !size(); ***REMOVED***

  // `InlinedVector::size()`
  //
  // Returns the number of elements in the inlined vector.
  size_type size() const noexcept { return storage_.GetSize(); ***REMOVED***
...
***REMOVED***
  ...
  iterator begin() noexcept { return data(); ***REMOVED***

  // Overload of `InlinedVector::begin()` to return a `const_iterator` to
  // the beginning of the inlined vector.
  const_iterator begin() const noexcept { return data(); ***REMOVED***

  // `InlinedVector::end()`
  //
  // Returns an `iterator` to the end of the inlined vector.
  iterator end() noexcept { return data() + size(); ***REMOVED***

  // Overload of `InlinedVector::end()` to return a `const_iterator` to the
  // end of the inlined vector.
  const_iterator end() const noexcept { return data() + size(); ***REMOVED***

  // `InlinedVector::cbegin()`
  //
  // Returns a `const_iterator` to the beginning of the inlined vector.
  const_iterator cbegin() const noexcept { return begin(); ***REMOVED***

  // `InlinedVector::cend()`
  //
  // Returns a `const_iterator` to the end of the inlined vector.
  const_iterator cend() const noexcept { return end(); ***REMOVED***

  // `InlinedVector::rbegin()`
  //
  // Returns a `reverse_iterator` from the end of the inlined vector.
  reverse_iterator rbegin() noexcept { return reverse_iterator(end()); ***REMOVED***
...
***REMOVED***
  ...
  reverse_iterator rend() noexcept { return reverse_iterator(begin()); ***REMOVED***
...
***REMOVED***
  ...
  allocator_type get_allocator() const { return *storage_.GetAllocPtr(); ***REMOVED***
...
***REMOVED***
  ...
  void resize(size_type n) { storage_.Resize(DefaultValueAdapter(), n); ***REMOVED***
...
***REMOVED***
  ...
  void push_back(const_reference v) { static_cast<void>(emplace_back(v)); ***REMOVED***
...
***REMOVED***
  ...
  void reserve(size_type n) { storage_.Reserve(n); ***REMOVED***
