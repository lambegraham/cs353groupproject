...
//     {{"a", "huey"***REMOVED***, {"b", "dewey"***REMOVED***, {"c", "louie"***REMOVED******REMOVED***;
//
//  // Insert a new element into the node hash map
//  ducks.insert({"d", "donald"***REMOVED******REMOVED***;
//
...
class node_hash_map
 ...
 public:
  ...
  //       {{1, "huey"***REMOVED***, {2, "dewey"***REMOVED***, {3, "louie"***REMOVED***,***REMOVED***;
  //
  // * Copy constructor
  //
  ...
  // * Range constructor
  //
  //   std::vector<std::pair<int, std::string>> v = {{1, "a"***REMOVED***, {2, "b"***REMOVED******REMOVED***;
  //   absl::node_hash_map<int, std::string> map7(v.begin(), v.end());
  node_hash_map() {***REMOVED***
  using Base::Base;
  ...
  typename Base::hasher hash_funct() { return this->hash_function(); ***REMOVED***

  ABSL_DEPRECATED("Call `rehash()` instead.")
  void resize(typename Base::size_type hint) { this->rehash(hint); ***REMOVED***
***REMOVED***;
...
***REMOVED***
  ...
  static Value& value(value_type* elem) { return elem->second; ***REMOVED***
  static const Value& value(const value_type* elem) { return elem->second; ***REMOVED***
***REMOVED***;
***REMOVED***  // namespace container_internal
...
struct IsUnorderedContainer<
    absl::node_hash_map<Key, T, Hash, KeyEqual, Allocator>> : std::true_type {***REMOVED***;
