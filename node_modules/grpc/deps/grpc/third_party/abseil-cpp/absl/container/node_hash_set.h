...
//     {"huey", "dewey"***REMOVED***, "louie"***REMOVED***;
//
//  // Insert a new element into the node hash map
//  ducks.insert("donald"***REMOVED***;
//
...
class node_hash_set
 ...
 public:
  ...
  //       {{"huey"***REMOVED***, {"dewey"***REMOVED***, {"louie"***REMOVED***,***REMOVED***;
  //
  // * Copy constructor
  //
  ...
  // * Range constructor
  //
  //   std::vector<std::string> v = {"a", "b"***REMOVED***;
  //   absl::node_hash_set<std::string> set7(v.begin(), v.end());
  node_hash_set() {***REMOVED***
  using Base::Base;
...
***REMOVED***
  ...
  static size_t element_space_used(const T*) { return sizeof(T); ***REMOVED***
***REMOVED***;
***REMOVED***  // namespace container_internal
