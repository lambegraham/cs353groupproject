...
class HashtablezInfoHandle {
 public:
  explicit HashtablezInfoHandle() : info_(nullptr) {***REMOVED***
  explicit HashtablezInfoHandle(HashtablezInfo* info) : info_(info) {***REMOVED***
...
***REMOVED***
  ...
  HashtablezInfoHandle(HashtablezInfoHandle&& o) noexcept
      : info_(absl::exchange(o.info_, nullptr)) {***REMOVED***
