...
struct IsMap : std::false_type {***REMOVED***;

template <class Map>
struct IsMap<Map, absl::void_t<typename Map::mapped_type>> : std::true_type {***REMOVED***;

***REMOVED***  // namespace generator_internal
...
struct Generator<U, absl::void_t<decltype(std::declval<U&>().key()),
    ...
    : Generator<std::pair<
          ...
          typename std::decay<decltype(std::declval<U&>().value())>::type>> {***REMOVED***;
