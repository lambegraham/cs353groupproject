...
struct StringHash {
  ...
  size_t operator()(absl::string_view v) const {
    return absl::Hash<absl::string_view>{***REMOVED***(v);
***REMOVED***
***REMOVED***;
...
template <>
struct HashEq<std::string> : StringHashEq {***REMOVED***;
template <>
struct HashEq<absl::string_view> : StringHashEq {***REMOVED***;
...
struct HashEq<T*> {
  struct Hash {
    ...
    size_t operator()(const U& ptr) const {
      return absl::Hash<const T*>{***REMOVED***(HashEq::ToPtr(ptr));
  ***REMOVED***
***REMOVED***
  struct Eq {
    using is_transparent = void;
...
***REMOVED***
 ...
 private:
  static const T* ToPtr(const T* ptr) { return ptr; ***REMOVED***
...
struct HashEq<std::unique_ptr<T, D>> : HashEq<T*> {***REMOVED***;
template <class T>
struct HashEq<std::shared_ptr<T>> : HashEq<T*> {***REMOVED***;
