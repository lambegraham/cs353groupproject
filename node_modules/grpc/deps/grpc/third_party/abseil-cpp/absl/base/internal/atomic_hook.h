...
class AtomicHook<ReturnType (*)(Args...)> {
 public:
  ...
  constexpr AtomicHook() : AtomicHook(DummyFunction) {***REMOVED***

  // Constructs an object that by default dispatches to/returns the
  // pre-registered default_fn when no hook has been registered at runtime.
#if ABSL_HAVE_WORKING_ATOMIC_POINTER
  explicit constexpr AtomicHook(FnPtr default_fn)
      : hook_(default_fn), default_fn_(default_fn) {***REMOVED***
#else
  explicit constexpr AtomicHook(FnPtr default_fn)
      : hook_(kUninitialized), default_fn_(default_fn) {***REMOVED***
#endif
...
***REMOVED***
  ...
  FnPtr DoLoad() const { return hook_.load(std::memory_order_acquire); ***REMOVED***
