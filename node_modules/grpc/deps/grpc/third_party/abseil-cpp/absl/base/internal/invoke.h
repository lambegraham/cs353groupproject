...
struct StrippedAccept {
  ...
  struct Accept : Derived::template AcceptImpl<typename std::remove_cv<
                      typename std::remove_reference<Args>::type>::type...> {***REMOVED***;
***REMOVED***;
...
struct MemFunAndPtr : StrippedAccept<MemFunAndPtr> {
  ...
  struct AcceptImpl<R (C::*)(Params...), Ptr, Args...>
      : std::integral_constant<bool, !std::is_base_of<C, Ptr>::value> {***REMOVED***;
...
struct DataMemAndRef : StrippedAccept<DataMemAndRef> {
  ...
  struct AcceptImpl<R C::*, Obj> : std::is_base_of<C, Obj> {***REMOVED***;
