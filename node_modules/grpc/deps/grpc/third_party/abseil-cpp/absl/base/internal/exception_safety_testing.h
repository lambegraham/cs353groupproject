...
struct NoThrowTag {***REMOVED***;
struct StrongGuaranteeTagType {***REMOVED***;

// A simple exception class.  We throw this so that test code can catch
// exceptions specifically thrown by ThrowingValue.
class TestException {
 public:
  explicit TestException(absl::string_view msg) : msg_(msg) {***REMOVED***
  virtual ~TestException() {***REMOVED***
  virtual const char* what() const noexcept { return msg_.c_str(); ***REMOVED***
...
class TestBadAllocException : public std::bad_alloc, public TestException {
 public:
  explicit TestBadAllocException(absl::string_view msg) : TestException(msg) {***REMOVED***
...
// value of 0)
inline void SetCountdown(int i = 0) { countdown = i; ***REMOVED***
// Sets the countdown to the terminal value -1
inline void UnsetCountdown() { SetCountdown(-1); ***REMOVED***
    ...
    if (tracked_address.is_alive) {
      ADD_FAILURE() << ErrorMessage(
          ...
          "Object was re-constructed. Current object was constructed by " +
              description);
  ***REMOVED***
    tracked_address = {true, std::move(description)***REMOVED***;
***REMOVED***
...
***REMOVED***
  ...
  ~TrackedObject() noexcept { ConstructorTracker::ObjectDestructed(this); ***REMOVED***
***REMOVED***;
***REMOVED***  // namespace exceptions_internal
...
class ThrowingBool {
 public:
  ThrowingBool(bool b) noexcept : b_(b) {***REMOVED***  // NOLINT(runtime/explicit)
 ...
 *   ThrowingValue<testing::kNoThrowMove | testing::kNoThrowCopy> my_thrwr{val***REMOVED***;
 */
...
***REMOVED***
  ...
  ThrowingValue(int i, exceptions_internal::NoThrowTag) noexcept
      : TrackedObject(GetInstanceString(i)), dummy_(i) {***REMOVED***
...
***REMOVED***
  ...
  void operator delete(void* p) noexcept { ::operator delete(p); ***REMOVED***
...
***REMOVED***
  ...
  void operator delete[](void* p) noexcept { return ::operator delete[](p); ***REMOVED***
...
***REMOVED***
  ...
  // throw.
  int& Get() noexcept { return dummy_; ***REMOVED***
  const int& Get() const noexcept { return dummy_; ***REMOVED***
...
***REMOVED***
  ...
  ThrowingAllocator(ThrowingAllocator<U, Spec>&& other) noexcept  // NOLINT
      : TrackedObject(GetInstanceString(*other.State())),
        dummy_(std::move(other.State())) {***REMOVED***
...
***REMOVED***
  ...
  const std::shared_ptr<const int>& State() const { return dummy_; ***REMOVED***
  std::shared_ptr<const int>& State() { return dummy_; ***REMOVED***
...
void TestThrowingCtor(Args&&... args) {
  struct Cleanup {
    ~Cleanup() { exceptions_internal::UnsetCountdown(); ***REMOVED***
***REMOVED*** c;
  for (int count = 0;; ++count) {
    ...
    try {
      ...
      break;
  ***REMOVED*** catch (const exceptions_internal::TestException&) {
  ***REMOVED***
***REMOVED***
***REMOVED***
...
testing::AssertionResult TestNothrowOp(const Operation& operation) {
  struct Cleanup {
    Cleanup() { exceptions_internal::SetCountdown(); ***REMOVED***
    ~Cleanup() { exceptions_internal::UnsetCountdown(); ***REMOVED***
***REMOVED*** c;
  try {
    operation();
...
struct UninitializedT {***REMOVED***;

template <typename T>
class DefaultFactory {
 public:
  explicit DefaultFactory(const T& t) : t_(t) {***REMOVED***
  std::unique_ptr<T> operator()() const { return absl::make_unique<T>(t_); ***REMOVED***
...
namespace exceptions_internal {
template <typename T>
struct IsUniquePtr : std::false_type {***REMOVED***;

template <typename T, typename D>
struct IsUniquePtr<std::unique_ptr<T, D>> : std::true_type {***REMOVED***;
...
class ExceptionSafetyTest {
 ...
 public:
  ...
  explicit ExceptionSafetyTest(const Factory& f, const Operation& op,
      ...
      : factory_(f), operation_(op), contracts_{WrapContract(contracts)...***REMOVED*** {***REMOVED***
  ...
  AssertionResult Test() const {
    for (int count = 0;; ++count) {
      ...
      ***REMOVED*** catch (const exceptions_internal::TestException& e) {
...
***REMOVED***
 ...
 private:
  ...
  Contract WrapContract(const ContractFn& contract) {
    return [contract](T* t_ptr) { return AssertionResult(contract(t_ptr)); ***REMOVED***;
***REMOVED***

  Contract WrapContract(StrongGuaranteeTagType) {
    return [this](T* t_ptr) { return AssertionResult(*factory_() == *t_ptr); ***REMOVED***;
***REMOVED***
...
***REMOVED***
  ...
  WithFactory(const NewFactory& new_factory) const {
    return {new_factory, operation_, contracts_***REMOVED***;
***REMOVED***
  ...
  WithOperation(const NewOperation& new_operation) const {
    return {factory_, new_operation, contracts_***REMOVED***;
***REMOVED***
...
***REMOVED***
 ...
 private:
  ...
  ExceptionSafetyTestBuilder() {***REMOVED***

  ExceptionSafetyTestBuilder(const Factory& f, const Operation& o,
                             const std::tuple<Contracts...>& i)
      : factory_(f), operation_(o), contracts_(i) {***REMOVED***
