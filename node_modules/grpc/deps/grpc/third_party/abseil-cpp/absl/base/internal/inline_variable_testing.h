...
ABSL_INTERNAL_INLINE_CONSTEXPR(Foo, inline_variable_foo, {***REMOVED***);
ABSL_INTERNAL_INLINE_CONSTEXPR(Foo, other_inline_variable_foo, {***REMOVED***);
...
***REMOVED***  // namespace inline_variable_testing_internal
