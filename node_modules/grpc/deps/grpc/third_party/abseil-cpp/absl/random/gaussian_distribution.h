...
class gaussian_distribution_base {
 ...
 private:
  ...
  //
  // x = {3.71308, 3.44261, 3.22308, ..., 0***REMOVED***
  // f = {0.00101, 0.00266, 0.00554, ..., 1***REMOVED***
  struct Tables {
    double x[kMask + 2];
    double f[kMask + 2];
***REMOVED***
...
***REMOVED***  // namespace random_internal
...
***REMOVED***
  ...
  gaussian_distribution() : gaussian_distribution(0) {***REMOVED***

  explicit gaussian_distribution(result_type mean, result_type stddev = 1)
      : param_(mean, stddev) {***REMOVED***

  explicit gaussian_distribution(const param_type& p) : param_(p) {***REMOVED***
...
***REMOVED***
  ...
  result_type mean() const { return param_.mean(); ***REMOVED***
  result_type stddev() const { return param_.stddev(); ***REMOVED***
