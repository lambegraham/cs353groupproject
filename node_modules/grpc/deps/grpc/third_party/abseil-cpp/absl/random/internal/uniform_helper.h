...
struct IntervalClosedClosedT {***REMOVED***;
struct IntervalClosedOpenT {***REMOVED***;
struct IntervalOpenClosedT {***REMOVED***;
struct IntervalOpenOpenT {***REMOVED***;
...
struct UniformDistributionWrapper : public UniformDistribution<NumType> {
  explicit UniformDistributionWrapper(NumType lo, NumType hi)
      : UniformDistribution<NumType>(
            uniform_lower_bound<NumType>(TagType{***REMOVED***, lo, hi),
            uniform_upper_bound<NumType>(TagType{***REMOVED***, lo, hi)) {***REMOVED***
***REMOVED***;
