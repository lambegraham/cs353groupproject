...
// a defined interval {lo, hi***REMOVED***. The interval `tag` defines the type of interval
...
// the return type based on the provided endpoint arguments {A lo, B hi***REMOVED***.
// Given these endpoints, one of {A, B***REMOVED*** will be chosen as the return type, if
// a type can be implicitly converted into the other in a lossless way. The
// lack of any such implcit conversion between {A, B***REMOVED*** will produce a
// compile-time error
//
