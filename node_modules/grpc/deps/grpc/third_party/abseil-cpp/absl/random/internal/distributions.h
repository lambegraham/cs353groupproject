...
// the data-types of the endpoint-arguments {A lo, B hi***REMOVED***.
//
// Given endpoints {A lo, B hi***REMOVED***, one of {A, B***REMOVED*** will be chosen as the
// return-type, if one type can be implicitly converted into the other, in a
// lossless way. The template "is_widening_convertible" implements the
// compile-time logic for deciding if such a conversion is possible.
//
// If no such conversion between {A, B***REMOVED*** exists, then the overload for
