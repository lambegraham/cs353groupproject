...
class uniform_int_distribution {
  ...
  ***REMOVED***
    ...
    result_type a() const { return lo_; ***REMOVED***
    result_type b() const {
...
***REMOVED***  // param_type
  ...
  uniform_int_distribution() : uniform_int_distribution(0) {***REMOVED***

  explicit uniform_int_distribution(
      result_type lo,
      result_type hi = (std::numeric_limits<result_type>::max)())
      : param_(lo, hi) {***REMOVED***

  explicit uniform_int_distribution(const param_type& param) : param_(param) {***REMOVED***
...
***REMOVED***
  ...
  result_type a() const { return param_.a(); ***REMOVED***
  result_type b() const { return param_.b(); ***REMOVED***

  param_type param() const { return param_; ***REMOVED***
  void param(const param_type& params) { param_ = params; ***REMOVED***

  result_type(min)() const { return a(); ***REMOVED***
  result_type(max)() const { return b(); ***REMOVED***
