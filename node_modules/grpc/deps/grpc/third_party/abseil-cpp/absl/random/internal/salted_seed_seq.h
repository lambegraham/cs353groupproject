...
class SaltedSeedSeq {
 public:
  ...
  SaltedSeedSeq() : seq_(absl::make_unique<SSeq>()) {***REMOVED***

  template <typename Iterator>
  SaltedSeedSeq(Iterator begin, Iterator end)
      : seq_(absl::make_unique<SSeq>(begin, end)) {***REMOVED***

  template <typename T>
  SaltedSeedSeq(std::initializer_list<T> il)
      : SaltedSeedSeq(il.begin(), il.end()) {***REMOVED***
  ...
  void generate(RandomAccessIterator begin, RandomAccessIterator end) {
    if (begin != end) {
      generate_impl(
          std::integral_constant<bool, sizeof(*begin) == sizeof(uint32_t)>{***REMOVED***,
          begin, end);
  ***REMOVED***
***REMOVED***
...
***REMOVED***
  ...
  size_t size() const { return seq_->size(); ***REMOVED***
...
***REMOVED***
  ...
  void generate_impl(std::integral_constant<bool, false> /*is_32bit*/,
    ...
    generate_impl(std::integral_constant<bool, true>{***REMOVED***, data.begin(),
                  data.end());
