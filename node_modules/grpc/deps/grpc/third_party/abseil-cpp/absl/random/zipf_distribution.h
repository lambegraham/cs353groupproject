 ...
 public:
  ...
  class param_type {
   public:
    ...
    result_type k() const { return k_; ***REMOVED***
    double q() const { return q_; ***REMOVED***
    double v() const { return v_; ***REMOVED***
...
***REMOVED***
  ...
  zipf_distribution()
      : zipf_distribution((std::numeric_limits<IntType>::max)()) {***REMOVED***

  explicit zipf_distribution(result_type k, double q = 2.0, double v = 1.0)
      : param_(k, q, v) {***REMOVED***

  explicit zipf_distribution(const param_type& p) : param_(p) {***REMOVED***
...
***REMOVED***
  ...
  result_type k() const { return param_.k(); ***REMOVED***
  double q() const { return param_.q(); ***REMOVED***
  double v() const { return param_.v(); ***REMOVED***
  ...
  result_type(max)() const { return k(); ***REMOVED***
