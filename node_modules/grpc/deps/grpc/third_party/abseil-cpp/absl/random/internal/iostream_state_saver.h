...
class null_state_saver {
 public:
  ...
  null_state_saver(T&, flags_type) {***REMOVED***
  ~null_state_saver() {***REMOVED***
***REMOVED***;
...
class istream_state_saver {
 public:
  ...
  istream_state_saver(istream_type& is,  // NOLINT(runtime/references)
                      flags_type flags)
      : is_(is), flags_(is.flags(flags)) {***REMOVED***

  ~istream_state_saver() { is_.flags(flags_); ***REMOVED***
...
struct stream_format_type
    : public std::conditional<(sizeof(T) == sizeof(char)), int, T> {***REMOVED***;
