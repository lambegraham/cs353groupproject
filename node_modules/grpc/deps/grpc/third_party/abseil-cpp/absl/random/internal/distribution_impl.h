...
struct PositiveValueT {***REMOVED***;
struct NegativeValueT {***REMOVED***;
struct SignedValueT {***REMOVED***;
...
***REMOVED***
  ...
  static input_type hi(result_type r) { return r >> kN; ***REMOVED***
  static input_type lo(result_type r) { return r; ***REMOVED***
...
***REMOVED***
  ...
  static uint64_t hi(result_type r) { return Uint128High64(r); ***REMOVED***
  static uint64_t lo(result_type r) { return Uint128Low64(r); ***REMOVED***
***REMOVED***;
#endif
