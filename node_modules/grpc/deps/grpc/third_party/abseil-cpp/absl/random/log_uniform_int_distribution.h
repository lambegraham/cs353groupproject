...
class log_uniform_int_distribution {
  ...
  ***REMOVED***
    ...
    result_type(min)() const { return min_; ***REMOVED***
    result_type(max)() const { return max_; ***REMOVED***
    result_type base() const { return base_; ***REMOVED***
  ...
  ***REMOVED***
   ...
   private:
    ...
    int log_range() const { return log_range_; ***REMOVED***
    unsigned_type range() const { return range_; ***REMOVED***
...
***REMOVED***
  ...
  log_uniform_int_distribution() : log_uniform_int_distribution(0) {***REMOVED***

  explicit log_uniform_int_distribution(
      result_type min,
      result_type max = (std::numeric_limits<result_type>::max)(),
      result_type base = 2)
      : param_(min, max, base) {***REMOVED***

  explicit log_uniform_int_distribution(const param_type& p) : param_(p) {***REMOVED***
...
***REMOVED***
  ...
  result_type(min)() const { return (param_.min)(); ***REMOVED***
  result_type(max)() const { return (param_.max)(); ***REMOVED***
  result_type base() const { return param_.base(); ***REMOVED***
