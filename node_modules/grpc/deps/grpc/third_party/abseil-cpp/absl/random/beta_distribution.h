...
class beta_distribution {
  ...
  ***REMOVED***
    ...
    result_type alpha() const { return alpha_; ***REMOVED***
    result_type beta() const { return beta_; ***REMOVED***
...
#undef ABSL_RANDOM_INTERNAL_LOG_EXP_CONSTEXPR
    ...
    static constexpr result_type ThresholdPadding() { return 0; ***REMOVED***
  ...
  ***REMOVED***
    ...
    result_type a_;  // the smaller of {alpha, beta***REMOVED***, or 1.0/alpha_ in JOEHNK
    result_type b_;  // the larger of {alpha, beta***REMOVED***, or 1.0/beta_ in JOEHNK
...
***REMOVED***
  ...
  beta_distribution() : beta_distribution(1) {***REMOVED***

  explicit beta_distribution(result_type alpha, result_type beta = 1)
      : param_(alpha, beta) {***REMOVED***

  explicit beta_distribution(const param_type& p) : param_(p) {***REMOVED***
...
***REMOVED***
  ...
  param_type param() const { return param_; ***REMOVED***
  void param(const param_type& p) { param_ = p; ***REMOVED***

  result_type(min)() const { return 0; ***REMOVED***
  result_type(max)() const { return 1; ***REMOVED***

  result_type alpha() const { return param_.alpha(); ***REMOVED***
  result_type beta() const { return param_.beta(); ***REMOVED***
