...
constexpr typename URBG::result_type constexpr_range() {
  ...
  return ((URBG::max)() == (std::numeric_limits<result_type>::max)() &&
          (URBG::min)() == std::numeric_limits<result_type>::lowest())
             ? result_type{0***REMOVED***
             : (URBG::max)() - (URBG::min)() + result_type{1***REMOVED***;
***REMOVED***
...
***REMOVED***
 ...
 public:
  ...
  static constexpr result_type(min)() { return 0; ***REMOVED***
...
FastUniformBits<UIntType, Width>::operator()(
  ...
  return Generate(
      g, std::integral_constant<bool, constants::kRangeMask >= (max)()>{***REMOVED***);
***REMOVED***
...
***REMOVED***
  ...
  do {
    u = g() - (URBG::min)();
***REMOVED*** while (u > constants::kRangeMask);
  return u;
***REMOVED***
