...
class bernoulli_distribution {
  ...
  ***REMOVED***
    ...
    double p() const { return prob_; ***REMOVED***
...
***REMOVED***
  ...
  bernoulli_distribution() : bernoulli_distribution(0.5) {***REMOVED***

  explicit bernoulli_distribution(double p) : param_(p) {***REMOVED***

  explicit bernoulli_distribution(param_type p) : param_(p) {***REMOVED***
...
***REMOVED***
  ...
  void param(const param_type& param) { param_ = param; ***REMOVED***

  double p() const { return param_.p(); ***REMOVED***

  result_type(min)() const { return false; ***REMOVED***
  result_type(max)() const { return true; ***REMOVED***
