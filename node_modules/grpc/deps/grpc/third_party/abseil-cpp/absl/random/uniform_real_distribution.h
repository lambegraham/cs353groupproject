...
class uniform_real_distribution {
  ...
  ***REMOVED***
    ...
    result_type b() const { return hi_; ***REMOVED***
...
***REMOVED***
  ...
  uniform_real_distribution() : uniform_real_distribution(0) {***REMOVED***

  explicit uniform_real_distribution(result_type lo, result_type hi = 1)
      : param_(lo, hi) {***REMOVED***

  explicit uniform_real_distribution(const param_type& param) : param_(param) {***REMOVED***
