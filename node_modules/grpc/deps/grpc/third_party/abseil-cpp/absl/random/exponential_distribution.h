...
class exponential_distribution {
  ...
  ***REMOVED***
    ...
    result_type lambda() const { return lambda_; ***REMOVED***
...
***REMOVED***
  ...
  exponential_distribution() : exponential_distribution(1) {***REMOVED***

  explicit exponential_distribution(result_type lambda) : param_(lambda) {***REMOVED***

  explicit exponential_distribution(const param_type& p) : param_(p) {***REMOVED***
...
***REMOVED***
  ...
  result_type lambda() const { return param_.lambda(); ***REMOVED***
