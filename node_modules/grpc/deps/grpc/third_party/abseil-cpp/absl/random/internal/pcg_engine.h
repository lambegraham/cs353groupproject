...
***REMOVED***
  ...
  explicit pcg_engine(uint64_t seed_value = 0) { seed(seed_value); ***REMOVED***
...
***REMOVED***
  ...
  void discard(uint64_t count) { state_ = advance(state_, count); ***REMOVED***

  bool operator==(const pcg_engine& other) const {
    return state_ == other.state_;
***REMOVED***

  bool operator!=(const pcg_engine& other) const { return !(*this == other); ***REMOVED***
...
***REMOVED***
  ...
  operator>>(
      std::basic_istream<CharT, Traits>& is,  // NOLINT(runtime/references)
      pcg_engine& engine) {                   // NOLINT(runtime/references)
    state_type mult{***REMOVED***, inc{***REMOVED***, tmp{***REMOVED***;
    is >> mult >> inc >> tmp;
    if (mult != pcg_engine::params_type::multiplier() ||
        inc != pcg_engine::params_type::increment()) {
      // signal failure by setting the failbit.
...
class pcg64_params {
 public:
  ...
  static inline constexpr state_type multiplier() { return kMult; ***REMOVED***
  static inline constexpr state_type increment() { return kInc; ***REMOVED***
***REMOVED***;
