 ...
 public:
  ...
  class param_type {
   public:
    ...
    double mean() const { return mean_; ***REMOVED***
...
***REMOVED***
  ...
  poisson_distribution() : poisson_distribution(1.0) {***REMOVED***

  explicit poisson_distribution(double mean) : param_(mean) {***REMOVED***

  explicit poisson_distribution(const param_type& p) : param_(p) {***REMOVED***
...
***REMOVED***
  ...
  result_type(max)() const { return (std::numeric_limits<result_type>::max)(); ***REMOVED***

  double mean() const { return param_.mean(); ***REMOVED***
