...
constexpr bool AllOf() { return true; ***REMOVED***
...
struct ConvList {
  ...
  constexpr Conv operator[](int i) const {
    return i < count ? array[i] : Conv{***REMOVED***;
***REMOVED***

  constexpr ConvList without_front() const {
    return count != 0 ? ConvList{array + 1, count - 1***REMOVED*** : *this;
***REMOVED***
***REMOVED***;
...
constexpr char GetChar(string_view str, size_t index) {
  return index < str.size() ? str[index] : char{***REMOVED***;
***REMOVED***
...
constexpr bool IsDigit(char c) { return c >= '0' && c <= '9'; ***REMOVED***
...
struct Integer {
  ...
  constexpr Integer ConsumePositionalDollar() const {
    return GetChar(format, 0) == '$' ? Integer{ConsumeFront(format), value***REMOVED***
                                     : Integer{format, 0***REMOVED***;
***REMOVED***
***REMOVED***;
...
***REMOVED***
  ...
  constexpr ConvParser ParseConversion() const {
    return is_positional_
               ? VerifyPositional({ConsumeFront(format_), arg_position_***REMOVED***,
                                  GetChar(format_, 0))
...
***REMOVED***
  ...
  constexpr ConvParser(string_view format, ConvList args, bool error,
      ...
      : format_(format),
        ...
        is_positional_(is_positional) {***REMOVED***
...
***REMOVED***
  ...
  constexpr string_view format() const { return format_; ***REMOVED***
  constexpr ConvList args() const { return args_; ***REMOVED***
  constexpr bool error() const { return error_; ***REMOVED***
  constexpr bool is_positional() const { return is_positional_; ***REMOVED***
...
***REMOVED***
 ...
 public:
  constexpr FormatParser(string_view format, ConvList args)
      : format_(ConsumeNonPercent(format)), args_(args) {***REMOVED***
...
constexpr bool ValidFormatImpl(string_view format) {
  return FormatParser(format,
                      {ConvListT<sizeof...(C)>{{C...***REMOVED******REMOVED***.list, sizeof...(C)***REMOVED***)
      .Run();
***REMOVED***
