...
//       {{"$count", absl::StrCat(5)***REMOVED***,
//        {"$who", "Bob"***REMOVED***,
//        {"#Noun", "Apples"***REMOVED******REMOVED***);
...
//   replacements.push_back({"&", "&amp;"***REMOVED***);
//   replacements.push_back({"<", "&lt;"***REMOVED***);
//   replacements.push_back({">", "&gt;"***REMOVED***);
...
//   int count;
//   count = absl::StrReplaceAll({{"$count", absl::StrCat(5)***REMOVED***,
//                               {"$who", "Bob"***REMOVED***,
//                               {"#Noun", "Apples"***REMOVED******REMOVED***, &s);
//  EXPECT_EQ(count, 4);
//  EXPECT_EQ("Bob bought 5 Apples. Thanks Bob!", s);
int StrReplaceAll(
    std::initializer_list<std::pair<absl::string_view, absl::string_view>>
...
//   int count = absl::StrReplaceAll({{"&", "&amp;"***REMOVED***,
//                                    {"<", "&lt;"***REMOVED***,
//                                    {">", "&gt;"***REMOVED******REMOVED***, &s);
//  EXPECT_EQ(count, 2);
//  EXPECT_EQ("if (ptr &lt; &amp;foo)", s);
...
struct ViableSubstitution {
  ...
  ViableSubstitution(absl::string_view old_str,
      ...
      : old(old_str), replacement(replacement_str), offset(offset_val) {***REMOVED***
