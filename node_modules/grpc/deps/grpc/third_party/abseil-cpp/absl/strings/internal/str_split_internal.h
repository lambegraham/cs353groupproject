...
class ConvertibleToStringView {
 public:
  ConvertibleToStringView(const char* s)  // NOLINT(runtime/explicit)
      : value_(s) {***REMOVED***
  ConvertibleToStringView(char* s) : value_(s) {***REMOVED***  // NOLINT(runtime/explicit)
...
ConvertibleToStringView(std::string&& s)  // NOLINT(runtime/explicit)
    : copy_(std::move(s)), value_(copy_) {***REMOVED***

  ConvertibleToStringView(const ConvertibleToStringView& other)
      : copy_(other.copy_),
        value_(other.IsSelfReferential() ? copy_ : other.value_) {***REMOVED***
...
***REMOVED***
  ...
  absl::string_view value() const { return value_; ***REMOVED***

 private:
  // Returns true if ctsp's value refers to its internal copy_ member.
  bool IsSelfReferential() const { return value_.data() == copy_.data(); ***REMOVED***
...
class SplitIterator {
 public:
  ...
  enum State { kInitState, kLastState, kEndState ***REMOVED***;
  SplitIterator(State state, const Splitter* splitter)
    ...
    //   Split(absl::string_view(""), '-');  // {""***REMOVED***
    //   Split(absl::string_view(), '-');    // {***REMOVED***
...
***REMOVED***
  ...
  bool at_end() const { return state_ == kEndState; ***REMOVED***

  reference operator*() const { return curr_; ***REMOVED***
  pointer operator->() const { return &curr_; ***REMOVED***
...
struct HasMappedType : std::false_type {***REMOVED***;
template <typename T>
...
template <typename T, typename = void>
struct HasValueType : std::false_type {***REMOVED***;
template <typename T>
...
template <typename T, typename = void>
struct HasConstIterator : std::false_type {***REMOVED***;
template <typename T>
...
struct IsInitializerList
    : decltype(IsInitializerListDispatch(static_cast<T*>(nullptr))) {***REMOVED***;
...
struct SplitterIsConvertibleToImpl : std::false_type {***REMOVED***;

template <typename C>
struct SplitterIsConvertibleToImpl<C, true, false>
    : std::is_constructible<typename C::value_type, absl::string_view> {***REMOVED***;

template <typename C>
struct SplitterIsConvertibleToImpl<C, true, true>
    : absl::conjunction<
          std::is_constructible<typename C::key_type, absl::string_view>,
          std::is_constructible<typename C::mapped_type, absl::string_view>> {***REMOVED***;
 ...
 public:
  ...
  Splitter(ConvertibleToStringView input_text, Delimiter d, Predicate p)
      : text_(std::move(input_text)),
        ...
        predicate_(std::move(p)) {***REMOVED***

  absl::string_view text() const { return text_.value(); ***REMOVED***
  const Delimiter& delimiter() const { return delimiter_; ***REMOVED***
  const Predicate& predicate() const { return predicate_; ***REMOVED***

  // Range functions that iterate the split substrings as absl::string_view
  // objects. These methods enable a Splitter to be used in a range-based for
  // loop.
  const_iterator begin() const { return {const_iterator::kInitState, this***REMOVED***; ***REMOVED***
  const_iterator end() const { return {const_iterator::kEndState, this***REMOVED***; ***REMOVED***
...
***REMOVED***
  ...
  operator std::pair<First, Second>() const {  // NOLINT(runtime/explicit)
    ...
    ***REMOVED***
  ***REMOVED***
    return {First(first), Second(second)***REMOVED***;
***REMOVED***
