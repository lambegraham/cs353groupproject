...
class OStringStream : private std::basic_streambuf<char>, public std::ostream {
 public:
  ...
  explicit OStringStream(std::string* s) : std::ostream(this), s_(s) {***REMOVED***

  std::string* str() { return s_; ***REMOVED***
  const std::string* str() const { return s_; ***REMOVED***
  void str(std::string* s) { s_ = s; ***REMOVED***
