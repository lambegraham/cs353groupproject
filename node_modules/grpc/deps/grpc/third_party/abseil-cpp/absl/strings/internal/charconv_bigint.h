...
***REMOVED***
  ...
  int size() const { return size_; ***REMOVED***
  const uint32_t* words() const { return words_; ***REMOVED***
...
int Compare(const BigUnsigned<N>& lhs, const BigUnsigned<M>& rhs) {
  ...
  for (int i = limit - 1; i >= 0; --i) {
    ...
    if (lhs_word < rhs_word) {
      return -1;
  ***REMOVED*** else if (lhs_word > rhs_word) {
      return 1;
  ***REMOVED***
***REMOVED***
  return 0;
