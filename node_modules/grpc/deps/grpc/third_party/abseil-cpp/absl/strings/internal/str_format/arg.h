...
struct HasUserDefinedConvert : std::false_type {***REMOVED***;

template <typename T>
struct HasUserDefinedConvert<
    T, void_t<decltype(AbslFormatConvert(
           std::declval<const T&>(), std::declval<ConversionSpec>(),
           std::declval<FormatSink*>()))>> : std::true_type {***REMOVED***;
...
struct VoidPtr {
  ...
  VoidPtr(T* ptr)  // NOLINT
      : value(ptr ? reinterpret_cast<uintptr_t>(ptr) : 0) {***REMOVED***
  uintptr_t value;
***REMOVED***;
...
ConvertResult<Conv::s> FormatConvertImpl(const AbslCord& value,
                                         ConversionSpec conv,
                                         FormatSinkImpl* sink) {
  if (conv.conv().id() != ConversionChar::s) return {false***REMOVED***;
...
struct FormatArgImplFriend {
  ...
  static bool ToInt(Arg arg, int* out) {
    ...
    return arg.dispatcher_(arg.data_, {***REMOVED***, out);
***REMOVED***
  ...
  struct store_by_value
      : std::integral_constant<bool, (sizeof(T) <= kInlinedSpace) &&
                                         (std::is_integral<T>::value ||
                                          ...
                                          std::is_same<VoidPtr, T>::value)> {***REMOVED***;

  enum StoragePolicy { ByPointer, ByVolatilePointer, ByValue ***REMOVED***;
  template <typename T>
...
***REMOVED***
  ...
  ***REMOVED***
    ...
    static const T& Value(Data arg) { return *static_cast<const T*>(arg.ptr); ***REMOVED***
***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED*** else if (std::is_signed<T>::value &&
