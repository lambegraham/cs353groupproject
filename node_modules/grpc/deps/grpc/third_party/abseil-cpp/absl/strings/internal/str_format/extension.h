...
class FormatRawSinkImpl {
 public:
  ...
  FormatRawSinkImpl(T* raw)  // NOLINT
      : sink_(raw), write_(&FormatRawSinkImpl::Flush<T>) {***REMOVED***

  void Write(string_view s) { write_(sink_, s); ***REMOVED***
...
class FormatSinkImpl {
 public:
  explicit FormatSinkImpl(FormatRawSinkImpl raw) : raw_(raw) {***REMOVED***

  ~FormatSinkImpl() { Flush(); ***REMOVED***
...
***REMOVED***
 ...
 private:
  size_t Avail() const { return buf_ + sizeof(buf_) - pos_; ***REMOVED***
...
***REMOVED***
  ...
  static LengthMod FromId(Id id) { return LengthMod(id); ***REMOVED***

  // The length modifier std::string associated with a specified LengthMod.
  string_view name() const {
    const Spec& spec = kSpecs[id_];
    return {spec.name, spec.name_length***REMOVED***;
***REMOVED***

  Id id() const { return id_; ***REMOVED***
...
***REMOVED***
  ...
  explicit LengthMod(Id id) : id_(id) {***REMOVED***
...
***REMOVED***
  ...
  ConversionChar() : id_(none) {***REMOVED***
...
***REMOVED***
  ...
  static ConversionChar FromId(Id id) { return ConversionChar(id); ***REMOVED***
  Id id() const { return id_; ***REMOVED***
...
***REMOVED***
  ...
  bool IsValid() const { return id() != none; ***REMOVED***

  // The associated char.
  char Char() const { return kSpecs[id_].name; ***REMOVED***
...
***REMOVED***
  ...
  explicit ConversionChar(Id id) : id_(id) {***REMOVED***
...
class ConversionSpec {
 public:
  Flags flags() const { return flags_; ***REMOVED***
  LengthMod length_mod() const { return length_mod_; ***REMOVED***
...
***REMOVED***
  ...
  // value.
  int width() const { return width_; ***REMOVED***
  // Returns the specified precision. If precision is unspecfied, it returns a
  // negative value.
  int precision() const { return precision_; ***REMOVED***

  void set_flags(Flags f) { flags_ = f; ***REMOVED***
  void set_length_mod(LengthMod lm) { length_mod_ = lm; ***REMOVED***
  void set_conv(ConversionChar c) { conv_ = c; ***REMOVED***
  void set_width(int w) { width_ = w; ***REMOVED***
  void set_precision(int p) { precision_ = p; ***REMOVED***
  void set_left(bool b) { flags_.left = b; ***REMOVED***
...
#define CONV_SET_CASE(c) \
  conv == #c[0] ? (uint64_t{1***REMOVED*** << (1 + ConversionChar::Id::c)):
...
***REMOVED***  // namespace str_format_internal
