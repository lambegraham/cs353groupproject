...
struct IsSpecializationImpl : std::false_type {***REMOVED***;
template <template <typename...> class T, typename... Args>
struct IsSpecializationImpl<T<Args...>, T> : std::true_type {***REMOVED***;
template <typename C, template <typename...> class T>
using IsSpecialization = IsSpecializationImpl<absl::decay_t<C>, T>;

template <typename C>
struct IsArrayImpl : std::false_type {***REMOVED***;
template <template <typename, size_t> class A, typename T, size_t N>
struct IsArrayImpl<A<T, N>> : std::is_same<A<T, N>, std::array<T, N>> {***REMOVED***;
template <typename C>
using IsArray = IsArrayImpl<absl::decay_t<C>>;

template <typename C>
struct IsBitsetImpl : std::false_type {***REMOVED***;
template <template <size_t> class B, size_t N>
struct IsBitsetImpl<B<N>> : std::is_same<B<N>, std::bitset<N>> {***REMOVED***;
template <typename C>
...
struct IsSTLContainer
    : absl::disjunction<
          ...
          IsSpecialization<C, std::vector>> {***REMOVED***;

template <typename C, template <typename...> class T, typename = void>
struct IsBaseOfSpecializationImpl : std::false_type {***REMOVED***;
...
struct IsBaseOfSpecializationImpl<
    ...
    : std::is_base_of<C,
                      T<typename C::value_type, typename C::allocator_type>> {***REMOVED***;
...
struct IsBaseOfSpecializationImpl<
    ...
    : std::is_base_of<C, T<typename C::key_type, typename C::key_compare,
                           typename C::allocator_type>> {***REMOVED***;
...
template <typename C>
struct IsBaseOfArrayImpl : std::false_type {***REMOVED***;
template <template <typename, size_t> class A, typename T, size_t N>
...
template <typename C>
struct IsBaseOfBitsetImpl : std::false_type {***REMOVED***;
template <template <size_t> class B, size_t N>
struct IsBaseOfBitsetImpl<B<N>> : std::is_base_of<B<N>, std::bitset<N>> {***REMOVED***;
template <typename C>
...
struct IsBaseOfSTLContainer
    : absl::disjunction<IsBaseOfArray<C>, IsBaseOfBitset<C>,
                        ...
                        IsBaseOfSpecialization<C, std::vector>> {***REMOVED***;

template <typename C, template <typename...> class T, typename = void>
struct IsConvertibleToSpecializationImpl : std::false_type {***REMOVED***;
...
struct IsConvertibleToSpecializationImpl<
    C, T, absl::void_t<typename C::value_type, typename C::allocator_type>>
    : std::is_convertible<
          C, T<typename C::value_type, typename C::allocator_type>> {***REMOVED***;
template <typename C, template <typename, typename, typename> class T>
struct IsConvertibleToSpecializationImpl<
    C, T,
    absl::void_t<typename C::key_type, typename C::key_compare,
...
struct IsConvertibleToSpecializationImpl<
    ...
    : std::is_convertible<
          C, T<typename C::key_type, typename C::mapped_type,
               typename C::key_compare, typename C::allocator_type>> {***REMOVED***;
template <typename C, template <typename, typename, typename, typename> class T>
struct IsConvertibleToSpecializationImpl<
    C, T,
    absl::void_t<typename C::key_type, typename C::hasher,
...
template <typename C>
struct IsConvertibleToArrayImpl : std::false_type {***REMOVED***;
template <template <typename, size_t> class A, typename T, size_t N>
struct IsConvertibleToArrayImpl<A<T, N>>
    : std::is_convertible<A<T, N>, std::array<T, N>> {***REMOVED***;
template <typename C>
using IsConvertibleToArray = IsConvertibleToArrayImpl<absl::decay_t<C>>;

template <typename C>
struct IsConvertibleToBitsetImpl : std::false_type {***REMOVED***;
template <template <size_t> class B, size_t N>
struct IsConvertibleToBitsetImpl<B<N>>
    : std::is_convertible<B<N>, std::bitset<N>> {***REMOVED***;
template <typename C>
...
struct IsConvertibleToSTLContainer
    : absl::disjunction<
          ...
          IsConvertibleToSpecialization<C, std::vector>> {***REMOVED***;

template <typename C>
struct IsStrictlyBaseOfAndConvertibleToSTLContainer
    : absl::conjunction<absl::negation<IsSTLContainer<C>>,
                        IsBaseOfSTLContainer<C>,
                        IsConvertibleToSTLContainer<C>> {***REMOVED***;
