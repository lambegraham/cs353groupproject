...
class BoundConversion : public ConversionSpec {
 public:
  const FormatArgImpl* arg() const { return arg_; ***REMOVED***
  void set_arg(const FormatArgImpl* a) { arg_ = a; ***REMOVED***
...
class UntypedFormatSpecImpl {
 public:
  ...
  explicit UntypedFormatSpecImpl(string_view s)
      : data_(s.data()), size_(s.size()) {***REMOVED***
  explicit UntypedFormatSpecImpl(
      const str_format_internal::ParsedFormatBase* pc)
      : data_(pc), size_(~size_t{***REMOVED***) {***REMOVED***

  bool has_parsed_conversion() const { return size_ == ~size_t{***REMOVED***; ***REMOVED***
...
***REMOVED***
  ...
  FormatSpecTemplate(const char* s) : Base(s) {***REMOVED***  // NOLINT
  FormatSpecTemplate(string_view s) : Base(s) {***REMOVED***  // NOLINT
...
***REMOVED***
 ...
 private:
  ...
  FormatArgImpl few_args_[4] = {FormatArgImpl(0), FormatArgImpl(0),
                                FormatArgImpl(0), FormatArgImpl(0)***REMOVED***;
...
class StreamedWrapper {
 public:
  explicit StreamedWrapper(const T& v) : v_(v) { ***REMOVED***
