...
//
//   If the input character is not an ASCII {lower,upper***REMOVED***-case letter (including
...
// digit character (i.e. {0-9***REMOVED*** or {A-F***REMOVED***).
...
// digit character (i.e. {0-9***REMOVED***).
inline bool ascii_isdigit(unsigned char c) { return c >= '0' && c <= '9'; ***REMOVED***

// ascii_isprint()
//
// Determines whether the given character is printable, including whitespace.
inline bool ascii_isprint(unsigned char c) { return c >= 32 && c < 127; ***REMOVED***

// ascii_isgraph()
//
// Determines whether the given character has a graphical representation.
inline bool ascii_isgraph(unsigned char c) { return c > 32 && c < 127; ***REMOVED***

// ascii_isupper()
//
// Determines whether the given character is uppercase.
inline bool ascii_isupper(unsigned char c) { return c >= 'A' && c <= 'Z'; ***REMOVED***

// ascii_islower()
//
// Determines whether the given character is lowercase.
inline bool ascii_islower(unsigned char c) { return c >= 'a' && c <= 'z'; ***REMOVED***

// ascii_isascii()
//
// Determines whether the given character is ASCII.
inline bool ascii_isascii(unsigned char c) { return c < 128; ***REMOVED***
