...
//     const char c_;
//     explicit SimpleDelimiter(char c) : c_(c) {***REMOVED***
...
class ByChar {
 public:
  explicit ByChar(char c) : c_(c) {***REMOVED***
  absl::string_view Find(absl::string_view text, size_t pos) const;
...
class MaxSplitsImpl {
 public:
  MaxSplitsImpl(Delimiter delimiter, int limit)
      : delimiter_(delimiter), limit_(limit), count_(0) {***REMOVED***
  absl::string_view Find(absl::string_view text, size_t pos) {
    if (count_++ == limit_) {
...
struct AllowEmpty {
  bool operator()(absl::string_view) const { return true; ***REMOVED***
***REMOVED***;
...
// predicate.
struct SkipEmpty {
  bool operator()(absl::string_view sp) const { return !sp.empty(); ***REMOVED***
***REMOVED***;
...
//
//   absl::StrSplit(absl::string_view(""), '-');  // {""***REMOVED***
//   absl::StrSplit(absl::string_view(), '-');    // {***REMOVED***, but should be {""***REMOVED***
//
