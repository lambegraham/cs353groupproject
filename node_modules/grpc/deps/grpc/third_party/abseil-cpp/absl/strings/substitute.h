...
class Arg {
 public:
  ...
  Arg(const char* value)  // NOLINT(runtime/explicit)
      : piece_(absl::NullSafeStringView(value)) {***REMOVED***
  template <typename Allocator>
  Arg(  // NOLINT
      const std::basic_string<char, std::char_traits<char>, Allocator>&
          value) noexcept
      : piece_(value) {***REMOVED***
  ...
  Arg(char value)  // NOLINT(runtime/explicit)
      : piece_(scratch_, 1) { scratch_[0] = value; ***REMOVED***
  Arg(short value)  // NOLINT(*)
      : piece_(scratch_,
               numbers_internal::FastIntToBuffer(value, scratch_) - scratch_) {***REMOVED***
...
***REMOVED***
  Arg(bool value)  // NOLINT(runtime/explicit)
      : piece_(value ? "true" : "false") {***REMOVED***
  ...
  Arg(T value)  // NOLINT(google-explicit-constructor)
      : Arg(static_cast<bool>(value)) {***REMOVED***
...
inline void SubstituteAndAppend(std::string* output, absl::string_view format,
  ...
  const absl::string_view args[] = {a0.piece()***REMOVED***;
...
inline void SubstituteAndAppend(std::string* output, absl::string_view format,
  ...
  const absl::string_view args[] = {a0.piece(), a1.piece()***REMOVED***;
  substitute_internal::SubstituteAndAppendArray(output, format, args,
                                                ABSL_ARRAYSIZE(args));
***REMOVED***
...
inline void SubstituteAndAppend(std::string* output, absl::string_view format,
  ...
  const absl::string_view args[] = {a0.piece(), a1.piece(), a2.piece()***REMOVED***;
  substitute_internal::SubstituteAndAppendArray(output, format, args,
                                                ABSL_ARRAYSIZE(args));
***REMOVED***
