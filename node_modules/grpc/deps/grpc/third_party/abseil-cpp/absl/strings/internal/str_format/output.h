...
class BufferRawSink {
 public:
  BufferRawSink(char* buffer, size_t size) : buffer_(buffer), size_(size) {***REMOVED***

  size_t total_written() const { return total_written_; ***REMOVED***
...
class FILERawSink {
 public:
  explicit FILERawSink(std::FILE* output) : output_(output) {***REMOVED***

  void Write(string_view v);

  size_t count() const { return count_; ***REMOVED***
  int error() const { return error_; ***REMOVED***
