...
struct NoFormatter : public AlphaNumFormatterImpl {***REMOVED***;
...
class PairFormatterImpl {
 public:
  PairFormatterImpl(F1 f1, absl::string_view sep, F2 f2)
      : f1_(std::move(f1)), sep_(sep), f2_(std::move(f2)) {***REMOVED***
...
class DereferenceFormatterImpl {
 public:
  DereferenceFormatterImpl() : f_() {***REMOVED***
  explicit DereferenceFormatterImpl(Formatter&& f)
      : f_(std::forward<Formatter>(f)) {***REMOVED***
...
struct DefaultFormatter<std::unique_ptr<ValueType>>
    : public DefaultFormatter<ValueType*> {***REMOVED***;
...
struct JoinTupleLoop<N, N> {
  template <typename Tup, typename Formatter>
  void operator()(std::string*, const Tup&, absl::string_view, Formatter&&) {***REMOVED***
***REMOVED***;
