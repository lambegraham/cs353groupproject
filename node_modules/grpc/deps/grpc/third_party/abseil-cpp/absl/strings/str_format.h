...
//   std::string out;
//   CHECK(absl::FormatUntyped(&out, format, {absl::FormatArg(1)***REMOVED***));
class UntypedFormatSpec {
 public:
  ...
  explicit UntypedFormatSpec(string_view s) : spec_(s) {***REMOVED***
...
class FormatCountCapture {
 public:
  explicit FormatCountCapture(int* p) : p_(p) {***REMOVED***
...
ABSL_MUST_USE_RESULT std::string StrFormat(const FormatSpec<Args...>& format,
  ...
  return str_format_internal::FormatPack(
      ...
      {str_format_internal::FormatArgImpl(args)...***REMOVED***);
***REMOVED***
