...
// Example:
//
//   std::vector<std::string> v = {"foo", "bar", "baz"***REMOVED***;
...
//
//   std::vector<int> v = {1, 2, 3, 4***REMOVED***;
...
//   std::string s = absl::StrJoin({"foo", "bar", "baz"***REMOVED***, "-");
//   EXPECT_EQ("foo-bar-baz", s);
//
// Example 3:
...
//   // `std::vector<int*>`.
//   int x = 1, y = 2, z = 3;
//   std::vector<int*> v = {&x, &y, &z***REMOVED***;
//   std::string s = absl::StrJoin(v, "-");
//   EXPECT_EQ("1-2-3", s);
//
// Example 5:
...
//
//   std::vector<std::string> v_one_item = {"foo"***REMOVED***;
//   EXPECT_EQ("foo", absl::StrJoin(v_one_item, "-"));
//
//   std::vector<std::string> v_empty_string = {""***REMOVED***;
//   EXPECT_EQ("", absl::StrJoin(v_empty_string, "-"));
//
//   std::vector<std::string> v_one_item_empty_string = {"a", ""***REMOVED***;
//   EXPECT_EQ("a-", absl::StrJoin(v_one_item_empty_string, "-"));
//
//   std::vector<std::string> v_two_empty_string = {"", ""***REMOVED***;
