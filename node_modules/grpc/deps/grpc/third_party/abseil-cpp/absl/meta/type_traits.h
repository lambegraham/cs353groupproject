...
template <class T>
struct IsTriviallyMoveAssignableReference : std::false_type {***REMOVED***;

template <class T>
struct IsTriviallyMoveAssignableReference<T&>
    : absl::is_trivially_move_assignable<T>::type {***REMOVED***;
...
template <template <class...> class Op, class... Args>
struct is_detected : is_detected_impl<void, Op, Args...>::type {***REMOVED***;
...
struct is_detected_convertible
    : is_detected_convertible_impl<void, To, Op, Args...>::type {***REMOVED***;
...
struct conjunction<T, Ts...>
    : std::conditional<T::value, conjunction<Ts...>, T>::type {***REMOVED***;

template <typename T>
struct conjunction<T> : T {***REMOVED***;

template <>
struct conjunction<> : std::true_type {***REMOVED***;
...
struct disjunction<T, Ts...> :
      std::conditional<T::value, T, disjunction<Ts...>>::type {***REMOVED***;

template <typename T>
struct disjunction<T> : T {***REMOVED***;

template <>
struct disjunction<> : std::false_type {***REMOVED***;
...
template <typename T>
struct negation : std::integral_constant<bool, !T::value> {***REMOVED***;
...
struct is_trivially_copyable
    : std::integral_constant<
          bool, type_traits_internal::is_trivially_copyable_impl<T>::kValue> {***REMOVED***;
***REMOVED***  // namespace type_traits_internal
...
struct IsHashable : std::true_type {***REMOVED***;
#else   // ABSL_META_INTERNAL_STD_HASH_SFINAE_FRIENDLY_
template <typename Key, typename = void>
struct IsHashable : std::false_type {***REMOVED***;
...
struct IsHashable<
    ...
    absl::enable_if_t<std::is_convertible<
        ...
        std::size_t>::value>> : std::true_type {***REMOVED***;
#endif  // !ABSL_META_INTERNAL_STD_HASH_SFINAE_FRIENDLY_

struct AssertHashEnabledHelper {
 private:
  static void Sink(...) {***REMOVED***
  struct NAT {***REMOVED***;
...
template <class T>
struct IsSwappable
    : absl::type_traits_internal::is_detected<IsSwappableImpl, T> {***REMOVED***;
...
struct IsNothrowSwappable
    : absl::type_traits_internal::is_detected<IsNothrowSwappableImpl, T> {***REMOVED***;
...
***REMOVED***  // namespace swap_internal
