...
class VDSOSupport {
...
#ifdef __powerpc64__
  enum { kVDSOSymbolType = STT_NOTYPE ***REMOVED***;
#else
  enum { kVDSOSymbolType = STT_FUNC ***REMOVED***;
#endif

  // Answers whether we have a vdso at all.
  bool IsPresent() const { return image_.IsPresent(); ***REMOVED***

  // Allow to iterate over all VDSO symbols.
  SymbolIterator begin() const { return image_.begin(); ***REMOVED***
  SymbolIterator end() const { return image_.end(); ***REMOVED***
 ...
 private:
  ...
  //              0   => there is no VDSO.
  //           else   => vma of VDSO Elf{32,64***REMOVED***_Ehdr.
  //
...
***REMOVED***  // namespace debugging_internal
