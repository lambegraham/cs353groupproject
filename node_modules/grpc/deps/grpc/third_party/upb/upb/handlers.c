...
***REMOVED*** else if (f && upb_fielddef_isseq(f) &&
...
const upb_msgdef *upb_handlers_msgdef(const upb_handlers *h) { return h->msg; ***REMOVED***
  ...
  switch (type) {
    ...
    case UPB_HANDLER_STRING:
      if (upb_fielddef_isstring(f)) {
        *s = selector_base;
    ***REMOVED*** else if (upb_fielddef_lazy(f)) {
        *s = selector_base + 3;
    ***REMOVED*** else {
        return false;
    ***REMOVED***
...
bool upb_msg_getscalarhandlerdata(const upb_handlers *h,
  ...
  if ((upb_int64_handlerfunc*)f == upb_msg_setint64) {
    *type = UPB_TYPE_INT64;
***REMOVED*** else if ((upb_int32_handlerfunc*)f == upb_msg_setint32) {
    *type = UPB_TYPE_INT32;
***REMOVED*** else if ((upb_uint64_handlerfunc*)f == upb_msg_setuint64) {
    *type = UPB_TYPE_UINT64;
***REMOVED*** else if ((upb_uint32_handlerfunc*)f == upb_msg_setuint32) {
    *type = UPB_TYPE_UINT32;
***REMOVED*** else if ((upb_double_handlerfunc*)f == upb_msg_setdouble) {
    *type = UPB_TYPE_DOUBLE;
***REMOVED*** else if ((upb_float_handlerfunc*)f == upb_msg_setfloat) {
    *type = UPB_TYPE_FLOAT;
***REMOVED*** else if ((upb_bool_handlerfunc*)f == upb_msg_setbool) {
    *type = UPB_TYPE_BOOL;
***REMOVED*** else {
    return false;
***REMOVED***
