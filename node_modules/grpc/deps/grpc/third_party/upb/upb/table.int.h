...
#define UPB_TABVALUE_EMPTY_INIT  {-1***REMOVED***
...
***REMOVED*** upb_inttable;

#define UPB_INTTABLE_INIT(count, mask, ctype, size_lg2, ent, a, asize, acount) \
  {UPB_TABLE_INIT(count, mask, ctype, size_lg2, ent), a, asize, acount***REMOVED***
 ...
 *
 * Modifying the table invalidates iterators.  upb_{str,int***REMOVED***table_done() is
