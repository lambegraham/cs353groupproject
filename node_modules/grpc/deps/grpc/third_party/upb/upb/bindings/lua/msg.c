 ...
 * field/entry in the underlying upb_{msg,array,map***REMOVED*** behind our back.  It's ok
...
static const struct luaL_Reg lupb_msgfactory_m[] = {
  {"get_message_class", lupb_msgfactory_getmsgclass***REMOVED***,
  {NULL, NULL***REMOVED***
***REMOVED***;

static const struct luaL_Reg lupb_msgfactory_mm[] = {
  {"__gc", lupb_msgfactory_gc***REMOVED***,
  {NULL, NULL***REMOVED***
***REMOVED***;
...
static const struct luaL_Reg lupb_msgclass_mm[] = {
  {"__call", lupb_msgclass_call***REMOVED***,
  {NULL, NULL***REMOVED***
***REMOVED***;
...
static const struct luaL_Reg lupb_array_mm[] = {
  {"__index", lupb_array_index***REMOVED***,
  {"__len", lupb_array_len***REMOVED***,
  {"__newindex", lupb_array_newindex***REMOVED***,
  {NULL, NULL***REMOVED***
***REMOVED***;
...
static const struct luaL_Reg lupb_map_mm[] = {
  {"__index", lupb_map_index***REMOVED***,
  {"__len", lupb_map_len***REMOVED***,
  {"__newindex", lupb_map_newindex***REMOVED***,
  {"__pairs", lupb_map_pairs***REMOVED***,
  {NULL, NULL***REMOVED***
***REMOVED***;
 ...
 *
 * - [0] -> our message class
 * - [lupb_fieldindex(f)] -> [lupb_{string,array,map,msg***REMOVED*** userdata]
 *
  ...
  if (in_userval(f)) {
    ...
    if (lua_isnil(L, -1)) {
      ...
      if (upb_fielddef_isseq(f)) {
        /* TODO(haberman) */
    ***REMOVED*** else if (upb_fielddef_issubmsg(f)) {
        /* TODO(haberman) */
    ***REMOVED*** else {
...
***REMOVED*** else if (upb_fielddef_ismap(f)) {
...
static const struct luaL_Reg lupb_msg_mm[] = {
  {"__index", lupb_msg_index***REMOVED***,
  {"__newindex", lupb_msg_newindex***REMOVED***,
  {NULL, NULL***REMOVED***
***REMOVED***;
...
static const struct luaL_Reg lupb_msg_toplevel_m[] = {
  {"Array", lupb_array_new***REMOVED***,
  {"Map", lupb_map_new***REMOVED***,
  {"MessageFactory", lupb_msgfactory_new***REMOVED***,
  {NULL, NULL***REMOVED***
***REMOVED***;
