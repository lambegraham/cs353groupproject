...
static const struct luaL_Reg lupb_fielddef_m[] = {
  {"containing_oneof", lupb_fielddef_containingoneof***REMOVED***,
  {"containing_type", lupb_fielddef_containingtype***REMOVED***,
  {"default", lupb_fielddef_default***REMOVED***,
  {"descriptor_type", lupb_fielddef_descriptortype***REMOVED***,
  {"getsel", lupb_fielddef_getsel***REMOVED***,
  {"has_subdef", lupb_fielddef_hassubdef***REMOVED***,
  {"index", lupb_fielddef_index***REMOVED***,
  {"is_extension", lupb_fielddef_isextension***REMOVED***,
  {"label", lupb_fielddef_label***REMOVED***,
  {"lazy", lupb_fielddef_lazy***REMOVED***,
  {"name", lupb_fielddef_name***REMOVED***,
  {"number", lupb_fielddef_number***REMOVED***,
  {"packed", lupb_fielddef_packed***REMOVED***,
  {"msgsubdef", lupb_fielddef_msgsubdef***REMOVED***,
  {"enumsubdef", lupb_fielddef_enumsubdef***REMOVED***,
  {"type", lupb_fielddef_type***REMOVED***,
  {NULL, NULL***REMOVED***
***REMOVED***;
...
***REMOVED*** else if (type == LUA_TSTRING) {
...
static const struct luaL_Reg lupb_oneofdef_m[] = {
  {"containing_type", lupb_oneofdef_containingtype***REMOVED***,
  {"field", lupb_oneofdef_field***REMOVED***,
  {"fields", lupb_oneofdef_fields***REMOVED***,
  {"name", lupb_oneofdef_name***REMOVED***,
  {NULL, NULL***REMOVED***
***REMOVED***;

static const struct luaL_Reg lupb_oneofdef_mm[] = {
  {"__len", lupb_oneofdef_len***REMOVED***,
  {NULL, NULL***REMOVED***
***REMOVED***;
...
static const struct luaL_Reg lupb_msgdef_mm[] = {
  {"__len", lupb_msgdef_len***REMOVED***,
  {NULL, NULL***REMOVED***
***REMOVED***;

static const struct luaL_Reg lupb_msgdef_m[] = {
  {"field", lupb_msgdef_field***REMOVED***,
  {"fields", lupb_msgdef_fields***REMOVED***,
  {"lookup_name", lupb_msgdef_lookupname***REMOVED***,
  {"oneofs", lupb_msgdef_oneofs***REMOVED***,
  {"syntax", lupb_msgdef_syntax***REMOVED***,
  {"_map_entry", lupb_msgdef_mapentry***REMOVED***,
  {NULL, NULL***REMOVED***
***REMOVED***;
...
static const struct luaL_Reg lupb_enumdef_mm[] = {
  {"__len", lupb_enumdef_len***REMOVED***,
  {NULL, NULL***REMOVED***
***REMOVED***;

static const struct luaL_Reg lupb_enumdef_m[] = {
  {"value", lupb_enumdef_value***REMOVED***,
  {"values", lupb_enumdef_values***REMOVED***,
  {NULL, NULL***REMOVED***
***REMOVED***;
...
static const struct luaL_Reg lupb_filedef_m[] = {
  {"dep", lupb_filedef_dep***REMOVED***,
  {"depcount", lupb_filedef_depcount***REMOVED***,
  {"enum", lupb_filedef_enum***REMOVED***,
  {"enumcount", lupb_filedef_enumcount***REMOVED***,
  {"msg", lupb_filedef_msg***REMOVED***,
  {"msgcount", lupb_filedef_msgcount***REMOVED***,
  {"name", lupb_filedef_name***REMOVED***,
  {"package", lupb_filedef_package***REMOVED***,
  {"syntax", lupb_filedef_syntax***REMOVED***,
  {NULL, NULL***REMOVED***
***REMOVED***;
...
static const struct luaL_Reg lupb_symtab_m[] = {
  {"add", lupb_symtab_add***REMOVED***,
  {"lookup_msg", lupb_symtab_lookupmsg***REMOVED***,
  {"lookup_enum", lupb_symtab_lookupenum***REMOVED***,
  {NULL, NULL***REMOVED***
***REMOVED***;

static const struct luaL_Reg lupb_symtab_mm[] = {
  {"__gc", lupb_symtab_gc***REMOVED***,
  {NULL, NULL***REMOVED***
***REMOVED***;
...
static const struct luaL_Reg lupbdef_toplevel_m[] = {
  {"SymbolTable", lupb_symtab_new***REMOVED***,
  {NULL, NULL***REMOVED***
***REMOVED***;
