...
bool upb_ok(const upb_status *status) { return status->ok; ***REMOVED***

const char *upb_status_errmsg(const upb_status *status) { return status->msg; ***REMOVED***
...
upb_alloc upb_alloc_global = {&upb_global_allocfunc***REMOVED***;
...
#define upb_alignof(type) offsetof (struct { char c; type member; ***REMOVED***, member)
