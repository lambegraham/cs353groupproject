...
UPB_INLINE opcode getop(uint32_t instr) { return (opcode)(instr & 0xff); ***REMOVED***
...
#define CHECK_RETURN(x) { int32_t ret = x; if (ret >= 0) return ret; ***REMOVED***
