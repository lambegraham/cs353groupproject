...
class upb::pb::DecoderMethodPtr {
 public:
  DecoderMethodPtr() : ptr_(nullptr) {***REMOVED***
  DecoderMethodPtr(const upb_pbdecodermethod* ptr) : ptr_(ptr) {***REMOVED***

  const upb_pbdecodermethod* ptr() { return ptr_; ***REMOVED***
...
class upb::pb::DecoderPtr {
 public:
  DecoderPtr() : ptr_(nullptr) {***REMOVED***
  DecoderPtr(upb_pbdecoder* ptr) : ptr_(ptr) {***REMOVED***

  upb_pbdecoder* ptr() { return ptr_; ***REMOVED***
...
***REMOVED***
  ...
  BytesSink input() { return BytesSink(upb_pbdecoder_input(ptr())); ***REMOVED***
   ...
   * callback. */
  uint64_t BytesParsed() { return upb_pbdecoder_bytesparsed(ptr()); ***REMOVED***
  ...
  size_t max_nesting() { return upb_pbdecoder_maxnesting(ptr()); ***REMOVED***
  bool set_max_nesting(size_t max) { return upb_pbdecoder_maxnesting(ptr()); ***REMOVED***

  void Reset() { upb_pbdecoder_reset(ptr()); ***REMOVED***
...
class upb::pb::CodeCache {
 public:
  CodeCache(upb::HandlerCache *dest)
      : ptr_(upb_pbcodecache_new(dest->ptr()), upb_pbcodecache_free) {***REMOVED***
  CodeCache(CodeCache&&) = default;
  CodeCache& operator=(CodeCache&&) = default;

  upb_pbcodecache* ptr() { return ptr_.get(); ***REMOVED***
  const upb_pbcodecache* ptr() const { return ptr_.get(); ***REMOVED***
  ...
  bool allow_jit() const { return upb_pbcodecache_allowjit(ptr()); ***REMOVED***

  /* This may only be called when the object is first constructed, and prior to
   * any code generation. */
  void set_allow_jit(bool allow) { upb_pbcodecache_setallowjit(ptr(), allow); ***REMOVED***

  /* Should the decoder push submessages to lazy handlers for fields that have
   * them?  The caller should set this iff the lazy handlers expect data that is
   * in protobuf binary format and the caller wishes to lazy parse it. */
  void set_lazy(bool lazy) { upb_pbcodecache_setlazy(ptr(), lazy); ***REMOVED***
