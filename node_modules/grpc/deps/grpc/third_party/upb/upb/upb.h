...
class upb::Status {
 public:
  Status() { upb_status_clear(&status_); ***REMOVED***

  upb_status* ptr() { return &status_; ***REMOVED***

  /* Returns true if there is no error. */
  bool ok() const { return upb_ok(&status_); ***REMOVED***

  /* Guaranteed to be NULL-terminated. */
  const char *error_message() const { return upb_status_errmsg(&status_); ***REMOVED***

  /* The error message will be truncated if it is longer than
   * UPB_STATUS_MAX_MESSAGE-4. */
  void SetErrorMessage(const char *msg) { upb_status_seterrmsg(&status_, msg); ***REMOVED***
...
***REMOVED***
  ...
  void Clear() { upb_status_clear(&status_); ***REMOVED***
...
#define UPB_STRVIEW_INIT(ptr, len) {ptr, len***REMOVED***
...
UPB_INLINE upb_alloc *upb_arena_alloc(upb_arena *a) { return (upb_alloc*)a; ***REMOVED***
...
class upb::Arena {
 public:
  ...
  Arena() : ptr_(upb_arena_new(), upb_arena_free) {***REMOVED***

  upb_arena* ptr() { return ptr_.get(); ***REMOVED***
   ...
   * calling free() either. */
  upb_alloc *allocator() { return upb_arena_alloc(ptr_.get()); ***REMOVED***
...
***REMOVED***
  ...
  size_t BytesAllocated() const { return upb_arena_bytesallocated(ptr_.get()); ***REMOVED***
...
template <int N> class upb::InlinedArena : public upb::Arena {
 public:
  InlinedArena() : ptr_(upb_arena_new(&initial_block_, N, &upb_alloc_global)) {***REMOVED***
