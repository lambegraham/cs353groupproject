...
class CouldntRemoveConst {***REMOVED***;
template <class T> struct remove_constptr { typedef CouldntRemoveConst type; ***REMOVED***;
template <class T> struct remove_constptr<const T *> { typedef T *type; ***REMOVED***;

/* Template that we use below to remove a template specialization from
 * consideration if it matches a specific type. */
template <class T, class U> struct disable_if_same { typedef void Type; ***REMOVED***;
template <class T> struct disable_if_same<T, T> {***REMOVED***;

template <class T> void DeletePointer(void *p) { delete static_cast<T>(p); ***REMOVED***
 ...
 * handler. */
struct UnboundFunc {
  CleanupFunc *GetCleanup() { return nullptr; ***REMOVED***
  void *GetData() { return nullptr; ***REMOVED***
***REMOVED***;
...
struct Func1 : public UnboundFunc {
  typedef R Return;
  typedef I FuncInfo;
  static R Call(P1 p1) { return F(p1); ***REMOVED***
***REMOVED***;
...
struct Func2 : public UnboundFunc {
  typedef R Return;
  typedef I FuncInfo;
  static R Call(P1 p1, P2 p2) { return F(p1, p2); ***REMOVED***
***REMOVED***;
...
struct Func3 : public UnboundFunc {
  typedef R Return;
  typedef I FuncInfo;
  static R Call(P1 p1, P2 p2, P3 p3) { return F(p1, p2, p3); ***REMOVED***
***REMOVED***;
...
struct Func4 : public UnboundFunc {
  typedef R Return;
  typedef I FuncInfo;
  static R Call(P1 p1, P2 p2, P3 p3, P4 p4) { return F(p1, p2, p3, p4); ***REMOVED***
***REMOVED***;
...
struct BoundFunc {
  ...
  explicit BoundFunc(MutableP2 data_) : data(data_) {***REMOVED***
  CleanupFunc *GetCleanup() { return &DeletePointer<MutableP2>; ***REMOVED***
  MutableP2 GetData() { return data; ***REMOVED***
  MutableP2 data;
***REMOVED***;
...
struct BoundFunc2 : public BoundFunc<P2> {
  ...
  typedef I FuncInfo;
  explicit BoundFunc2(typename Base::MutableP2 arg) : Base(arg) {***REMOVED***
***REMOVED***;
...
struct BoundFunc3 : public BoundFunc<P2> {
  typedef BoundFunc<P2> Base;
  typedef I FuncInfo;
  explicit BoundFunc3(typename Base::MutableP2 arg) : Base(arg) {***REMOVED***
***REMOVED***;
...
struct BoundFunc4 : public BoundFunc<P2> {
  typedef BoundFunc<P2> Base;
  typedef I FuncInfo;
  explicit BoundFunc4(typename Base::MutableP2 arg) : Base(arg) {***REMOVED***
***REMOVED***;
...
struct BoundFunc5 : public BoundFunc<P2> {
  typedef BoundFunc<P2> Base;
  typedef I FuncInfo;
  explicit BoundFunc5(typename Base::MutableP2 arg) : Base(arg) {***REMOVED***
***REMOVED***;
