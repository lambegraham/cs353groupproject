...
class upb::json::ParserMethodPtr {
 public:
  ParserMethodPtr() : ptr_(nullptr) {***REMOVED***
  ParserMethodPtr(const upb_json_parsermethod* ptr) : ptr_(ptr) {***REMOVED***

  const upb_json_parsermethod* ptr() const { return ptr_; ***REMOVED***
...
class upb::json::ParserPtr {
 public:
  ParserPtr(upb_json_parser* ptr) : ptr_(ptr) {***REMOVED***
...
***REMOVED***
  ...
  BytesSink input() { return upb_json_parser_input(ptr_); ***REMOVED***
...
class upb::json::CodeCache {
 public:
  CodeCache() : ptr_(upb_json_codecache_new(), upb_json_codecache_free) {***REMOVED***
