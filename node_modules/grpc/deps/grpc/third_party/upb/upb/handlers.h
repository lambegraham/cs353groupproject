...
typedef struct {
  ...
  bool alwaysok;
***REMOVED*** upb_handlerattr;

#define UPB_HANDLERATTR_INIT {NULL, NULL, NULL, false***REMOVED***
...
***REMOVED***
#endif
***REMOVED*** upb_bufhandle;

#define UPB_BUFHANDLE_INIT {NULL, 0, NULL, NULL***REMOVED***
...
template <class T> class upb::Handler {
 public:
  ...
  ~Handler() { UPB_ASSERT(registered_); ***REMOVED***

  void AddCleanup(upb_handlers* h) const;
  FuncPtr handler() const { return handler_; ***REMOVED***
  const upb_handlerattr& attr() const { return attr_; ***REMOVED***
...
class upb::HandlersPtr {
 public:
  HandlersPtr(upb_handlers* ptr) : ptr_(ptr) {***REMOVED***

  upb_handlers* ptr() const { return ptr_; ***REMOVED***
...
class upb::HandlerCache {
 public:
  HandlerCache(upb_handlers_callback *callback, const void *closure)
      : ptr_(upb_handlercache_new(callback, closure), upb_handlercache_free) {***REMOVED***
  HandlerCache(HandlerCache&&) = default;
  HandlerCache& operator=(HandlerCache&&) = default;
  HandlerCache(upb_handlercache* c) : ptr_(c, upb_handlercache_free) {***REMOVED***

  upb_handlercache* ptr() { return ptr_.get(); ***REMOVED***
...
typedef struct {
  ...
  upb_handlerattr attr;
***REMOVED*** upb_handlers_tabent;

#define UPB_TABENT_INIT {NULL, UPB_HANDLERATTR_INIT***REMOVED***

typedef struct {
  upb_handlers_tabent table[3];
***REMOVED*** upb_byteshandler;

#define UPB_BYTESHANDLER_INIT                             \
  {                                                       \
    { UPB_TABENT_INIT, UPB_TABENT_INIT, UPB_TABENT_INIT ***REMOVED*** \
***REMOVED***
