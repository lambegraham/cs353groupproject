...
class upb::Sink {
 public:
  ...
  Sink(const upb_sink& sink) : sink_(sink) {***REMOVED***
  Sink &operator=(const upb_sink &sink) {
    sink_ = sink;
    return *this;
***REMOVED***

  upb_sink sink() { return sink_; ***REMOVED***
...
***REMOVED***
  ...
  upb_sink* ptr() { return &sink_; ***REMOVED***
...
***REMOVED***
  ...
  bool StartMessage() { return upb_sink_startmsg(sink_); ***REMOVED***
...
class upb::BytesSink {
 public:
  ...
  BytesSink(const upb_bytessink& sink) : sink_(sink) {***REMOVED***
  BytesSink &operator=(const upb_bytessink &sink) {
    sink_ = sink;
    return *this;
***REMOVED***

  upb_bytessink sink() { return sink_; ***REMOVED***
