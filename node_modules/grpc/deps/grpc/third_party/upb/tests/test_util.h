...
class VerboseParserEnvironment {
 public:
  ...
  VerboseParserEnvironment(bool verbose) : verbose_(verbose) {***REMOVED***
...
***REMOVED***
  ...
  size_t ofs() { return ofs_; ***REMOVED***

  bool SkippedWithNull() { return skipped_with_null_; ***REMOVED***

  upb::Arena* arena() { return &arena_; ***REMOVED***
  upb::Status* status() { return &status_; ***REMOVED***
