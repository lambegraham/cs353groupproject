...
#define PUT2(p,a) do {(p)[0]=a;(p)[1]=(a)>>8;***REMOVED*** while(0)
#define PUT4(p,a) do {PUT2(p,a);PUT2(p+2,a>>16);***REMOVED*** while(0)
#define PUT8(p,a) do {PUT4(p,a);PUT4(p+4,a>>32);***REMOVED*** while(0)
