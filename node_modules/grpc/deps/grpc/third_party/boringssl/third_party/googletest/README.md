...
Suppose you put Google Test in directory `${GTEST_DIR***REMOVED***`.  To build it,
create a library build target (or a project as called by Visual Studio
and Xcode) to compile

    ${GTEST_DIR***REMOVED***/src/gtest-all.cc

with `${GTEST_DIR***REMOVED***/include` in the system header search path and `${GTEST_DIR***REMOVED***`
in the normal header search path.  Assuming a Linux-like system and gcc,
something like the following will do:

    g++ -isystem ${GTEST_DIR***REMOVED***/include -I${GTEST_DIR***REMOVED*** \
        -pthread -c ${GTEST_DIR***REMOVED***/src/gtest-all.cc
    ar -rv libgtest.a gtest-all.o

(We need `-pthread` as Google Test uses threads.)

Next, you should compile your test source file with
`${GTEST_DIR***REMOVED***/include` in the system header search path, and link it
with gtest and any other necessary libraries:

    g++ -isystem ${GTEST_DIR***REMOVED***/include -pthread path/to/your_test.cc libgtest.a \
        -o your_test
...
workflow starts with:
    ...
    cd mybuild
    cmake ${GTEST_DIR***REMOVED***  # Generate native build scripts.

If you want to build Google Test's samples, you should replace the
last command with

    cmake -Dgtest_build_samples=ON ${GTEST_DIR***REMOVED***
...
New file `CMakeLists.txt.in`:
    ...
    ExternalProject_Add(googletest
      ...
      GIT_TAG           master
      SOURCE_DIR        "${CMAKE_BINARY_DIR***REMOVED***/googletest-src"
      BINARY_DIR        "${CMAKE_BINARY_DIR***REMOVED***/googletest-build"
      CONFIGURE_COMMAND ""
      BUILD_COMMAND     ""
      INSTALL_COMMAND   ""
      TEST_COMMAND      ""
...
Existing build's `CMakeLists.txt`:
    ...
    execute_process(COMMAND ${CMAKE_COMMAND***REMOVED*** -G "${CMAKE_GENERATOR***REMOVED***" .
      RESULT_VARIABLE result
      WORKING_DIRECTORY ${CMAKE_BINARY_DIR***REMOVED***/googletest-download )
    if(result)
      message(FATAL_ERROR "CMake step for googletest failed: ${result***REMOVED***")
    endif()
    execute_process(COMMAND ${CMAKE_COMMAND***REMOVED*** --build .
      RESULT_VARIABLE result
      WORKING_DIRECTORY ${CMAKE_BINARY_DIR***REMOVED***/googletest-download )
    if(result)
      message(FATAL_ERROR "Build step for googletest failed: ${result***REMOVED***")
    endif()
    ...
    add_subdirectory(${CMAKE_BINARY_DIR***REMOVED***/googletest-src
                     ${CMAKE_BINARY_DIR***REMOVED***/googletest-build
                     EXCLUDE_FROM_ALL)
    ...
    if (CMAKE_VERSION VERSION_LESS 2.8.11)
      include_directories("${gtest_SOURCE_DIR***REMOVED***/include")
    endif()
...
need to write
    ...
    GTEST_TEST(SomeTest, DoesThis) { ... ***REMOVED***

instead of

    TEST(SomeTest, DoesThis) { ... ***REMOVED***
