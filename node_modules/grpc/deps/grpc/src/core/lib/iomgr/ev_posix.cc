...
static event_engine_factory g_factories[] = {
    {ENGINE_HEAD_CUSTOM, nullptr***REMOVED***,        {ENGINE_HEAD_CUSTOM, nullptr***REMOVED***,
    {ENGINE_HEAD_CUSTOM, nullptr***REMOVED***,        {ENGINE_HEAD_CUSTOM, nullptr***REMOVED***,
    {"epollex", grpc_init_epollex_linux***REMOVED***, {"epoll1", grpc_init_epoll1_linux***REMOVED***,
    {"poll", grpc_init_poll_posix***REMOVED***,       {"none", init_non_polling***REMOVED***,
    {ENGINE_TAIL_CUSTOM, nullptr***REMOVED***,        {ENGINE_TAIL_CUSTOM, nullptr***REMOVED***,
    {ENGINE_TAIL_CUSTOM, nullptr***REMOVED***,        {ENGINE_TAIL_CUSTOM, nullptr***REMOVED***,
***REMOVED***;
...
const char* grpc_get_poll_strategy_name() { return g_poll_strategy_name; ***REMOVED***
...
void grpc_fd_set_readable(grpc_fd* fd) { g_event_engine->fd_set_readable(fd); ***REMOVED***

void grpc_fd_set_writable(grpc_fd* fd) { g_event_engine->fd_set_writable(fd); ***REMOVED***

void grpc_fd_set_error(grpc_fd* fd) { g_event_engine->fd_set_error(fd); ***REMOVED***

static size_t pollset_size(void) { return g_event_engine->pollset_size; ***REMOVED***
...
void pollset_global_init() {***REMOVED***
void pollset_global_shutdown() {***REMOVED***
...
grpc_pollset_vtable grpc_posix_pollset_vtable = {
    ...
    pollset_kick,        pollset_size***REMOVED***;
...
grpc_pollset_set_vtable grpc_posix_pollset_set_vtable = {
    ...
    pollset_set_add_pollset_set, pollset_set_del_pollset_set***REMOVED***;
