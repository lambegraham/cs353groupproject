...
class GrpcUdpListener {
 public:
  ...
  int fd() const { return fd_; ***REMOVED***

 protected:
  grpc_fd* emfd() const { return emfd_; ***REMOVED***

  gpr_mu* mutex() { return &mutex_; ***REMOVED***
...
GrpcUdpListener::~GrpcUdpListener() { gpr_mu_destroy(&mutex_); ***REMOVED***
...
***REMOVED***
  ...
  if (grpc_set_socket_ip_pktinfo_if_possible(fd) != GRPC_ERROR_NONE) {
    ...
    goto error;
***REMOVED*** else if (addr_ptr->sa_family == AF_INET6) {
...
***REMOVED***
  ...
  for (size_t i = 0; i < num_listeners; ++i) {
    ...
    if (grpc_sockaddr_is_wildcard(addr, &port)) {
      ...
      ***REMOVED*** else if (allocated_port1 >= 0) {
  ...
  ***REMOVED*** else if (allocated_port2 >= 0) {
