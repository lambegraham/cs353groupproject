...
***REMOVED***
static void iomgr_platform_flush(void) {***REMOVED***
static void iomgr_platform_shutdown(void) { grpc_pollset_global_shutdown(); ***REMOVED***
static void iomgr_platform_shutdown_background_closure(void) {***REMOVED***
...
static grpc_iomgr_platform_vtable vtable = {
    ...
    iomgr_platform_add_closure_to_background_poller***REMOVED***;
