  ...
  for (size_t i = 0; i < (args == nullptr ? 0 : args->num_args); i++) {
    ...
    ***REMOVED*** else {
        ...
        return GRPC_ERROR_CREATE_FROM_STATIC_STRING(GRPC_ARG_ALLOW_REUSEPORT
                                                    " must be an integer");
    ***REMOVED***
  ***REMOVED*** else if (0 == strcmp(GRPC_ARG_EXPAND_WILDCARD_ADDRS, args->args[i].key)) {
      if (args->args[i].type == GRPC_ARG_INTEGER) {
...
class ExternalConnectionHandler : public grpc_core::TcpServerFdHandler {
 public:
  explicit ExternalConnectionHandler(grpc_tcp_server* s) : s_(s) {***REMOVED***
...
grpc_tcp_server_vtable grpc_posix_tcp_server_vtable = {
    ...
    tcp_server_unref,         tcp_server_shutdown_listeners***REMOVED***;
