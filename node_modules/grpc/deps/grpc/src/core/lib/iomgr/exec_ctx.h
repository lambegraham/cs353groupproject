...
***REMOVED***
  ...
  unsigned starting_cpu() const { return starting_cpu_; ***REMOVED***
...
***REMOVED***
  ...
  CombinerData* combiner_data() { return &combiner_data_; ***REMOVED***

  /** Return pointer to grpc_closure_list */
  grpc_closure_list* closure_list() { return &closure_list_; ***REMOVED***

  /** Return flags */
  uintptr_t flags() { return flags_; ***REMOVED***
...
***REMOVED***
   ...
   *  Now().
   */
  void InvalidateNow() { now_is_valid_ = false; ***REMOVED***
...
***REMOVED***
  ...
  static void GlobalShutdown(void) { gpr_tls_destroy(&exec_ctx_); ***REMOVED***
...
***REMOVED***
 ...
 protected:
  ...
  virtual bool CheckReadyToFinish() { return false; ***REMOVED***

  /** Disallow delete on ExecCtx. */
  static void operator delete(void* p) { abort(); ***REMOVED***

 private:
  /** Set exec_ctx_ to exec_ctx. */

  grpc_closure_list closure_list_ = GRPC_CLOSURE_LIST_INIT;
  CombinerData combiner_data_ = {nullptr, nullptr***REMOVED***;
  uintptr_t flags_;
...
class ApplicationCallbackExecCtx {
 public:
  /** Default Constructor */
  ApplicationCallbackExecCtx() { Set(this, flags_); ***REMOVED***

  /** Parameterised Constructor */
  ApplicationCallbackExecCtx(uintptr_t fl) : flags_(fl) { Set(this, flags_); ***REMOVED***
...
***REMOVED***
  ...
  static void GlobalInit(void) { gpr_tls_init(&callback_exec_ctx_); ***REMOVED***

  /** Global shutdown for ApplicationCallbackExecCtx. Called by init. */
  static void GlobalShutdown(void) { gpr_tls_destroy(&callback_exec_ctx_); ***REMOVED***

 private:
  uintptr_t flags_{0u***REMOVED***;
  grpc_experimental_completion_queue_functor* head_{nullptr***REMOVED***;
  grpc_experimental_completion_queue_functor* tail_{nullptr***REMOVED***;
