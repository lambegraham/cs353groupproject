...
static void tcp_ref(grpc_tcp* tcp) { gpr_ref(&tcp->refcount); ***REMOVED***
#endif
...
static int win_get_fd(grpc_endpoint* ep) { return -1; ***REMOVED***

static bool win_can_track_err(grpc_endpoint* ep) { return false; ***REMOVED***
