...
class MPMCQueueInterface {
 public:
  virtual ~MPMCQueueInterface() {***REMOVED***
...
class InfLenFIFOQueue : public MPMCQueueInterface {
 public:
  ...
  // quickly.
  int count() const { return count_.Load(MemoryOrder::RELAXED); ***REMOVED***
...
***REMOVED***
  ...
  int num_nodes() const { return num_nodes_; ***REMOVED***

  // For test purpose only. Returns the initial number of nodes in queue.
  int init_num_nodes() const { return kQueueInitNumNodes; ***REMOVED***
...
***REMOVED***
  ...
  Atomic<int> count_{0***REMOVED***;        // Number of elements in queue
