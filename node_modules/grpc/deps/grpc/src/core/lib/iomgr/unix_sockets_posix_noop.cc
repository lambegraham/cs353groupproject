...
int grpc_is_unix_socket(const grpc_resolved_address* addr) { return false; ***REMOVED***

void grpc_unlink_if_unix_domain_socket(const grpc_resolved_address* addr) {***REMOVED***
