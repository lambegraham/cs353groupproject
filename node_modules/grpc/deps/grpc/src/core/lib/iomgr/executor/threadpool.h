...
class ThreadPoolInterface {
 public:
  ...
  virtual ~ThreadPoolInterface() {***REMOVED***
 ...
 public:
  ThreadPoolWorker(const char* thd_name, ThreadPoolInterface* pool,
    ...
    thd_ = Thread(thd_name,
                  [](void* th) { static_cast<ThreadPoolWorker*>(th)->Run(); ***REMOVED***,
                  this, nullptr, options);
***REMOVED***

  ~ThreadPoolWorker() {***REMOVED***

  void Start() { thd_.Start(); ***REMOVED***
  void Join() { thd_.Join(); ***REMOVED***

 private:
  // struct for tracking stats of thread
  struct Stats {
    gpr_timespec sleep_time;
    Stats() { sleep_time = gpr_time_0(GPR_TIMESPAN); ***REMOVED***
***REMOVED***
...
class ThreadPool : public ThreadPoolInterface {
 ...
 private:
  ...
  Atomic<bool> shut_down_{false***REMOVED***;  // Destructor has been called if set to true
