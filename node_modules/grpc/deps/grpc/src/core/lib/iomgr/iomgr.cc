...
void grpc_iomgr_start() { grpc_timer_manager_init(); ***REMOVED***
...
size_t grpc_iomgr_count_objects_for_testing(void) { return count_objects(); ***REMOVED***
...
bool grpc_iomgr_abort_on_leaks(void) { return g_grpc_abort_on_leaks; ***REMOVED***
