...
void grpc_iomgr_platform_init() { iomgr_platform_vtable->init(); ***REMOVED***

void grpc_iomgr_platform_flush() { iomgr_platform_vtable->flush(); ***REMOVED***

void grpc_iomgr_platform_shutdown() { iomgr_platform_vtable->shutdown(); ***REMOVED***
