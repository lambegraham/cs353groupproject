...
void grpc_pollset_global_init() { grpc_pollset_impl->global_init(); ***REMOVED***

void grpc_pollset_global_shutdown() { grpc_pollset_impl->global_shutdown(); ***REMOVED***
...
size_t grpc_pollset_size(void) { return grpc_pollset_impl->pollset_size(); ***REMOVED***
