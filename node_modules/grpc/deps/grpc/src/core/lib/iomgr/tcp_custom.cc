...
static void tcp_ref(custom_tcp_endpoint* tcp) { gpr_ref(&tcp->refcount); ***REMOVED***
#endif
...
static void custom_close_callback(grpc_custom_socket* socket) {
  ...
  if (socket->refs == 0) {
    ...
    gpr_free(socket);
***REMOVED*** else if (socket->endpoint) {
    grpc_core::ApplicationCallbackExecCtx callback_exec_ctx;
    grpc_core::ExecCtx exec_ctx;
    custom_tcp_endpoint* tcp = (custom_tcp_endpoint*)socket->endpoint;
...
static int endpoint_get_fd(grpc_endpoint* ep) { return -1; ***REMOVED***

static bool endpoint_can_track_err(grpc_endpoint* ep) { return false; ***REMOVED***
...
static grpc_endpoint_vtable vtable = {endpoint_read,
                                      ...
                                      endpoint_get_peer,
                                      endpoint_get_fd,
                                      endpoint_can_track_err***REMOVED***;
