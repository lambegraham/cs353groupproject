...
***REMOVED***
***REMOVED***
static void CFStreamRef(CFStreamEndpoint* ep) { gpr_ref(&ep->refcount); ***REMOVED***
#endif
...
int CFStreamGetFD(grpc_endpoint* ep) { return 0; ***REMOVED***

bool CFStreamCanTrackErr(grpc_endpoint* ep) { return false; ***REMOVED***

void CFStreamAddToPollset(grpc_endpoint* ep, grpc_pollset* pollset) {***REMOVED***
void CFStreamAddToPollsetSet(grpc_endpoint* ep, grpc_pollset_set* pollset) {***REMOVED***
