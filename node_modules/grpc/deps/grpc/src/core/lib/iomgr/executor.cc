    ...
    vtables_[static_cast<size_t>(ExecutorType::NUM_EXECUTORS)]
            [static_cast<size_t>(ExecutorJobType::NUM_JOB_TYPES)] = {
                {{&default_enqueue_short, &default_enqueue_short,
                  "def-ex-short"***REMOVED***,
                 {&default_enqueue_long, &default_enqueue_long, "def-ex-long"***REMOVED******REMOVED***,
                {{&resolver_enqueue_short, &resolver_enqueue_short,
                  "res-ex-short"***REMOVED***,
                 {&resolver_enqueue_long, &resolver_enqueue_long,
                  "res-ex-long"***REMOVED******REMOVED******REMOVED***;
    ...
    schedulers_[static_cast<size_t>(ExecutorType::NUM_EXECUTORS)]
               [static_cast<size_t>(ExecutorJobType::NUM_JOB_TYPES)] = {
                   {{&vtables_[static_cast<size_t>(ExecutorType::DEFAULT)]
                              [static_cast<size_t>(ExecutorJobType::SHORT)]***REMOVED***,
                    {&vtables_[static_cast<size_t>(ExecutorType::DEFAULT)]
                              [static_cast<size_t>(ExecutorJobType::LONG)]***REMOVED******REMOVED***,
                   {{&vtables_[static_cast<size_t>(ExecutorType::RESOLVER)]
                              [static_cast<size_t>(ExecutorJobType::SHORT)]***REMOVED***,
                    {&vtables_[static_cast<size_t>(ExecutorType::RESOLVER)]
                              [static_cast<size_t>(ExecutorJobType::LONG)]***REMOVED******REMOVED******REMOVED***;
...
void Executor::Init() { SetThreading(true); ***REMOVED***
...
void Executor::Shutdown() { SetThreading(false); ***REMOVED***
