...
static const grpc_closure_scheduler_vtable exec_ctx_scheduler_vtable = {
    exec_ctx_run, exec_ctx_sched, "exec_ctx"***REMOVED***;
static grpc_closure_scheduler exec_ctx_scheduler = {&exec_ctx_scheduler_vtable***REMOVED***;
  ...
  for (;;) {
    if (!grpc_closure_list_empty(closure_list_)) {
      ...
      while (c != nullptr) {
        ...
        c = next;
    ***REMOVED***
  ***REMOVED*** else if (!grpc_combiner_continue_exec_ctx()) {
      break;
  ***REMOVED***
***REMOVED***
