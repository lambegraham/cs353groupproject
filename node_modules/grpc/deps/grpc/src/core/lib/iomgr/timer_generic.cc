...
static grpc_timer* g_timer_ht[NUM_HASH_BUCKETS] = {nullptr***REMOVED***;
...
static void remove_from_ht(grpc_timer* t) {
  ...
  if (g_timer_ht[i] == t) {
    ...
    removed = true;
***REMOVED*** else if (g_timer_ht[i] != nullptr) {
    grpc_timer* p = g_timer_ht[i];
...
void grpc_timer_init_unset(grpc_timer* timer) { timer->pending = false; ***REMOVED***
...
grpc_timer_vtable grpc_generic_timer_vtable = {
    ...
    timer_list_init, timer_list_shutdown, timer_consume_kick***REMOVED***;
