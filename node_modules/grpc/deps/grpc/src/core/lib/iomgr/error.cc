...
static void internal_set_int(grpc_error** err, grpc_error_ints which,
  ...
  if (slot == UINT8_MAX) {
    ...
    if (slot == UINT8_MAX) {
      gpr_log(GPR_ERROR, "Error %p is full, dropping int {\"%s\":%" PRIiPTR "***REMOVED***",
...
static void internal_set_str(grpc_error** err, grpc_error_strs which,
  ...
  if (slot == UINT8_MAX) {
    ...
    if (slot == UINT8_MAX) {
      ...
      gpr_log(GPR_ERROR, "Error %p is full, dropping string {\"%s\":\"%s\"***REMOVED***",
...
static void internal_add_error(grpc_error** err, grpc_error* new_err) {
  grpc_linked_error new_last = {new_err, UINT8_MAX***REMOVED***;
...
const special_error_status_map error_status_map[] = {
    {GRPC_STATUS_OK, "", 0***REMOVED***,                // GRPC_ERROR_NONE
    {GRPC_STATUS_INVALID_ARGUMENT, "", 0***REMOVED***,  // GRPC_ERROR_RESERVED_1
    {GRPC_STATUS_RESOURCE_EXHAUSTED, "Out of memory",
     strlen("Out of memory")***REMOVED***,              // GRPC_ERROR_OOM
    {GRPC_STATUS_INVALID_ARGUMENT, "", 0***REMOVED***,  // GRPC_ERROR_RESERVED_2
    {GRPC_STATUS_CANCELLED, "Cancelled",
     strlen("Cancelled")***REMOVED***,  // GRPC_ERROR_CANCELLED
***REMOVED***;
