...
static void shutdown_callback(uv_shutdown_t* req, int status) {***REMOVED***
...
grpc_custom_resolver_vtable uv_resolver_vtable = {uv_resolve, uv_resolve_async***REMOVED***;
...
grpc_socket_vtable grpc_uv_socket_vtable = {
    ...
    uv_socket_bind,     uv_socket_listen,      uv_socket_accept***REMOVED***;
