...
static void empty_timer_cb(uv_timer_t* handle) {***REMOVED***

static void kick_timer_cb(uv_timer_t* handle) { g_kicked = false; ***REMOVED***
...
grpc_custom_poller_vtable uv_pollset_vtable = {init, run_loop, kick, shutdown***REMOVED***;
