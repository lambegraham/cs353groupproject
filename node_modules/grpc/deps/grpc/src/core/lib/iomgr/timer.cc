...
void grpc_timer_cancel(grpc_timer* timer) { grpc_timer_impl->cancel(timer); ***REMOVED***

grpc_timer_check_result grpc_timer_check(grpc_millis* next) {
  return grpc_timer_impl->check(next);
***REMOVED***

void grpc_timer_list_init() { grpc_timer_impl->list_init(); ***REMOVED***

void grpc_timer_list_shutdown() { grpc_timer_impl->list_shutdown(); ***REMOVED***

void grpc_timer_consume_kick() { grpc_timer_impl->consume_kick(); ***REMOVED***
