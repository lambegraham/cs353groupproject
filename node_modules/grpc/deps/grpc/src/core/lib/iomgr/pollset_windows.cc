...
static void pollset_global_shutdown(void) { gpr_mu_destroy(&grpc_polling_mu); ***REMOVED***
...
static size_t pollset_size(void) { return sizeof(grpc_pollset); ***REMOVED***
...
static void pollset_destroy(grpc_pollset* pollset) {***REMOVED***
...
***REMOVED*** else {
  ...
  ***REMOVED*** else if (p->is_iocp_worker) {
      grpc_iocp_kick();
  ***REMOVED*** else {
      p->kicked_without_pollers = 1;
  ***REMOVED***
