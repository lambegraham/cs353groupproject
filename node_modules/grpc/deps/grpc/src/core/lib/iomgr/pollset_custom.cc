...
static size_t pollset_size() { return sizeof(grpc_pollset); ***REMOVED***

static void pollset_global_init() { poller_vtable->init(); ***REMOVED***

static void pollset_global_shutdown() { poller_vtable->shutdown(); ***REMOVED***
