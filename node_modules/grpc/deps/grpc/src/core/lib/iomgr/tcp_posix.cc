...
static void tcp_ref(grpc_tcp* tcp) { tcp->refcount.Ref(); ***REMOVED***
#endif
...
static void tcp_read(grpc_endpoint* ep, grpc_slice_buffer* incoming_buffer,
  ...
  if (tcp->is_first_read) {
    ...
    notify_on_read(tcp);
***REMOVED*** else if (!urgent && tcp->inq == 0) {
...
static void process_errors(grpc_tcp* tcp) {
  ...
  ***REMOVED*** aligned_buf;
    ...
    do {
      ...
      saved_errno = errno;
  ***REMOVED*** while (r < 0 && saved_errno == EINTR);
  ...
  if (channel_args != nullptr) {
    for (size_t i = 0; i < channel_args->num_args; i++) {
      if (0 ==
        ...
        grpc_integer_options options = {tcp_read_chunk_size, 1, MAX_CHUNK_SIZE***REMOVED***;
        tcp_read_chunk_size =
