...
typedef enum { GRPC_SECURITY_OK = 0, GRPC_SECURITY_ERROR ***REMOVED*** grpc_security_status;
 ...
 public:
  explicit grpc_security_connector(const char* url_scheme)
      : grpc_core::RefCounted<grpc_security_connector>(
        ...
        url_scheme_(url_scheme) {***REMOVED***
  ...
  const char* url_scheme() const { return url_scheme_; ***REMOVED***
