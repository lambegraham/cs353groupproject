...
***REMOVED***
  ...
  PemKeyCertPair(const PemKeyCertPair& other)
      : private_key_(gpr_strdup(other.private_key())),
        cert_chain_(gpr_strdup(other.cert_chain())) {***REMOVED***
...
***REMOVED***
  ...
  char* private_key() const { return private_key_.get(); ***REMOVED***
  char* cert_chain() const { return cert_chain_.get(); ***REMOVED***
