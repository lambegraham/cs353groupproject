 ...
 public:
  grpc_composite_channel_credentials(
      ...
      : grpc_channel_credentials(channel_creds->type()),
        ...
        call_creds_(std::move(call_creds)) {***REMOVED***
...
***REMOVED***
  const grpc_call_credentials* call_creds() const { return call_creds_.get(); ***REMOVED***
  grpc_call_credentials* mutable_call_creds() { return call_creds_.get(); ***REMOVED***
...
class grpc_composite_call_credentials : public grpc_call_credentials {
 public:
  ...
  const CallCredentialsList& inner() const { return inner_; ***REMOVED***
