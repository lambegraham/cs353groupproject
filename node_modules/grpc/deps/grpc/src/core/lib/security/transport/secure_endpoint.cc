...
static void destroy(secure_endpoint* ep) { grpc_core::Delete(ep); ***REMOVED***
...
static void secure_endpoint_ref(secure_endpoint* ep) { gpr_ref(&ep->ref); ***REMOVED***
#endif
    ...
    for (i = 0; i < ep->source_buffer.count; i++) {
      ...
      ***REMOVED***
        ...
        if (cur == end) {
          ...
          keep_looping = 1;
      ***REMOVED*** else if (unprotected_buffer_size_written > 0) {
          keep_looping = 1;
      ***REMOVED*** else {
          keep_looping = 0;
      ***REMOVED***
