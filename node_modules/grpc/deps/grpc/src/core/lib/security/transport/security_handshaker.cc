...
class SecurityHandshaker : public Handshaker {
 public:
  ...
  const char* name() const override { return "security"; ***REMOVED***
...
***REMOVED*** else if (handshaker_result == nullptr) {
...
class FailHandshaker : public Handshaker {
 public:
  const char* name() const override { return "security_fail"; ***REMOVED***
  void Shutdown(grpc_error* why) override { GRPC_ERROR_UNREF(why); ***REMOVED***
  void DoHandshake(grpc_tcp_server_acceptor* acceptor,
                   grpc_closure* on_handshake_done,
                   HandshakerArgs* args) override {
