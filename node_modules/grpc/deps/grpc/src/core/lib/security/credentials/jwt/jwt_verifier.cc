...
static const EVP_MD* evp_md_from_alg(const char* alg) {
  if (strcmp(alg, "RS256") == 0) {
    return EVP_sha256();
***REMOVED*** else if (strcmp(alg, "RS384") == 0) {
    return EVP_sha384();
***REMOVED*** else if (strcmp(alg, "RS512") == 0) {
    return EVP_sha512();
***REMOVED*** else {
    return nullptr;
***REMOVED***
...
static jose_header* jose_header_from_json(grpc_json* json,
  ...
  for (cur = json->child; cur != nullptr; cur = cur->next) {
    ...
    ***REMOVED***
      h->alg = cur->value;
  ***REMOVED*** else if (strcmp(cur->key, "typ") == 0) {
      h->typ = validate_string_field(cur, "typ");
      if (h->typ == nullptr) goto error;
  ***REMOVED*** else if (strcmp(cur->key, "kid") == 0) {
...
gpr_timespec grpc_jwt_verifier_clock_skew = {60, 0, GPR_TIMESPAN***REMOVED***;
...
***REMOVED***
  ...
  ***REMOVED*** else if (strcmp(key_prop->key, "e") == 0) {
