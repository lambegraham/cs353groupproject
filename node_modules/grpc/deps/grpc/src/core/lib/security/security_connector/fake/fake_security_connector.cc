  ...
  bool check_call_host(grpc_core::StringView host,
    ...
    if (target_name_override_ != nullptr) {
      ...
      if (authority_hostname != fake_security_target_name_override_hostname) {
        ...
        abort();
    ***REMOVED***
  ***REMOVED*** else if (authority_hostname != target_hostname) {
...
***REMOVED***
  ...
  char* target() const { return target_; ***REMOVED***
  char* expected_targets() const { return expected_targets_; ***REMOVED***
  bool is_lb_channel() const { return is_lb_channel_; ***REMOVED***
  char* target_name_override() const { return target_name_override_; ***REMOVED***
