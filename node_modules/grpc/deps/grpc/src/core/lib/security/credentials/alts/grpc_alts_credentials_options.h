...
***REMOVED*** grpc_alts_credentials_options_vtable;
...
typedef struct target_service_account {
  ...
  char* data;
***REMOVED*** target_service_account;
...
***REMOVED*** grpc_alts_credentials_client_options;
...
typedef struct grpc_alts_credentials_server_options {
  grpc_alts_credentials_options base;
***REMOVED*** grpc_alts_credentials_server_options;
