...
class grpc_alts_credentials final : public grpc_channel_credentials {
 public:
  ...
  const grpc_alts_credentials_options* options() const { return options_; ***REMOVED***
  grpc_alts_credentials_options* mutable_options() { return options_; ***REMOVED***
  const char* handshaker_service_url() const { return handshaker_service_url_; ***REMOVED***
