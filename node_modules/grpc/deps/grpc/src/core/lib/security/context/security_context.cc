...
static grpc_auth_property_iterator empty_iterator = {nullptr, 0, nullptr***REMOVED***;
...
static int auth_context_pointer_cmp(void* a, void* b) { return GPR_ICMP(a, b); ***REMOVED***
