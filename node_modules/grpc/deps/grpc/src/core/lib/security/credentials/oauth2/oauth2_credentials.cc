  ...
  ***REMOVED***
    for (ptr = json->child; ptr; ptr = ptr->next) {
      if (strcmp(ptr->key, "access_token") == 0) {
        access_token = ptr;
    ***REMOVED*** else if (strcmp(ptr->key, "token_type") == 0) {
        token_type = ptr;
    ***REMOVED*** else if (strcmp(ptr->key, "expires_in") == 0) {
        expires_in = ptr;
    ***REMOVED***
  ***REMOVED***
 ...
 protected:
  void fetch_oauth2(grpc_credentials_metadata_request* metadata_req,
    ...
    grpc_http_header header = {const_cast<char*>("Metadata-Flavor"),
                               const_cast<char*>("Google")***REMOVED***;
...
void grpc_google_refresh_token_credentials::fetch_oauth2(
  ...
  grpc_http_header header = {
      ...
      const_cast<char*>("application/x-www-form-urlencoded")***REMOVED***;
  grpc_httpcli_request request;
  char* body = nullptr;
...
grpc_google_refresh_token_credentials::grpc_google_refresh_token_credentials(
    ...
    : refresh_token_(refresh_token) {***REMOVED***
 ...
 public:
  StsTokenFetcherCredentials(grpc_uri* sts_url,  // Ownership transferred.
      ...
      : sts_url_(sts_url),
        ...
        actor_token_type_(gpr_strdup(options->actor_token_type)) {***REMOVED***

  ~StsTokenFetcherCredentials() override { grpc_uri_destroy(sts_url_); ***REMOVED***
...
grpc_error* ValidateStsCredentialsOptions(
  ...
  struct GrpcUriDeleter {
    void operator()(grpc_uri* uri) { grpc_uri_destroy(uri); ***REMOVED***
***REMOVED***
  *sts_url_out = nullptr;
