...
struct grpc_channel_credentials
 ...
 public:
  explicit grpc_channel_credentials(const char* type) : type_(type) {***REMOVED***
...
***REMOVED***
  ...
  const char* type() const { return type_; ***REMOVED***
...
struct grpc_call_credentials
 ...
 public:
  explicit grpc_call_credentials(const char* type) : type_(type) {***REMOVED***
...
struct grpc_server_credentials
 ...
 public:
  explicit grpc_server_credentials(const char* type) : type_(type) {***REMOVED***

  virtual ~grpc_server_credentials() { DestroyProcessor(); ***REMOVED***
