...
grpc_server_security_connector::grpc_server_security_connector(
    ...
    : grpc_security_connector(url_scheme),
      server_creds_(std::move(server_creds)) {***REMOVED***
...
grpc_channel_security_connector::grpc_channel_security_connector(
    ...
    : grpc_security_connector(url_scheme),
      ...
      request_metadata_creds_(std::move(request_metadata_creds)) {***REMOVED***
grpc_channel_security_connector::~grpc_channel_security_connector() {***REMOVED***
