...
struct channel_data {
  channel_data(grpc_channel_security_connector* security_connector,
      ...
      : security_connector(
        ...
        auth_context(auth_context->Ref(DEBUG_LOCATION, "client_auth_filter")) {***REMOVED***
  ~channel_data() {
...
***REMOVED***
  ...
  /* pollset{_set***REMOVED*** bound to this call; if we need to make external
     network requests, they should be done under a pollset added to this
     pollset_set so that work can progress when this call wants work to progress
  */
  grpc_polling_entity* pollent = nullptr;
  grpc_credentials_mdelem_array md_array;
  grpc_linked_mdelem md_links[MAX_CREDENTIALS_METADATA_COUNT] = {***REMOVED***;
...
***REMOVED*** else if (last_slash == service) {
    method_name = gpr_strdup("");
***REMOVED*** else {
    *last_slash = '\0';
