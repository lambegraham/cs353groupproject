...
class BackOff {
  ...
  ***REMOVED***
    ...
    grpc_millis initial_backoff() const { return initial_backoff_; ***REMOVED***
    /// factor with which to multiply backoff after a failed retry
    double multiplier() const { return multiplier_; ***REMOVED***
    /// amount to randomize backoffs
    double jitter() const { return jitter_; ***REMOVED***
    /// maximum time between retries
    grpc_millis max_backoff() const { return max_backoff_; ***REMOVED***
