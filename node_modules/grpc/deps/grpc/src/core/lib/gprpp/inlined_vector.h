...
class InlinedVector {
 public:
  InlinedVector() { init_data(); ***REMOVED***
  ~InlinedVector() { destroy_elements(); ***REMOVED***
...
***REMOVED***
  ...
  void push_back(const T& value) { emplace_back(value); ***REMOVED***

  void push_back(T&& value) { emplace_back(std::move(value)); ***REMOVED***
