...
class ThreadInternalsInterface {
 public:
  virtual ~ThreadInternalsInterface() {***REMOVED***
...
class Thread {
 public:
  class Options {
   public:
    Options() : joinable_(true), tracked_(true), stack_size_(0) {***REMOVED***
    /// Set whether the thread is joinable or detached.
    Options& set_joinable(bool joinable) {
      joinable_ = joinable;
      return *this;
  ***REMOVED***
    bool joinable() const { return joinable_; ***REMOVED***
    ...
    Options& set_tracked(bool tracked) {
      ...
      return *this;
  ***REMOVED***
    bool tracked() const { return tracked_; ***REMOVED***
    ...
    Options& set_stack_size(size_t bytes) {
      ...
      return *this;
  ***REMOVED***
    size_t stack_size() const { return stack_size_; ***REMOVED***
...
***REMOVED***
  ...
  Thread() : state_(FAKE), impl_(nullptr) {***REMOVED***
...
***REMOVED***
  ...
  /// to do anything.
  ~Thread() { GPR_ASSERT(!options_.joinable() || impl_ == nullptr); ***REMOVED***
...
***REMOVED***
 ...
 private:
  ...
  enum ThreadState { FAKE, ALIVE, STARTED, DONE, FAILED, MOVED ***REMOVED***;
  ThreadState state_;
