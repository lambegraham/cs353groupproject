...
class GlobalConfigEnv {
 protected:
  ...
  constexpr explicit GlobalConfigEnv(char* name) : name_(name) {***REMOVED***
...
class GlobalConfigEnvBool : public GlobalConfigEnv {
 public:
  constexpr GlobalConfigEnvBool(char* name, bool default_value)
      : GlobalConfigEnv(name), default_value_(default_value) {***REMOVED***
...
#define GPR_GLOBAL_CONFIG_DEFINE_BOOL(name, default_value, help)         \
  ...
  static ::grpc_core::GlobalConfigEnvBool g_env_##name(g_env_str_##name, \
                                                       default_value);   \
  bool gpr_global_config_get_##name() { return g_env_##name.Get(); ***REMOVED***     \
  void gpr_global_config_set_##name(bool value) { g_env_##name.Set(value); ***REMOVED***
...
#define GPR_GLOBAL_CONFIG_DEFINE_INT32(name, default_value, help)         \
  ...
  static ::grpc_core::GlobalConfigEnvInt32 g_env_##name(g_env_str_##name, \
                                                        default_value);   \
  int32_t gpr_global_config_get_##name() { return g_env_##name.Get(); ***REMOVED***   \
  void gpr_global_config_set_##name(int32_t value) { g_env_##name.Set(value); ***REMOVED***
