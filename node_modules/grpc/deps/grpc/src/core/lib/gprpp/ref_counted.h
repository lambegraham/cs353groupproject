...
***REMOVED***
 ...
 private:
  Value get() const { return value_.Load(MemoryOrder::RELAXED); ***REMOVED***
...
// the dtor of Child.
//
//    class Parent : public RefCounted<Parent, NonPolymorphicRefCount> {***REMOVED***
//    class Child : public Parent {***REMOVED***
//
//    Child* ch;
//    ch->Unref();
//
...
***REMOVED***
  ...
  bool RefIfNonZero() { return refs_.RefIfNonZero(); ***REMOVED***
  bool RefIfNonZero(const DebugLocation& location, const char* reason) {
...
***REMOVED***
 ...
 protected:
  ...
  explicit RefCounted(TraceFlagT* trace_flag = nullptr,
      ...
      : refs_(initial_refcount, trace_flag) {***REMOVED***
 ...
 private:
  ...
  void IncrementRefCount() { refs_.Ref(); ***REMOVED***
