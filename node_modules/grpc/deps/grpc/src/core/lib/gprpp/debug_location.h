...
class DebugLocation {
 public:
  DebugLocation(const char* file, int line) : file_(file), line_(line) {***REMOVED***
  const char* file() const { return file_; ***REMOVED***
...
class DebugLocation {
 public:
  const char* file() const { return nullptr; ***REMOVED***
  int line() const { return -1; ***REMOVED***
***REMOVED***;
