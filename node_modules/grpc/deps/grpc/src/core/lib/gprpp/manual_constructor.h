...
class PolymorphicManualConstructor {
 public:
  ...
  BaseType* get() { return reinterpret_cast<BaseType*>(&space_); ***REMOVED***
  const BaseType* get() const {
    return reinterpret_cast<const BaseType*>(&space_);
***REMOVED***

  BaseType* operator->() { return get(); ***REMOVED***
  const BaseType* operator->() const { return get(); ***REMOVED***
...
***REMOVED***
  ...
  void Destroy() { get()->~BaseType(); ***REMOVED***
...
class ManualConstructor {
 public:
  ...
  Type* get() { return reinterpret_cast<Type*>(&space_); ***REMOVED***
  const Type* get() const { return reinterpret_cast<const Type*>(&space_); ***REMOVED***

  Type* operator->() { return get(); ***REMOVED***
  const Type* operator->() const { return get(); ***REMOVED***

  Type& operator*() { return *get(); ***REMOVED***
  const Type& operator*() const { return *get(); ***REMOVED***

  void Init() { new (&space_) Type; ***REMOVED***
...
***REMOVED***
  ...
  //   ManualConstructor<std::vector<int>> v;
  //   v.Init({1, 2, 3***REMOVED***);
  void Init(const Type& x) { new (&space_) Type(x); ***REMOVED***
  void Init(Type&& x) { new (&space_) Type(std::move(x)); ***REMOVED***

  void Destroy() { get()->~Type(); ***REMOVED***
