...
***REMOVED***
#else
static grpc_avl_node* assert_invariants(grpc_avl_node* n) { return n; ***REMOVED***
#endif
...
***REMOVED***
  ...
  ***REMOVED*** else if (node->right == nullptr) {
      return ref_node(node->left);
  ***REMOVED*** else if (node->left->height < node->right->height) {
...
int grpc_avl_is_empty(grpc_avl avl) { return avl.root == nullptr; ***REMOVED***
