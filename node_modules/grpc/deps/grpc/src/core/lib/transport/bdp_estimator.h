...
class BdpEstimator {
 public:
  ...
  ~BdpEstimator() {***REMOVED***

  int64_t EstimateBdp() const { return estimate_; ***REMOVED***
  double EstimateBandwidth() const { return bw_est_; ***REMOVED***

  void AddIncomingBytes(int64_t num_bytes) { accumulator_ += num_bytes; ***REMOVED***
...
***REMOVED***
 ...
 private:
  enum class PingState { UNSCHEDULED, SCHEDULED, STARTED ***REMOVED***;
