...
class PidController {
 public:
  class Args {
   public:
    double gain_p() const { return gain_p_; ***REMOVED***
    double gain_i() const { return gain_i_; ***REMOVED***
    double gain_d() const { return gain_d_; ***REMOVED***
    double initial_control_value() const { return initial_control_value_; ***REMOVED***
    double min_control_value() const { return min_control_value_; ***REMOVED***
    double max_control_value() const { return max_control_value_; ***REMOVED***
    double integral_range() const { return integral_range_; ***REMOVED***
...
***REMOVED***
  ...
  double last_control_value() const { return last_control_value_; ***REMOVED***

  /// Returns the current error integral (mostly for testing)
  double error_integral() const { return error_integral_; ***REMOVED***
