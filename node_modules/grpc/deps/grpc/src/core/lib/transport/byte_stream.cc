...
SliceBufferByteStream::~SliceBufferByteStream() {***REMOVED***
...
ByteStreamCache::~ByteStreamCache() { Destroy(); ***REMOVED***
...
ByteStreamCache::CachingByteStream::CachingByteStream(ByteStreamCache* cache)
    : ByteStream(cache->length_, cache->flags_), cache_(cache) {***REMOVED***

ByteStreamCache::CachingByteStream::~CachingByteStream() {***REMOVED***
