...
class ByteStream : public Orphanable {
 public:
  ...
  uint32_t length() const { return length_; ***REMOVED***
  uint32_t flags() const { return flags_; ***REMOVED***

  void set_flags(uint32_t flags) { flags_ = flags; ***REMOVED***

  GRPC_ABSTRACT_BASE_CLASS

 protected:
  ByteStream(uint32_t length, uint32_t flags)
      : length_(length), flags_(flags) {***REMOVED***
...
***REMOVED***
  ...
  grpc_slice_buffer* cache_buffer() { return &cache_buffer_; ***REMOVED***
