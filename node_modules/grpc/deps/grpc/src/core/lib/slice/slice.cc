...
grpc_slice grpc_empty_slice(void) { return grpc_core::UnmanagedMemorySlice(); ***REMOVED***
...
***REMOVED***
 ...
 private:
  ~NewSliceRefcount() { user_destroy_(user_data_); ***REMOVED***
...
***REMOVED***
 ...
 private:
  ~NewWithLenSliceRefcount() { user_destroy_(user_data_, user_length_); ***REMOVED***
...
grpc_slice grpc_slice_split_head(grpc_slice* source, size_t split) {
  ...
  if (source->refcount == nullptr) {
    ...
    memmove(source->data.inlined.bytes, source->data.inlined.bytes + split,
            source->data.inlined.length);
***REMOVED*** else if (split < sizeof(head.data.inlined.bytes)) {
    GPR_ASSERT(source->data.refcounted.length >= split);
