...
uint32_t grpc_slice_hash(grpc_slice s) { return grpc_slice_hash_internal(s); ***REMOVED***
...
static const void* GetBuffer(const void* buf, size_t len) { return buf; ***REMOVED***
static size_t GetLength(const void* buf, size_t len) { return len; ***REMOVED***
