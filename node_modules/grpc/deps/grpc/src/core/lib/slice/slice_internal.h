...
***REMOVED***
  ...
  explicit grpc_slice_refcount(Type t) : ref_type_(t) {***REMOVED***

  explicit grpc_slice_refcount(grpc_slice_refcount* sub) : sub_refcount_(sub) {***REMOVED***
  ...
  grpc_slice_refcount(grpc_slice_refcount::Type type, grpc_core::RefCount* ref,
      ...
      : ref_(ref),
        ...
        destroy_fn_arg_(destroyer_arg) {***REMOVED***
  // Initializer for static refcounts.
  grpc_slice_refcount(grpc_slice_refcount* sub, Type type)
      : ref_type_(type), sub_refcount_(sub) {***REMOVED***

  Type GetType() const { return ref_type_; ***REMOVED***
...
***REMOVED***
  ...
  grpc_slice_refcount* sub_refcount() const { return sub_refcount_; ***REMOVED***
...
***REMOVED***
  ...
  InternedSliceRefcount(size_t length, uint32_t hash,
      ...
      : base(grpc_slice_refcount::Type::INTERNED, &refcnt, Destroy, this, &sub),
        ...
        length(length),
        hash(hash),
        bucket_next(bucket_next) {***REMOVED***
