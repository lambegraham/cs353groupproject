...
***REMOVED***
  ...
  ***REMOVED*** else if (0 == strcmp(args->args[i].key, GRPC_ARG_CHANNELZ_CHANNEL_NODE)) {
...
static grpc_core::UniquePtr<char> get_default_authority(
  ...
  ***REMOVED*** else if (0 == strcmp(input_args->args[i].key,
...
void channelz_node_destroy(void* p) {
  ...
  node->Unref();
***REMOVED***
int channelz_node_cmp(void* p1, void* p2) { return GPR_ICMP(p1, p2); ***REMOVED***
const grpc_arg_pointer_vtable channelz_node_arg_vtable = {
    channelz_node_copy, channelz_node_destroy, channelz_node_cmp***REMOVED***;
...
***REMOVED***
  ...
  const char* args_to_remove[] = {GRPC_ARG_CHANNELZ_PARENT_UUID***REMOVED***;
...
***REMOVED*** else if (cur == size) {
    /* no change: holding pattern */
***REMOVED*** else if (cur > 0) {
