...
struct parent_call {
  parent_call() { gpr_mu_init(&child_list_mu); ***REMOVED***
  ~parent_call() { gpr_mu_destroy(&child_list_mu); ***REMOVED***
...
struct child_call {
  child_call(grpc_call* parent) : parent(parent) {***REMOVED***
  grpc_call* parent;
...
***REMOVED***
  ...
  batch_control* active_batches[MAX_CONCURRENT_BATCHES] = {***REMOVED***;
  grpc_transport_stream_op_batch_payload stream_op_payload;

  /* first idx: is_receiving, second idx: is_trailing */
  grpc_metadata_batch metadata_batch[2][2] = {***REMOVED***;

  /* Buffered read metadata waiting to be returned to the application.
     Element 0 is initial metadata, element 1 is trailing metadata. */
  grpc_metadata_array* buffered_metadata[2] = {***REMOVED***;
  ...
  grpc_call_context_element context[GRPC_CONTEXT_COUNT] = {***REMOVED***;
  ...
  ***REMOVED***
    ...
    ***REMOVED***
      grpc_call_context_set(call, GRPC_CONTEXT_TRACING,
                            ...
                            nullptr);
  ***REMOVED*** else if (args->propagation_mask & GRPC_PROPAGATE_CENSUS_STATS_CONTEXT) {
      add_init_error(&error, GRPC_ERROR_CREATE_FROM_STATIC_STRING(
...
void grpc_call_ref(grpc_call* c) { c->ext_ref.Ref(); ***REMOVED***
...
static void destroy_encodings_accepted_by_peer(void* p) { return; ***REMOVED***
...
static int prepare_application_metadata(grpc_call* call, int count,
  ...
  for (i = 0; i < total_count; i++) {
    ...
    if (!GRPC_LOG_IF_ERROR("validate_metadata",
      ...
      break;
  ***REMOVED*** else if (!grpc_is_binary_header_internal(md->key) &&
               !GRPC_LOG_IF_ERROR(
                   "validate_metadata",
                   grpc_validate_header_nonbin_value_is_legal(md->value))) {
      break;
  ***REMOVED*** else if (GRPC_SLICE_LENGTH(md->value) >= UINT32_MAX) {
...
***REMOVED*** else if (b->idx.named.grpc_status != nullptr) {
  ...
  ***REMOVED***
    ...
    GRPC_ERROR_UNREF(error);
***REMOVED*** else if (!call->is_client) {
...
grpc_core::Arena* grpc_call_get_arena(grpc_call* call) { return call->arena; ***REMOVED***
...
uint8_t grpc_call_is_client(grpc_call* call) { return call->is_client; ***REMOVED***
