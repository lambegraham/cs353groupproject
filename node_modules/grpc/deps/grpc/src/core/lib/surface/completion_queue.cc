...
size_t non_polling_poller_size(void) { return sizeof(non_polling_poller); ***REMOVED***
...
const cq_poller_vtable g_poller_vtable_by_poller_type[] = {
    ...
    {true, true, grpc_pollset_size, grpc_pollset_init, grpc_pollset_kick,
     grpc_pollset_work, grpc_pollset_shutdown, grpc_pollset_destroy***REMOVED***,
    ...
    {false, false, non_polling_poller_size, non_polling_poller_init,
     ...
     non_polling_poller_shutdown, non_polling_poller_destroy***REMOVED***,
***REMOVED***;
...
class CqEventQueue {
 public:
  CqEventQueue() { gpr_mpscq_init(&queue_); ***REMOVED***
  ~CqEventQueue() { gpr_mpscq_destroy(&queue_); ***REMOVED***
...
***REMOVED***
 ...
 private:
  ...
  grpc_core::Atomic<intptr_t> num_queue_items_{0***REMOVED***;
***REMOVED***;

struct cq_next_data {
  ~cq_next_data() { GPR_ASSERT(queue.num_items() == 0); ***REMOVED***
  ...
  grpc_core::Atomic<intptr_t> things_queued_ever{0***REMOVED***;

  /** Number of outstanding events (+1 if not shut down)
      Initial count is dropped by grpc_completion_queue_shutdown */
  grpc_core::Atomic<intptr_t> pending_events{1***REMOVED***;
...
***REMOVED***
   ...
   * pending_events */
  grpc_core::Atomic<bool> shutdown{false***REMOVED***;
...
struct cq_callback_data {
  cq_callback_data(
      grpc_experimental_completion_queue_functor* shutdown_callback)
      : shutdown_callback(shutdown_callback) {***REMOVED***
...
static const cq_vtable g_cq_vtable[] = {
    ...
    {GRPC_CQ_CALLBACK, sizeof(cq_callback_data), cq_init_callback,
     ...
     cq_end_op_for_callback, nullptr, nullptr***REMOVED***,
***REMOVED***;
...
class ExecCtxNext : public grpc_core::ExecCtx {
 public:
  ExecCtxNext(void* arg) : ExecCtx(0), check_ready_to_finish_arg_(arg) {***REMOVED***
...
class ExecCtxPluck : public grpc_core::ExecCtx {
 public:
  ExecCtxPluck(void* arg) : ExecCtx(0), check_ready_to_finish_arg_(arg) {***REMOVED***
