...
class TraceFlag {
 public:
  ...
  const char* name() const { return name_; ***REMOVED***
...
***REMOVED***
#else
  bool enabled() { return false; ***REMOVED***
...
class DebugOnlyTraceFlag {
 public:
  constexpr DebugOnlyTraceFlag(bool default_enabled, const char* name) {***REMOVED***
  constexpr bool enabled() const { return false; ***REMOVED***
  constexpr const char* name() const { return "DebugOnlyTraceFlag"; ***REMOVED***

 private:
  void set_enabled(bool enabled) {***REMOVED***
***REMOVED***;
#endif
