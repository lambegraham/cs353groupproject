...
void gpr_mu_destroy(gpr_mu* mu) { DeleteCriticalSection(&mu->cs); ***REMOVED***
...
void gpr_cv_init(gpr_cv* cv) { InitializeConditionVariable(cv); ***REMOVED***
...
void gpr_cv_signal(gpr_cv* cv) { WakeConditionVariable(cv); ***REMOVED***

void gpr_cv_broadcast(gpr_cv* cv) { WakeAllConditionVariable(cv); ***REMOVED***
