...
#define GPR_TLS_DECL(name) static struct gpr_pthread_thread_local name = {0***REMOVED***
 ...
 *  GPR_TLS_CLASS_DEF needs to be called to define this member. */
#define GPR_TLS_CLASS_DEF(name) struct gpr_pthread_thread_local name = {0***REMOVED***
