...
static dump_out dump_out_create(void) {
  dump_out r = {0, 0, nullptr***REMOVED***;
  return r;
***REMOVED***
...
void gpr_strvec_init(gpr_strvec* sv) { memset(sv, 0, sizeof(*sv)); ***REMOVED***
...
int gpr_strincmp(const char* a, const char* b, size_t n) {
  ...
  do {
    ...
    ++b;
    --n;
***REMOVED*** while (ca == cb && ca != 0 && cb != 0 && n != 0);
  return ca - cb;
***REMOVED***
...
bool gpr_parse_bool_value(const char* s, bool* dst) {
  const char* kTrue[] = {"1", "t", "true", "y", "yes"***REMOVED***;
  const char* kFalse[] = {"0", "f", "false", "n", "no"***REMOVED***;
...
***REMOVED***
  for (size_t i = 0; i < GPR_ARRAY_SIZE(kTrue); ++i) {
    if (gpr_stricmp(s, kTrue[i]) == 0) {
      *dst = true;
      return true;
  ***REMOVED*** else if (gpr_stricmp(s, kFalse[i]) == 0) {
      *dst = false;
      return true;
  ***REMOVED***
***REMOVED***
