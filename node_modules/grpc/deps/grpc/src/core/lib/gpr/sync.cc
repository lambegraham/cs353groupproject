...
/* Number of mutexes to allocate for events, to avoid lock contention.
   Should be a prime. */
enum { event_sync_partitions = 31 ***REMOVED***;
...
void gpr_ref_init(gpr_refcount* r, int n) { gpr_atm_rel_store(&r->count, n); ***REMOVED***

void gpr_ref(gpr_refcount* r) { gpr_atm_no_barrier_fetch_add(&r->count, 1); ***REMOVED***
