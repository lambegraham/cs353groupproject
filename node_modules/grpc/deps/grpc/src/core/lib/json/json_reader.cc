        ...
        switch (reader->state) {
          ...
          ***REMOVED***
          ...
          case GRPC_JSON_STATE_VALUE_NUMBER_EPM:
            if (reader->depth == 0) {
              return GRPC_JSON_PARSE_ERROR;
          ***REMOVED*** else if ((c == '***REMOVED***') && !reader->in_object) {
              return GRPC_JSON_PARSE_ERROR;
          ***REMOVED*** else if ((c == ']') && !reader->in_array) {
              return GRPC_JSON_PARSE_ERROR;
          ***REMOVED***
            success = static_cast<uint32_t>(json_reader_set_number(reader));
            if (!success) return GRPC_JSON_PARSE_ERROR;
          ...
          case GRPC_JSON_STATE_VALUE_BEGIN:
            ...
            ***REMOVED*** else if (reader->in_array) {
                reader->state = GRPC_JSON_STATE_VALUE_BEGIN;
            ***REMOVED*** else {
                return GRPC_JSON_PARSE_ERROR;
            ***REMOVED***
        ...
        switch (reader->state) {
          ...
          ***REMOVED***
            ...
            switch (reader->state) {
              ...
              ***REMOVED*** else if ((reader->unicode_char & 0xfc00) == 0xdc00) {
