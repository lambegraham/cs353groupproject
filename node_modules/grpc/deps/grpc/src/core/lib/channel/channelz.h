...
***REMOVED***
 ...
 public:
  ...
  EntityType type() const { return type_; ***REMOVED***
  intptr_t uuid() const { return uuid_; ***REMOVED***
  const char* name() const { return name_.get(); ***REMOVED***
...
//   - track calls_{started,succeeded,failed***REMOVED***
    ...
    AtomicCounterData(const AtomicCounterData& that)
        : calls_started(that.calls_started.Load(MemoryOrder::RELAXED)),
          ...
          last_call_started_cycle(
              that.last_call_started_cycle.Load(MemoryOrder::RELAXED)) {***REMOVED***

    Atomic<intptr_t> calls_started{0***REMOVED***;
    Atomic<intptr_t> calls_succeeded{0***REMOVED***;
    Atomic<intptr_t> calls_failed{0***REMOVED***;
    Atomic<gpr_cycle_counter> last_call_started_cycle{0***REMOVED***;
...
class ChannelNode : public BaseNode {
 public:
  ...
  intptr_t parent_uuid() const { return parent_uuid_; ***REMOVED***
...
***REMOVED***
  void RecordCallStarted() { call_counter_.RecordCallStarted(); ***REMOVED***
  void RecordCallFailed() { call_counter_.RecordCallFailed(); ***REMOVED***
  void RecordCallSucceeded() { call_counter_.RecordCallSucceeded(); ***REMOVED***
 ...
 private:
  ...
  Atomic<int> connectivity_state_{0***REMOVED***;
...
***REMOVED***
  ...
  const char* remote() { return remote_.get(); ***REMOVED***
...
class ListenSocketNode : public BaseNode {
 public:
  ...
  ~ListenSocketNode() override {***REMOVED***
