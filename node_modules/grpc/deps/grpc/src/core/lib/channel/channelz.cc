...
void* parent_uuid_copy(void* p) { return p; ***REMOVED***
void parent_uuid_destroy(void* p) {***REMOVED***
int parent_uuid_cmp(void* p1, void* p2) { return GPR_ICMP(p1, p2); ***REMOVED***
const grpc_arg_pointer_vtable parent_uuid_vtable = {
    parent_uuid_copy, parent_uuid_destroy, parent_uuid_cmp***REMOVED***;
...
BaseNode::~BaseNode() { ChannelzRegistry::Unregister(uuid_); ***REMOVED***
...
ChannelNode::ChannelNode(UniquePtr<char> target,
    ...
    : BaseNode(parent_uuid == 0 ? EntityType::kTopLevelChannel
      ...
      parent_uuid_(parent_uuid) {***REMOVED***
...
ServerNode::ServerNode(grpc_server* server, size_t channel_tracer_max_nodes)
    : BaseNode(EntityType::kServer, /* name */ nullptr),
      trace_(channel_tracer_max_nodes) {***REMOVED***

ServerNode::~ServerNode() {***REMOVED***
...
***REMOVED*** else if (uri != nullptr && strcmp(uri->scheme, "unix") == 0) {
...
SocketNode::SocketNode(UniquePtr<char> local, UniquePtr<char> remote,
    ...
    : BaseNode(EntityType::kSocket, std::move(name)),
      ...
      remote_(std::move(remote)) {***REMOVED***
...
ListenSocketNode::ListenSocketNode(UniquePtr<char> local_addr,
                                   UniquePtr<char> name)
    : BaseNode(EntityType::kSocket, std::move(name)),
      local_addr_(std::move(local_addr)) {***REMOVED***
