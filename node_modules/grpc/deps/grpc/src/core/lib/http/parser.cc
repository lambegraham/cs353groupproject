...
static grpc_error* add_header(grpc_http_parser* parser) {
  ...
  grpc_http_header hdr = {nullptr, nullptr***REMOVED***;
...
***REMOVED*** else if (parser->type == GRPC_HTTP_REQUEST) {
...
void grpc_http_parser_destroy(grpc_http_parser* parser) {***REMOVED***
