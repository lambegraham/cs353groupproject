 ...
 public:
  explicit grpc_httpcli_ssl_channel_security_connector(char* secure_peer_name)
      : grpc_channel_security_connector(
        ...
        secure_peer_name_(secure_peer_name) {***REMOVED***
...
***REMOVED***
  ...
  const char* secure_peer_name() const { return secure_peer_name_; ***REMOVED***
...
***REMOVED***
  ...
  grpc_channel_args args = {1, &channel_arg***REMOVED***;
...
const grpc_httpcli_handshaker grpc_httpcli_ssl = {"https", ssl_handshake***REMOVED***;
