...
int grpc_compression_algorithm_parse(grpc_slice name,
  ...
  if (grpc_slice_eq_static_interned(name, GRPC_MDSTR_IDENTITY)) {
    *algorithm = GRPC_COMPRESS_NONE;
    return 1;
***REMOVED*** else if (grpc_slice_eq_static_interned(name, GRPC_MDSTR_DEFLATE)) {
    *algorithm = GRPC_COMPRESS_DEFLATE;
    return 1;
***REMOVED*** else if (grpc_slice_eq_static_interned(name, GRPC_MDSTR_GZIP)) {
    *algorithm = GRPC_COMPRESS_GZIP;
    return 1;
***REMOVED*** else if (grpc_slice_eq_static_interned(name,
...
***REMOVED*** else if (level <= GRPC_COMPRESS_LEVEL_HIGH) {
