...
***REMOVED*** tsi_ssl_handshaker_result;
...
static const unsigned char kSslSessionIdContext[] = {'g', 'r', 'p', 'c'***REMOVED***;
...
static tsi_result add_subject_alt_names_properties_to_peer(
  ...
  for (i = 0; i < subject_alt_name_count; i++) {
    ...
    ***REMOVED*** else if (subject_alt_name->type == GEN_EMAIL) {
    ...
    ***REMOVED***
      ...
      OPENSSL_free(name);
  ***REMOVED*** else if (subject_alt_name->type == GEN_IPADD) {
      char ntop_buf[INET6_ADDRSTRLEN];
      int af;

      if (subject_alt_name->d.iPAddress->length == 4) {
        af = AF_INET;
    ***REMOVED*** else if (subject_alt_name->d.iPAddress->length == 16) {
        af = AF_INET6;
    ***REMOVED*** else {
...
static tsi_ssl_handshaker_factory_vtable handshaker_factory_vtable = {nullptr***REMOVED***;
  ...
  for (i = 0; i < peer->property_count; i++) {
    ...
    if (strcmp(property->name,
      ...
      if (!like_ip && does_entry_match_name(entry, name)) {
        return 1;
    ***REMOVED*** else if (like_ip && name == entry) {
