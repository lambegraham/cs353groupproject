...
***REMOVED*** alts_grpc_integrity_only_record_protocol;
...
***REMOVED***
  ...
  iovec_t header_iovec = {GRPC_SLICE_START_PTR(header_slice),
                          GRPC_SLICE_LENGTH(header_slice)***REMOVED***;
  iovec_t tag_iovec = {GRPC_SLICE_START_PTR(tag_slice),
                       GRPC_SLICE_LENGTH(tag_slice)***REMOVED***;
...
***REMOVED***
  ...
  iovec_t tag_iovec = {nullptr, rp->tag_length***REMOVED***;
...
static const alts_grpc_record_protocol_vtable
    alts_grpc_integrity_only_record_protocol_vtable = {
        ...
        alts_grpc_integrity_only_destruct***REMOVED***;
