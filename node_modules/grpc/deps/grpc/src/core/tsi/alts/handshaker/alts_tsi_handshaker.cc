...
typedef struct alts_tsi_handshaker_result {
  ...
  bool is_client;
***REMOVED*** alts_tsi_handshaker_result;
...
static const tsi_handshaker_result_vtable result_vtable = {
    ...
    handshaker_result_get_unused_bytes, handshaker_result_destroy***REMOVED***;
...
static void on_handshaker_service_resp_recv_dedicated(void* arg,
  ...
  grpc_cq_end_op(resource->cq, arg, GRPC_ERROR_NONE,
                 [](void* done_arg, grpc_cq_completion* storage) {***REMOVED***, nullptr,
                 &resource->storage);
***REMOVED***
...
static const tsi_handshaker_vtable handshaker_vtable = {
    ...
    handshaker_next, handshaker_shutdown***REMOVED***;
