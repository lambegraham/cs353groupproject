...
static const upb_msglayout_field envoy_api_v2_DiscoveryRequest__fields[6] = {
  ...
  {2, UPB_SIZE(24, 48), 0, 0, 11, 1***REMOVED***,
  {3, UPB_SIZE(32, 64), 0, 0, 9, 3***REMOVED***,
  {4, UPB_SIZE(8, 16), 0, 0, 9, 1***REMOVED***,
  {5, UPB_SIZE(16, 32), 0, 0, 9, 1***REMOVED***,
  {6, UPB_SIZE(28, 56), 0, 1, 11, 1***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_DiscoveryResponse__fields[6] = {
  {1, UPB_SIZE(4, 8), 0, 0, 9, 1***REMOVED***,
  {2, UPB_SIZE(32, 64), 0, 1, 11, 3***REMOVED***,
  {3, UPB_SIZE(0, 0), 0, 0, 8, 1***REMOVED***,
  {4, UPB_SIZE(12, 24), 0, 0, 9, 1***REMOVED***,
  {5, UPB_SIZE(20, 40), 0, 0, 9, 1***REMOVED***,
  {6, UPB_SIZE(28, 56), 0, 0, 11, 1***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_DeltaDiscoveryRequest__fields[7] = {
  {1, UPB_SIZE(16, 32), 0, 1, 11, 1***REMOVED***,
  {2, UPB_SIZE(0, 0), 0, 0, 9, 1***REMOVED***,
  {3, UPB_SIZE(24, 48), 0, 0, 9, 3***REMOVED***,
  {4, UPB_SIZE(28, 56), 0, 0, 9, 3***REMOVED***,
  {5, UPB_SIZE(32, 64), 0, 0, 11, 3***REMOVED***,
  {6, UPB_SIZE(8, 16), 0, 0, 9, 1***REMOVED***,
  {7, UPB_SIZE(20, 40), 0, 2, 11, 1***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_DeltaDiscoveryResponse__fields[5] = {
  {1, UPB_SIZE(0, 0), 0, 0, 9, 1***REMOVED***,
  {2, UPB_SIZE(24, 48), 0, 0, 11, 3***REMOVED***,
  {4, UPB_SIZE(8, 16), 0, 0, 9, 1***REMOVED***,
  {5, UPB_SIZE(16, 32), 0, 0, 9, 1***REMOVED***,
...
static const upb_msglayout_field envoy_api_v2_Resource__fields[4] = {
  {1, UPB_SIZE(0, 0), 0, 0, 9, 1***REMOVED***,
  {2, UPB_SIZE(16, 32), 0, 0, 11, 1***REMOVED***,
  {3, UPB_SIZE(8, 16), 0, 0, 9, 1***REMOVED***,
  {4, UPB_SIZE(20, 40), 0, 0, 9, 3***REMOVED***,
***REMOVED***;
