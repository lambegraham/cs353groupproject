...
static const upb_msglayout_field envoy_api_v2_core_Locality__fields[3] = {
  ...
  {2, UPB_SIZE(8, 16), 0, 0, 9, 1***REMOVED***,
  {3, UPB_SIZE(16, 32), 0, 0, 9, 1***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_core_Node__fields[5] = {
  {1, UPB_SIZE(0, 0), 0, 0, 9, 1***REMOVED***,
  {2, UPB_SIZE(8, 16), 0, 0, 9, 1***REMOVED***,
  {3, UPB_SIZE(24, 48), 0, 1, 11, 1***REMOVED***,
  {4, UPB_SIZE(28, 56), 0, 0, 11, 1***REMOVED***,
  {5, UPB_SIZE(16, 32), 0, 0, 9, 1***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_core_RuntimeUInt32__fields[2] = {
  {2, UPB_SIZE(0, 0), 0, 0, 13, 1***REMOVED***,
  {3, UPB_SIZE(4, 8), 0, 0, 9, 1***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_core_DataSource__fields[3] = {
  {1, UPB_SIZE(0, 0), UPB_SIZE(-9, -17), 0, 9, 1***REMOVED***,
  {2, UPB_SIZE(0, 0), UPB_SIZE(-9, -17), 0, 12, 1***REMOVED***,
  {3, UPB_SIZE(0, 0), UPB_SIZE(-9, -17), 0, 9, 1***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_core_AsyncDataSource__fields[2] = {
  {1, UPB_SIZE(0, 0), UPB_SIZE(-5, -9), 0, 11, 1***REMOVED***,
  {2, UPB_SIZE(0, 0), UPB_SIZE(-5, -9), 1, 11, 1***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_core_TransportSocket__fields[3] = {
  {1, UPB_SIZE(0, 0), 0, 0, 9, 1***REMOVED***,
  {2, UPB_SIZE(8, 16), UPB_SIZE(-13, -25), 1, 11, 1***REMOVED***,
  {3, UPB_SIZE(8, 16), UPB_SIZE(-13, -25), 0, 11, 1***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_core_SocketOption__fields[6] = {
  {1, UPB_SIZE(24, 24), 0, 0, 9, 1***REMOVED***,
  {2, UPB_SIZE(0, 0), 0, 0, 3, 1***REMOVED***,
  {3, UPB_SIZE(8, 8), 0, 0, 3, 1***REMOVED***,
  {4, UPB_SIZE(32, 40), UPB_SIZE(-41, -57), 0, 3, 1***REMOVED***,
  {5, UPB_SIZE(32, 40), UPB_SIZE(-41, -57), 0, 12, 1***REMOVED***,
  {6, UPB_SIZE(16, 16), 0, 0, 14, 1***REMOVED***,
***REMOVED***;
