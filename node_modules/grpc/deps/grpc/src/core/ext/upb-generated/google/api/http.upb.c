...
static const upb_msglayout_field google_api_Http__fields[2] = {
  {1, UPB_SIZE(4, 8), 0, 0, 11, 3***REMOVED***,
  {2, UPB_SIZE(0, 0), 0, 0, 8, 1***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field google_api_HttpRule__fields[10] = {
  ...
  {2, UPB_SIZE(28, 56), UPB_SIZE(-37, -73), 0, 9, 1***REMOVED***,
  {3, UPB_SIZE(28, 56), UPB_SIZE(-37, -73), 0, 9, 1***REMOVED***,
  {4, UPB_SIZE(28, 56), UPB_SIZE(-37, -73), 0, 9, 1***REMOVED***,
  {5, UPB_SIZE(28, 56), UPB_SIZE(-37, -73), 0, 9, 1***REMOVED***,
  {6, UPB_SIZE(28, 56), UPB_SIZE(-37, -73), 0, 9, 1***REMOVED***,
  {7, UPB_SIZE(8, 16), 0, 0, 9, 1***REMOVED***,
  {8, UPB_SIZE(28, 56), UPB_SIZE(-37, -73), 0, 11, 1***REMOVED***,
  {11, UPB_SIZE(24, 48), 0, 1, 11, 3***REMOVED***,
  {12, UPB_SIZE(16, 32), 0, 0, 9, 1***REMOVED***,
***REMOVED***;
