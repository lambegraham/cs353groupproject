...
static const upb_msglayout_field envoy_api_v2_endpoint_UpstreamLocalityStats__fields[8] = {
  {1, UPB_SIZE(36, 40), 0, 0, 11, 1***REMOVED***,
  {2, UPB_SIZE(0, 0), 0, 0, 4, 1***REMOVED***,
  {3, UPB_SIZE(8, 8), 0, 0, 4, 1***REMOVED***,
  {4, UPB_SIZE(16, 16), 0, 0, 4, 1***REMOVED***,
  {5, UPB_SIZE(40, 48), 0, 1, 11, 3***REMOVED***,
  {6, UPB_SIZE(32, 32), 0, 0, 13, 1***REMOVED***,
  {7, UPB_SIZE(44, 56), 0, 2, 11, 3***REMOVED***,
  {8, UPB_SIZE(24, 24), 0, 0, 4, 1***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_endpoint_UpstreamEndpointStats__fields[7] = {
  {1, UPB_SIZE(32, 32), 0, 0, 11, 1***REMOVED***,
  {2, UPB_SIZE(0, 0), 0, 0, 4, 1***REMOVED***,
  {3, UPB_SIZE(8, 8), 0, 0, 4, 1***REMOVED***,
  {4, UPB_SIZE(16, 16), 0, 0, 4, 1***REMOVED***,
  {5, UPB_SIZE(40, 48), 0, 1, 11, 3***REMOVED***,
  {6, UPB_SIZE(36, 40), 0, 2, 11, 1***REMOVED***,
  {7, UPB_SIZE(24, 24), 0, 0, 4, 1***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_endpoint_EndpointLoadMetricStats__fields[3] = {
  {1, UPB_SIZE(16, 16), 0, 0, 9, 1***REMOVED***,
  {2, UPB_SIZE(0, 0), 0, 0, 4, 1***REMOVED***,
  {3, UPB_SIZE(8, 8), 0, 0, 1, 1***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_endpoint_ClusterStats__fields[6] = {
  ...
  {2, UPB_SIZE(28, 48), 0, 1, 11, 3***REMOVED***,
  {3, UPB_SIZE(0, 0), 0, 0, 4, 1***REMOVED***,
  {4, UPB_SIZE(24, 40), 0, 2, 11, 1***REMOVED***,
  {5, UPB_SIZE(32, 56), 0, 0, 11, 3***REMOVED***,
  {6, UPB_SIZE(16, 24), 0, 0, 9, 1***REMOVED***,
***REMOVED***;
