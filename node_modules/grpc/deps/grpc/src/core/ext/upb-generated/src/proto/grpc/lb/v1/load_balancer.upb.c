...
static const upb_msglayout_field grpc_lb_v1_LoadBalanceRequest__fields[2] = {
  ...
  {2, UPB_SIZE(0, 0), UPB_SIZE(-5, -9), 0, 11, 1***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field grpc_lb_v1_ClientStats__fields[6] = {
  ...
  {6, UPB_SIZE(16, 16), 0, 0, 3, 1***REMOVED***,
  {7, UPB_SIZE(24, 24), 0, 0, 3, 1***REMOVED***,
  {8, UPB_SIZE(36, 40), 0, 1, 11, 3***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field grpc_lb_v1_Server__fields[4] = {
  {1, UPB_SIZE(8, 8), 0, 0, 12, 1***REMOVED***,
  {2, UPB_SIZE(0, 0), 0, 0, 5, 1***REMOVED***,
  {3, UPB_SIZE(16, 24), 0, 0, 9, 1***REMOVED***,
  {4, UPB_SIZE(4, 4), 0, 0, 8, 1***REMOVED***,
***REMOVED***;
