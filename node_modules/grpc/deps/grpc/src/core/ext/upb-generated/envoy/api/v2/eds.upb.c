...
static const upb_msglayout_field envoy_api_v2_ClusterLoadAssignment__fields[4] = {
  ...
  {2, UPB_SIZE(12, 24), 0, 2, 11, 3***REMOVED***,
  {4, UPB_SIZE(8, 16), 0, 1, 11, 1***REMOVED***,
  {5, UPB_SIZE(16, 32), 0, 0, 11, 3***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_ClusterLoadAssignment_Policy__fields[3] = {
  {2, UPB_SIZE(8, 16), 0, 0, 11, 3***REMOVED***,
  {3, UPB_SIZE(0, 0), 0, 2, 11, 1***REMOVED***,
  {4, UPB_SIZE(4, 8), 0, 1, 11, 1***REMOVED***,
***REMOVED***;
