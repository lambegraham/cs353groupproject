...
static const upb_msglayout_field envoy_api_v2_endpoint_Endpoint_HealthCheckConfig__fields[1] = {
  {1, UPB_SIZE(0, 0), 0, 0, 13, 1***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_endpoint_LbEndpoint__fields[5] = {
  {1, UPB_SIZE(16, 24), UPB_SIZE(-25, -41), 1, 11, 1***REMOVED***,
  {2, UPB_SIZE(0, 0), 0, 0, 14, 1***REMOVED***,
  {3, UPB_SIZE(8, 8), 0, 0, 11, 1***REMOVED***,
  {4, UPB_SIZE(12, 16), 0, 2, 11, 1***REMOVED***,
  {5, UPB_SIZE(16, 24), UPB_SIZE(-25, -41), 0, 9, 1***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_endpoint_LocalityLbEndpoints__fields[5] = {
  {1, UPB_SIZE(4, 8), 0, 0, 11, 1***REMOVED***,
  {2, UPB_SIZE(16, 32), 0, 1, 11, 3***REMOVED***,
  {3, UPB_SIZE(8, 16), 0, 2, 11, 1***REMOVED***,
  {5, UPB_SIZE(0, 0), 0, 0, 13, 1***REMOVED***,
  {6, UPB_SIZE(12, 24), 0, 2, 11, 1***REMOVED***,
***REMOVED***;
