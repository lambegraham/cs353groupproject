...
static const upb_msglayout_field envoy_api_v2_core_SocketAddress__fields[6] = {
  ...
  {2, UPB_SIZE(12, 16), 0, 0, 9, 1***REMOVED***,
  {3, UPB_SIZE(28, 48), UPB_SIZE(-37, -65), 0, 13, 1***REMOVED***,
  {4, UPB_SIZE(28, 48), UPB_SIZE(-37, -65), 0, 9, 1***REMOVED***,
  {5, UPB_SIZE(20, 32), 0, 0, 9, 1***REMOVED***,
  {6, UPB_SIZE(8, 8), 0, 0, 8, 1***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_core_BindConfig__fields[3] = {
  {1, UPB_SIZE(0, 0), 0, 0, 11, 1***REMOVED***,
  {2, UPB_SIZE(4, 8), 0, 2, 11, 1***REMOVED***,
  {3, UPB_SIZE(8, 16), 0, 1, 11, 3***REMOVED***,
***REMOVED***;
