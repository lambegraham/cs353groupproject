...
static const upb_msglayout_field envoy_api_v2_core_GrpcService__fields[4] = {
  {1, UPB_SIZE(8, 16), UPB_SIZE(-13, -25), 0, 11, 1***REMOVED***,
  {2, UPB_SIZE(8, 16), UPB_SIZE(-13, -25), 1, 11, 1***REMOVED***,
  {3, UPB_SIZE(0, 0), 0, 3, 11, 1***REMOVED***,
  {5, UPB_SIZE(4, 8), 0, 2, 11, 3***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_core_GrpcService_GoogleGrpc__fields[6] = {
  {1, UPB_SIZE(0, 0), 0, 0, 9, 1***REMOVED***,
  {2, UPB_SIZE(24, 48), 0, 1, 11, 1***REMOVED***,
  {3, UPB_SIZE(32, 64), 0, 0, 11, 3***REMOVED***,
  {4, UPB_SIZE(8, 16), 0, 0, 9, 1***REMOVED***,
  {5, UPB_SIZE(16, 32), 0, 0, 9, 1***REMOVED***,
  {6, UPB_SIZE(28, 56), 0, 2, 11, 1***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_core_GrpcService_GoogleGrpc_SslCredentials__fields[3] = {
  ...
  {2, UPB_SIZE(4, 8), 0, 0, 11, 1***REMOVED***,
  {3, UPB_SIZE(8, 16), 0, 0, 11, 1***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_core_GrpcService_GoogleGrpc_ChannelCredentials__fields[3] = {
  {1, UPB_SIZE(0, 0), UPB_SIZE(-5, -9), 1, 11, 1***REMOVED***,
  {2, UPB_SIZE(0, 0), UPB_SIZE(-5, -9), 2, 11, 1***REMOVED***,
  {3, UPB_SIZE(0, 0), UPB_SIZE(-5, -9), 0, 11, 1***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_core_GrpcService_GoogleGrpc_CallCredentials__fields[6] = {
  ...
  {2, UPB_SIZE(0, 0), UPB_SIZE(-9, -17), 3, 11, 1***REMOVED***,
  {3, UPB_SIZE(0, 0), UPB_SIZE(-9, -17), 0, 9, 1***REMOVED***,
  {4, UPB_SIZE(0, 0), UPB_SIZE(-9, -17), 2, 11, 1***REMOVED***,
  {5, UPB_SIZE(0, 0), UPB_SIZE(-9, -17), 0, 11, 1***REMOVED***,
  {6, UPB_SIZE(0, 0), UPB_SIZE(-9, -17), 1, 11, 1***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_core_GrpcService_GoogleGrpc_CallCredentials_ServiceAccountJWTAccessCredentials__fields[2] = {
  {1, UPB_SIZE(8, 8), 0, 0, 9, 1***REMOVED***,
  {2, UPB_SIZE(0, 0), 0, 0, 4, 1***REMOVED***,
***REMOVED***;
