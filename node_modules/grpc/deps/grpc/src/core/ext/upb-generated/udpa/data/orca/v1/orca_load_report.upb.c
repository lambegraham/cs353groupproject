...
static const upb_msglayout_field udpa_data_orca_v1_OrcaLoadReport__fields[5] = {
  ...
  {2, UPB_SIZE(8, 8), 0, 0, 1, 1***REMOVED***,
  {3, UPB_SIZE(16, 16), 0, 0, 4, 1***REMOVED***,
  {4, UPB_SIZE(24, 24), 0, 0, 11, 3***REMOVED***,
  {5, UPB_SIZE(28, 32), 0, 1, 11, 3***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field udpa_data_orca_v1_OrcaLoadReport_RequestCostEntry__fields[2] = {
  ...
  {2, UPB_SIZE(0, 0), 0, 0, 1, 1***REMOVED***,
***REMOVED***;
