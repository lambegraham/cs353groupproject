...
static const upb_msglayout_field envoy_api_v2_Cluster__fields[38] = {
  {1, UPB_SIZE(28, 32), 0, 0, 9, 1***REMOVED***,
  {2, UPB_SIZE(144, 264), UPB_SIZE(-153, -273), 0, 14, 1***REMOVED***,
  {3, UPB_SIZE(44, 64), 0, 2, 11, 1***REMOVED***,
  {4, UPB_SIZE(48, 72), 0, 23, 11, 1***REMOVED***,
  {5, UPB_SIZE(52, 80), 0, 24, 11, 1***REMOVED***,
  {6, UPB_SIZE(0, 0), 0, 0, 14, 1***REMOVED***,
  {7, UPB_SIZE(120, 216), 0, 15, 11, 3***REMOVED***,
  {8, UPB_SIZE(124, 224), 0, 17, 11, 3***REMOVED***,
  {9, UPB_SIZE(56, 88), 0, 24, 11, 1***REMOVED***,
  {10, UPB_SIZE(60, 96), 0, 12, 11, 1***REMOVED***,
  {11, UPB_SIZE(64, 104), 0, 11, 11, 1***REMOVED***,
  {13, UPB_SIZE(68, 112), 0, 18, 11, 1***REMOVED***,
  {14, UPB_SIZE(72, 120), 0, 19, 11, 1***REMOVED***,
  {16, UPB_SIZE(76, 128), 0, 23, 11, 1***REMOVED***,
  {17, UPB_SIZE(8, 8), 0, 0, 14, 1***REMOVED***,
  {18, UPB_SIZE(128, 232), 0, 15, 11, 3***REMOVED***,
  {19, UPB_SIZE(80, 136), 0, 14, 11, 1***REMOVED***,
  {20, UPB_SIZE(84, 144), 0, 23, 11, 1***REMOVED***,
  {21, UPB_SIZE(88, 152), 0, 16, 11, 1***REMOVED***,
  {22, UPB_SIZE(92, 160), 0, 4, 11, 1***REMOVED***,
  {23, UPB_SIZE(156, 280), UPB_SIZE(-161, -289), 7, 11, 1***REMOVED***,
  {24, UPB_SIZE(96, 168), 0, 22, 11, 1***REMOVED***,
  {25, UPB_SIZE(100, 176), 0, 21, 11, 1***REMOVED***,
  {26, UPB_SIZE(16, 16), 0, 0, 14, 1***REMOVED***,
  {27, UPB_SIZE(104, 184), 0, 0, 11, 1***REMOVED***,
  {28, UPB_SIZE(36, 48), 0, 0, 9, 1***REMOVED***,
  {29, UPB_SIZE(108, 192), 0, 20, 11, 1***REMOVED***,
  {30, UPB_SIZE(112, 200), 0, 10, 11, 1***REMOVED***,
  {31, UPB_SIZE(24, 24), 0, 0, 8, 1***REMOVED***,
  {32, UPB_SIZE(25, 25), 0, 0, 8, 1***REMOVED***,
  {33, UPB_SIZE(116, 208), 0, 9, 11, 1***REMOVED***,
  {34, UPB_SIZE(156, 280), UPB_SIZE(-161, -289), 6, 11, 1***REMOVED***,
  {35, UPB_SIZE(132, 240), 0, 3, 11, 3***REMOVED***,
  {36, UPB_SIZE(136, 248), 0, 8, 11, 3***REMOVED***,
  {37, UPB_SIZE(156, 280), UPB_SIZE(-161, -289), 5, 11, 1***REMOVED***,
  {38, UPB_SIZE(144, 264), UPB_SIZE(-153, -273), 1, 11, 1***REMOVED***,
  {39, UPB_SIZE(26, 26), 0, 0, 8, 1***REMOVED***,
  {40, UPB_SIZE(140, 256), 0, 13, 11, 3***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_Cluster_CustomClusterType__fields[2] = {
  {1, UPB_SIZE(0, 0), 0, 0, 9, 1***REMOVED***,
  {2, UPB_SIZE(8, 16), 0, 0, 11, 1***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_Cluster_EdsClusterConfig__fields[2] = {
  {1, UPB_SIZE(8, 16), 0, 0, 11, 1***REMOVED***,
  {2, UPB_SIZE(0, 0), 0, 0, 9, 1***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_Cluster_LbSubsetConfig__fields[7] = {
  {1, UPB_SIZE(0, 0), 0, 0, 14, 1***REMOVED***,
  {2, UPB_SIZE(12, 16), 0, 1, 11, 1***REMOVED***,
  {3, UPB_SIZE(16, 24), 0, 0, 11, 3***REMOVED***,
  {4, UPB_SIZE(8, 8), 0, 0, 8, 1***REMOVED***,
  {5, UPB_SIZE(9, 9), 0, 0, 8, 1***REMOVED***,
  {6, UPB_SIZE(10, 10), 0, 0, 8, 1***REMOVED***,
  {7, UPB_SIZE(11, 11), 0, 0, 8, 1***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_Cluster_LbSubsetConfig_LbSubsetSelector__fields[2] = {
  {1, UPB_SIZE(8, 8), 0, 0, 9, 3***REMOVED***,
  {2, UPB_SIZE(0, 0), 0, 0, 14, 1***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_Cluster_LeastRequestLbConfig__fields[1] = {
  {1, UPB_SIZE(0, 0), 0, 0, 11, 1***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_Cluster_RingHashLbConfig__fields[3] = {
  {1, UPB_SIZE(8, 8), 0, 0, 11, 1***REMOVED***,
  {3, UPB_SIZE(0, 0), 0, 0, 14, 1***REMOVED***,
  {4, UPB_SIZE(12, 16), 0, 0, 11, 1***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_Cluster_OriginalDstLbConfig__fields[1] = {
  {1, UPB_SIZE(0, 0), 0, 0, 8, 1***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_Cluster_CommonLbConfig__fields[6] = {
  {1, UPB_SIZE(4, 8), 0, 2, 11, 1***REMOVED***,
  {2, UPB_SIZE(12, 24), UPB_SIZE(-17, -33), 1, 11, 1***REMOVED***,
  {3, UPB_SIZE(12, 24), UPB_SIZE(-17, -33), 0, 11, 1***REMOVED***,
  {4, UPB_SIZE(8, 16), 0, 3, 11, 1***REMOVED***,
  {5, UPB_SIZE(0, 0), 0, 0, 8, 1***REMOVED***,
  {6, UPB_SIZE(1, 1), 0, 0, 8, 1***REMOVED***,
***REMOVED***;
...
static const upb_msglayout_field envoy_api_v2_Cluster_CommonLbConfig_ZoneAwareLbConfig__fields[2] = {
  {1, UPB_SIZE(0, 0), 0, 0, 11, 1***REMOVED***,
  {2, UPB_SIZE(4, 8), 0, 1, 11, 1***REMOVED***,
***REMOVED***;
