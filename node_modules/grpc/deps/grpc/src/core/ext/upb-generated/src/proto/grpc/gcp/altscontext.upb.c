...
static const upb_msglayout_field grpc_gcp_AltsContext__fields[7] = {
  ...
  {2, UPB_SIZE(16, 24), 0, 0, 9, 1***REMOVED***,
  {3, UPB_SIZE(0, 0), 0, 0, 14, 1***REMOVED***,
  {4, UPB_SIZE(24, 40), 0, 0, 9, 1***REMOVED***,
  {5, UPB_SIZE(32, 56), 0, 0, 9, 1***REMOVED***,
  {6, UPB_SIZE(40, 72), 0, 1, 11, 1***REMOVED***,
  {7, UPB_SIZE(44, 80), 0, 0, 11, 3***REMOVED***,
***REMOVED***;
