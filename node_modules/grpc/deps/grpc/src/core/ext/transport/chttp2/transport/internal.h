...
typedef struct {
  grpc_closure_list lists[GRPC_CHTTP2_PCL_COUNT] = {***REMOVED***;
...
***REMOVED***
  ...
  uint32_t remaining_bytes() const { return remaining_bytes_; ***REMOVED***
...
struct grpc_chttp2_transport {
  ...
  grpc_chttp2_stream_list lists[STREAM_LIST_COUNT] = {***REMOVED***;
...
***REMOVED*** reffer;
  ...
  uint8_t included[STREAM_LIST_COUNT] = {***REMOVED***;
  ...
  grpc_published_metadata_method published_metadata[2] = {***REMOVED***;
