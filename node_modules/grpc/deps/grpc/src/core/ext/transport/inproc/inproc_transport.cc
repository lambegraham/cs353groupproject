...
***REMOVED***
  ...
  ~shared_mu() { gpr_mu_destroy(&mu); ***REMOVED***
...
***REMOVED*** else if (!s->other_side_closed) {
...
void fail_helper_locked(inproc_stream* s, grpc_error* error) {
  ...
  ***REMOVED*** else if (s->write_buffer_cancel_error == GRPC_ERROR_NONE) {
...
void op_state_machine(void* arg, grpc_error* error) {
  ...
  if (s->cancel_self_error != GRPC_ERROR_NONE) {
    ...
    goto done;
***REMOVED*** else if (s->cancel_other_error != GRPC_ERROR_NONE) {
...
***REMOVED***
  ...
  ***REMOVED*** else if (!s->t->is_client && s->trailing_md_sent) {
...
void do_nothing(void* arg, grpc_error* error) {***REMOVED***
...
***REMOVED*** else if (s->cancel_self_error != GRPC_ERROR_NONE) {
...
grpc_endpoint* get_endpoint(grpc_transport* t) { return nullptr; ***REMOVED***
