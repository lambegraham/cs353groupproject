...
***REMOVED***
  ...
  Urgency send_stream_update() const { return send_stream_update_; ***REMOVED***
  Urgency send_transport_update() const { return send_transport_update_; ***REMOVED***
...
***REMOVED***
  uint32_t initial_window_size() const { return initial_window_size_; ***REMOVED***
  uint32_t max_frame_size() const { return max_frame_size_; ***REMOVED***
...
class TransportFlowControlBase {
 public:
  ...
  virtual grpc_error* RecvData(int64_t incoming_frame_size) { abort(); ***REMOVED***

  // Called to do bookkeeping when we receive a WINDOW_UPDATE frame.
  virtual void RecvUpdate(uint32_t size) { abort(); ***REMOVED***
  ...
  virtual BdpEstimator* bdp_estimator() { return nullptr; ***REMOVED***

  // Getters
  int64_t remote_window() const { return remote_window_; ***REMOVED***
  virtual int64_t target_window() const { return target_initial_window_size_; ***REMOVED***
  int64_t announced_window() const { return announced_window_; ***REMOVED***

  // Used in certain benchmarks in which we don't want FlowControl to be a
  // factor
  virtual void TestOnlyForceHugeWindow() {***REMOVED***
...
class TransportFlowControlDisabled final : public TransportFlowControlBase {
 public:
  ...
  bool flow_control_enabled() const override { return false; ***REMOVED***

  // Never do anything.
  uint32_t MaybeSendUpdate(bool writing_anyway) override { return 0; ***REMOVED***
  FlowControlAction MakeAction() override { return FlowControlAction(); ***REMOVED***
  FlowControlAction PeriodicUpdate() override { return FlowControlAction(); ***REMOVED***
  void StreamSentData(int64_t size) override {***REMOVED***
  grpc_error* RecvData(int64_t incoming_frame_size) override {
    return GRPC_ERROR_NONE;
***REMOVED***
  void RecvUpdate(uint32_t size) override {***REMOVED***
***REMOVED***;
...
class TransportFlowControl final : public TransportFlowControlBase {
 public:
  ...
  ~TransportFlowControl() {***REMOVED***

  bool flow_control_enabled() const override { return true; ***REMOVED***

  bool bdp_probe() const { return enable_bdp_probe_; ***REMOVED***
...
***REMOVED***
  ...
  void StreamSentData(int64_t size) override { remote_window_ -= size; ***REMOVED***
...
***REMOVED***
  ...
  const grpc_chttp2_transport* transport() const { return t_; ***REMOVED***
...
***REMOVED***
  ...
  BdpEstimator* bdp_estimator() override { return &bdp_estimator_; ***REMOVED***
...
class StreamFlowControlBase {
 public:
  StreamFlowControlBase() {***REMOVED***
  virtual ~StreamFlowControlBase() {***REMOVED***

  // Updates an action using the protected members.
  virtual FlowControlAction UpdateAction(FlowControlAction action) { abort(); ***REMOVED***
  ...
  virtual void SentData(int64_t outgoing_frame_size) { abort(); ***REMOVED***
  ...
  virtual uint32_t MaybeSendUpdate() { abort(); ***REMOVED***
...
***REMOVED***
  ...
  // Getters
  int64_t remote_window_delta() { return remote_window_delta_; ***REMOVED***
  int64_t local_window_delta() { return local_window_delta_; ***REMOVED***
  int64_t announced_window_delta() { return announced_window_delta_; ***REMOVED***
...
***REMOVED***
  FlowControlAction MakeAction() override { return FlowControlAction(); ***REMOVED***
  void SentData(int64_t outgoing_frame_size) override {***REMOVED***
  grpc_error* RecvData(int64_t incoming_frame_size) override {
    return GRPC_ERROR_NONE;
***REMOVED***
  uint32_t MaybeSendUpdate() override { return 0; ***REMOVED***
  void RecvUpdate(uint32_t size) override {***REMOVED***
  void IncomingByteStreamUpdate(size_t max_size_hint,
                                size_t have_already) override {***REMOVED***
***REMOVED***;
...
***REMOVED***
  ...
  int64_t remote_window_delta() const { return remote_window_delta_; ***REMOVED***
  int64_t local_window_delta() const { return local_window_delta_; ***REMOVED***
  int64_t announced_window_delta() const { return announced_window_delta_; ***REMOVED***

  const grpc_chttp2_stream* stream() const { return s_; ***REMOVED***
