...
***REMOVED***
  ...
  void IncInitialMetadataWrites() { ++initial_metadata_writes_; ***REMOVED***
  void IncWindowUpdateWrites() { ++flow_control_writes_; ***REMOVED***
  void IncMessageWrites() { ++message_writes_; ***REMOVED***
  void IncTrailingMetadataWrites() { ++trailing_metadata_writes_; ***REMOVED***

  void NoteScheduledResults() { result_.early_results_scheduled = true; ***REMOVED***

  grpc_chttp2_transport* transport() const { return t_; ***REMOVED***
...
***REMOVED***
 ...
 private:
  ...
  grpc_chttp2_begin_write_result result_ = {false, false, false***REMOVED***;
***REMOVED***;
 ...
 public:
  DataSendContext(WriteContext* write_context, grpc_chttp2_transport* t,
      ...
      : write_context_(write_context),
        t_(t),
        s_(s),
        sending_bytes_before_(s_->sending_bytes) {***REMOVED***
...
***REMOVED***
  ...
  bool AnyOutgoing() const { return max_outgoing() > 0; ***REMOVED***
...
***REMOVED***
  ...
  bool is_last_frame() const { return is_last_frame_; ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
    ...
    ***REMOVED*** else if (data_send_context.stream_remote_window() <= 0) {
...
***REMOVED***
  ...
  bool stream_became_writable() { return stream_became_writable_; ***REMOVED***
