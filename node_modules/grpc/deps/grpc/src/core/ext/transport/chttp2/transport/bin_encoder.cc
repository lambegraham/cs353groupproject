...
static const b64_huff_sym huff_alphabet[64] = {
    {0x21, 6***REMOVED***, {0x5d, 7***REMOVED***, {0x5e, 7***REMOVED***,   {0x5f, 7***REMOVED***, {0x60, 7***REMOVED***, {0x61, 7***REMOVED***,
    {0x62, 7***REMOVED***, {0x63, 7***REMOVED***, {0x64, 7***REMOVED***,   {0x65, 7***REMOVED***, {0x66, 7***REMOVED***, {0x67, 7***REMOVED***,
    {0x68, 7***REMOVED***, {0x69, 7***REMOVED***, {0x6a, 7***REMOVED***,   {0x6b, 7***REMOVED***, {0x6c, 7***REMOVED***, {0x6d, 7***REMOVED***,
    {0x6e, 7***REMOVED***, {0x6f, 7***REMOVED***, {0x70, 7***REMOVED***,   {0x71, 7***REMOVED***, {0x72, 7***REMOVED***, {0xfc, 8***REMOVED***,
    {0x73, 7***REMOVED***, {0xfd, 8***REMOVED***, {0x3, 5***REMOVED***,    {0x23, 6***REMOVED***, {0x4, 5***REMOVED***,  {0x24, 6***REMOVED***,
    {0x5, 5***REMOVED***,  {0x25, 6***REMOVED***, {0x26, 6***REMOVED***,   {0x27, 6***REMOVED***, {0x6, 5***REMOVED***,  {0x74, 7***REMOVED***,
    {0x75, 7***REMOVED***, {0x28, 6***REMOVED***, {0x29, 6***REMOVED***,   {0x2a, 6***REMOVED***, {0x7, 5***REMOVED***,  {0x2b, 6***REMOVED***,
    {0x76, 7***REMOVED***, {0x2c, 6***REMOVED***, {0x8, 5***REMOVED***,    {0x9, 5***REMOVED***,  {0x2d, 6***REMOVED***, {0x77, 7***REMOVED***,
    {0x78, 7***REMOVED***, {0x79, 7***REMOVED***, {0x7a, 7***REMOVED***,   {0x7b, 7***REMOVED***, {0x0, 5***REMOVED***,  {0x1, 5***REMOVED***,
    {0x2, 5***REMOVED***,  {0x19, 6***REMOVED***, {0x1a, 6***REMOVED***,   {0x1b, 6***REMOVED***, {0x1c, 6***REMOVED***, {0x1d, 6***REMOVED***,
    {0x1e, 6***REMOVED***, {0x1f, 6***REMOVED***, {0x7fb, 11***REMOVED***, {0x18, 6***REMOVED******REMOVED***;

static const uint8_t tail_xtra[3] = {0, 2, 3***REMOVED***;
