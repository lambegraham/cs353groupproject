...
static bool read_channel_args(grpc_chttp2_transport* t,
  ...
  for (i = 0; i < channel_args->num_args; i++) {
    if (0 == strcmp(channel_args->args[i].key,
      ...
      const grpc_integer_options options = {-1, 0, INT_MAX***REMOVED***;
      const int value =
  ...
  ***REMOVED*** else if (0 == strcmp(channel_args->args[i].key,
      ...
      t->ping_policy.max_ping_strikes = grpc_channel_arg_get_integer(
          &channel_args->args[i], {g_default_max_ping_strikes, 0, INT_MAX***REMOVED***);
  ***REMOVED*** else if (0 ==
  ...
  ***REMOVED*** else if (0 == strcmp(channel_args->args[i].key,
      ...
      t->write_buffer_size = static_cast<uint32_t>(grpc_channel_arg_get_integer(
          &channel_args->args[i], {0, 0, MAX_WRITE_BUFFER_SIZE***REMOVED***));
  ***REMOVED*** else if (0 ==
  ...
  ***REMOVED*** else if (0 == strcmp(channel_args->args[i].key,
      ...
      t->keepalive_permit_without_calls = static_cast<uint32_t>(
          grpc_channel_arg_get_integer(&channel_args->args[i], {0, 0, 1***REMOVED***));
  ***REMOVED*** else if (0 == strcmp(channel_args->args[i].key,
                           GRPC_ARG_OPTIMIZATION_TARGET)) {
      if (channel_args->args[i].type != GRPC_ARG_STRING) {
        gpr_log(GPR_ERROR, "%s should be a string",
                GRPC_ARG_OPTIMIZATION_TARGET);
    ***REMOVED*** else if (0 == strcmp(channel_args->args[i].value.string, "blend")) {
        t->opt_target = GRPC_CHTTP2_OPTIMIZE_FOR_LATENCY;
    ***REMOVED*** else if (0 == strcmp(channel_args->args[i].value.string, "latency")) {
        t->opt_target = GRPC_CHTTP2_OPTIMIZE_FOR_LATENCY;
    ***REMOVED*** else if (0 ==
  ...
  ***REMOVED*** else {
    ...
    ***REMOVED*** settings_map[] = {{GRPC_ARG_MAX_CONCURRENT_STREAMS,
                           GRPC_CHTTP2_SETTINGS_MAX_CONCURRENT_STREAMS,
                           {-1, 0, INT32_MAX***REMOVED***,
                          ...
                          {GRPC_ARG_HTTP2_STREAM_LOOKAHEAD_BYTES,
                           ...
                           {-1, 5, INT32_MAX***REMOVED***,
                           {true, true***REMOVED******REMOVED******REMOVED***;
...
grpc_chttp2_stream::grpc_chttp2_stream(grpc_chttp2_transport* t,
    ...
    : t(t),
      ...
      metadata_buffer{grpc_chttp2_incoming_metadata_buffer(arena),
                      grpc_chttp2_incoming_metadata_buffer(arena)***REMOVED*** {
  if (server_data) {
...
static void continue_fetching_send_locked(grpc_chttp2_transport* t,
  ...
  ***REMOVED***
    ...
    ***REMOVED***
      ...
      return; /* early out */
  ***REMOVED*** else if (s->fetching_send_message->Next(UINT32_MAX,
...
void grpc_chttp2_maybe_complete_recv_message(grpc_chttp2_transport* t,
      ...
      ***REMOVED***
        if (error != GRPC_ERROR_NONE) {
          ...
          grpc_slice_buffer_reset_and_unref_internal(
              &s->unprocessed_incoming_frames_buffer);
          break;
      ***REMOVED*** else if (*s->recv_message != nullptr) {
          break;
      ***REMOVED***
    ***REMOVED***
  ***REMOVED***
  ...
  ***REMOVED*** else if (s->published_metadata[1] != GRPC_METADATA_NOT_PUBLISHED) {
      *s->recv_message = nullptr;
      null_then_sched_closure(&s->recv_message_ready);
  ***REMOVED***
    GRPC_ERROR_UNREF(error);
...
static void end_all_the_calls(grpc_chttp2_transport* t, grpc_error* error) {
  ...
  if (!t->is_client && !grpc_error_has_clear_grpc_status(error) &&
    ...
    error = grpc_error_set_int(error, GRPC_ERROR_INT_GRPC_STATUS,
                               GRPC_STATUS_UNAVAILABLE);
***REMOVED***
  cancel_stream_cb_args args = {error, t***REMOVED***;
...
void grpc_chttp2_act_on_flowctl_action(
  ...
  WithUrgency(t, action.send_stream_update(),
              ...
              [t, s]() { grpc_chttp2_mark_stream_writable(t, s); ***REMOVED***);
  WithUrgency(t, action.send_transport_update(),
              GRPC_CHTTP2_INITIATE_WRITE_TRANSPORT_FLOW_CONTROL, []() {***REMOVED***);
...
***REMOVED*** else if (t->closed_with_error == GRPC_ERROR_NONE) {
    keep_reading = true;
  ...
  if (args) {
    ...
    ***REMOVED*** else if (0 ==
        ...
        g_default_max_ping_strikes = grpc_channel_arg_get_integer(
            &args->args[i], {g_default_max_ping_strikes, 0, INT_MAX***REMOVED***);
    ***REMOVED*** else if (0 == strcmp(args->args[i].key,
                             GRPC_ARG_HTTP2_MAX_PINGS_WITHOUT_DATA)) {
        g_default_max_pings_without_data = grpc_channel_arg_get_integer(
            &args->args[i], {g_default_max_pings_without_data, 0, INT_MAX***REMOVED***);
    ***REMOVED*** else if (0 ==
                 strcmp(
                     args->args[i].key,
                     GRPC_ARG_HTTP2_MIN_SENT_PING_INTERVAL_WITHOUT_DATA_MS)) {
        g_default_min_sent_ping_interval_without_data_ms =
            grpc_channel_arg_get_integer(
                &args->args[i],
                {g_default_min_sent_ping_interval_without_data_ms, 0, INT_MAX***REMOVED***);
    ***REMOVED*** else if (0 ==
                 strcmp(
                     args->args[i].key,
                     GRPC_ARG_HTTP2_MIN_RECV_PING_INTERVAL_WITHOUT_DATA_MS)) {
        g_default_min_recv_ping_interval_without_data_ms =
            grpc_channel_arg_get_integer(
                &args->args[i],
                {g_default_min_recv_ping_interval_without_data_ms, 0, INT_MAX***REMOVED***);
    ***REMOVED***
  ***REMOVED***
***REMOVED***
***REMOVED***
...
***REMOVED*** else if (error == GRPC_ERROR_NONE) {
  ...
  ***REMOVED*** else {
      ...
      grpc_timer_init(&t->keepalive_ping_timer,
                      ...
                      &t->init_keepalive_ping_locked);
  ***REMOVED***
***REMOVED*** else if (error == GRPC_ERROR_CANCELLED) {
...
***REMOVED*** else if (s->byte_stream_error != GRPC_ERROR_NONE) {
...
static const grpc_transport_vtable* get_vtable(void) { return &vtable; ***REMOVED***
