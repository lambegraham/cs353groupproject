...
grpc_millis GetClientIdleTimeout(const grpc_channel_args* args) {
  return GPR_MAX(
      grpc_channel_arg_get_integer(
          ...
          {DEFAULT_IDLE_TIMEOUT_MS, 0, INT_MAX***REMOVED***),
      MIN_IDLE_TIMEOUT_MS);
***REMOVED***
...
class ChannelData {
 ...
 private:
  ...
  Atomic<intptr_t> call_count_{0***REMOVED***;
  Atomic<ChannelState> state_{IDLE***REMOVED***;
...
void grpc_client_idle_filter_shutdown(void) {***REMOVED***
