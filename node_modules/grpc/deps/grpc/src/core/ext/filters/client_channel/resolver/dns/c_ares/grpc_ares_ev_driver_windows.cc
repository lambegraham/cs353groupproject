...
class WSAErrorContext {
 public:
  explicit WSAErrorContext(){***REMOVED***;
...
***REMOVED***
  ...
  void SetWSAError(int error) { error_ = error; ***REMOVED***
...
***REMOVED***
  ...
  const char* GetName() override { return name_; ***REMOVED***
...
***REMOVED***
  ...
  bool gotten_into_driver_list() const { return gotten_into_driver_list_; ***REMOVED***
  void set_gotten_into_driver_list() { gotten_into_driver_list_ = true; ***REMOVED***
  ...
  // We don't run register_for_{readable,writeable***REMOVED*** logic until
...
class GrpcPolledFdFactoryWindows : public GrpcPolledFdFactory {
 public:
  GrpcPolledFdFactoryWindows(grpc_combiner* combiner)
      : sock_to_polled_fd_map_(combiner) {***REMOVED***
