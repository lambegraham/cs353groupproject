...
ConnectedSubchannel::ConnectedSubchannel(
    ...
    : RefCounted<ConnectedSubchannel>(&grpc_trace_subchannel_refcount),
      ...
      channelz_subchannel_(std::move(channelz_subchannel)) {***REMOVED***
...
***REMOVED***
  ...
  grpc_connectivity_state state() const { return state_; ***REMOVED***
...
***REMOVED***
  ...
  bool HasWatchers() const { return !watcher_list_.empty(); ***REMOVED***
...
void Subchannel::HealthWatcherMap::ShutdownLocked() { map_.clear(); ***REMOVED***
...
Subchannel::Subchannel(SubchannelKey* key, grpc_connector* connector,
  ...
  if (grpc_proxy_mappers_map_address(addr, args, &new_address, &new_args)) {
    ...
    addr = new_address;
***REMOVED***
  static const char* keys_to_remove[] = {GRPC_ARG_SUBCHANNEL_ADDRESS***REMOVED***;
  ...
  const grpc_integer_options options = {
      GRPC_MAX_CHANNEL_TRACE_EVENT_MEMORY_PER_NODE_DEFAULT, 0, INT_MAX***REMOVED***;
...
void Subchannel::OnRetryAlarm(void* arg, grpc_error* error) {
  ...
  if (c->disconnected_) {
    error = GRPC_ERROR_CREATE_REFERENCING_FROM_STATIC_STRING("Disconnected",
                                                             &error, 1);
***REMOVED*** else if (c->retry_immediately_) {
...
void Subchannel::OnConnectingFinished(void* arg, grpc_error* error) {
  ...
  ***REMOVED*** else if (c->disconnected_) {
      GRPC_SUBCHANNEL_WEAK_UNREF(c, "connecting");
  ***REMOVED*** else {
