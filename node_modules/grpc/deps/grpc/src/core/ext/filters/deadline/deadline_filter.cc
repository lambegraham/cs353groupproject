...
struct start_timer_after_init_state {
  start_timer_after_init_state(grpc_call_element* elem, grpc_millis deadline)
      : elem(elem), deadline(deadline) {***REMOVED***
  ~start_timer_after_init_state() { start_timer_if_needed(elem, deadline); ***REMOVED***
...
grpc_deadline_state::~grpc_deadline_state() { cancel_timer_if_needed(this); ***REMOVED***
...
static void destroy_channel_elem(grpc_channel_element* elem) {***REMOVED***
...
void grpc_deadline_filter_shutdown(void) {***REMOVED***
