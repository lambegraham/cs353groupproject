...
class ConnectedSubchannel : public RefCounted<ConnectedSubchannel> {
 public:
  ...
  grpc_channel_stack* channel_stack() const { return channel_stack_; ***REMOVED***
  const grpc_channel_args* args() const { return args_; ***REMOVED***
...
***REMOVED***
  ...
  const grpc_channel_args* channel_args() const { return args_; ***REMOVED***
 ...
 private:
  ...
  class ConnectivityStateWatcherList {
   public:
    ~ConnectivityStateWatcherList() { Clear(); ***REMOVED***
    ...
    void Clear() { watchers_.clear(); ***REMOVED***

    bool empty() const { return watchers_.empty(); ***REMOVED***
