...
***REMOVED***
  ...
  class ChannelControlHelper {
   public:
    ...
    enum TraceSeverity { TRACE_INFO, TRACE_WARNING, TRACE_ERROR ***REMOVED***;
...
***REMOVED***
  ...
  struct UpdateArgs {
    ...
    UpdateArgs() = default;
    ~UpdateArgs() { grpc_channel_args_destroy(args); ***REMOVED***
...
***REMOVED***
  ...
  /// IDLE state.
  virtual void ExitIdleLocked() {***REMOVED***

  /// Resets connection backoff.
  virtual void ResetBackoffLocked() GRPC_ABSTRACT;

  grpc_pollset_set* interested_parties() const { return interested_parties_; ***REMOVED***
  ...
  class QueuePicker : public SubchannelPicker {
   public:
    ...
    ~QueuePicker() { parent_.reset(DEBUG_LOCATION, "QueuePicker"); ***REMOVED***
...
***REMOVED***
  ...
  class TransientFailurePicker : public SubchannelPicker {
   public:
    explicit TransientFailurePicker(grpc_error* error) : error_(error) {***REMOVED***
    ~TransientFailurePicker() override { GRPC_ERROR_UNREF(error_); ***REMOVED***
...
***REMOVED***
 ...
 protected:
  grpc_combiner* combiner() const { return combiner_; ***REMOVED***
