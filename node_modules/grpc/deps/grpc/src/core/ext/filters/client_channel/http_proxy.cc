...
***REMOVED*** else if (authority_nstrs == 2) {
    /* User cred found */
...
static void proxy_mapper_destroy(grpc_proxy_mapper* mapper) {***REMOVED***
...
static grpc_proxy_mapper proxy_mapper = {&proxy_mapper_vtable***REMOVED***;
