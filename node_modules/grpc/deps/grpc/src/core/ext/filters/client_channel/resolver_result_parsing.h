...
***REMOVED***
  ...
  ClientChannelGlobalParsedConfig(
      ...
      : parsed_lb_config_(std::move(parsed_lb_config)),
        ...
        health_check_service_name_(health_check_service_name) {***REMOVED***
...
***REMOVED***
  ...
  ClientChannelMethodParsedConfig(grpc_millis timeout,
      ...
      : timeout_(timeout),
        ...
        retry_policy_(std::move(retry_policy)) {***REMOVED***

  grpc_millis timeout() const { return timeout_; ***REMOVED***

  Optional<bool> wait_for_ready() const { return wait_for_ready_; ***REMOVED***

  const RetryPolicy* retry_policy() const { return retry_policy_.get(); ***REMOVED***
