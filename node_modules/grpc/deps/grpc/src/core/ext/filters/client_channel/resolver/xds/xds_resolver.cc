 ...
 public:
  explicit XdsResolver(ResolverArgs args)
      : Resolver(args.combiner, std::move(args.result_handler)),
        args_(grpc_channel_args_copy(args.args)) {***REMOVED***
  ~XdsResolver() override { grpc_channel_args_destroy(args_); ***REMOVED***
...
void XdsResolver::StartLocked() {
  static const char* service_config =
      "{\n"
      "  \"loadBalancingConfig\":[\n"
      "    { \"xds_experimental\":{***REMOVED*** ***REMOVED***\n"
      "  ]\n"
      "***REMOVED***";
  Result result;
  result.args = args_;
...
***REMOVED***
  ...
  const char* scheme() const override { return "xds-experimental"; ***REMOVED***
***REMOVED***;
...
void grpc_resolver_xds_shutdown() {***REMOVED***
