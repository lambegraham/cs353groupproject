...
void ServerLoadReportingCallData::Destroy(
  ...
  if (client_ip_and_lr_token_ != nullptr) {
    opencensus::stats::Record(
        {{::grpc::load_reporter::MeasureEndCount(), 1***REMOVED***,
         {::grpc::load_reporter::MeasureEndBytesSent(),
          final_info->stats.transport_stream_stats.outgoing.data_bytes***REMOVED***,
         {::grpc::load_reporter::MeasureEndBytesReceived(),
          final_info->stats.transport_stream_stats.incoming.data_bytes***REMOVED***,
         {::grpc::load_reporter::MeasureEndLatencyMs(),
          gpr_time_to_millis(final_info->stats.latency)***REMOVED******REMOVED***,
        {{::grpc::load_reporter::TagKeyToken(),
          {client_ip_and_lr_token_, client_ip_and_lr_token_len_***REMOVED******REMOVED***,
         {::grpc::load_reporter::TagKeyHost(),
          {target_host_, target_host_len_***REMOVED******REMOVED***,
         {::grpc::load_reporter::TagKeyUserId(),
          {chand->peer_identity(), chand->peer_identity_len()***REMOVED******REMOVED***,
         {::grpc::load_reporter::TagKeyStatus(),
          GetStatusTagForStatus(final_info->final_status)***REMOVED******REMOVED***);
...
***REMOVED*** else if (op->send_trailing_metadata() != nullptr) {
    GRPC_LOG_IF_ERROR(
...
***REMOVED***
  ...
  if (addr->sa_family == GRPC_AF_INET) {
    ...
    *size = 8;
***REMOVED*** else if (addr->sa_family == GRPC_AF_INET6) {
...
***REMOVED*** else if (calld->target_host_ == nullptr &&
  ...
  ***REMOVED***
***REMOVED*** else if (grpc_slice_str_cmp(GRPC_MDKEY(md),
...
void ServerLoadReportingCallData::RecvInitialMetadataReady(void* arg,
  ...
  ***REMOVED***
    opencensus::stats::Record(
        {{::grpc::load_reporter::MeasureStartCount(), 1***REMOVED******REMOVED***,
        {{::grpc::load_reporter::TagKeyToken(),
          {calld->client_ip_and_lr_token_, calld->client_ip_and_lr_token_len_***REMOVED******REMOVED***,
         {::grpc::load_reporter::TagKeyHost(),
          {calld->target_host_, calld->target_host_len_***REMOVED******REMOVED***,
         {::grpc::load_reporter::TagKeyUserId(),
          {chand->peer_identity(), chand->peer_identity_len()***REMOVED******REMOVED******REMOVED***);
***REMOVED***
...
grpc_filtered_mdelem ServerLoadReportingCallData::SendTrailingMetadataFilter(
  ...
  ***REMOVED***
    ...
    opencensus::stats::Record(
        {{::grpc::load_reporter::MeasureOtherCallMetric(), cost_value***REMOVED******REMOVED***,
        {{::grpc::load_reporter::TagKeyToken(),
          {calld->client_ip_and_lr_token_, calld->client_ip_and_lr_token_len_***REMOVED******REMOVED***,
         {::grpc::load_reporter::TagKeyHost(),
          {calld->target_host_, calld->target_host_len_***REMOVED******REMOVED***,
         ...
         {::grpc::load_reporter::TagKeyMetricName(),
          {cost_name, cost_name_len***REMOVED******REMOVED******REMOVED***);
    return GRPC_FILTERED_REMOVE();
***REMOVED***
  return GRPC_FILTERED_MDELEM(md);
***REMOVED***
...
struct ServerLoadReportingFilterStaticRegistrar {
  ServerLoadReportingFilterStaticRegistrar() {
    static grpc_core::Atomic<bool> registered{false***REMOVED***;
...
***REMOVED***
***REMOVED*** server_load_reporting_filter_static_registrar;
