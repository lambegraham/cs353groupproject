 ...
 public:
  ParsedXdsConfig(const char* balancer_name,
      ...
      : balancer_name_(balancer_name),
        ...
        fallback_policy_(std::move(fallback_policy)) {***REMOVED***

  const char* name() const override { return kXds; ***REMOVED***

  const char* balancer_name() const { return balancer_name_; ***REMOVED***;
...
class XdsLb : public LoadBalancingPolicy {
   ...
   public:
    ...
    class RetryableLbCall : public InternallyRefCounted<RetryableLbCall<T>> {
     public:
      ...
      T* lb_calld() const { return lb_calld_.get(); ***REMOVED***
      LbChannelState* lb_chand() const { return lb_chand_.get(); ***REMOVED***
  ...
  ***REMOVED***
    ...
    class EdsCallState : public InternallyRefCounted<EdsCallState> {
     public:
      ...
      RetryableLbCall<EdsCallState>* parent() const { return parent_.get(); ***REMOVED***
      LbChannelState* lb_chand() const { return parent_->lb_chand(); ***REMOVED***
      XdsLb* xdslb_policy() const { return lb_chand()->xdslb_policy(); ***REMOVED***
      bool seen_response() const { return seen_response_; ***REMOVED***
  ...
  ***REMOVED***
    ...
    class LrsCallState : public InternallyRefCounted<LrsCallState> {
     public:
      ...
      RetryableLbCall<LrsCallState>* parent() { return parent_.get(); ***REMOVED***
      LbChannelState* lb_chand() const { return parent_->lb_chand(); ***REMOVED***
      XdsLb* xdslb_policy() const { return lb_chand()->xdslb_policy(); ***REMOVED***
      bool seen_response() const { return seen_response_; ***REMOVED***
      ...
      ***REMOVED***
        XdsLb* xdslb_policy() const { return parent_->xdslb_policy(); ***REMOVED***
  ...
  ***REMOVED***
    ...
    grpc_channel* channel() const { return channel_; ***REMOVED***
    XdsLb* xdslb_policy() const { return xdslb_policy_.get(); ***REMOVED***
    EdsCallState* eds_calld() const { return eds_calld_->lb_calld(); ***REMOVED***
    LrsCallState* lrs_calld() const { return lrs_calld_->lb_calld(); ***REMOVED***
  ...
  ***REMOVED***
    bool HasActiveEdsCall() const { return eds_calld_->lb_calld() != nullptr; ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
    ~PickerWrapper() { locality_stats_->UnrefByPicker(); ***REMOVED***
   ...
   public:
    ...
    Picker(RefCountedPtr<XdsLb> xds_policy, PickerList pickers)
        : xds_policy_(std::move(xds_policy)),
          ...
          drop_config_(xds_policy_->drop_config_) {***REMOVED***
  ...
  class FallbackHelper : public ChannelControlHelper {
   public:
    explicit FallbackHelper(RefCountedPtr<XdsLb> parent)
        : parent_(std::move(parent)) {***REMOVED***

    ~FallbackHelper() { parent_.reset(DEBUG_LOCATION, "FallbackHelper"); ***REMOVED***
    ...
    void set_child(LoadBalancingPolicy* child) { child_ = child; ***REMOVED***
...
***REMOVED***
  ...
  class LocalityMap {
    ...
    ***REMOVED***
      uint32_t locality_weight() const { return locality_weight_; ***REMOVED***
      ...
      class Helper : public ChannelControlHelper {
       public:
        explicit Helper(RefCountedPtr<LocalityEntry> entry)
            : entry_(std::move(entry)) {***REMOVED***

        ~Helper() { entry_.reset(DEBUG_LOCATION, "Helper"); ***REMOVED***
  ...
  ***REMOVED***
    ...
    explicit LocalityMap(XdsLb* xds_policy) : xds_policy_(xds_policy) {***REMOVED***
...
XdsLb::PickResult XdsLb::Picker::PickFromLocality(const uint32_t key,
  ...
  while (end_index > start_index) {
    ...
    if (pickers_[mid].first > key) {
      end_index = mid;
  ***REMOVED*** else if (pickers_[mid].first < key) {
      start_index = mid + 1;
  ***REMOVED*** else {
      index = mid + 1;
      break;
...
***REMOVED*** else if (!CalledByCurrentFallback()) {
...
void XdsLb::ProcessAddressesAndChannelArgsLocked(
  ...
  static const char* args_to_remove[] = {GRPC_ARG_LB_POLICY_NAME***REMOVED***;
...
void XdsLb::LocalityMap::ShutdownLocked() { map_.clear(); ***REMOVED***
...
***REMOVED*** else if (!CalledByCurrentChild()) {
...
***REMOVED***
  ...
  ***REMOVED***
    ...
    ***REMOVED*** else if (strcmp(field->key, "childPolicy") == 0) {
      ...
      ***REMOVED***
    ***REMOVED*** else if (strcmp(field->key, "fallbackPolicy") == 0) {
...
void grpc_lb_policy_xds_shutdown() {***REMOVED***
