...
UniquePtr<ServiceConfig::ParsedConfig> MessageSizeParser::ParsePerMethodParams(
  ...
  for (grpc_json* field = json->child; field != nullptr; field = field->next) {
    ...
    ***REMOVED***  // Duplicate, continue parsing.
    ...
    ***REMOVED*** else {
      ...
      ***REMOVED***
    ***REMOVED***
  ***REMOVED*** else if (strcmp(field->key, "maxResponseMessageBytes") == 0) {
...
size_t MessageSizeParser::ParserIndex() { return g_message_size_parser_index; ***REMOVED***
...
struct call_data {
  ...
  ***REMOVED*** else if (chand.svc_cfg != nullptr) {
...
***REMOVED***
  ...
  ~call_data() { GRPC_ERROR_UNREF(error); ***REMOVED***
...
grpc_core::MessageSizeParsedConfig::message_size_limits get_message_size_limits(
  ...
  for (size_t i = 0; i < channel_args->num_args; ++i) {
    if (strcmp(channel_args->args[i].key, GRPC_ARG_MAX_SEND_MESSAGE_LENGTH) ==
        0) {
      const grpc_integer_options options = {lim.max_send_size, -1, INT_MAX***REMOVED***;
      lim.max_send_size =
          grpc_channel_arg_get_integer(&channel_args->args[i], options);
  ***REMOVED***
    if (strcmp(channel_args->args[i].key,
               GRPC_ARG_MAX_RECEIVE_MESSAGE_LENGTH) == 0) {
      const grpc_integer_options options = {lim.max_recv_size, -1, INT_MAX***REMOVED***;
      lim.max_recv_size =
          grpc_channel_arg_get_integer(&channel_args->args[i], options);
  ***REMOVED***
***REMOVED***
...
void grpc_message_size_filter_shutdown(void) {***REMOVED***
