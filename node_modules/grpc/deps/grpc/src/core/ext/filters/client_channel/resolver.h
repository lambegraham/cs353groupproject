...
***REMOVED***
  ...
  virtual void RequestReresolutionLocked() {***REMOVED***
  ...
  virtual void ResetBackoffLocked() {***REMOVED***
...
***REMOVED***
 ...
 protected:
  ...
  ResultHandler* result_handler() const { return result_handler_.get(); ***REMOVED***
