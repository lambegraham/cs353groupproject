...
***REMOVED***
  ...
  SubchannelInterface* subchannel() const { return subchannel_.get(); ***REMOVED***
   ...
   public:
    Watcher(
        ...
        : subchannel_data_(subchannel_data),
          subchannel_list_(std::move(subchannel_list)) {***REMOVED***

    ~Watcher() { subchannel_list_.reset(DEBUG_LOCATION, "Watcher dtor"); ***REMOVED***
...
class SubchannelList : public InternallyRefCounted<SubchannelListType> {
 public:
  ...
  size_t num_subchannels() const { return subchannels_.size(); ***REMOVED***

  // The data for the subchannel at a particular index.
  SubchannelDataType* subchannel(size_t index) { return &subchannels_[index]; ***REMOVED***

  // Returns true if the subchannel list is shutting down.
  bool shutting_down() const { return shutting_down_; ***REMOVED***

  // Accessors.
  LoadBalancingPolicy* policy() const { return policy_; ***REMOVED***
  TraceFlag* tracer() const { return tracer_; ***REMOVED***
...
SubchannelData<SubchannelListType, SubchannelDataType>::SubchannelData(
    ...
    : subchannel_list_(subchannel_list),
      ...
      connectivity_state_(GRPC_CHANNEL_IDLE) {***REMOVED***
...
***REMOVED***
  ...
  static const char* keys_to_remove[] = {GRPC_ARG_SUBCHANNEL_ADDRESS,
                                         GRPC_ARG_SERVICE_CONFIG***REMOVED***;
