...
***REMOVED***
  ...
  min_time_between_resolutions_ =
      grpc_channel_arg_get_integer(arg, {1000 * 30, 0, INT_MAX***REMOVED***);
...
***REMOVED***
  ...
  query_timeout_ms_ = grpc_channel_arg_get_integer(
      ...
      {GRPC_DNS_ARES_DEFAULT_QUERY_TIMEOUT_MS, 0, INT_MAX***REMOVED***);
***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
    ...
    for (grpc_json* field = choice->child; field != nullptr;
      ...
      ***REMOVED*** else if (!ValueInJsonArray(field, "c++")) {
          selected = false;
      ***REMOVED***
    ***REMOVED***
...
***REMOVED***
  ...
  const char* scheme() const override { return "dns"; ***REMOVED***
***REMOVED***;
...
static grpc_address_resolver_vtable ares_resolver = {
    grpc_resolve_address_ares, blocking_resolve_address_ares***REMOVED***;
