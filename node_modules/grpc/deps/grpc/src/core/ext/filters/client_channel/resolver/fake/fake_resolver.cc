...
FakeResolver::FakeResolver(ResolverArgs args)
  ...
  const char* args_to_remove[] = {GRPC_ARG_FAKE_RESOLVER_RESPONSE_GENERATOR***REMOVED***;
...
FakeResolver::~FakeResolver() { grpc_channel_args_destroy(channel_args_); ***REMOVED***
...
***REMOVED*** else if (has_next_result_) {
    Result result;
...
FakeResolverResponseGenerator::FakeResolverResponseGenerator() {***REMOVED***
...
static int response_generator_cmp(void* a, void* b) { return GPR_ICMP(a, b); ***REMOVED***
...
class FakeResolverFactory : public ResolverFactory {
 public:
  bool IsValidUri(const grpc_uri* uri) const override { return true; ***REMOVED***

  OrphanablePtr<Resolver> CreateResolver(ResolverArgs args) const override {
    return OrphanablePtr<Resolver>(New<FakeResolver>(std::move(args)));
***REMOVED***

  const char* scheme() const override { return "fake"; ***REMOVED***
***REMOVED***;
...
void grpc_resolver_fake_shutdown() {***REMOVED***
