...
void ares_uv_poll_close_cb(uv_handle_t* handle) { Delete(handle); ***REMOVED***
...
***REMOVED***
  ...
  ares_socket_t GetWrappedAresSocketLocked() override { return as_; ***REMOVED***
...
struct AresUvPollCbArg {
  AresUvPollCbArg(uv_poll_t* handle, int status, int events)
      : handle(handle), status(status), events(events) {***REMOVED***
...
***REMOVED***
  ...
  void ConfigureAresChannelLocked(ares_channel channel) override {***REMOVED***
***REMOVED***;
