...
#define MAX_CONNECTION_AGE_INTEGER_OPTIONS \
  { DEFAULT_MAX_CONNECTION_AGE_MS, 1, INT_MAX ***REMOVED***
#define MAX_CONNECTION_IDLE_INTEGER_OPTIONS \
  { DEFAULT_MAX_CONNECTION_IDLE_MS, 1, INT_MAX ***REMOVED***
...
static grpc_error* init_channel_elem(grpc_channel_element* elem,
  ...
  ***REMOVED*** else if (0 == strcmp(args->channel_args->args[i].key,
      ...
      const int value = grpc_channel_arg_get_integer(
          ...
          {DEFAULT_MAX_CONNECTION_AGE_GRACE_MS, 0, INT_MAX***REMOVED***);
      chand->max_connection_age_grace =
...
void grpc_max_age_filter_shutdown(void) {***REMOVED***
