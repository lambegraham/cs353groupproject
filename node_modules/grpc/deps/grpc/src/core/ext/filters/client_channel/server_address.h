...
class ServerAddress {
 public:
  ...
  ~ServerAddress() { grpc_channel_args_destroy(args_); ***REMOVED***

  // Copyable.
  ServerAddress(const ServerAddress& other)
      : address_(other.address_), args_(grpc_channel_args_copy(other.args_)) {***REMOVED***
...
***REMOVED***
  ...
  const grpc_resolved_address& address() const { return address_; ***REMOVED***
