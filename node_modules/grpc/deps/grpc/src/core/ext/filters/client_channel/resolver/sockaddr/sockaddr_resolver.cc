...
class SockaddrResolver : public Resolver {
 public:
  ...
  void ShutdownLocked() override {***REMOVED***
...
SockaddrResolver::SockaddrResolver(ServerAddressList addresses,
    ...
    : Resolver(args.combiner, std::move(args.result_handler)),
      ...
      channel_args_(grpc_channel_args_copy(args.args)) {***REMOVED***
...
void DoNothing(void* ignored) {***REMOVED***
...
***REMOVED***
  ...
  const char* scheme() const override { return "ipv4"; ***REMOVED***
***REMOVED***;
...
***REMOVED***
  ...
  const char* scheme() const override { return "ipv6"; ***REMOVED***
***REMOVED***;
...
***REMOVED***
  ...
  const char* scheme() const override { return "unix"; ***REMOVED***
***REMOVED***;
...
void grpc_resolver_sockaddr_shutdown() {***REMOVED***
