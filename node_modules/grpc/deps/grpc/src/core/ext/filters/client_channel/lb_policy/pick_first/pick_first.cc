...
class PickFirst : public LoadBalancingPolicy {
 public:
  ...
  const char* name() const override { return kPickFirst; ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
    ...
    bool in_transient_failure() const { return in_transient_failure_; ***REMOVED***
  ...
  class Picker : public SubchannelPicker {
   public:
    explicit Picker(RefCountedPtr<SubchannelInterface> subchannel)
        : subchannel_(std::move(subchannel)) {***REMOVED***
...
void grpc_lb_policy_pick_first_shutdown() {***REMOVED***
