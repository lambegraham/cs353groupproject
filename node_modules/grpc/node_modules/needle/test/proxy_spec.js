...
***REMOVED***)
  ...
  describe('when null proxy is passed', function() {
    ...
    it('does not proxy', function(done) {
      send_request({ proxy: null ***REMOVED***, not_proxied(done))
  ***REMOVED***)

    describe('but defaults has been set', function() {

      before(function() {
        needle.defaults({ proxy: 'foobar' ***REMOVED***);
    ***REMOVED***)

      after(function() {
        needle.defaults({ proxy: null ***REMOVED***);
    ***REMOVED***)

      it('tries to proxy anyway', function(done) {
        send_request({***REMOVED***, proxied('foobar', 80, done))
    ***REMOVED***)
...
***REMOVED***)
  ...
  describe('when weird string is passed', function() {
    ...
    it('tries to proxy anyway', function(done) {
      send_request({ proxy: 'alfalfa' ***REMOVED***, proxied('alfalfa', 80, done))
  ***REMOVED***)
***REMOVED***)
  ...
  describe('when valid url is passed', function() {
    ...
    it('proxies request', function(done) {
      send_request({ proxy: nonexisting_host + ':123/done' ***REMOVED***, proxied(nonexisting_host, '123', done))
  ***REMOVED***)

    it('does not set a Proxy-Authorization header', function(done) {
      send_request({ proxy: nonexisting_host + ':123/done' ***REMOVED***, no_proxy_auth(done));
  ***REMOVED***)
  ...
  ***REMOVED***)
    ...
    ***REMOVED***)
      ...
      describe('and options.username is also present', function() {
        ...
        before(function() {
          opts = { proxy_user: 'foobar', username: 'someone' ***REMOVED***;
      ***REMOVED***)
