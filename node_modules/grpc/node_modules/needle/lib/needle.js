...
***REMOVED*** catch(e) { /* zlib not available */ ***REMOVED***
...
function keys_by_type(type) {
  return Object.keys(defaults).map(function(el) {
    if (defaults[el] !== null && defaults[el].constructor == type)
      return el;
***REMOVED***).filter(function(el) { return el ***REMOVED***)
***REMOVED***

function parse_content_type(header) {
  if (!header || header === '') return {***REMOVED***;
  ...
  return { type: arr[0], charset: charset ***REMOVED***;
***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***, // passed later to http.request() directly
...
Needle.prototype.start = function() {
  ...
  var out      = new stream.PassThrough({ objectMode: false ***REMOVED***),
      uri      = this.uri,
      data     = this.data,
      method   = this.method,
      callback = (typeof this.options == 'function') ? this.options : this.callback,
      options  = this.options || {***REMOVED***;
  ...
  ***REMOVED*** else if (is_stream(data)) {
  ...
  ***REMOVED*** else if (Buffer.isBuffer(data)) {

      body = data; // use the raw buffer as request body.

  ***REMOVED*** else if (method.toUpperCase() == 'GET' && !json) {

      // append the data to the URI as a querystring.
      uri = uri.replace(/\?.*|$/, '?' + stringify(data));

  ***REMOVED*** else { // string or object data, no multipart.
...
***REMOVED***
  ...
  ***REMOVED***
    ...
    if (options.json && (!options.accept && !(options.headers || {***REMOVED***).accept))
...
***REMOVED***
  ...
  var request = protocol.request(request_opts, function(resp) {
    ...
    if (config.parse_cookies && (headers['set-cookie'] || config.stored_cookies)) {
      resp.cookies = extend(config.stored_cookies || {***REMOVED***, cookies.read(headers['set-cookie']));
  ...
  ***REMOVED***
    ...
    ***REMOVED*** else if (config.follow_max > 0) {
  ...
  ***REMOVED*** else if (text_response && config.decode_response
  ...
  ***REMOVED***
    ...
    out.on('end', function() {
      ...
      ***REMOVED*** else { // we got one or several buffers. string or binary.
    ...
    ***REMOVED***
      ...
      ***REMOVED***)
    ***REMOVED*** else { // elvis has left the building.
        done(null, resp, resp.body);
    ***REMOVED***

  ***REMOVED***);

***REMOVED***); // end request call
...
***REMOVED***)
  ...
  ***REMOVED***
    ...
    if (!socket.on_socket_end) {
      ...
      socket.once('end', function() { process.nextTick(on_socket_end.bind(socket)) ***REMOVED***);
  ***REMOVED***
***REMOVED***)
