...
function get_runtime_abi(runtime, target_version) {
  ...
  ***REMOVED*** else if (runtime === 'electron') {
  ...
  ***REMOVED*** else {
      ...
      ***REMOVED*** else {
          ...
          ***REMOVED*** else {
                var target_parts = target_version.split('.').map(function(i) { return +i; ***REMOVED***);
              ...
              ***REMOVED*** else if (major >= 2) {
                  ...
                  ***REMOVED***
              ***REMOVED*** else if (major === 0) { // node.js
...
function get_process_runtime(versions) {
    ...
    if (versions['node-webkit']) {
        runtime = 'node-webkit';
  ***REMOVED*** else if (versions.electron) {
        runtime = 'electron';
  ***REMOVED***
    return runtime;
***REMOVED***
...
var default_package_name = '{module_name***REMOVED***-v{version***REMOVED***-{node_abi***REMOVED***-{platform***REMOVED***-{arch***REMOVED***.tar.gz';
...
module.exports.evaluate = function(package_json,options,napi_build_version) {
  ...
  ***REMOVED***
    // support host mirror with npm config `--{module_name***REMOVED***_binary_host_mirror`
