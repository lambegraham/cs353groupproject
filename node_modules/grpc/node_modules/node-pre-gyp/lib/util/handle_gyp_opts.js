...
function handle_gyp_opts(gyp, argv, callback) {
    ...
    share_with_node_gyp.forEach(function(key) {
      ...
      ***REMOVED*** else if (key === 'napi_build_version') {
  ...
  ***REMOVED***);
    ...
    cooked.forEach(function(value) {
        if (value.length > 2 && value.slice(0,2) == '--') {
          ...
          ***REMOVED*** else { // pass through --foo
                node_gyp_options.push(value);
          ***REMOVED***
      ***REMOVED***
  ***REMOVED***);

    var result = {'opts':opts,'gyp':node_gyp_options,'pre':node_pre_gyp_options,'unparsed':unparsed_options***REMOVED***;
