	...
	***REMOVED***
	...
	if (napi_build_versions && (!module_path_ok || (!remote_path_ok && !package_name_ok))) {
		throw new Error("When napi_versions is specified; module_path and either remote_path or " +
			"package_name must contain the substitution string '{napi_build_version***REMOVED***`.");
	***REMOVED***

	if ((module_path_ok || remote_path_ok || package_name_ok) && !napi_build_versions_raw) {
		throw new Error("When the substitution string '{napi_build_version***REMOVED***` is specified in " +
...
function pathOK (path) {
	return path && (path.indexOf('{napi_build_version***REMOVED***') !== -1 || path.indexOf('{node_napi_label***REMOVED***') !== -1);
***REMOVED***
...
module.exports.expand_commands = function(package_json, opts, commands) {
	...
	commands.forEach(function(command){
		if (napi_build_versions && command.name === 'install') {
			...
			expanded_commands.push ({ name: command.name, args: args ***REMOVED***);
		***REMOVED*** else if (napi_build_versions && napi_multiple_commands.indexOf(command.name) !== -1) {
			napi_build_versions.forEach(function(napi_build_version){
...
module.exports.get_napi_build_versions = function(package_json, opts, warnings) { // opts may be undefined
	...
	if (package_json.binary && package_json.binary.napi_versions) {
		package_json.binary.napi_versions.forEach(function(napi_version) {
			...
			***REMOVED*** else if (warnings && !duplicated && supported_napi_version) {
...
module.exports.build_napi_only = function(package_json) {
	...
	package_json.binary.package_name.indexOf('{node_napi_label***REMOVED***') === -1;
***REMOVED***;