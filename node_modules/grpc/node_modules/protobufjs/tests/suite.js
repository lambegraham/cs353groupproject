...
(function(global) {
     ...
     * @param {Object.<string,*>***REMOVED*** properties Additional properties to set
     * @constructor
     */
    var Sandbox = function(properties) {
        this.ByteBuffer = function() {***REMOVED***;
  ...
  ***REMOVED***
     ...
     * @param {****REMOVED*** test Nodeunit test
     * @param {Object***REMOVED*** Game Game namespace
     */
  ...
  ***REMOVED***
    ...
    var suite = {
            ...
            try {
              ...
              ***REMOVED***
                ...
                var f_vals = [
                    ...
                    // { f: -0.0 , b: "80 00 00 00" ***REMOVED***,
                    { f: +0.0 , b: "00 00 00 00" ***REMOVED***,
                    { f: -1e-10 , b: "AE DB E6 FF" ***REMOVED***,
                    { f: +1e-10 , b: "2E DB E6 FF" ***REMOVED***,
                    { f: -2e+10 , b: "D0 95 02 F9" ***REMOVED***,
                    { f: +2e+10 , b: "50 95 02 F9" ***REMOVED***,
                    { f: -3e-30 , b: "8E 73 63 90" ***REMOVED***,
                    { f: +3e-30 , b: "0E 73 63 90" ***REMOVED***,
                    { f: -4e+30 , b: "F2 49 F2 CA" ***REMOVED***,
                    { f: +4e+30 , b: "72 49 F2 CA" ***REMOVED***,
                    { f: -123456789.0 , b: "CC EB 79 A3" ***REMOVED***,
                    { f: +123456789.0 , b: "4C EB 79 A3" ***REMOVED***,
                    { f: -0.987654321 , b: "BF 7C D6 EA" ***REMOVED***,
                    { f: +0.987654321 , b: "3F 7C D6 EA" ***REMOVED***,
                    { f: -Infinity , b: "FF 80 00 00" ***REMOVED***,
                    { f: +Infinity , b: "7F 80 00 00" ***REMOVED***
                    // { f: -NaN , b: "FF C0 00 00>" ***REMOVED***,
                    // { f: +NaN , b: "7F C0 00 00" ***REMOVED***
                ];
                ...
                f_vals.map( function(x) {
                    ...
                    var s2 = s1.split(" ");
                    var s3 = s2.reverse();
                    var i1 = s3.map(function(y) { return parseInt(y,16) ***REMOVED*** );
                    i1.map(function(y) { b2.writeUint8(y) ***REMOVED***);
                    b2.limit = b2.offset;
                    b2.offset = 0;
      ...
      ***REMOVED***,
        ...
        "bytes": function(test) {
            try {
                var str_proto = "message Test { required bytes b = 1; ***REMOVED***";
                var builder = ProtoBuf.loadProto(str_proto);
      ...
      ***REMOVED***,
        ...
        "bytesFromFile": function(test) {
            try {
                var builder = ProtoBuf.loadProto("message Image { required bytes data = 1; ***REMOVED***"),
                    Image = builder.build("Image"),
                    data = fs.readFileSync(__dirname+"/../protobuf.png"),
                    image = new Image({ data: data ***REMOVED***),
                    bb = image.encode(),
      ...
      ***REMOVED***,
        ...
        "notEnoughBytes": function(test) {
            var builder = ProtoBuf.loadProto("message Test { required bytes b = 1; ***REMOVED***");
            var Test = builder.build("Test");
      ...
      ***REMOVED***,
        ...
        "bool": function(test) {
            try {
                var builder = ProtoBuf.loadProto("message Test { optional bool ok = 1 [ default = false ]; ***REMOVED***"),
      ...
      ***REMOVED***,
        ...
        "emptyDefaultString": function(test) {
            try {
                var builder = ProtoBuf.loadProto("message Test1 { required string test = 1 [default = \"\"]; ***REMOVED***");
                var Test1;
      ...
      ***REMOVED***,
        ...
        "trailingSemicolon": function(test) {
            try {
                var builder = ProtoBuf.loadProto("message Test1 { optional string test = 1; ***REMOVED***;");
                test.doesNotThrow(function() {
                    var Test1 = builder.build("Test1");
              ***REMOVED***);
          ***REMOVED*** catch (e) {
      ...
      ***REMOVED***,
        ...
        "inner": {
            ...
            "longstr": function(test) {
                try {
                    var builder = ProtoBuf.loadProto("message Test { required Inner a = 1; message Inner { required string b = 1; ***REMOVED*** ***REMOVED***");
                    var Test = builder.build("Test");
                    var t = new Test();
          ...
          ***REMOVED***,
            ...
            "float": function(test) {
                try {
                    var builder = ProtoBuf.loadProto("message Foo { required Bar bar = 1; ***REMOVED*** message Bar { required float baz = 1; ***REMOVED***");
                    var root = builder.build();
      ...
      ***REMOVED***,
        ...
        "truncated": function(test) {
            try {
                var builder = ProtoBuf.loadProto("message Test { required int32 a = 1; required int32 b = 2; ***REMOVED***");
                var Test = builder.build("Test");
        ...
        "comments": function(test) {
            try {
              ...
              ***REMOVED*** while (token !== null);
                test.deepEqual(tokens, ['message', 'TestC', '{', 'required', 'int32', 'a', '=', '1', ';', '***REMOVED***', null]);
          ***REMOVED*** catch (e) {
                fail(e);
          ***REMOVED***
            test.done();
      ...
      ***REMOVED***,
        ...
        "errorMessage": function(test) {
            test.throws(function() {
                ...
                car.speed = "hello";
                car.encode();
          ***REMOVED***, /Illegal value for speed/);
            test.done();
      ***REMOVED***,
      ...
      ***REMOVED***,
        ...
        "inner": function(test) {
            try {
                ...
                // Multiple
                outer = new Outer({ inner: [new Inner(1), new Inner(2)] ***REMOVED***);
                bb = new ByteBuffer(8);
      ...
      ***REMOVED***,
        ...
        "groups": function(test) {
            try {
                ...
                test.deepEqual(Tinner.options, { "deprecated": true ***REMOVED***);
      ...
      ***REMOVED***,
        ...
        "keywords": function(test) {
            try {
                var builder = ProtoBuf.loadProto("message Reserved { optional string get = 1; ***REMOVED***");
      ...
      ***REMOVED***,
        ...
        "dupimport": function(test) {
            try {
                ...
                fixture.capture(function() { return false;***REMOVED***);
      ...
      ***REMOVED***,
        ...
        "extend": function(test) {
            try {
                    ...
                    messages:
                        [ { ref: 'google.protobuf.MessageOptions',
                            ...
                            { name: 'Foo',
                                ...
                                services: [],
                                oneofs: {***REMOVED***,
                                extensions: [ [ 2, 536870911 ] ] ***REMOVED***,
                            { ref: 'Foo',
                                fields:
                                    [ { rule: 'optional',
                                        type: 'string',
                            ...
                            { name: 'Bar',
                                ...
                                messages:
                                    [ { name: 'Foo',
                                        ...
                                        { ref: '.Foo',
                                            fields: [ { rule: 'optional', type: 'Foo', name: 'foo', options: {***REMOVED***, id: 3 ***REMOVED*** ] ***REMOVED*** ],
                                options: {***REMOVED***,
                                services: [],
                                oneofs: {***REMOVED*** ***REMOVED*** ],
                    enums: [],
                ...
                test.deepEqual(TBar.getChild("foo"), { builder: builder, parent: TBar, name: "foo", field: TFoo.getChild('.Bar.foo') ***REMOVED***);
      ...
      ***REMOVED***, */
        ...
        "delimited": function(test) {
            try {
                var builder = ProtoBuf.loadProto("message Position { required int32 x = 1; required int32 y = 2; ***REMOVED***");
      ...
      ***REMOVED***,
        ...
        "stringify": function(test) {
            try {
                var builder = ProtoBuf.loadProto("message Position { required int32 x = 1; required int64 y = 2; ***REMOVED***");
                var Position = builder.build("Position");
                var position = new Position(1, ProtoBuf.Long.fromNumber(2));
                var json = JSON.stringify(position);
                test.strictEqual(json, '{"x":1,"y":{"low":2,"high":0,"unsigned":false***REMOVED******REMOVED***');
                position = new Position(JSON.parse(json));
                test.strictEqual(position.x, 1);
                test.ok(position.y instanceof ProtoBuf.Long);
                test.deepEqual(position.y, {"low":2,"high":0,"unsigned":false***REMOVED***);
      ...
      ***REMOVED***,
        ...
        "setarray": function(test) {
            try {
                ...
                inners = [];
                inners.push({ str: 'a' ***REMOVED***, { str: 'b' ***REMOVED***, { str: 'c' ***REMOVED***);
      ...
      ***REMOVED***,
        ...
        "negInt32": function(test) {
            try {
                var builder = ProtoBuf.loadProto("message Test { required int32 value = 2; ***REMOVED***");
                var Test = builder.build("Test");
                var t = new Test(-1);
      ...
      ***REMOVED***,
        ...
        "base64": function(test) {
            try {
                var Message = ProtoBuf.loadProto("message Message { required string s = 1; ***REMOVED***").build("Message");
      ...
      ***REMOVED***,
        ...
        "forwardComp": function(test) {
            try {
                var Message = ProtoBuf.loadProto("message Message { required int32 a = 1; required string b = 2; required float c = 3; ***REMOVED***").build("Message");
                var msg = new Message(123, "abc", 0.123);
                var bb = msg.encode();
                Message = ProtoBuf.loadProto("message Message {***REMOVED***").build("Message");
                test.doesNotThrow(function() {
                    Message.decode(bb);
              ***REMOVED***);
                test.strictEqual(bb.offset, bb.limit);
      ...
      ***REMOVED***,
        ...
        "excludeFields": function(test) {
            try {
                var builder = ProtoBuf.loadProto("message A { required int32 i = 1; ***REMOVED*** message B { required A A = 1; ***REMOVED***");
                builder.build();
          ***REMOVED*** catch (e) {
                fail(e);
          ***REMOVED***
      ...
      ***REMOVED***,
        ...
        "emptyMessage": function(test) {
            try {
                var builder = ProtoBuf.loadProto("message EmptyMessage {***REMOVED***"),
      ...
      ***REMOVED***,
        ...
        "toRaw": function(test) {
            try {
                var builder = ProtoBuf.loadProto("message MyMessage { required int32 a = 1; required int32 b = 2; required bytes c = 3; ***REMOVED***"),
                    MyMessage = builder.build("MyMessage");
                var raw = { a: 1, b: 2, c: "YWJj" ***REMOVED***,
      ...
      ***REMOVED***,
        ...
        "importStringSuccessively": function(test) {
            try {
                var proto1 = "message A { required string a = 1; ***REMOVED***;";
                var proto2 = "import \"proto1.proto\"; message B { required A a = 1; ***REMOVED***;";
      ...
      ***REMOVED***,
        ...
        "packable": function(test) {
            try {
                var proto = 'message Inner { required int32 id=2; ***REMOVED***\nmessage Outer { repeated Inner inner = 1 [packed=true]; ***REMOVED***';
      ...
      ***REMOVED***,
        ...
        "$type": function(test) {
            var builder = ProtoBuf.loadProto("message Test {***REMOVED***");
            var Test = builder.build("Test"),
                TTest = builder.lookup("Test");
      ...
      ***REMOVED***,
        ...
        "mismatchedNesting": function(test) {
            try {
                var proto = "message Child { optional uint32 foo = 1; ***REMOVED*** message FakeChild { optional uint32 foo = 1; ***REMOVED*** message Parent { optional Child child = 1; ***REMOVED***";
                var builder = ProtoBuf.loadProto(proto, "tests/mismatchedNesting.proto");
                var root = builder.build();
                var foo = new root.Parent({ child: new root.FakeChild({ foo: 1 ***REMOVED***)***REMOVED***);
          ***REMOVED*** catch (e) {
                fail(e);
          ***REMOVED***
            test.done();
      ***REMOVED***,
        ...
        /* "mismatchedType": function(test) {
            try {
                var proto  = "message Test1 { optional string foo = 1; ***REMOVED***";
                    proto += "message Test2 { optional int32 foo = 1; ***REMOVED***";
                var builder = ProtoBuf.loadProto(proto, "tests/mistmatchedType.proto");
                var root = builder.build();
                var test1 = new root.Test1({ foo: 'bar' ***REMOVED***);
      ...
      ***REMOVED***, */
        ...
        "builderOptions": function(test) {
            try {
                var proto = "message Foo { optional uint32 foo_bar = 1; ***REMOVED***";
                var builder = ProtoBuf.newBuilder({
      ...
      ***REMOVED***,
        ...
        /* "proto3DisallowedFeatures": function(test) {
            try {
                // Required field
                var proto = "syntax = \"proto3\"; message Foo { required int32 field = 1; ***REMOVED***";
                var builder = ProtoBuf.newBuilder();
          ...
          ***REMOVED***
            ...
            try {
                ...
                var proto = "syntax = \"proto3\"; message Foo { int32 field = 1 [default=42]; ***REMOVED***";
                var builder = ProtoBuf.newBuilder();
                ProtoBuf.loadProto(proto, builder, "tests/proto3DisallowedFeatures.proto");
                test.ok(false);  // ^ should throw
          ***REMOVED*** catch (e) {
          ...
          ***REMOVED***
            ...
            try {
                ...
                var proto = "syntax = \"proto3\"; message Foo { extensions 100 to max; ***REMOVED*** ";
                var builder = ProtoBuf.newBuilder();
                ProtoBuf.loadProto(proto, builder, "tests/proto3DisallowedFeatures.proto");
                test.ok(false);  // ^ should throw
          ***REMOVED*** catch (e) {
          ...
          ***REMOVED***
            ...
            try {
                ...
                var proto = "syntax = \"proto3\"; message Foo { extensions 100 to max; ***REMOVED*** " +
                            "message Bar { extend Foo { optional Bar bar = 100; ***REMOVED*** ***REMOVED***";
                var builder = ProtoBuf.newBuilder();
                ProtoBuf.loadProto(proto, builder, "tests/proto3DisallowedFeatures.proto");
                test.ok(false);  // ^ should throw
          ***REMOVED*** catch (e) {
          ...
          ***REMOVED***
            ...
            try {
                ...
                var proto = "syntax = \"proto3\"; enum E { A = 1; B = 2; ***REMOVED***";
                var builder = ProtoBuf.newBuilder();
                ProtoBuf.loadProto(proto, builder, "tests/proto3DisallowedFeatures.proto");
                test.ok(false);  // ^ should throw
          ***REMOVED*** catch (e) {
          ...
          ***REMOVED***
            ...
            try {
                ...
                var proto2 = "syntax = \"proto2\"; enum E { A = 1; B = 2; ***REMOVED***";
                var proto3 = "syntax = \"proto3\"; message Test { E enum_field = 1; ***REMOVED***";
                var builder = ProtoBuf.newBuilder();
      ...
      ***REMOVED***, */
        ...
        "proto3FieldPresence": function(test) {
            var proto =
                ...
                "  oneof oneof_type { bool oneof_bool = 17; ***REMOVED***;\n" +
                "***REMOVED***\n" +
                "enum Enum { Default = 0; A = 1; B = 2; ***REMOVED***\n";
            var builder = ProtoBuf.newBuilder();
      ...
      ***REMOVED***,
        ...
        "mapContainer": function(test) {
          ...
          ***REMOVED***
            ...
            var map_int64_string =
                new ProtoBuf.Map(builder.lookup("Test.map_int64_string"),
                                 { "9223372036854775807": "asdf" ***REMOVED***);
            test.strictEqual(map_int64_string.size, 1);
      ...
      ***REMOVED***,
        ...
        "mapField": function(test) {
            ...
            testMsg.$set('map_string_int32', { 'asdf': 42 ***REMOVED***);

            try {
                testMsg.$set('map_string_int32', { 'asdf': 42.1 ***REMOVED***);
                test.ok(false); // ^ should throw
          ***REMOVED*** catch (e) {
            ...
            test.deepEqual(jsonObj,
                {
                    ...
                    repeated_bool: [true],
                    repeated_enum: ["A"],
                    map_string_int32: { "a": 1, "b": 2 ***REMOVED***,
                    map_string_int64: { "c": "12345678901234", "d": "98765432109876" ***REMOVED***,
                    map_string_string: { "e": "asdf", "f": "jkl;" ***REMOVED***,
                    map_string_enum: { "g": "A", "h": "B" ***REMOVED***,
                    map_int32_string: { "9": "a", "10": "b" ***REMOVED***,
                    map_int64_string: { "12345678901234": "a", "98765432109876": "b" ***REMOVED***,
                    map_bool_string: { "false": "a", "true": "b" ***REMOVED***,
              ***REMOVED***);
