...
<dl class="details">
    ...
    <h4 class="name" id=".fetch"><span class="type-signature">(static) </span>fetch<span class="signature">(path, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {string|undefined***REMOVED***</span></h4>
...
<span class="param-type">undefined</span>
    ...
    <h4 class="name" id=".toCamelCase"><span class="type-signature">(static) </span>toCamelCase<span class="signature">(str)</span><span class="type-signature"> &rarr; {string***REMOVED***</span></h4>
...
<span class="param-type">string</span>
    ...
    <h4 class="name" id=".XHR"><span class="type-signature">(static) </span>XHR<span class="signature">()</span><span class="type-signature"> &rarr; {XMLHttpRequest***REMOVED***</span></h4>
