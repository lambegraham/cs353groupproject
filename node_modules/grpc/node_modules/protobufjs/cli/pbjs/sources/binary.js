 ...
 * @function
 * @param {!Array.<string>***REMOVED*** filenames Source files
 * @param {!Object.<string,*>=***REMOVED*** options Options
 * @returns {!ProtoBuf.Builder***REMOVED***
 */
 ...
 * @param {string***REMOVED*** filename Source file
 * @param {!Object.<string,*>***REMOVED*** options Options
 * @param {!Array.<string>=***REMOVED*** loaded An array of already loaded filenames
 * @returns {****REMOVED*** JSON descriptor
 */
