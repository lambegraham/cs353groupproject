 ...
 * @param {****REMOVED*** val JSON
 * @returns {!JS.Value***REMOVED*** JS-Namespace value
 * @inner
 */
function _protoify(val) {
    switch (typeof val) {
        ...
        case 'string':
            return new JS.Value({ 'string': val ***REMOVED***); // uses object notation instead
        case 'boolean':
            return new JS.Value({ 'boolean': val ***REMOVED***);
        case 'object':
            if (val === null)
                return new JS.Value({ 'null': true ***REMOVED***);
            if (Object.prototype.toString.call(val) === "[object Array]") {
                var arr = new JS.Array();
                for (var i=0; i<val.length; ++i)
                    arr['values'][i] = _protoify(val[i]);
                return new JS.Value({ 'array': arr ***REMOVED***);
          ***REMOVED***
            ...
            return new JS.Value({ 'object': obj ***REMOVED***);
        case 'undefined':
 ...
 * @param {!JS.Value***REMOVED*** value JS value
 ...
 * @param {****REMOVED*** json JSON
 * @returns {!Buffer|!ArrayBuffer***REMOVED***
 * @expose
 */
 ...
 * @param {!Buffer|!ArrayBuffer***REMOVED*** proto Buffer
 * @returns {****REMOVED*** JSON
 * @expose
 */
