 ...
 * @param {function()***REMOVED*** cls The constructor of the message type to deserialize
 * @param {bool=***REMOVED*** binaryAsBase64 Deserialize bytes fields as base64 strings
 *     instead of Buffers. Defaults to false
 * @param {bool=***REMOVED*** longsAsStrings Deserialize long values as strings instead of
 *     objects. Defaults to true
 * @return {function(Buffer):cls***REMOVED*** The deserialization function
 */
exports.deserializeCls = function deserializeCls(cls, options) {
  /**
   * Deserialize a buffer to a message object
   * @param {Buffer***REMOVED*** arg_buf The buffer to deserialize
   * @return {cls***REMOVED*** The resulting object
   */
 ...
 * @param {function()***REMOVED*** Cls The constructor of the message type to serialize
 * @return {function(Cls):Buffer***REMOVED*** The serialization function
 */
exports.serializeCls = function serializeCls(Cls) {
  /**
   * Serialize an object to a Buffer
   * @param {Object***REMOVED*** arg The object to serialize
   * @return {Buffer***REMOVED*** The serialized object
   */
 ...
 * @param {ProtoBuf.Reflect.Namespace***REMOVED*** value The value to get the name of
 * @return {string***REMOVED*** The fully qualified name of the value
 */
 ...
 * @param {ProtoBuf.Reflect.Service***REMOVED*** service The service to get attributes for
 * @param {Object=***REMOVED*** options Options to apply to these attributes
 * @return {Object***REMOVED*** The attributes map
 */
...
***REMOVED***), service.children.map(function(method) {
    return {
 ...
 * @param {ProtoBuf.Reflect.Namespace***REMOVED*** value The ProtoBuf object to load.
 * @param {Object=***REMOVED*** options Options to apply to the loaded object
 * @return {Object<string, *>***REMOVED*** The resulting gRPC object
 */
...
***REMOVED***
  ...
  ***REMOVED***);
    return result;
***REMOVED*** else if (value.className === 'Service') {
    return client.makeClientConstructor(getProtobufServiceAttrs(value, options),
                                        options);
***REMOVED*** else if (value.className === 'Message' || value.className === 'Enum') {
    return value.build();
***REMOVED*** else {
    return value;
***REMOVED***
 ...
 * @return {boolean***REMOVED*** Whether the object appears to be a Protobuf.js 5
 *   ReflectionObject
 */
