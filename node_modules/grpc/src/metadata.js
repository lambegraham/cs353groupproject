 ...
 * @memberof grpc
 * @constructor
 * @param {Object=***REMOVED*** options Boolean options for the beginning of the call.
 *     These options only have any effect when passed at the beginning of
 *     a client request.
 * @param {boolean=***REMOVED*** [options.idempotentRequest=false] Signal that the request
 *     is idempotent
 * @param {boolean=***REMOVED*** [options.waitForReady=true] Signal that the call should
 *     not return UNAVAILABLE before it has started.
 * @param {boolean=***REMOVED*** [options.cacheableRequest=false] Signal that the call is
 *     cacheable. GRPC is free to use GET verb.
 * @param {boolean=***REMOVED*** [options.corked=false] Signal that the initial metadata
 *     should be corked.
 * @example
 ...
 * @param {String***REMOVED*** key The key to set
 * @param {String|Buffer***REMOVED*** value The value to set. Must be a buffer if and only
 ...
 * @param {String***REMOVED*** key The key to add to.
 * @param {String|Buffer***REMOVED*** value The value to add. Must be a buffer if and only
 *     if the normalized key ends with '-bin'
 */
 ...
 * @param {String***REMOVED*** key The key to remove
 */
 ...
 * @param {String***REMOVED*** key The key to get
 * @return {Array.<String|Buffer>***REMOVED*** The values associated with that key
 */
 ...
 * @return {Object.<String,String|Buffer>***REMOVED*** A key/value mapping of the metadata
 */
 ...
 * @return {grpc.Metadata***REMOVED*** The new cloned object
 */
 ...
 * @typedef {object***REMOVED*** grpc~CoreMetadata
 * @param {Object.<String, Array.<String|Buffer>>***REMOVED*** metadata The metadata
 * @param {number***REMOVED*** flags Metadata flags
 */
 ...
 * @private
 * @return {grpc~CoreMetadata***REMOVED*** The metadata
 */
 ...
 * @private
 * @param {grpc~CoreMetadata***REMOVED*** metadata The metadata object from core
 * @return {Metadata***REMOVED*** The new Metadata object
 */
