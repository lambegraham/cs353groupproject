 ...
 * @param {ProtoBuf.ReflectionObject***REMOVED*** value The value to get the name of
 ...
 * @param {ProtoBuf.Service***REMOVED*** service The service to get attributes for
...
***REMOVED***), service.methodsArray.map(function(method) {
    return {
 ...
 * @return {boolean***REMOVED*** Whether the object appears to be a Protobuf.js 6
 *   ReflectionObject
 */
