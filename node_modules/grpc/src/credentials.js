 ...
 * be created using the factory functions in {@link grpc.credentials***REMOVED***
...
function wrapCheckServerIdentityCallback(callback) {
  ...
  ***REMOVED***
    ...
    return callback(hostname, { raw: rawBuffer ***REMOVED***);
***REMOVED***
***REMOVED***
 ...
 * @kind function
 * @param {Buffer=***REMOVED*** root_certs The root certificate data
 * @param {Buffer=***REMOVED*** private_key The client certificate private key, if
 *     applicable
 * @param {Buffer=***REMOVED*** cert_chain The client certificate cert chain, if applicable
 * @param {Function***REMOVED*** verify_options.checkServerIdentity Optional callback
 ...
 * @return {grpc.credentials~ChannelCredentials***REMOVED*** The SSL Credentials object
 */
exports.createSsl = function(root_certs, private_key, cert_chain, verify_options) {
  ...
  ***REMOVED***
    ...
    var updated_verify_options = Object.assign({***REMOVED***, verify_options);
 ...
 * @param {Error***REMOVED*** error The error, if getting metadata failed
 * @param {grpc.Metadata***REMOVED*** metadata The metadata
 */

/**
 * @callback grpc.credentials~generateMetadata
 * @param {Object***REMOVED*** params Parameters that can modify metadata generation
 * @param {string***REMOVED*** params.service_url The URL of the service that the call is
 *     going to
 * @param {grpc.credentials~metadataCallback***REMOVED*** callback
 */
 ...
 * @param {grpc.credentials~generateMetadata***REMOVED*** metadata_generator The function
 *     that generates metadata
 * @return {grpc.credentials~CallCredentials***REMOVED*** The credentials object
 */
exports.createFromMetadataGenerator = function(metadata_generator) {
  return CallCredentials.createFromPlugin(function(service_url, cb_data,
                                                   callback) {
    metadata_generator({service_url: service_url***REMOVED***, function(error, metadata) {
 ...
 * @param {external:GoogleCredential***REMOVED*** google_credential The Google credential
 *     object to use
 * @return {grpc.credentials~CallCredentials***REMOVED*** The resulting credentials object
 */
 ...
 * @param {grpc.credentials~ChannelCredentials***REMOVED*** channel_credential The ChannelCredentials to
 *     start with
 * @param {...grpc.credentials~CallCredentials***REMOVED*** credentials The CallCredentials to compose
 * @return {grpc.credentials~ChannelCredentials***REMOVED*** A credentials object that combines all of the
 *     input credentials
 */
 ...
 * @param {...grpc.credentials~CallCredentials***REMOVED*** credentials The CallCredentials to compose
 * @return {grpc.credentials~CallCredentials***REMOVED*** A credentials object that combines all of the input
 *     credentials
 */
 ...
 * @kind function
 * @return {grpc.credentials~ChannelCredentials***REMOVED*** The insecure credentials object
 */
