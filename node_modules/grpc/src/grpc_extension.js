...
Expected directory: ${searchName***REMOVED***
Found: [${foundNames.join(', ')***REMOVED***]
...
Original error: ${e.message***REMOVED***`;
    ...
    throw error;
***REMOVED*** else {
    e.message = `Failed to load ${binding_path***REMOVED***. ${e.message***REMOVED***`;
    throw e;
***REMOVED***
***REMOVED***
