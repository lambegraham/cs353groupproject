...
declare module "grpc" {
  import { Message, Service as ProtobufService ***REMOVED*** from "protobufjs";
  import { Duplex, Readable, Writable ***REMOVED*** from "stream";
  import { SecureContext ***REMOVED*** from "tls";
   ...
   * @param {(number|string)=***REMOVED*** [options.protobufjsVersion='detect'] 5 and 6
...
***REMOVED***
   ...
   * A filename
   */
  export type Filename = string | { root: string, file: string ***REMOVED***;
...
***REMOVED***
   ...
   */
  export type UntypedServiceImplementation = { [name: string]: handleCall<any, any> ***REMOVED***;
...
***REMOVED***
  ...
  export class Metadata {
     ...
     */
    getMap(): { [key: string]: MetadataValue ***REMOVED***;
...
***REMOVED***
  ...
  export interface ServiceError extends Error {
    /**
     * The error code, a key of {@link grpc.status***REMOVED*** that is not `grpc.status.OK`
     */
    code?: status;
    /**
     * Trailing metadata sent with the status, if applicable
...
***REMOVED***
   ...
   */
  export type metadataGenerator = (params: { service_url: string ***REMOVED***, callback: (error: Error | null, metadata?: Metadata) => void) => void;
...
***REMOVED***
  ...
  export class ClientWritableStream<RequestType> extends Writable {
     ...
     * @return As defined for [Writable]{@link external:Writable***REMOVED***
     */
...
***REMOVED***
  ...
  export class Channel {
     ...
     */
    constructor(target: string, credentials: ChannelCredentials, options: {[key:string]: string|number***REMOVED***);
    /**
