...
***REMOVED***
  ...
  function runAll() {
    var localStorage = new Storage(dbPath, { strict: false, ws: '  ' ***REMOVED***)
      , sessionStorage = new Storage(null, { strict: false ***REMOVED***)
      ;
    ...
    setTimeout(function () {
      assert.deepEqual({ a: 1 ***REMOVED***, JSON.parse(fs.readFileSync(dbPath)));
