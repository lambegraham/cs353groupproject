...
describe('node-fetch', function() {
	...
	***REMOVED***);
	...
	it('should reject with error on network failure', function() {
		...
		return expect(fetch(url)).to.eventually.be.rejected
			...
			.and.include({ type: 'system', code: 'ECONNREFUSED', errno: 'ECONNREFUSED' ***REMOVED***);
	***REMOVED***);
	...
	it('should accept json response', function() {
		...
		return fetch(url).then(function(res) {
			...
			return res.json().then(function(result) {
				...
				expect(result).to.deep.equal({ name: 'value' ***REMOVED***);
			***REMOVED***);
		***REMOVED***);
	***REMOVED***);
	...
	it('should send request with custom headers', function() {
		url = base + '/inspect';
		opts = {
			headers: { 'x-custom-header': 'abc' ***REMOVED***
		***REMOVED***;
	...
	***REMOVED***);
	...
	it('should accept headers instance', function() {
		url = base + '/inspect';
		opts = {
			headers: new Headers({ 'x-custom-header': 'abc' ***REMOVED***)
		***REMOVED***;
		return fetch(url, opts).then(function(res) {
			return res.json();
		***REMOVED***).then(function(res) {
	...
	***REMOVED***);
	...
	it('should clear internal timeout on fetch response', function (done) {
		this.timeout(1000);
		spawn('node', ['-e', 'require("./")("' + base + '/hello", { timeout: 5000 ***REMOVED***)'])
			.on('exit', function () {
				done();
			***REMOVED***);
	***REMOVED***);
	...
	it('should clear internal timeout on fetch redirect', function (done) {
		this.timeout(1000);
		spawn('node', ['-e', 'require("./")("' + base + '/redirect/301", { timeout: 5000 ***REMOVED***)'])
			.on('exit', function () {
				done();
			***REMOVED***);
	***REMOVED***);
	...
	it('should clear internal timeout on fetch error', function (done) {
		this.timeout(1000);
		spawn('node', ['-e', 'require("./")("' + base + '/error/reset", { timeout: 5000 ***REMOVED***)'])
			.on('exit', function () {
				done();
			***REMOVED***);
	***REMOVED***);
	...
	it('should allow cloning a json response and log it as text response', function() {
		...
		return fetch(url).then(function(res) {
			...
			return fetch.Promise.all([res.json(), r1.text()]).then(function(results) {
				expect(results[0]).to.deep.equal({name: 'value'***REMOVED***);
				expect(results[1]).to.equal('{"name":"value"***REMOVED***');
			***REMOVED***);
		***REMOVED***);
	***REMOVED***);
		...
		return fetch(url).then(function(res) {
			...
			return res.json().then(function(result) {
				...
				return r1.text().then(function(result) {
					expect(result).to.equal('{"name":"value"***REMOVED***');
				***REMOVED***);
			***REMOVED***);
		***REMOVED***);
	***REMOVED***);
	...
	***REMOVED***);
	...
	it('should ignore unsupported attributes while reading headers', function() {
		var FakeHeader = function() {***REMOVED***;
	...
	***REMOVED***);
	...
	it('should support json() method in Response constructor', function() {
		var res = new Response('{"a":1***REMOVED***');
		return res.json().then(function(result) {
