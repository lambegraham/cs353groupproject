...
function requestToFetchOptions(reqOpts) {
    var options = __assign(__assign({ method: reqOpts.method || 'GET' ***REMOVED***, (reqOpts.timeout && { timeout: reqOpts.timeout ***REMOVED***)), (reqOpts.gzip && { compress: reqOpts.gzip ***REMOVED***));
  ...
  ***REMOVED***
    ...
    return { uri: uri, options: options ***REMOVED***;
***REMOVED***
/**
...
function fetchToRequestResponse(opts, res) {
    ...
    var resHeaders = {***REMOVED***;
    res.headers.forEach(function (value, key) { return (resHeaders[key] = value); ***REMOVED***);
    var response = Object.assign(res.body, {
        ...
        body: res.body,
        headers: resHeaders,
        toJSON: function () { return ({ headers: resHeaders ***REMOVED***); ***REMOVED***,
  ***REMOVED***);
    return response;
***REMOVED***
/**
...
function createMultipartStream(boundary, multipart) {
    ...
    for (var _i = 0, multipart_1 = multipart; _i < multipart_1.length; _i++) {
      ...
      ***REMOVED***
            ...
            part.body.pipe(stream, { end: false ***REMOVED***);
...
teenyRequest.defaults = function (defaults) {
    return function (reqOpts, callback) {
        var opts = __assign(__assign({***REMOVED***, defaults), reqOpts);
        if (callback === undefined) {
