...
tape('shifts next with object mode', function (t) {
  var passthrough = through({objectMode: true***REMOVED***)

  passthrough.write({hello: 1***REMOVED***)
  passthrough.write({world: 1***REMOVED***)

  t.same(shift(passthrough), {hello: 1***REMOVED***)
  t.same(shift(passthrough), {world: 1***REMOVED***)
  t.end()
***REMOVED***)

tape('shifts next with object mode with core', function (t) {
  var passthrough = stream.PassThrough({objectMode: true***REMOVED***)
