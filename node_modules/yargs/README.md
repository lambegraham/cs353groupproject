...
function WARN()  { VERBOSE_LEVEL >= 0 && console.log.apply(console, arguments); ***REMOVED***
function INFO()  { VERBOSE_LEVEL >= 1 && console.log.apply(console, arguments); ***REMOVED***
function DEBUG() { VERBOSE_LEVEL >= 2 && console.log.apply(console, arguments); ***REMOVED***
...
***
	...
	$ ./demand_count.js a b
	{ _: [ 'a', 'b' ], '$0': 'demand_count.js' ***REMOVED***

	$ ./demand_count.js a b c
	{ _: [ 'a', 'b', 'c' ], '$0': 'demand_count.js' ***REMOVED***
...
`{ _: [], token: '-my-token', '$0': 'node test' ***REMOVED***`
...
undefined or to override a default you can do `--no-key`.
    ...
    { _: [], a: true, b: false, '$0': 'examples/reflect.js' ***REMOVED***
...
all the values in order.
    ...
    { _: [], x: [ 5, 8, 0 ], '$0': 'examples/reflect.js' ***REMOVED***
...
This lets you organize arguments into nested objects.
    ...
    { _: [],
      foo: { bar: { baz: 33 ***REMOVED***, quux: 5 ***REMOVED***,
      '$0': 'examples/reflect.js' ***REMOVED***
...
Short numeric `-n5` style arguments work too:
    ...
    { _: [], n: 123, m: 456, '$0': 'examples/reflect.js' ***REMOVED***
