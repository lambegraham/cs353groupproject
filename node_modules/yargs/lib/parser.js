...
module.exports = function (args, opts, y18n) {
  ...
  var __ = y18n.__
  var error = null
  var flags = { arrays: {***REMOVED***, bools: {***REMOVED***, strings: {***REMOVED***, counts: {***REMOVED***, normalize: {***REMOVED***, configs: {***REMOVED***, defaulted: {***REMOVED*** ***REMOVED***
...
***REMOVED***
  ...
  for (var i = 0; i < args.length; i++) {
    ...
    ***REMOVED*** else if (checkAllAliases(m[1], flags.arrays) && args.length > i + 1) {
        args.splice(i + 1, m[1], m[2])
        i = eatArray(i, m[1], args)
    ***REMOVED*** else {
        setArg(m[1], m[2])
    ***REMOVED***
  ***REMOVED*** else if (arg.match(/^--no-.+/)) {
      key = arg.match(/^--no-(.+)/)[1]
      setArg(key, false)
  ...
  ***REMOVED*** else if (arg.match(/^--.+/)) {
    ...
    ***REMOVED*** else if (checkAllAliases(key, flags.arrays) && args.length > i + 1) {
    ...
    ***REMOVED*** else {
        ...
        if (next !== undefined && !next.match(/^-/) &&
          ...
          setArg(key, next)
          i++
      ***REMOVED*** else if (/^(true|false)$/.test(next)) {
          setArg(key, next)
          i++
      ***REMOVED*** else {
    ...
    ***REMOVED***
      ...
      ***REMOVED*** else {
          if (args[i + 1] && !/^(-|--)[^-]/.test(args[i + 1]) &&
            ...
            setArg(key, args[i + 1])
            i++
        ***REMOVED*** else if (args[i + 1] && /true|false/.test(args[i + 1])) {
            setArg(key, args[i + 1])
            i++
        ***REMOVED*** else {
            setArg(key, defaultForType(guessType(key, flags)))
...
***REMOVED***
  ...
  ***REMOVED*** else if (o[key] === undefined && checkAllAliases(key, flags.arrays)) {
      o[key] = Array.isArray(value) ? value : [value]
  ***REMOVED*** else if (o[key] === undefined || typeof o[key] === 'boolean') {
      o[key] = value
  ***REMOVED*** else if (Array.isArray(o[key])) {
      o[key].push(value)
  ***REMOVED*** else {
      o[key] = [ o[key], value ]
  ***REMOVED***
