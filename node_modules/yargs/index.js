  ...
  ***REMOVED*** else {
    ...
    ***REMOVED***)
      ...
      if (aliases) { // x was an alias itself.
        aliases.push(y)
    ***REMOVED*** else { // x is a new alias key.
...
***REMOVED***
  ...
  ***REMOVED***
    ...
    if (typeof keys === 'number') {
      if (!demanded._) demanded._ = { count: 0, msg: null, max: max ***REMOVED***
      demanded._.count = keys
      demanded._.msg = msg
  ***REMOVED*** else if (Array.isArray(keys)) {
      keys.forEach(function (key) {
        self.demand(key, msg)
    ***REMOVED***)
  ***REMOVED*** else {
      if (typeof msg === 'string') {
        demanded[keys] = { msg: msg ***REMOVED***
    ***REMOVED*** else if (msg === true || typeof msg === 'undefined') {
        demanded[keys] = { msg: undefined ***REMOVED***
    ***REMOVED***
  ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED*** else {
    ...
    ***REMOVED*** if ('config' in opt) {
        self.config(key, opt.configParser)
    ***REMOVED*** if ('default' in opt) {
        self.default(key, opt.default)
    ***REMOVED*** if ('nargs' in opt) {
        self.nargs(key, opt.nargs)
    ***REMOVED*** if ('choices' in opt) {
        self.choices(key, opt.choices)
    ***REMOVED*** if ('group' in opt) {
        self.group(key, opt.group)
    ***REMOVED*** if (opt.boolean || opt.type === 'boolean') {
        self.boolean(key)
        if (opt.alias) self.boolean(opt.alias)
    ***REMOVED*** if (opt.array || opt.type === 'array') {
        self.array(key)
        if (opt.alias) self.array(opt.alias)
    ***REMOVED*** if (opt.string || opt.type === 'string') {
        self.string(key)
        if (opt.alias) self.string(opt.alias)
    ***REMOVED*** if (opt.count || opt.type === 'count') {
        self.count(key)
    ***REMOVED*** if (opt.defaultDescription) {
    ...
    Object.keys(argv).forEach(function (key) {
      if (key === helpOpt && argv[key]) {
        ...
        if (exitProcess) {
          process.exit(0)
      ***REMOVED***
    ***REMOVED*** else if (key === versionOpt && argv[key]) {
        helpOrVersion = true
        usage.showVersion()
        if (exitProcess) {
          process.exit(0)
...
***REMOVED***
  ...
  function guessLocale () {
    ...
    try {
      ...
      self.locale(osLocale.sync({ spawn: false ***REMOVED***))
  ***REMOVED*** catch (err) {
