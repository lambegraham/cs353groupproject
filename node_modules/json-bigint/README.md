...
var json = '{ "value" : 9223372036854775807, "v2": 123 ***REMOVED***';
...
```
Input: { "value" : 9223372036854775807, "v2": 123 ***REMOVED***

node.js bult-in JSON:
JSON.parse(input).value :  9223372036854776000
JSON.stringify(JSON.parse(input)): {"value":9223372036854776000,"v2":123***REMOVED***


big number JSON:
JSON.parse(input).value :  9223372036854775807
JSON.stringify(JSON.parse(input)): {"value":9223372036854775807,"v2":123***REMOVED***
```
### Options
...
```js
var JSONbig = require('json-bigint');
var JSONstrict = require('json-bigint')({"strict": true***REMOVED***);

var dupkeys = '{ "dupkey": "value 1", "dupkey": "value 2"***REMOVED***';
...
Input: { "dupkey": "value 1", "dupkey": "value 2"***REMOVED***
JSON.parse(dupkeys).dupkey: value 2
Succesfully catched expected exception on duplicate keys: {"name":"SyntaxError","message":"Duplicate key \"dupkey\"","at":33,"text":"{ \"dupkey\": \"value 1\", \"dupkey\": \"value 2\"***REMOVED***"***REMOVED***
...
```js
var JSONbig = require('json-bigint');
var JSONbigString = require('json-bigint')({"storeAsString": true***REMOVED***);
var key = '{ "key": 1234567890123456789 ***REMOVED***';
...
```
Storing the BigInt as a string, instead of a BigNumber
Input: { "key": 1234567890123456789 ***REMOVED***
