declare module "crypto" {
  ...
  ***REMOVED***
    ...
    interface CredentialDetails {
        ...
        ciphers: string;
  ***REMOVED***
    interface Credentials { context?: any; ***REMOVED***
  ...
  ***REMOVED***
    interface CipherCCM extends Cipher {
        setAAD(buffer: Buffer, options: { plaintextLength: number ***REMOVED***): this;
        getAuthTag(): Buffer;
  ***REMOVED***
  ...
  ***REMOVED***
    interface DecipherCCM extends Decipher {
        ...
        setAAD(buffer: Buffer | NodeJS.TypedArray | DataView, options: { plaintextLength: number ***REMOVED***): this;
  ***REMOVED***
  ...
  ***REMOVED***
    ...
    interface Signer extends NodeJS.WritableStream {
        ...
        sign(private_key: string | { key: string; passphrase?: string, padding?: number, saltLength?: number ***REMOVED***): Buffer;
        sign(private_key: string | { key: string; passphrase?: string, padding?: number, saltLength?: number ***REMOVED***, output_format: HexBase64Latin1Encoding): string;
  ***REMOVED***
  ...
  ***REMOVED***
    ...
    namespace generateKeyPair {
        function __promisify__(type: "rsa", options: RSAKeyPairOptions<'pem', 'pem'>): Promise<{ publicKey: string, privateKey: string ***REMOVED***>;
        function __promisify__(type: "rsa", options: RSAKeyPairOptions<'pem', 'der'>): Promise<{ publicKey: string, privateKey: Buffer ***REMOVED***>;
        function __promisify__(type: "rsa", options: RSAKeyPairOptions<'der', 'pem'>): Promise<{ publicKey: Buffer, privateKey: string ***REMOVED***>;
        function __promisify__(type: "rsa", options: RSAKeyPairOptions<'der', 'der'>): Promise<{ publicKey: Buffer, privateKey: Buffer ***REMOVED***>;

        function __promisify__(type: "dsa", options: DSAKeyPairOptions<'pem', 'pem'>): Promise<{ publicKey: string, privateKey: string ***REMOVED***>;
        function __promisify__(type: "dsa", options: DSAKeyPairOptions<'pem', 'der'>): Promise<{ publicKey: string, privateKey: Buffer ***REMOVED***>;
        function __promisify__(type: "dsa", options: DSAKeyPairOptions<'der', 'pem'>): Promise<{ publicKey: Buffer, privateKey: string ***REMOVED***>;
        function __promisify__(type: "dsa", options: DSAKeyPairOptions<'der', 'der'>): Promise<{ publicKey: Buffer, privateKey: Buffer ***REMOVED***>;

        function __promisify__(type: "ec", options: ECKeyPairOptions<'pem', 'pem'>): Promise<{ publicKey: string, privateKey: string ***REMOVED***>;
        function __promisify__(type: "ec", options: ECKeyPairOptions<'pem', 'der'>): Promise<{ publicKey: string, privateKey: Buffer ***REMOVED***>;
        function __promisify__(type: "ec", options: ECKeyPairOptions<'der', 'pem'>): Promise<{ publicKey: Buffer, privateKey: string ***REMOVED***>;
        function __promisify__(type: "ec", options: ECKeyPairOptions<'der', 'der'>): Promise<{ publicKey: Buffer, privateKey: Buffer ***REMOVED***>;
  ***REMOVED***
***REMOVED***
