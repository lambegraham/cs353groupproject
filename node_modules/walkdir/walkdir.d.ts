...
declare function walkdir(
    path:string,
    options:{sync:true,return_object:true***REMOVED***&walkdir.WalkOptions, 
    eventListener?:walkdir.WalkEventListener)
    :{[path:string]:Stats***REMOVED***;
    
declare function walkdir(
    path:string,
    options:{sync:true,return_object?:false***REMOVED***&walkdir.WalkOptions, 
    eventListener?:walkdir.WalkEventListener)
    :string[];

declare function walkdir(
    path:string,
    options?:({sync?:false***REMOVED***&walkdir.WalkOptions)|walkdir.WalkEventListener, 
    eventListener?:walkdir.WalkEventListener)
    :walkdir.WalkEmitter;
...
declare function walkdir(
    ...
    eventListener?:walkdir.WalkEventListener)
    :walkdir.WalkEmitter|string[]|{[path:string]:Stats***REMOVED***;
...
declare namespace walkdir {
    export type WalkOptions = {
        ...
        "sync"?:boolean,
        /**
         * return an object of {path:stat***REMOVED*** instead of just the resolved path names
         */
        "return_object"?: boolean, // if true the sync return will be in {path:stat***REMOVED*** format instead of [path,path,...]
        /**
  ...
  ***REMOVED***
    ...
    export function sync(path:string,options:walkdir.WalkOptions&{return_object:true***REMOVED***,eventListener?:walkdir.WalkEventListener):{[path:string]:Stats***REMOVED***;
    export function sync(path:string,options?:walkdir.WalkOptions&{return_object?:false***REMOVED***,eventListener?:walkdir.WalkEventListener):string[];
    export function sync(path:string,options?:walkdir.WalkOptions&{return_object?:boolean***REMOVED***,eventListener?:walkdir.WalkEventListener):string[]|{[path:string]:Stats***REMOVED***;
    ...
    export function async(path:string,options:walkdir.WalkOptions&{return_object:true***REMOVED***,eventListener?:walkdir.WalkEventListener):Promise<{[path:string]:Stats***REMOVED***>;
    export function async(path:string,options?:walkdir.WalkOptions&{return_object?:false***REMOVED***,eventListener?:walkdir.WalkEventListener):Promise<string[]>;
    export function async(path:string,options?:walkdir.WalkOptions&{return_object?:boolean***REMOVED***,eventListener?:walkdir.WalkEventListener):Promise<string[]>|Promise<{[path:string]:Stats***REMOVED***>;
***REMOVED***
