...
class Gaxios {
  ...
  ***REMOVED***
    ...
    async request(opts = {***REMOVED***) {
        ...
        try {
          ...
          ***REMOVED***
            if (!opts.validateStatus(translatedResponse.status)) {
                throw new common_1.GaxiosError(`Request failed with status code ${translatedResponse.status***REMOVED***`, opts, translatedResponse);
          ***REMOVED***
      ...
      ***REMOVED***
            ...
            const err = e;
            err.config = opts;
            const { shouldRetry, config ***REMOVED*** = await retry_1.getRetryConfig(e);
  ...
  ***REMOVED***
    ...
    validateOpts(options) {
        const opts = extend_1.default(true, {***REMOVED***, this.defaults, options);
        if (!opts.url) {
      ...
      ***REMOVED***
        ...
        opts.url = `${parsedUrl.origin***REMOVED***${parsedUrl.pathname***REMOVED***`;
