...
***REMOVED***);
  ...
  it('define()', function() {
    ...
    var mime = new Mime({'text/a': ['a']***REMOVED***, {'text/b': ['b']***REMOVED***);

    assert.throws(function() {
      mime.define({'text/c': ['b']***REMOVED***);
  ***REMOVED***);

    assert.doesNotThrow(function() {
      mime.define({'text/c': ['b']***REMOVED***, true);
  ***REMOVED***);
...
***REMOVED***);
  ...
  it('getType()', function() {
    ...
    assert.strictEqual(mime.getType({***REMOVED***), null);
...
***REMOVED***);
  ...
  it('getExtension()', function() {
    ...
    assert.strictEqual(mime.getExtension({***REMOVED***), null);
***REMOVED***);
***REMOVED***);
...
***REMOVED***);
  ...
  it('Consistency', function() {
    for (var ext in this.types) {
      assert.equal(ext, this.extensions[this.types[ext]], '${ext***REMOVED*** does not have consistent ext->type->ext mapping');
  ***REMOVED***
***REMOVED***);
