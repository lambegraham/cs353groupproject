...
***REMOVED***);
  ...
  after(function (done) {
    proxy.once('close', function () { done(); ***REMOVED***);
    proxy.close();
***REMOVED***);

  after(function (done) {
    server.once('close', function () { done(); ***REMOVED***);
    server.close();
***REMOVED***);

  after(function (done) {
    sslProxy.once('close', function () { done(); ***REMOVED***);
    sslProxy.close();
***REMOVED***);
  ...
  ***REMOVED***);
    describe('secureProxy', function () {
      it('should default to `false`', function () {
        var agent = new HttpProxyAgent({ port: proxyPort ***REMOVED***);
        assert.equal(false, agent.secureProxy);
    ***REMOVED***);
      it('should be `false` when "http:" protocol is used', function () {
        var agent = new HttpProxyAgent({ port: proxyPort, protocol: 'http:' ***REMOVED***);
        assert.equal(false, agent.secureProxy);
    ***REMOVED***);
      it('should be `true` when "https:" protocol is used', function () {
        var agent = new HttpProxyAgent({ port: proxyPort, protocol: 'https:' ***REMOVED***);
