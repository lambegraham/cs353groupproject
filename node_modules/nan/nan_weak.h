...
***REMOVED***
  inline v8::Isolate *GetIsolate() const { return isolate_; ***REMOVED***
  inline T *GetParameter() const { return static_cast<T*>(parameter_); ***REMOVED***
...
***REMOVED*** else {
    ...
    void *internal_fields[kInternalFieldsInWeakCallback] = {0, 0***REMOVED***;
