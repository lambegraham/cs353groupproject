...
template<typename T, typename M> class Persistent :
 ...
 public:
  inline Persistent() : v8::Persistent<T, M>() {***REMOVED***

  template<typename S> inline Persistent(v8::Local<S> that) :
      v8::Persistent<T, M>(v8::Isolate::GetCurrent(), that) {***REMOVED***

  template<typename S, typename M2>
  inline
  Persistent(const v8::Persistent<S, M2> &that) :  // NOLINT(runtime/explicit)
      v8::Persistent<T, M2>(v8::Isolate::GetCurrent(), that) {***REMOVED***

  inline void Reset() { v8::PersistentBase<T>::Reset(); ***REMOVED***
...
***REMOVED***
 ...
 private:
  inline T *operator*() const { return *PersistentBase<T>::persistent; ***REMOVED***
...
class Global : public v8::Global<T> {
 public:
  inline Global() : v8::Global<T>() {***REMOVED***

  template<typename S> inline Global(v8::Local<S> that) :
    v8::Global<T>(v8::Isolate::GetCurrent(), that) {***REMOVED***

  template<typename S>
  inline
  Global(const v8::PersistentBase<S> &that) :  // NOLINT(runtime/explicit)
      v8::Global<S>(v8::Isolate::GetCurrent(), that) {***REMOVED***
...
class Global : public v8::UniquePersistent<T> {
 public:
  inline Global() : v8::UniquePersistent<T>() {***REMOVED***

  template<typename S> inline Global(v8::Local<S> that) :
    v8::UniquePersistent<T>(v8::Isolate::GetCurrent(), that) {***REMOVED***

  template<typename S>
  inline
  Global(const v8::PersistentBase<S> &that) :  // NOLINT(runtime/explicit)
      v8::UniquePersistent<S>(v8::Isolate::GetCurrent(), that) {***REMOVED***
