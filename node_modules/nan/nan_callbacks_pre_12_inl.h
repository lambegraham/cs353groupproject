...
class ReturnValue {
 ...
 public:
  ...
  explicit inline ReturnValue(v8::Isolate *isolate, v8::Persistent<S> *p) :
      isolate_(isolate), value_(p) {***REMOVED***
  template <class S>
...
***REMOVED***
  ...
  template<typename S>
  inline void Set(S *whatever) { TYPE_CHECK(S*, v8::Primitive); ***REMOVED***
***REMOVED***;
 ...
 public:
  explicit inline FunctionCallbackInfo(
    ...
    , v8::Local<v8::Value> data) :
        ...
        , retval_(v8::Persistent<T>::New(v8::Undefined())) {***REMOVED***
...
***REMOVED***
  ...
  inline v8::Local<v8::Function> Callee() const { return args_.Callee(); ***REMOVED***
  inline v8::Local<v8::Value> Data() const { return data_; ***REMOVED***
  inline v8::Local<v8::Object> Holder() const { return args_.Holder(); ***REMOVED***
  inline bool IsConstructCall() const { return args_.IsConstructCall(); ***REMOVED***
  inline int Length() const { return args_.Length(); ***REMOVED***
  inline v8::Local<v8::Value> operator[](int i) const { return args_[i]; ***REMOVED***
  inline v8::Local<v8::Object> This() const { return args_.This(); ***REMOVED***
  inline v8::Isolate *GetIsolate() const { return args_.GetIsolate(); ***REMOVED***
...
class PropertyCallbackInfoBase {
 ...
 public:
  ...
  inline v8::Isolate* GetIsolate() const { return info_.GetIsolate(); ***REMOVED***
  inline v8::Local<v8::Value> Data() const { return data_; ***REMOVED***
  inline v8::Local<v8::Object> This() const { return info_.This(); ***REMOVED***
  inline v8::Local<v8::Object> Holder() const { return info_.Holder(); ***REMOVED***
...
***REMOVED***
  ...
  inline ReturnValue<T> GetReturnValue() const { return return_value_; ***REMOVED***
***REMOVED***;
 ...
 public:
  explicit inline PropertyCallbackInfo(
    ...
    , const v8::Local<v8::Value> data) :
        ...
        , return_value_(info.GetIsolate(), &retval_)
        , retval_(v8::Persistent<v8::Array>::New(v8::Local<v8::Array>())) {***REMOVED***
 ...
 public:
  explicit inline PropertyCallbackInfo(
    ...
    , const v8::Local<v8::Value> data) :
        ...
        , return_value_(info.GetIsolate(), &retval_)
        , retval_(v8::Persistent<v8::Boolean>::New(v8::Local<v8::Boolean>())) {***REMOVED***
 ...
 public:
  explicit inline PropertyCallbackInfo(
    ...
    , const v8::Local<v8::Value> data) :
        ...
        , return_value_(info.GetIsolate(), &retval_)
        , retval_(v8::Persistent<v8::Integer>::New(v8::Local<v8::Integer>())) {***REMOVED***
