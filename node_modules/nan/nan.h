...
class NonCopyablePersistentTraits :
    public v8::NonCopyablePersistentTraits<T> {***REMOVED***;
template<typename T>
class CopyablePersistentTraits :
    public v8::CopyablePersistentTraits<T> {***REMOVED***;

template<typename T>
class PersistentBase :
    public v8::PersistentBase<T> {***REMOVED***;
...
class Maybe {
 public:
  inline bool IsNothing() const { return !has_value_; ***REMOVED***
  inline bool IsJust() const { return has_value_; ***REMOVED***

  inline T ToChecked() const { return FromJust(); ***REMOVED***
  inline void Check() const { FromJust(); ***REMOVED***
...
***REMOVED***
  ...
  Maybe(const v8::Maybe<T>& that)  // NOLINT(runtime/explicit)
    ...
    , value_(that.FromMaybe(T())) {***REMOVED***
#endif

 private:
  Maybe() : has_value_(false) {***REMOVED***
  explicit Maybe(const T& t) : has_value_(true), value_(t) {***REMOVED***
  bool has_value_;
  T value_;
...
struct WeakCallbackType {
  enum E {kParameter, kInternalFields***REMOVED***;
  E type;
  WeakCallbackType(E other) : type(other) {***REMOVED***  // NOLINT(runtime/explicit)
  inline bool operator==(E other) { return other == this->type; ***REMOVED***
  inline bool operator!=(E other) { return !operator==(other); ***REMOVED***
***REMOVED***;
#endif
...
class EscapableHandleScope {
 public:
#if NODE_MODULE_VERSION > NODE_0_10_MODULE_VERSION
  inline EscapableHandleScope() : scope(v8::Isolate::GetCurrent()) {***REMOVED***
...
#else
  inline EscapableHandleScope() : scope() {***REMOVED***
...
class TryCatch {
 ...
 public:
#if NODE_MODULE_VERSION > NODE_0_12_MODULE_VERSION
  TryCatch() : try_catch_(v8::Isolate::GetCurrent()) {***REMOVED***
#endif

  inline bool HasCaught() const { return try_catch_.HasCaught(); ***REMOVED***

  inline bool CanContinue() const { return try_catch_.CanContinue(); ***REMOVED***
...
***REMOVED***
  ...
  inline void Reset() { try_catch_.Reset(); ***REMOVED***

  inline void SetVerbose(bool value) { try_catch_.SetVerbose(value); ***REMOVED***
...
***REMOVED***
  ...
  inline char* operator*() { return str_; ***REMOVED***
  inline const char* operator*() const { return str_; ***REMOVED***
...
class Callback {
 public:
  ...
  explicit Callback(const v8::Local<v8::Function> &fn) : handle_(fn) {***REMOVED***
...
***REMOVED***
  ...
  inline
  v8::Local<v8::Function> operator*() const { return GetFunction(); ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
   ...
   private:
    explicit ExecutionProgress(AsyncBareProgressWorker *that) : that_(that) {***REMOVED***
...
enum Encoding {ASCII, UTF8, BASE64, UCS2, BINARY, HEX, BUFFER***REMOVED***;
...
***REMOVED***
  ...
  ~Tap() { t_.Reset(); ***REMOVED***  // not sure if neccessary
