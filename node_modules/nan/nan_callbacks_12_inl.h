...
***REMOVED***
  ...
  inline v8::Local<v8::Function> Callee() const { return info_.Callee(); ***REMOVED***
#endif
  ...
  inline bool IsConstructCall() const { return info_.IsConstructCall(); ***REMOVED***
  inline int Length() const { return info_.Length(); ***REMOVED***
  inline v8::Local<v8::Value> operator[](int i) const { return info_[i]; ***REMOVED***
