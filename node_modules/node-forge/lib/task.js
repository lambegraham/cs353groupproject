 ...
 */
var sStateTable = {***REMOVED***;

sStateTable[READY] = {***REMOVED***;
sStateTable[READY][STOP] = READY;
sStateTable[READY][START] = RUNNING;
sStateTable[READY][CANCEL] = DONE;
sStateTable[READY][FAIL] = ERROR;

sStateTable[RUNNING] = {***REMOVED***;
...
***REMOVED***
  ...
  ***REMOVED*** else if(sTaskQueues[task.type].length === 0) {
      // report error if queue is empty
      forge.log.error(cat,
        '[%s][%s] task queue empty [%s]',
        task.id, task.name, task.type);
  ***REMOVED*** else if(sTaskQueues[task.type][0] !== task) {
  ...
  ***REMOVED***
    ...
    ***REMOVED*** else if(!task.error && task.successCallback) {
...
/* Tasks API */
module.exports = forge.task = forge.task || {***REMOVED***;
