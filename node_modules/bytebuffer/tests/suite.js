...
var Sandbox = function(properties) {
    this.Int8Array = function() {***REMOVED***;
    this.Uint8Array = function() {***REMOVED***;
    this.Int16Array = function() {***REMOVED***;
    this.Uint16Array = function() {***REMOVED***;
    this.Int32Array = function() {***REMOVED***;
    this.Uint32Array = function() {***REMOVED***;
    this.Float32Array = function() {***REMOVED***;
    this.Float64Array = function() {***REMOVED***;
    this.DataView = function() {***REMOVED***;
...
function makeSuite(ByteBuffer) {
          ...
          ***REMOVED***);
            ...
            if (output instanceof Long) {
                if (!varint)
                    ...
                    test.deepEqual(val, {value: output, length: size***REMOVED***);
          ***REMOVED*** else {
                if (!varint)
                    test.strictEqual(val, output);
                else
  ...
  ***REMOVED***);
    ...
    ***REMOVED***
      ...
      bb.reset();
      bb.writeBitSet([,null,"",0,42,"hello world",new Date(0),{***REMOVED***,[]]);
      bb.reset();
  ...
  ***REMOVED***
    ...
    suite.types.istring = function(test) {
        ...
        test.deepEqual(bb.readIString(0), {"string": "ab", "length": 6***REMOVED***);
  ...
  ***REMOVED***
    ...
    suite.types.vstring = function(test) {
        ...
        test.deepEqual(bb.readVString(0), {"string": "ab", "length": 3***REMOVED***);
        test.equal(bb.toString("debug").substr(0, 10), "<02 61 62>");
  ...
  ***REMOVED***
    ...
    suite.types.cstring = function(test) {
        ...
        test.deepEqual(bb.readCString(0), {"string": "ab", "length": 3***REMOVED***);
        test.equal(bb.toString("debug").substr(0, 10), "<61 62 00>");
  ...
  ***REMOVED***
    ...
    suite.debug.printDebug = function(test) {
        var bb = new ByteBuffer(3);
        function callMe() { callMe.called = true; ***REMOVED***
