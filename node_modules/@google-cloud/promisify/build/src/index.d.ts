 ...
 *
 * @param {function***REMOVED*** originalMethod - The method to promisify.
 * @param {object=***REMOVED*** options - Promise options.
 * @param {boolean***REMOVED*** options.singular - Resolve the promise with single arg instead of an array.
 * @return {function***REMOVED*** wrapped
 */
 ...
 * streaming methods.
 *
 * @param {module:common/service***REMOVED*** Class - Service class.
 ...
 *
 * @param {function***REMOVED*** originalMethod - The method to callbackify.
 * @param {object=***REMOVED*** options - Callback options.
 * @param {boolean***REMOVED*** options.singular - Pass to the callback a single arg instead of an array.
 * @return {function***REMOVED*** wrapped
 */
