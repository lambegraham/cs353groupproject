 ...
 * {@link Storage***REMOVED*** (ES6) class, which should be instantiated with `new`.
 *
 * See {@link Storage***REMOVED*** and {@link ClientConfig***REMOVED*** for client methods and
 * configuration options.
 *
 * @module {Storage***REMOVED*** @google-cloud/storage
