...
import { BodyResponseCallback, DecorateRequestOptions, GetConfig, Metadata, ServiceObject ***REMOVED*** from '@google-cloud/common';
import { Writable, Readable ***REMOVED*** from 'stream';
import * as http from 'http';
import { Storage ***REMOVED*** from './storage';
import { Bucket ***REMOVED*** from './bucket';
import { Acl ***REMOVED*** from './acl';
import { ResponseBody, Duplexify ***REMOVED*** from '@google-cloud/common/build/src/util';
...
declare class File extends ServiceObject<File> {
     ...
     * ***REMOVED***;
     *
     * file.acl.add(options, function(err, aclObject) {***REMOVED***);
     *
     * //-
...
/**
 * Reference to the {@link File***REMOVED*** class.
