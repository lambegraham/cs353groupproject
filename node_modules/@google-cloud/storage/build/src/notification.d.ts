 ...
 */
import { Metadata, MetadataCallback, ServiceObject ***REMOVED*** from '@google-cloud/common';
import { ResponseBody ***REMOVED*** from '@google-cloud/common/build/src/util';
...
***REMOVED***
/**
 * @typedef {array***REMOVED*** GetNotificationMetadataResponse
 * @property {object***REMOVED*** 0 The notification metadata.
 ...
 * @param {object***REMOVED*** files The notification metadata.
...
***REMOVED***
/**
 * @typedef {array***REMOVED*** GetNotificationResponse
 * @property {Notification***REMOVED*** 0 The {@link Notification***REMOVED***
 * @property {object***REMOVED*** 1 The full API response.
 */
 ...
 * @param {?Error***REMOVED*** err Request error, if any.
 * @param {Notification***REMOVED*** notification The {@link Notification***REMOVED***.
 * @param {object***REMOVED*** apiResponse The full API response.
 */
...
***REMOVED***
/**
 * Reference to the {@link Notification***REMOVED*** class.
