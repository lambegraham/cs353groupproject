 ...
 */
import { MetadataCallback, ServiceObject, ServiceObjectConfig ***REMOVED*** from './service-object';
export declare class Operation<T = any> extends ServiceObject<T> {
     ...
     * @param {module:common/service|module:common/serviceObject|module:common/grpcService|module:common/grpcServiceObject***REMOVED*** config.parent - The parent object.
     */
