...
import { ApiError, BodyResponseCallback, DecorateRequestOptions ***REMOVED*** from './util';
...
declare class ServiceObject<T = any> extends EventEmitter {
     ...
     * @param {?error***REMOVED*** callback.err - An error returned while making this request.
     * @param {object***REMOVED*** callback.instance - The instance.
     * @param {object***REMOVED*** callback.apiResponse - The full API response.
     */
     ...
     * @param {function***REMOVED*** callback - The callback function.
     * @param {?error***REMOVED*** callback.err - An error returned while making this request.
     * @param {boolean***REMOVED*** callback.exists - Whether the object exists or not.
     */
     ...
     *
     * @param {object=***REMOVED*** options - The configuration object that will be used to
     *     create the object if necessary.
     * @param {boolean***REMOVED*** options.autoCreate - Create the object if it doesn't already exist.
     * @param {function***REMOVED*** callback - The callback function.
     * @param {?error***REMOVED*** callback.err - An error returned while making this request.
     * @param {object***REMOVED*** callback.instance - The instance.
     * @param {object***REMOVED*** callback.apiResponse - The full API response.
     ...
     * @param {function***REMOVED*** callback - The callback function.
     * @param {?error***REMOVED*** callback.err - An error returned while making this request.
     * @param {object***REMOVED*** callback.metadata - The metadata for this object.
     * @param {object***REMOVED*** callback.apiResponse - The full API response.
     */
     ...
     *
     * @param {object***REMOVED*** metadata - The metadata to set on this object.
     ...
     * @private
     *
     * @param {object***REMOVED*** reqOpts - Request options that are passed to `request`.
     * @param {string***REMOVED*** reqOpts.uri - A URI relative to the baseUrl.
     * @param {function***REMOVED*** callback - The callback function passed to `request`.
     */
    private request_;
    /**
     * Make an authenticated API request.
