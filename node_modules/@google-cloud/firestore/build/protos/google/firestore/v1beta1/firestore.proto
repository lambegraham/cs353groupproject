...
service Firestore {
  ...
  rpc GetDocument(GetDocumentRequest) returns (Document) {
    option (google.api.http) = {
      get: "/v1beta1/{name=projects/*/databases/*/documents/*/*****REMOVED***"
  ***REMOVED***
***REMOVED***
  ...
  rpc ListDocuments(ListDocumentsRequest) returns (ListDocumentsResponse) {
    option (google.api.http) = {
      get: "/v1beta1/{parent=projects/*/databases/*/documents/*/*****REMOVED***/{collection_id***REMOVED***"
  ***REMOVED***
***REMOVED***
  ...
  rpc CreateDocument(CreateDocumentRequest) returns (Document) {
    option (google.api.http) = {
      post: "/v1beta1/{parent=projects/*/databases/*/documents/*****REMOVED***/{collection_id***REMOVED***"
      body: "document"
  ***REMOVED***
***REMOVED***
  ...
  rpc UpdateDocument(UpdateDocumentRequest) returns (Document) {
    option (google.api.http) = {
      patch: "/v1beta1/{document.name=projects/*/databases/*/documents/*/*****REMOVED***"
      body: "document"
  ***REMOVED***
***REMOVED***
  ...
  rpc DeleteDocument(DeleteDocumentRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = {
      delete: "/v1beta1/{name=projects/*/databases/*/documents/*/*****REMOVED***"
  ***REMOVED***
***REMOVED***
  ...
  rpc BatchGetDocuments(BatchGetDocumentsRequest) returns (stream BatchGetDocumentsResponse) {
    option (google.api.http) = {
      post: "/v1beta1/{database=projects/*/databases/****REMOVED***/documents:batchGet"
      body: "*"
  ***REMOVED***
***REMOVED***
  ...
  rpc BeginTransaction(BeginTransactionRequest) returns (BeginTransactionResponse) {
    option (google.api.http) = {
      post: "/v1beta1/{database=projects/*/databases/****REMOVED***/documents:beginTransaction"
      body: "*"
  ***REMOVED***
***REMOVED***
  ...
  rpc Commit(CommitRequest) returns (CommitResponse) {
    option (google.api.http) = {
      post: "/v1beta1/{database=projects/*/databases/****REMOVED***/documents:commit"
      body: "*"
  ***REMOVED***
***REMOVED***
  ...
  rpc Rollback(RollbackRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = {
      post: "/v1beta1/{database=projects/*/databases/****REMOVED***/documents:rollback"
      body: "*"
  ***REMOVED***
***REMOVED***
  ...
  rpc RunQuery(RunQueryRequest) returns (stream RunQueryResponse) {
    option (google.api.http) = {
      post: "/v1beta1/{parent=projects/*/databases/*/documents***REMOVED***:runQuery"
      body: "*"
      additional_bindings {
        post: "/v1beta1/{parent=projects/*/databases/*/documents/*/*****REMOVED***:runQuery"
        body: "*"
...
***REMOVED***
  ...
  rpc Write(stream WriteRequest) returns (stream WriteResponse) {
    option (google.api.http) = {
      post: "/v1beta1/{database=projects/*/databases/****REMOVED***/documents:write"
      body: "*"
  ***REMOVED***
***REMOVED***
  ...
  rpc Listen(stream ListenRequest) returns (stream ListenResponse) {
    option (google.api.http) = {
      post: "/v1beta1/{database=projects/*/databases/****REMOVED***/documents:listen"
      body: "*"
  ***REMOVED***
***REMOVED***
  ...
  rpc ListCollectionIds(ListCollectionIdsRequest) returns (ListCollectionIdsResponse) {
    option (google.api.http) = {
      post: "/v1beta1/{parent=projects/*/databases/*/documents***REMOVED***:listCollectionIds"
      body: "*"
      additional_bindings {
        post: "/v1beta1/{parent=projects/*/databases/*/documents/*/*****REMOVED***:listCollectionIds"
        body: "*"
