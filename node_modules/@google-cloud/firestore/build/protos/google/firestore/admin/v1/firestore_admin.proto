...
service FirestoreAdmin {
  ...
  rpc CreateIndex(CreateIndexRequest) returns (google.longrunning.Operation) {
    option (google.api.http) = {
      post: "/v1/{parent=projects/*/databases/*/collectionGroups/****REMOVED***/indexes"
      body: "index"
  ***REMOVED***
***REMOVED***
  ...
  rpc ListIndexes(ListIndexesRequest) returns (ListIndexesResponse) {
    option (google.api.http) = {
      get: "/v1/{parent=projects/*/databases/*/collectionGroups/****REMOVED***/indexes"
  ***REMOVED***
***REMOVED***
  ...
  rpc GetIndex(GetIndexRequest) returns (Index) {
    option (google.api.http) = {
      get: "/v1/{name=projects/*/databases/*/collectionGroups/*/indexes/****REMOVED***"
  ***REMOVED***
***REMOVED***
  ...
  rpc DeleteIndex(DeleteIndexRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = {
      delete: "/v1/{name=projects/*/databases/*/collectionGroups/*/indexes/****REMOVED***"
  ***REMOVED***
***REMOVED***
  ...
  rpc GetField(GetFieldRequest) returns (Field) {
    option (google.api.http) = {
      get: "/v1/{name=projects/*/databases/*/collectionGroups/*/fields/****REMOVED***"
  ***REMOVED***
***REMOVED***
  ...
  rpc UpdateField(UpdateFieldRequest) returns (google.longrunning.Operation) {
    option (google.api.http) = {
      patch: "/v1/{field.name=projects/*/databases/*/collectionGroups/*/fields/****REMOVED***"
      body: "field"
  ***REMOVED***
***REMOVED***
  ...
  rpc ListFields(ListFieldsRequest) returns (ListFieldsResponse) {
    option (google.api.http) = {
      get: "/v1/{parent=projects/*/databases/*/collectionGroups/****REMOVED***/fields"
  ***REMOVED***
***REMOVED***
  ...
  rpc ExportDocuments(ExportDocumentsRequest) returns (google.longrunning.Operation) {
    option (google.api.http) = {
      post: "/v1/{name=projects/*/databases/****REMOVED***:exportDocuments"
      body: "*"
  ***REMOVED***
***REMOVED***
  ...
  rpc ImportDocuments(ImportDocumentsRequest) returns (google.longrunning.Operation) {
    option (google.api.http) = {
      post: "/v1/{name=projects/*/databases/****REMOVED***:importDocuments"
      body: "*"
  ***REMOVED***
***REMOVED***
***REMOVED***
