 ...
 * as a [FieldPath]{@link FieldPath***REMOVED*** object.
 *
 * @type {RegExp***REMOVED***
 */
const FIELD_PATH_RE = /^[^*~/[\]]+$/;
...
class QualifiedResourcePath extends ResourcePath {
  ...
  ***REMOVED***
    ...
    static fromSlashSeparatedString(absolutePath) {
      ...
      ***REMOVED***
        throw new Error(`Resource name '${absolutePath***REMOVED***' is not valid.`);
  ***REMOVED***
    /**
     * Create a child path beneath the current level.
     *
...
function validateResourcePath(arg, resourcePath) {
    if (typeof resourcePath !== 'string' || resourcePath === '') {
        throw new Error(`${validate_1.invalidArgumentMessage(arg, 'resource path')***REMOVED*** Path must be a non-empty string.`);
  ***REMOVED***
    if (resourcePath.indexOf('//') >= 0) {
        throw new Error(`${validate_1.invalidArgumentMessage(arg, 'resource path')***REMOVED*** Paths must not contain //.`);
  ***REMOVED***
***REMOVED***
...
class FieldPath extends Path {
     ...
     *
     * @param {...string***REMOVED*** segments Sequence of field names that form this path.
     *
     * @example
     ...
     *     console.log(`Document contains {'f.o.o' : {'bar' : 42***REMOVED******REMOVED***`);
     * ***REMOVED***);
     * ***REMOVED***);
     */
    constructor(...segments) {
      ...
      ***REMOVED***
        ...
        for (let i = 0; i < segments.length; ++i) {
            ...
            if (segments[i].length === 0) {
                throw new Error(`Element at index ${i***REMOVED*** should not be an empty string.`);
          ***REMOVED***
      ***REMOVED***
        super(segments);
  ***REMOVED***
     ...
     *
     * @returns {FieldPath***REMOVED***
     */
    static documentId() {
        return FieldPath._DOCUMENT_ID;
  ***REMOVED***
    /**
     * Turns a field path argument into a [FieldPath]{@link FieldPath***REMOVED***.
     * Supports FieldPaths as input (which are passed through) and dot-separated
     * strings.
     *
     * @private
     * @param {string|FieldPath***REMOVED*** fieldPath The FieldPath to create.
     * @returns {FieldPath***REMOVED*** A field path representation.
     */
  ...
  ***REMOVED***
     ...
     * @private
     * @override
     * @returns {string***REMOVED*** The representation as expected by the API.
     */
    get formattedName() {
  ...
  ***REMOVED***
     ...
     * @private
     * @override
     * @param {string***REMOVED*** fieldPath The path to split.
     * @returns {Array.<string>***REMOVED*** - The split path segments.
     */
    split(fieldPath) {
  ...
  ***REMOVED***
     ...
     * @return {boolean***REMOVED*** true if this `FieldPath` is equal to the provided value.
     */
    isEqual(other) {
...
function validateFieldPath(arg, fieldPath) {
  ...
  ***REMOVED***
    if (typeof fieldPath !== 'string') {
        throw new Error(`${validate_1.invalidArgumentMessage(arg, 'field path')***REMOVED*** Paths can only be specified as strings or via a FieldPath object.`);
  ***REMOVED***
    if (fieldPath.indexOf('..') >= 0) {
        throw new Error(`${validate_1.invalidArgumentMessage(arg, 'field path')***REMOVED*** Paths must not contain ".." in them.`);
  ***REMOVED***
    if (fieldPath.startsWith('.') || fieldPath.endsWith('.')) {
        throw new Error(`${validate_1.invalidArgumentMessage(arg, 'field path')***REMOVED*** Paths must not start or end with ".".`);
  ***REMOVED***
    if (!FIELD_PATH_RE.test(fieldPath)) {
        throw new Error(`${validate_1.invalidArgumentMessage(arg, 'field path')***REMOVED*** Paths can't be empty and must not contain
    "*~/[]".`);
  ***REMOVED***
***REMOVED***
