...
class WriteResult {
  ...
  ***REMOVED***
     ...
     *
     * documentRef.set({foo: 'bar'***REMOVED***).then(writeResult => {
     *   console.log(`Document written at: ${writeResult.writeTime.toDate()***REMOVED***`);
     * ***REMOVED***);
     */
    get writeTime() {
...
class WriteBatch {
  ...
  ***REMOVED***
     ...
     * @returns {WriteBatch***REMOVED*** This WriteBatch instance. Used for chaining
     * method calls.
     *
     * @example
     ...
     *
     * writeBatch.create(documentRef, {foo: 'bar'***REMOVED***);
     *
    ...
    create(documentRef, data) {
        ...
        transform.validate();
        const precondition = new document_1.Precondition({ exists: false ***REMOVED***);
        const op = () => {
  ...
  ***REMOVED***
    ...
    delete(documentRef, precondition) {
        reference_1.validateDocumentReference('documentRef', documentRef);
        validateDeletePrecondition('precondition', precondition, { optional: true ***REMOVED***);
        this.verifyNotCommitted();
  ...
  ***REMOVED***
     ...
     * [SetOptions]{@link SetOptions***REMOVED***., the provided data can be merged
     ...
     * let documentRef = firestore.doc('col/doc');
     *
     * writeBatch.set(documentRef, {foo: 'bar'***REMOVED***);
     *
     * writeBatch.commit().then(() => {
     *   console.log('Successfully executed batch.');
     * ***REMOVED***);
    ...
    set(documentRef, data, options) {
        validateSetOptions('options', options, { optional: true ***REMOVED***);
  ...
  ***REMOVED***
     ...
     * let documentRef = firestore.doc('col/doc');
     *
     * writeBatch.update(documentRef, {foo: 'bar'***REMOVED***);
     *
     * writeBatch.commit().then(() => {
     *   console.log('Successfully executed batch.');
     * ***REMOVED***);
    ...
    update(documentRef, dataOrField, ...preconditionOrValues) {
        ...
        let precondition = new document_1.Precondition({ exists: true ***REMOVED***);
        ...
        if (usesVarargs) {
          ...
          ***REMOVED***
                ...
                // error message.
                throw new Error(`${argumentError***REMOVED*** ${err.message***REMOVED***`);
          ***REMOVED***
      ***REMOVED***
        else {
            try {
  ...
  ***REMOVED***
     ...
     *
     * @returns {Promise.<Array.<WriteResult>>***REMOVED*** A Promise that resolves
  ...
  ***REMOVED***
    ...
    async commit_(commitOptions) {
        ...
        const request = { database ***REMOVED***;
        ...
        if (!explicitTransaction && this._shouldCreateTransaction()) {
            ...
            return this._firestore
                ...
                .then(resp => {
                return this.commit_({ transactionId: resp.transaction ***REMOVED***);
          ***REMOVED***);
      ***REMOVED***
        ...
        /* allowRetries= */ false)
            ...
            if (request.writes.length > 0) {
                assert(Array.isArray(resp.writeResults) &&
                    request.writes.length === resp.writeResults.length, `Expected one write result per operation, but got ${resp.writeResults.length***REMOVED*** results for ${request.writes.length***REMOVED*** operations.`);
...
function validatePrecondition(arg, value, allowExists) {
  ...
  ***REMOVED***
    ...
    if (precondition.exists !== undefined) {
        ++conditions;
        if (!allowExists) {
            throw new Error(`${validate_1.invalidArgumentMessage(arg, 'precondition')***REMOVED*** "exists" is not an allowed precondition.`);
      ***REMOVED***
        if (typeof precondition.exists !== 'boolean') {
            throw new Error(`${validate_1.invalidArgumentMessage(arg, 'precondition')***REMOVED*** "exists" is not a boolean.'`);
      ***REMOVED***
  ***REMOVED***
    if (precondition.lastUpdateTime !== undefined) {
        ++conditions;
        if (!(precondition.lastUpdateTime instanceof timestamp_1.Timestamp)) {
            throw new Error(`${validate_1.invalidArgumentMessage(arg, 'precondition')***REMOVED*** "lastUpdateTime" is not a Firestore Timestamp.`);
      ***REMOVED***
  ***REMOVED***
    if (conditions > 1) {
        throw new Error(`${validate_1.invalidArgumentMessage(arg, 'precondition')***REMOVED*** Input specifies more than one precondition.`);
  ***REMOVED***
***REMOVED***
/**
...
function validateSetOptions(arg, value, options) {
    if (!validate_1.validateOptional(value, options)) {
        if (!util_1.isObject(value)) {
            throw new Error(`${validate_1.invalidArgumentMessage(arg, 'set() options argument')***REMOVED*** Input is not an object.`);
      ***REMOVED***
        const setOptions = value;
        if ('merge' in setOptions && typeof setOptions.merge !== 'boolean') {
            throw new Error(`${validate_1.invalidArgumentMessage(arg, 'set() options argument')***REMOVED*** "merge" is not a boolean.`);
      ***REMOVED***
        if ('mergeFields' in setOptions) {
            if (!Array.isArray(setOptions.mergeFields)) {
                throw new Error(`${validate_1.invalidArgumentMessage(arg, 'set() options argument')***REMOVED*** "mergeFields" is not an array.`);
          ***REMOVED***
            for (let i = 0; i < setOptions.mergeFields.length; ++i) {
              ...
              ***REMOVED***
                    ...
                    throw new Error(`${validate_1.invalidArgumentMessage(arg, 'set() options argument')***REMOVED*** "mergeFields" is not valid: ${err.message***REMOVED***`);
              ***REMOVED***
          ***REMOVED***
      ***REMOVED***
        if ('merge' in setOptions && 'mergeFields' in setOptions) {
            throw new Error(`${validate_1.invalidArgumentMessage(arg, 'set() options argument')***REMOVED*** You cannot specify both "merge" and "mergeFields".`);
      ***REMOVED***
  ***REMOVED***
***REMOVED***
...
function validateDocumentData(arg, obj, allowDeletes) {
  ...
  ***REMOVED***
    for (const prop of Object.keys(obj)) {
      ...
      ***REMOVED***, new path_1.FieldPath(prop));
  ***REMOVED***
***REMOVED***
...
function validateFieldValue(arg, val, path) {
    serializer_1.validateUserInput(arg, val, 'Firestore value', { allowDeletes: 'root', allowTransforms: true ***REMOVED***, path);
***REMOVED***
  ...
  ***REMOVED***);
    ...
    for (let i = 1; i < fields.length; ++i) {
        if (fields[i - 1].isPrefixOf(fields[i])) {
            throw new Error(`${validate_1.invalidArgumentMessage(arg, 'update map')***REMOVED*** Field "${fields[i - 1]***REMOVED***" was specified multiple times.`);
      ***REMOVED***
  ***REMOVED***
***REMOVED***
/**
