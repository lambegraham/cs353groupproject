 ...
 *
 * @private
 * @param {function***REMOVED*** handler A handler than matches the API of `setTimeout()`.
 */
...
class ExponentialBackoff {
    ...
    backoffAndWait() {
      ...
      ***REMOVED***
        ...
        if (this.currentBaseMs > 0) {
            logger_1.logger('ExponentialBackoff.backoffAndWait', null, `Backing off for ${delayWithJitterMs***REMOVED*** ms ` +
  ...
  ***REMOVED***
     ...
     * factor.
     *
     * @returns {number***REMOVED*** The jitter to apply based on the current delay.
     * @private
     */
    jitterDelayMs() {
