 ...
 *
 * This corresponds to
 * {@link https://github.com/grpc/grpc/blob/master/doc/statuscodes.md***REMOVED***.
 */
  ...
  ***REMOVED***
    ...
    extractCurrentChanges(readTime) {
        ...
        this.changeMap.forEach((value, name) => {
          ...
          ***REMOVED***
      ***REMOVED***);
        return { deletes, adds, updates ***REMOVED***;
  ***REMOVED***
    /**
      ...
      ***REMOVED***
          ...
          ***REMOVED***
            ...
            if (changed) {
                ...
                snapshot.fieldsProto = document.fields || {***REMOVED***;
...
class QueryWatch extends Watch {
  ...
  ***REMOVED***
    getTarget(resumeToken) {
        ...
        return { query, targetId: WATCH_TARGET_ID, resumeToken ***REMOVED***;
  ***REMOVED***
***REMOVED***
