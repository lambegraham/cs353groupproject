...
class FirestoreClient {
    ...
    constructor(opts) {
      ...
      ***REMOVED***
        ...
        const defaults = gaxGrpc.constructSettings('google.firestore.v1.Firestore', gapicConfig, opts.clientConfig, { 'x-goog-api-client': clientHeader.join(' ') ***REMOVED***);
  ...
  ***REMOVED***
     ...
     *
     *   The second parameter to the callback is an object representing [Document]{@link google.firestore.v1.Document***REMOVED***.
     * @returns {Promise***REMOVED*** - The promise which resolves to an array.
     *   The first element of the array is an object representing [Document]{@link google.firestore.v1.Document***REMOVED***.
  ...
  ***REMOVED***
     ...
     *   The function which will be called with the result of the API call.
     *
     *   The second parameter to the callback is Array of [Document]{@link google.firestore.v1.Document***REMOVED***.
     *
     *   When autoPaginate: false is specified through options, it contains the result
     *   in a single response. If the response indicates the next page exists, the third
     *   parameter is set to be used for the next request object. The fourth parameter keeps
     *   the raw response object of an object representing [ListDocumentsResponse]{@link google.firestore.v1.ListDocumentsResponse***REMOVED***.
     * @returns {Promise***REMOVED*** - The promise which resolves to an array.
     *   The first element of the array is Array of [Document]{@link google.firestore.v1.Document***REMOVED***.
     *
     *   When autoPaginate: false is specified through options, the array has three elements.
     *   The first element is Array of [Document]{@link google.firestore.v1.Document***REMOVED*** in a single response.
     *   The second element is the next request object if the response
     *   indicates the next page exists, or null. The third element is
     *   an object representing [ListDocumentsResponse]{@link google.firestore.v1.ListDocumentsResponse***REMOVED***.
     *
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     *
     * @example
  ...
  ***REMOVED***
     ...
     *   An object stream which emits an object representing [Document]{@link google.firestore.v1.Document***REMOVED*** on 'data' event.
     *
     * @example
     *
     * const firestore = require('@google-cloud/firestore');
  ...
  ***REMOVED***
     ...
     *   retries, paginations, etc. See [gax.CallOptions]{@link https://googleapis.github.io/gax-nodejs/interfaces/CallOptions.html***REMOVED*** for the details.
     * @returns {Stream***REMOVED***
     *   An object stream which emits [BatchGetDocumentsResponse]{@link google.firestore.v1.BatchGetDocumentsResponse***REMOVED*** on 'data' event.
     *
     * @example
     *
     * const firestore = require('@google-cloud/firestore');
  ...
  ***REMOVED***
     ...
     *   The function which will be called with the result of the API call.
     *
     *   The second parameter to the callback is an object representing [BeginTransactionResponse]{@link google.firestore.v1.BeginTransactionResponse***REMOVED***.
     * @returns {Promise***REMOVED*** - The promise which resolves to an array.
     *   The first element of the array is an object representing [BeginTransactionResponse]{@link google.firestore.v1.BeginTransactionResponse***REMOVED***.
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     *
     * @example
     *
  ...
  ***REMOVED***
     ...
     *   The function which will be called with the result of the API call.
     *
     *   The second parameter to the callback is an object representing [CommitResponse]{@link google.firestore.v1.CommitResponse***REMOVED***.
     * @returns {Promise***REMOVED*** - The promise which resolves to an array.
     *   The first element of the array is an object representing [CommitResponse]{@link google.firestore.v1.CommitResponse***REMOVED***.
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     *
     * @example
     *
  ...
  ***REMOVED***
     ...
     *   retries, paginations, etc. See [gax.CallOptions]{@link https://googleapis.github.io/gax-nodejs/interfaces/CallOptions.html***REMOVED*** for the details.
     * @returns {Stream***REMOVED***
     *   An object stream which emits [RunQueryResponse]{@link google.firestore.v1.RunQueryResponse***REMOVED*** on 'data' event.
     *
     * @example
     *
     * const firestore = require('@google-cloud/firestore');
  ...
  ***REMOVED***
     ...
     *   representing [WriteRequest]{@link google.firestore.v1.WriteRequest***REMOVED*** for write() method, and
     *   will emit objects representing [WriteResponse]{@link google.firestore.v1.WriteResponse***REMOVED*** on 'data' event asynchronously.
     *
     * @example
     *
     * const firestore = require('@google-cloud/firestore');
  ...
  ***REMOVED***
     ...
     * @returns {Stream***REMOVED***
     *   An object stream which is both readable and writable. It accepts objects
     *   representing [ListenRequest]{@link google.firestore.v1.ListenRequest***REMOVED*** for write() method, and
     *   will emit objects representing [ListenResponse]{@link google.firestore.v1.ListenResponse***REMOVED*** on 'data' event asynchronously.
     *
     * @example
     *
     * const firestore = require('@google-cloud/firestore');
  ...
  ***REMOVED***
     ...
     *   in a single response. If the response indicates the next page exists, the third
     *   parameter is set to be used for the next request object. The fourth parameter keeps
     *   the raw response object of an object representing [ListCollectionIdsResponse]{@link google.firestore.v1.ListCollectionIdsResponse***REMOVED***.
     * @returns {Promise***REMOVED*** - The promise which resolves to an array.
     ...
     *   The second element is the next request object if the response
     *   indicates the next page exists, or null. The third element is
     *   an object representing [ListCollectionIdsResponse]{@link google.firestore.v1.ListCollectionIdsResponse***REMOVED***.
     *
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     *
     * @example
