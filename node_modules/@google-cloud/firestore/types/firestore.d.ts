...
declare namespace FirebaseFirestore {
  ...
  export interface Settings {
     ...
     * support {@link https://cloud.google.com/docs/authentication Application
     * Default Credentials***REMOVED***. To configure Firestore with custom credentials, use
     ...
     */
    credentials?: {client_email?:string, private_key?:string***REMOVED***;
...
***REMOVED***
  ...
  export class Firestore {
     ...
     * {@link https://firebase.google.com/docs/firestore/***REMOVED***
     */
     ...
     *
     * @param {object***REMOVED*** settings The settings to use for all Firestore
     * operations.
     */
     ...
     *
     * @param {Array.<DocumentReference|ReadOptions>***REMOVED*** documentRefsOrReadOptions
    ...
    runTransaction<T>(
        ...
        transactionOptions?:{maxAttempts?: number***REMOVED***
    ): Promise<T>;
...
***REMOVED***
  ...
  export class FieldValue {
    ...
    /**
     * Returns a sentinel for use with update() or set() with {merge:true***REMOVED*** to
...
***REMOVED***
   ...
   */
  export const v1: {FirestoreClient: any, FirestoreAdminClient: any***REMOVED***;
***REMOVED***
