...
/**
 * Builds a banner.
 * @param {string=***REMOVED*** title App name
 * @param {string=***REMOVED*** appendix Appendix, e.g. version
...
function ascli(title, appendix) {
    ...
    for (var i=0; i<title.length; i++) {
        ...
        if (c == '\x1B') {
          ...
          ***REMOVED***
            ac += c;
      ***REMOVED*** else if ((a=alphabet[c])||(a=alphabet[c.toLowerCase()]))
            for (j=0; j<3; j++)
                lines[j] += ac+a[j];
  ***REMOVED***
 ...
 * @param {string=***REMOVED*** title Title in dojo alphabet
 * @param {string=***REMOVED*** appendix Title appendix
 * @returns {Function***REMOVED*** ascli
 */
 ...
 * @param {string|Object.<string,Array.<string>***REMOVED*** alpha File name or alphabet to use
 * @returns {Function***REMOVED*** ascli
 */
 ...
 * @param {string***REMOVED*** msg Message text
 * @param {number=***REMOVED*** code Exit code, defaults not to send it explicitly
 */
 ...
 * @param {string***REMOVED*** msg Message text
 * @param {number=***REMOVED*** code Exit code, defaults to not send it explicitly
 */
...
/**
 * opt.js
 * @param {Array.<string>=***REMOVED*** argv
 * @returns {{node: string, script: string, argv: Array.<string>, opt: Object.<string,boolean|string>***REMOVED******REMOVED***
 */
