...
var DEFAULTS = {
  ...
  shouldRetryFn: function (response) {
    ...
    debug(`Response status: ${statusCode***REMOVED***`);
...
***REMOVED***
  ...
  if (streamMode) {
    retryStream = through({ objectMode: opts.objectMode ***REMOVED***);
...
***REMOVED***
  ...
  function resetStreams() {
    ...
    ***REMOVED*** else if (requestStream.end) {
        requestStream.end();
    ***REMOVED***
  ***REMOVED***
***REMOVED***
  ...
  function makeRequest() {
    currentRetryAttempt++;
    debug(`Current retry attempt: ${currentRetryAttempt***REMOVED***`);

    if (streamMode) {
      streamResponseHandled = false;

      delayStream = through({ objectMode: opts.objectMode ***REMOVED***);
...
***REMOVED***
  ...
  ***REMOVED***
    ...
    debug(`Next retry delay: ${nextRetryDelay***REMOVED***`);
