...
void function() {
   ...
   *
   * @param {HTMLDialogElement?***REMOVED*** opt_dialog to check, or test default
   */
...
***REMOVED***
   ...
   *
   * @param {number***REMOVED*** keyCode to press
   * @param {string?***REMOVED*** opt_type to use, default keydown
...
***REMOVED***
   ...
   *
   * @param {!Element***REMOVED*** el to clean up
   * @return {!Element***REMOVED*** the same element, for chaining
   */
...
***REMOVED***)();
   ...
   *
   * @param {string?***REMOVED*** opt_content to be used as innerHTML
   */
...
***REMOVED***);
  ...
  ***REMOVED***);
    test('show/showModal interaction', function() {
      ...
      var show = function() { dialog.show(); ***REMOVED***;
      var showModal = function() { dialog.showModal(); ***REMOVED***;
  ...
  ***REMOVED***);
    test('show/showModal outside document', function() {
      ...
      assert.throws(function() { dialog.showModal(); ***REMOVED***);

      assert.doesNotThrow(function() { dialog.show(); ***REMOVED***);
