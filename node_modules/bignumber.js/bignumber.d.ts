...
//
//   import {BigNumber***REMOVED*** from "bignumber.js"
//   //import BigNumber from "bignumber.js"
//
//   let rm: BigNumber.RoundingMode = BigNumber.ROUND_UP;
//   let f: BigNumber.Format = { decimalSeparator: ',' ***REMOVED***;
//   let c: BigNumber.Config = { DECIMAL_PLACES: 4, ROUNDING_MODE: rm, FORMAT: f ***REMOVED***;
//   BigNumber.config(c);
//
...
export namespace BigNumber {
  ...
  export interface Config {
     ...
     *
     * ```ts
     * BigNumber.config({ DECIMAL_PLACES: 5 ***REMOVED***)
     * BigNumber.set({ DECIMAL_PLACES: 5 ***REMOVED***)
     * ```
     */
     ...
     *
     * ```ts
     * BigNumber.config({ ROUNDING_MODE: 0 ***REMOVED***)
     * BigNumber.set({ ROUNDING_MODE: BigNumber.ROUND_UP ***REMOVED***)
     * ```
     */
     ...
     *
     * ```ts
     * BigNumber.config({ EXPONENTIAL_AT: 2 ***REMOVED***)
     ...
     * BigNumber.config({ EXPONENTIAL_AT: 0 ***REMOVED***)
     * ```
     *
     ...
     *
     * ```ts
     * BigNumber.config({ RANGE: 500 ***REMOVED***)
     ...
     *
     * ```ts
     * BigNumber.config({ CRYPTO: true ***REMOVED***)
     ...
     *
     * ```ts
     * BigNumber.config({ MODULO_MODE: BigNumber.EUCLID ***REMOVED***)
     * BigNumber.set({ MODULO_MODE: 9 ***REMOVED***)          // equivalent
     * ```
     */
     ...
     *
     * ```ts
     * BigNumber.config({ POW_PRECISION: 100 ***REMOVED***)
     * ```
     */
...
export declare class BigNumber {
   ...
   * ```
   *
   * @param {BigNumber.RoundingMode***REMOVED*** [rm] The roundng mode, an integer, 0 to 8.
   */
   ...
   * BN = BigNumber.clone()
   * BN.config({ DECIMAL_PLACES: 9 ***REMOVED***)
   * ```
   *
   ...
   *
   * ```ts
   * BigNumber.config({ DECIMAL_PLACES: 10 ***REMOVED***)
