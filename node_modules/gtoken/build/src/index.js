...
class GoogleToken {
  ...
  ***REMOVED***
    ...
    hasExpired() {
      ...
      ***REMOVED***
  ***REMOVED***
    getToken(callback, opts = {***REMOVED***) {
    ...
    async getCredentials(keyFile) {
        ...
        switch (mimeType) {
            case 'application/json': {
              ...
              ***REMOVED***
                return { privateKey, clientEmail ***REMOVED***;
          ***REMOVED***
            case 'application/x-x509-ca-cert': {
                // *.pem file
                const privateKey = await readFile(keyFile, 'utf8');
                return { privateKey ***REMOVED***;
          ***REMOVED***
  ...
  ***REMOVED***
    async revokeTokenAsync() {
      ...
      ***REMOVED***
        ...
        await gaxios_1.request({ url ***REMOVED***);
        this.configure({
            email: this.iss,
            sub: this.sub,
            key: this.key,
  ...
  ***REMOVED***
    ...
    async requestToken() {
        ...
        const additionalClaims = this.additionalClaims || {***REMOVED***;
        const payload = Object.assign({
            ...
            iat,
            sub: this.sub,
      ***REMOVED***, additionalClaims);
        const signedJWT = jws.sign({
            header: { alg: 'RS256' ***REMOVED***,
            payload,
            secret: this.key,
      ***REMOVED***);
        try {
      ...
      ***REMOVED***
            ...
            const body = e.response && e.response.data ? e.response.data : {***REMOVED***;
            if (body.error) {
                const desc = body.error_description
                    ? `: ${body.error_description***REMOVED***`
                    : '';
                e.message = `${body.error***REMOVED***${desc***REMOVED***`;
          ***REMOVED***
            throw e;
      ***REMOVED***
  ***REMOVED***
