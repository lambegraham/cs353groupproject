...
* **Message.create**(properties: `Object`): `Message`<br />
  ...
  ```js
  var message = AwesomeMessage.create({ awesomeField: "AwesomeString" ***REMOVED***);
  ```
...
* **Message.fromObject**(object: `Object`): `Message`<br />
  ...
  ```js
  var message = AwesomeMessage.fromObject({ awesomeField: 42 ***REMOVED***);
...
protobuf.load("awesome.proto", function(err, root) {
    ...
    // Exemplary payload
    var payload = { awesomeField: "AwesomeString" ***REMOVED***;
...
greeter.sayHello({ name: 'you' ***REMOVED***, function(err, response) {
...
```js
greeter.sayHello({ name: 'you' ***REMOVED***)
...
```ts
import { load ***REMOVED*** from "protobufjs"; // respectively "./node_modules/protobufjs"
...
load("awesome.proto", function(err, root) {
  ...
  let message = AwesomeMessage.create({ awesomeField: "hello" ***REMOVED***);
  console.log(`message = ${JSON.stringify(message)***REMOVED***`);

  let buffer = AwesomeMessage.encode(message).finish();
  console.log(`buffer = ${Array.prototype.toString.call(buffer)***REMOVED***`);

  let decoded = AwesomeMessage.decode(buffer);
  console.log(`decoded = ${JSON.stringify(decoded)***REMOVED***`);
***REMOVED***);
```
...
```ts
import { AwesomeMessage ***REMOVED*** from "./bundle.js";
...
```ts
import { Message, Type, Field, OneOf ***REMOVED*** from "protobufjs/light"; // respectively "./node_modules/protobufjs/light.js"
...
// example code
let message = new AwesomeMessage({ awesomeField: "hello" ***REMOVED***);
let buffer  = AwesomeMessage.encode(message).finish();
let decoded = AwesomeMessage.decode(buffer);
```
...
* **MapField.d&lt;T extends { [key: string]: any ***REMOVED***>(fieldId: `number`, fieldKeyType: `string`, fieldValueType. `string | Constructor<{***REMOVED***>`)**<br />
