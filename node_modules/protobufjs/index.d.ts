 ...
 */
export function common(name: string, json: { [k: string]: any ***REMOVED***): void;
...
export namespace common {
  ...
  ***REMOVED***
    ...
    interface IStruct {
        fields?: { [k: string]: IValue ***REMOVED***;
  ***REMOVED***
...
export class Enum extends ReflectionObject {
     ...
     */
    constructor(name: string, values?: { [k: string]: number ***REMOVED***, options?: { [k: string]: any ***REMOVED***, comment?: string, comments?: { [k: string]: string ***REMOVED***);

    /** Enum values by id. */
    public valuesById: { [k: number]: string ***REMOVED***;

    /** Enum values by name. */
    public values: { [k: string]: number ***REMOVED***;

    /** Enum comment text. */
    public comment: (string|null);

    /** Value comment texts, if any. */
    public comments: { [k: string]: string ***REMOVED***;
...
export interface IEnum {
    ...
    /** Enum values */
    values: { [k: string]: number ***REMOVED***;

    /** Enum options */
    options?: { [k: string]: any ***REMOVED***;
***REMOVED***
...
export class Field extends FieldBase {
     ...
     * @param [options] Declared options
     */
    constructor(name: string, id: number, type: string, rule?: (string|{ [k: string]: any ***REMOVED***), extend?: (string|{ [k: string]: any ***REMOVED***), options?: { [k: string]: any ***REMOVED***);
...
export class FieldBase extends ReflectionObject {
     ...
     */
    constructor(name: string, id: number, type: string, rule?: (string|{ [k: string]: any ***REMOVED***), extend?: (string|{ [k: string]: any ***REMOVED***), options?: { [k: string]: any ***REMOVED***, comment?: string);
...
export class MapField extends FieldBase {
     ...
     * @param [comment] Comment associated with this field
     */
    constructor(name: string, id: number, keyType: string, type: string, options?: { [k: string]: any ***REMOVED***, comment?: string);
     ...
     * @returns Decorator function
     */
    public static d<T extends { [key: string]: number | Long | string | boolean | Uint8Array | Buffer | number[] | Message<{***REMOVED***> ***REMOVED***>(fieldId: number, fieldKeyType: ("int32"|"uint32"|"sint32"|"fixed32"|"sfixed32"|"int64"|"uint64"|"sint64"|"fixed64"|"sfixed64"|"bool"|"string"), fieldValueType: ("double"|"float"|"int32"|"uint32"|"sint32"|"fixed32"|"sfixed32"|"int64"|"uint64"|"sint64"|"fixed64"|"sfixed64"|"bool"|"string"|"bytes"|object|Constructor<{***REMOVED***>)): FieldDecorator;
***REMOVED***
...
export class Message<T extends object = object> {
     ...
     */
    public static create<T extends Message<T>>(this: Constructor<T>, properties?: { [k: string]: any ***REMOVED***): Message<T>;
     ...
     * @returns Writer
     */
    public static encode<T extends Message<T>>(this: Constructor<T>, message: (T|{ [k: string]: any ***REMOVED***), writer?: Writer): Writer;
     ...
     * @returns Writer
     */
    public static encodeDelimited<T extends Message<T>>(this: Constructor<T>, message: (T|{ [k: string]: any ***REMOVED***), writer?: Writer): Writer;
     ...
     */
    public static verify(message: { [k: string]: any ***REMOVED***): (string|null);
     ...
     * @returns Message instance
     */
    public static fromObject<T extends Message<T>>(this: Constructor<T>, object: { [k: string]: any ***REMOVED***): T;
     ...
     */
    public static toObject<T extends Message<T>>(this: Constructor<T>, message: T, options?: IConversionOptions): { [k: string]: any ***REMOVED***;

    /**
     * Converts this message to JSON.
     * @returns JSON object
     */
    public toJSON(): { [k: string]: any ***REMOVED***;
***REMOVED***
...
export class Method extends ReflectionObject {
     ...
     */
    constructor(name: string, type: (string|undefined), requestType: string, responseType: string, requestStream?: (boolean|{ [k: string]: any ***REMOVED***), responseStream?: (boolean|{ [k: string]: any ***REMOVED***), options?: { [k: string]: any ***REMOVED***, comment?: string);
...
export class Namespace extends NamespaceBase {
     ...
     * @param [options] Declared options
     */
    constructor(name: string, options?: { [k: string]: any ***REMOVED***);
     ...
     * @throws {TypeError***REMOVED*** If arguments are invalid
     */
    public static fromJSON(name: string, json: { [k: string]: any ***REMOVED***): Namespace;
     ...
     */
    public static arrayToJSON(array: ReflectionObject[], toJSONOptions?: IToJSONOptions): ({ [k: string]: any ***REMOVED***|undefined);
...
export abstract class NamespaceBase extends ReflectionObject {
    ...
    public nested?: { [k: string]: ReflectionObject ***REMOVED***;
     ...
     * @returns `this`
     */
    public addJSON(nestedJson: { [k: string]: AnyNestedObject ***REMOVED***): Namespace;
     ...
     */
    public getEnum(name: string): { [k: string]: number ***REMOVED***;
...
export interface INamespace {
    ...
    nested?: { [k: string]: AnyNestedObject ***REMOVED***;
***REMOVED***
...
export abstract class ReflectionObject {
    ...
    /** Options. */
    public options?: { [k: string]: any ***REMOVED***;
     ...
     * @returns `this`
     */
    public setOptions(options: { [k: string]: any ***REMOVED***, ifNotSet?: boolean): ReflectionObject;
...
export class OneOf extends ReflectionObject {
     ...
     * @param [comment] Comment associated with this field
     */
    constructor(name: string, fieldNames?: (string[]|{ [k: string]: any ***REMOVED***), options?: { [k: string]: any ***REMOVED***, comment?: string);
 ...
 * @param [options] Parse options. Defaults to {@link parse.defaults***REMOVED*** when omitted.
...
export class Reader {
     ...
     * @param buffer Buffer to read from
     * @returns A {@link BufferReader***REMOVED*** if `buffer` is a Buffer, otherwise a {@link Reader***REMOVED***
...
export class Root extends NamespaceBase {
     ...
     */
    constructor(options?: { [k: string]: any ***REMOVED***);
 ...
 */
export let roots: { [k: string]: Root ***REMOVED***;
...
export namespace rpc {
    ...
    /** An RPC service as returned by {@link Service#create***REMOVED***. */
...
export class Service extends NamespaceBase {
    ...
    /** Service methods. */
    public methods: { [k: string]: Method ***REMOVED***;
...
export interface IService extends INamespace {
    ...
    /** Method descriptors */
    methods: { [k: string]: IMethod ***REMOVED***;
***REMOVED***
...
export class Type extends NamespaceBase {
    ...
    /** Message fields. */
    public fields: { [k: string]: Field ***REMOVED***;

    /** Oneofs declared within this namespace, if any. */
    public oneofs: { [k: string]: OneOf ***REMOVED***;
    ...
    public readonly fieldsById: { [k: number]: Field ***REMOVED***;
     ...
     * @returns Message instance
     */
    public create(properties?: { [k: string]: any ***REMOVED***): Message<{***REMOVED***>;
     ...
     * @returns writer
     */
    public encode(message: (Message<{***REMOVED***>|{ [k: string]: any ***REMOVED***), writer?: Writer): Writer;
     ...
     * @returns writer
     */
    public encodeDelimited(message: (Message<{***REMOVED***>|{ [k: string]: any ***REMOVED***), writer?: Writer): Writer;
     ...
     * @returns `null` if valid, otherwise the reason why it is not
     */
    public verify(message: { [k: string]: any ***REMOVED***): (null|string);
     ...
     * @returns Message instance
     */
    public fromObject(object: { [k: string]: any ***REMOVED***): Message<{***REMOVED***>;
     ...
     * @returns Plain object
     */
    public toObject(message: Message<{***REMOVED***>, options?: IConversionOptions): { [k: string]: any ***REMOVED***;
...
export interface IType extends INamespace {
    ...
    /** Oneof descriptors */
    oneofs?: { [k: string]: IOneOf ***REMOVED***;

    /** Field descriptors */
    fields: { [k: string]: IField ***REMOVED***;
...
/** Properties type. */
type Properties<T> = { [P in keyof T]?: T[P] ***REMOVED***;
...
export namespace util {
  ...
  ***REMOVED***
     ...
     */
    function merge(dst: { [k: string]: any ***REMOVED***, src: { [k: string]: any ***REMOVED***, ifNotSet?: boolean): { [k: string]: any ***REMOVED***;
    ...
    class ProtocolError<T extends Message<T>> extends Error {
         ...
         */
        constructor(message: string, properties?: { [k: string]: any ***REMOVED***);
  ...
  ***REMOVED***
     ...
     */
    function toArray(object: { [k: string]: any ***REMOVED***): any[];
     ...
     */
    function toObject(array: any[]): { [k: string]: any ***REMOVED***;
...
export const wrappers: { [k: string]: IWrapper ***REMOVED***;
 ...
 * @returns Message instance
 */
type WrapperFromObjectConverter = (this: Type, object: { [k: string]: any ***REMOVED***) => Message<{***REMOVED***>;
 ...
 * @returns Plain object
 */
type WrapperToObjectConverter = (this: Type, message: Message<{***REMOVED***>, options?: IConversionOptions) => { [k: string]: any ***REMOVED***;
...
export class Writer {
     ...
     * @returns A {@link BufferWriter***REMOVED*** when Buffers are supported, otherwise a {@link Writer***REMOVED***
     */
 ...
 */
type Codegen = (formatStringOrScope?: (string|{ [k: string]: any ***REMOVED***), ...formatParams: any[]) => (Codegen|Function);

/**
 * Event listener as used by {@link util.EventEmitter***REMOVED***.
 * @param args Arguments
 */
