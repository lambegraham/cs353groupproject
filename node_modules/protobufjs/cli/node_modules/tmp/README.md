...
tmp.file({ mode: 0644, prefix: 'prefix-', postfix: '.txt' ***REMOVED***, function _tempFileCreated(err, path, fd) {
  if (err) throw err;
...
var tmpobj = tmp.fileSync({ mode: 0644, prefix: 'prefix-', postfix: '.txt' ***REMOVED***);
console.log('File: ', tmpobj.name);
console.log('Filedescriptor: ', tmpobj.fd);
```
...
tmp.file({ discardDescriptor: true ***REMOVED***, function _tempFileCreated(err, path, fd, cleanupCallback) {
  if (err) throw err;
...
tmp.file({ detachDescriptor: true ***REMOVED***, function _tempFileCreated(err, path, fd, cleanupCallback) {
  if (err) throw err;
...
tmp.dir({ mode: 0750, prefix: 'myTmpDir_' ***REMOVED***, function _tempDirCreated(err, path) {
  if (err) throw err;
...
var tmpobj = tmp.dirSync({ mode: 0750, prefix: 'myTmpDir_' ***REMOVED***);
console.log('Dir: ', tmpobj.name);
```
...
tmp.dir({ template: '/tmp/tmp-XXXXXX' ***REMOVED***, function _tempDirCreated(err, path) {
  if (err) throw err;
...
var tmpobj = tmp.dirSync({ template: '/tmp/tmp-XXXXXX' ***REMOVED***);
console.log('Dir: ', tmpobj.name);
```
...
tmp.tmpName({ template: '/tmp/tmp-XXXXXX' ***REMOVED***, function _tempNameGenerated(err, path) {
    if (err) throw err;
...
```javascript
var tmp = require('tmp');
var tmpname = tmp.tmpNameSync({ template: '/tmp/tmp-XXXXXX' ***REMOVED***);
