...
var tests = [
  { source: 'nested',
    opts: { boundary: 'AaB03x' ***REMOVED***,
    chsize: 32,
    nparts: 2,
    what: 'One nested multipart'
***REMOVED***,
  { source: 'many',
    opts: { boundary: '----WebKitFormBoundaryWLHCs9qmcJJoyjKR' ***REMOVED***,
    chsize: 16,
    nparts: 7,
    what: 'Many parts'
***REMOVED***,
  { source: 'many-wrongboundary',
    opts: { boundary: 'LOLOLOL' ***REMOVED***,
    chsize: 8,
    nparts: 0,
    dicerError: true,
...
***REMOVED***,
  { source: 'nested-full',
    opts: { boundary: 'AaB03x', headerFirst: true ***REMOVED***,
    chsize: 32,
    nparts: 2,
    what: 'One nested multipart with preceding header'
***REMOVED***,
  { source: 'nested-full',
    opts: { headerFirst: true ***REMOVED***,
    chsize: 32,
    nparts: 2,
    setBoundary: 'AaB03x',
...
function next() {
  ...
  var v = tests[t],
      ...
      state = { parts: [], preamble: undefined ***REMOVED***;
