...
import { FirebaseServiceInternals ***REMOVED*** from '@firebase/app-types/private';
import { FirebaseMessaging ***REMOVED*** from '@firebase/messaging-types';
import { CompleteFn, ErrorFn, NextFn, Observer, Unsubscribe ***REMOVED*** from '@firebase/util';
import { MessagePayload ***REMOVED*** from '../interfaces/message-payload';
import { SubscriptionManager ***REMOVED*** from '../models/subscription-manager';
import { TokenDetailsModel ***REMOVED*** from '../models/token-details-model';
import { VapidDetailsModel ***REMOVED*** from '../models/vapid-details-model';
