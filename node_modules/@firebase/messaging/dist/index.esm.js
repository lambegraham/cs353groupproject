...
import { __spread, __awaiter, __generator, __extends, __assign ***REMOVED*** from 'tslib';
import { ErrorFactory, createSubscribe ***REMOVED*** from '@firebase/util';
...
var ERROR_MAP = (_a = {***REMOVED***,
    ...
    _a["failed-serviceworker-registration" /* FAILED_DEFAULT_REGISTRATION */] = 'We are unable to register the ' +
        'default service worker. {$browserErrorMessage***REMOVED***',
    ...
    _a["token-subscribe-failed" /* TOKEN_SUBSCRIBE_FAILED */] = 'A problem occured while subscribing the user to FCM: {$errorInfo***REMOVED***',
    ...
    _a["token-unsubscribe-failed" /* TOKEN_UNSUBSCRIBE_FAILED */] = 'A problem occured while unsubscribing the ' +
        'user from FCM: {$errorInfo***REMOVED***',
    _a["token-update-failed" /* TOKEN_UPDATE_FAILED */] = 'A problem occured while updating the user from FCM: {$errorInfo***REMOVED***',
    ...
    _a["unable-to-resubscribe" /* UNABLE_TO_RESUBSCRIBE */] = 'There was an error while re-subscribing ' +
        ...
        'user on next visit. {$errorInfo***REMOVED***',
...
***REMOVED***)(MessageType || (MessageType = {***REMOVED***));
...
var DbInterface = /** @class */ (function () {
  ...
  ***REMOVED***
    ...
    DbInterface.prototype.get = function (key) {
        return this.createTransaction(function (objectStore) { return objectStore.get(key); ***REMOVED***);
  ***REMOVED***
  ...
  ***REMOVED***
    ...
    DbInterface.prototype.put = function (value) {
        return this.createTransaction(function (objectStore) { return objectStore.put(value); ***REMOVED***, 'readwrite');
  ***REMOVED***
    /** Deletes record(s) from the objectStore that match the given key. */
    DbInterface.prototype.delete = function (key) {
        return this.createTransaction(function (objectStore) { return objectStore.delete(key); ***REMOVED***, 'readwrite');
  ***REMOVED***
    /**
  ...
  ***REMOVED***
    ...
    DbInterface.prototype.createTransaction = function (runRequest, mode) {
        if (mode === void 0) { mode = 'readonly'; ***REMOVED***
        return __awaiter(this, void 0, void 0, function () {
    ...
    DbInterface.prototype.getDb = function () {
        ...
        if (!this.dbPromise) {
            this.dbPromise = new Promise(function (resolve, reject) {
              ...
              ***REMOVED***
                request.onupgradeneeded = function (event) { return _this.onDbUpgrade(request, event); ***REMOVED***;
          ***REMOVED***);
      ***REMOVED***
            ...
            case 0: {
              ...
              ***REMOVED***);
                ...
                objectStore.createIndex('fcmSenderId', 'fcmSenderId', {
                    unique: false
              ***REMOVED***);
                objectStore.createIndex('fcmToken', 'fcmToken', { unique: true ***REMOVED***);
          ***REMOVED***
            case 1: {
            ...
            case 2: {
                ...
                cursorRequest_1.onsuccess = function () {
                    ...
                    if (cursor) {
                        ...
                        var newValue = __assign({***REMOVED***, value);
                        if (!value.createTime) {
    ...
    TokenDetailsModel.prototype.getTokenDetailsFromToken = function (fcmToken) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              ...
              ***REMOVED***
                validateInputs({ fcmToken: fcmToken ***REMOVED***);
    ...
    TokenDetailsModel.prototype.getTokenDetailsFromSWScope = function (swScope) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              ...
              ***REMOVED***
                validateInputs({ swScope: swScope ***REMOVED***);
...
var VapidDetailsModel = /** @class */ (function (_super) {
  ...
  ***REMOVED***
    VapidDetailsModel.prototype.onDbUpgrade = function (request) {
        var db = request.result;
        db.createObjectStore(this.objectStoreName, { keyPath: 'swScope' ***REMOVED***);
  ***REMOVED***
    /**
...
var BaseController = /** @class */ (function () {
    function BaseController(app) {
      ...
      ***REMOVED***
        this.INTERNAL = {
            delete: function () { return _this.delete(); ***REMOVED***
      ***REMOVED***
    ...
    SwController.prototype.getNotificationData_ = function (msgPayload) {
      ...
      ***REMOVED***
        if (typeof msgPayload.notification !== 'object') {
            return;
      ***REMOVED***
        var notificationInformation = __assign({***REMOVED***, msgPayload.notification);
        // Put the message payload under FCM_MSG name so we can identify the
        // notification as being an FCM notification vs a notification from
        // somewhere else (i.e. normal web push or developer generated
        // notification).
        notificationInformation.data = __assign(__assign({***REMOVED***, msgPayload.notification.data), (_a = {***REMOVED***, _a[FCM_MSG] = msgPayload, _a));
...
export { isSupported, registerMessaging ***REMOVED***;
