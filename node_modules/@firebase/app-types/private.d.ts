...
import { Observer, Subscribe ***REMOVED*** from '@firebase/util';
import { FirebaseError, ErrorFactory ***REMOVED*** from '@firebase/util';
...
export interface FirebaseServiceFactory {
  (
    app: FirebaseApp,
    extendApp?: (props: { [prop: string]: any ***REMOVED***) => void,
...
export interface FirebaseAppInternals {
  ...
  analytics: {
    logEvent: (
      ...
      options?: { global: boolean ***REMOVED***
    ) => void;
***REMOVED***
***REMOVED***
...
export interface _FirebaseNamespace extends FirebaseNamespace {
  INTERNAL: {
    ...
    registerService(
      ...
      serviceProperties?: { [prop: string]: any ***REMOVED***,
      appHook?: AppHook,
     ...
     *   namespace.
     */
    extendNamespace(props: { [prop: string]: any ***REMOVED***): void;
     ...
     */
    factories: { [name: string]: FirebaseServiceFactory ***REMOVED***;
