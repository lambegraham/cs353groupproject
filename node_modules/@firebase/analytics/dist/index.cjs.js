...
function logEvent(gtagFunction, analyticsId, eventName, eventParams, options) {
    var params = eventParams || {***REMOVED***;
    if (!options || !options.global) {
        params = tslib.__assign(tslib.__assign({***REMOVED***, eventParams), { 'send_to': analyticsId ***REMOVED***);
  ***REMOVED***
        ...
        return tslib.__generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    gtagCore(GtagCommand.CONFIG, app.options[ANALYTICS_ID_FIELD], (_a = {***REMOVED***,
                        _a[GA_FID_KEY] = fid,
        ...
        if (command === GtagCommand.EVENT) {
          ...
          ***REMOVED***
            ...
            Promise.all(initializationPromisesToWaitFor)
                // Workaround for http://b/141370449 - third argument cannot be undefined.
                .then(function () {
                return gtagCore(GtagCommand.EVENT, idOrNameOrParams, gtagParams || {***REMOVED***);
          ***REMOVED***)
                .catch(function (e) { return console.error(e); ***REMOVED***);
      ***REMOVED***
...
var ERRORS = (_a = {***REMOVED***,
    ...
    _a["already-exists" /* ALREADY_EXISTS */] = 'A Firebase Analytics instance with the measurement ID ${id***REMOVED*** ' +
        ' already exists. ' +
 ...
 */
var initializedIdPromisesMap = {***REMOVED***;
/**
...
function resetGlobalVars(newGlobalInitDone, newGaInitializedPromise) {
    if (newGlobalInitDone === void 0) { newGlobalInitDone = false; ***REMOVED***
    if (newGaInitializedPromise === void 0) { newGaInitializedPromise = {***REMOVED***; ***REMOVED***
