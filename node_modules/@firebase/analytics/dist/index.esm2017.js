...
***REMOVED***)(GtagCommand || (GtagCommand = {***REMOVED***));
/*
...
***REMOVED***)(EventName || (EventName = {***REMOVED***));
...
function logEvent(gtagFunction, analyticsId, eventName, eventParams, options) {
    let params = eventParams || {***REMOVED***;
    if (!options || !options.global) {
        params = Object.assign(Object.assign({***REMOVED***, eventParams), { 'send_to': analyticsId ***REMOVED***);
  ***REMOVED***
    // Workaround for http://b/141370449 - third argument cannot be undefined.
    gtagFunction(GtagCommand.EVENT, eventName, params || {***REMOVED***);
***REMOVED***
...
function setCurrentScreen(gtagFunction, analyticsId, screenName, options) {
    if (options && options.global) {
        gtagFunction(GtagCommand.SET, { 'screen_name': screenName ***REMOVED***);
  ***REMOVED***
    else {
...
function setUserId(gtagFunction, analyticsId, id, options) {
    if (options && options.global) {
        gtagFunction(GtagCommand.SET, { 'user_id': id ***REMOVED***);
  ***REMOVED***
    else {
        gtagFunction(GtagCommand.CONFIG, analyticsId, {
            update: true,
...
function setUserProperties(gtagFunction, analyticsId, properties, options) {
    if (options && options.global) {
        ...
        for (const key of Object.keys(properties)) {
            ...
            flatProperties[`user_properties.${key***REMOVED***`] = properties[key];
      ***REMOVED***
...
function setAnalyticsCollectionEnabled(analyticsId, enabled) {
    window[`ga-disable-${analyticsId***REMOVED***`] = !enabled;
***REMOVED***
...
function insertScriptTag(dataLayerName) {
    ...
    script.src = `https://www.googletagmanager.com/gtag/js?l=${dataLayerName***REMOVED***`;
    script.async = true;
        ...
        if (command === GtagCommand.EVENT) {
          ...
          ***REMOVED***
            ...
            Promise.all(initializationPromisesToWaitFor)
                // Workaround for http://b/141370449 - third argument cannot be undefined.
                .then(() => gtagCore(GtagCommand.EVENT, idOrNameOrParams, gtagParams || {***REMOVED***))
 ...
 */
const ERRORS = {
    ["no-ga-id" /* NO_GA_ID */]: `"${ANALYTICS_ID_FIELD***REMOVED***" field is empty in ` +
        'Firebase config. Firebase Analytics ' +
        'requires this field to contain a valid measurement ID.',
    ["already-exists" /* ALREADY_EXISTS */]: 'A Firebase Analytics instance with the measurement ID ${id***REMOVED*** ' +
        ' already exists. ' +
 ...
 */
let initializedIdPromisesMap = {***REMOVED***;
/**
 ...
 * For testing
 */
function resetGlobalVars(newGlobalInitDone = false, newGaInitializedPromise = {***REMOVED***) {
  ...
  ***REMOVED***
    if (!globalInitDone) {
      ...
      ***REMOVED***
        ...
        const { wrappedGtag, gtagCore ***REMOVED*** = wrapOrCreateGtag(initializedIdPromisesMap, dataLayerName, gtagName);
...
export { factory, registerAnalytics, resetGlobalVars, settings ***REMOVED***;
