...
const CONSTANTS = {
    /**
     * @define {boolean***REMOVED*** Whether this is the client Node.js SDK.
     */
    NODE_CLIENT: false,
    /**
     * @define {boolean***REMOVED*** Whether this is the Admin Node.js SDK.
     */
    NODE_ADMIN: false,
    /**
     * Firebase SDK Version
     */
    SDK_VERSION: '${JSCORE_VERSION***REMOVED***'
***REMOVED***;
  ...
  ***REMOVED***
    create(code, ...data) {
        ...
        for (const key of Object.keys(customData)) {
            if (key.slice(-1) !== '_') {
                if (key in error) {
                    console.warn(`Overwriting FirebaseError base field "${key***REMOVED***" can cause unexpected behavior.`);
              ***REMOVED***
 ...
 *
 * @param {string***REMOVED*** str A string containing JSON.
 ...
 * @return {string***REMOVED*** The JSON contents of the object.
 */
 ...
 * params object (e.g. {arg: 'val', arg2: 'val2'***REMOVED***)
