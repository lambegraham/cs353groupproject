...
class ContextProvider {
  ...
  ***REMOVED***
    async getContext() {
        ...
        return { authToken, instanceIdToken ***REMOVED***;
  ***REMOVED***
***REMOVED***
...
class Service {
  ...
  ***REMOVED***
    ...
    _url(name) {
        ...
        if (this.emulatorOrigin !== null) {
            ...
            return `${origin***REMOVED***/${projectId***REMOVED***/${region***REMOVED***/${name***REMOVED***`;
      ***REMOVED***
        return `https://${region***REMOVED***-${projectId***REMOVED***.cloudfunctions.net/${name***REMOVED***`;
  ***REMOVED***
    /**
  ...
  ***REMOVED***
    ...
    httpsCallable(name, options) {
        return data => {
            return this.call(name, data, options || {***REMOVED***);
      ***REMOVED***
  ***REMOVED***
    /**
  ...
  ***REMOVED***
    ...
    async call(name, data, options) {
      ...
      ***REMOVED***
        ...
        return { data: decodedData ***REMOVED***;
  ***REMOVED***
***REMOVED***
