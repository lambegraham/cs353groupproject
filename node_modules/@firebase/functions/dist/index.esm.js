...
import { __extends, __awaiter, __generator ***REMOVED*** from 'tslib';
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, { authToken: authToken, instanceIdToken: instanceIdToken ***REMOVED***];
              ***REMOVED***
          ***REMOVED***);
      ***REMOVED***);
  ***REMOVED***
...
function mapValues(
// { [k: string]: unknown ***REMOVED*** is no longer a wildcard assignment target after typescript 3.5
// eslint-disable-next-line @typescript-eslint/no-explicit-any
o, f) {
    var result = {***REMOVED***;
    for (var key in o) {
    ...
    Serializer.prototype.encode = function (data) {
      ...
      ***REMOVED***
        if (Array.isArray(data)) {
            return data.map(function (x) { return _this.encode(x); ***REMOVED***);
      ***REMOVED***
        if (typeof data === 'function' || typeof data === 'object') {
            return mapValues(data, function (x) { return _this.encode(x); ***REMOVED***);
      ***REMOVED***
    ...
    Serializer.prototype.decode = function (json) {
      ...
      ***REMOVED***
        if (Array.isArray(json)) {
            return json.map(function (x) { return _this.decode(x); ***REMOVED***);
      ***REMOVED***
        if (typeof json === 'function' || typeof json === 'object') {
            return mapValues(json, function (x) { return _this.decode(x); ***REMOVED***);
      ***REMOVED***
...
var Service = /** @class */ (function () {
    ...
    function Service(app_, region_) {
        var _this = this;
        if (region_ === void 0) { region_ = 'us-central1'; ***REMOVED***
        this.app_ = app_;
  ...
  ***REMOVED***
    ...
    Service.prototype.httpsCallable = function (name, options) {
        ...
        return function (data) {
            return _this.call(name, data, options || {***REMOVED***);
      ***REMOVED***
  ***REMOVED***
    /**
                ...
                switch (_a.label) {
                    ...
                    case 2:
                      ...
                      ***REMOVED***
                        ...
                        return [2 /*return*/, { data: decodedData ***REMOVED***];
              ***REMOVED***
          ***REMOVED***);
      ***REMOVED***);
  ***REMOVED***
...
export { registerFunctions ***REMOVED***;
