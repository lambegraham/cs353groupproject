...
import { LogLevel, Logger ***REMOVED*** from '@firebase/logger';
 ...
 */
/**
 * Implements the {@link RemoteConfigClient***REMOVED*** abstraction with success response caching.
 *
...
class CachingClient {
  ...
  ***REMOVED***
     ...
     * {@link Settings#minimumFetchIntervalInSeconds***REMOVED***.
     *
     * <p>This is comparable to passing `headers = { 'Cache-Control': max-age <maxAge> ***REMOVED***` to the
     * native Fetch API.
     *
    ...
    isCachedDataFresh(cacheMaxAgeMillis, lastSuccessfulFetchTimestampMillis) {
      ...
      ***REMOVED***
        ...
        this.logger.debug('Config fetch cache check.' +
            ` Cache age millis: ${cacheAgeMillis***REMOVED***.` +
            ` Cache max age millis (minimumFetchIntervalMillis setting): ${cacheMaxAgeMillis***REMOVED***.` +
            ` Is cache hit: ${isCachedDataFresh***REMOVED***.`);
...
const ERROR_DESCRIPTION_MAP = {
    ...
    ["storage-open" /* STORAGE_OPEN */]: 'Error thrown when opening storage. Original error: {$originalErrorMessage***REMOVED***.',
    ["storage-get" /* STORAGE_GET */]: 'Error thrown when reading from storage. Original error: {$originalErrorMessage***REMOVED***.',
    ["storage-set" /* STORAGE_SET */]: 'Error thrown when writing to storage. Original error: {$originalErrorMessage***REMOVED***.',
    ["storage-delete" /* STORAGE_DELETE */]: 'Error thrown when deleting from storage. Original error: {$originalErrorMessage***REMOVED***.',
    ["fetch-client-network" /* FETCH_NETWORK */]: 'Fetch client failed to connect to a network. Check Internet connection.' +
        ' Original error: {$originalErrorMessage***REMOVED***.',
    ["fetch-timeout" /* FETCH_TIMEOUT */]: 'The config fetch request timed out. ' +
        ' Configure timeout using "fetchTimeoutMillis" SDK setting.',
    ["fetch-throttle" /* FETCH_THROTTLE */]: 'The config fetch request timed out while in an exponential backoff state.' +
        ' Configure timeout using "fetchTimeoutMillis" SDK setting.' +
        ' Unix timestamp in milliseconds when fetch request throttling ends: {$throttleEndTimeMillis***REMOVED***.',
    ["fetch-client-parse" /* FETCH_PARSE */]: 'Fetch client could not parse response.' +
        ' Original error: {$originalErrorMessage***REMOVED***.',
    ["fetch-status" /* FETCH_STATUS */]: 'Fetch server returned an HTTP error status. HTTP status: {$httpStatus***REMOVED***.'
***REMOVED***;
 ...
 *
 * @param navigatorLanguage Enables tests to override read-only {@link NavigatorLanguage***REMOVED***.
 */
...
class RestClient {
  ...
  ***REMOVED***
     ...
     *
     * @throws a {@link ErrorCode.FETCH_NETWORK***REMOVED*** error if {@link GlobalFetch#fetch***REMOVED*** can't
     * connect to the network.
     * @throws a {@link ErrorCode.FETCH_PARSE***REMOVED*** error if {@link Response#json***REMOVED*** can't parse the
     * fetch response.
     * @throws a {@link ErrorCode.FETCH_STATUS***REMOVED*** error if the service returns an HTTP error status.
     */
    async fetch(request) {
        ...
        const url = `${urlBase***REMOVED***/v1/projects/${this.projectId***REMOVED***/namespaces/${this.namespace***REMOVED***:fetch?key=${this.apiKey***REMOVED***`;
        const headers = {
      ...
      ***REMOVED***
        ...
        if (status !== 304 && status !== 200) {
          ...
          ***REMOVED***);
      ***REMOVED***
        return { status, eTag: responseEtag, config ***REMOVED***;
  ***REMOVED***
***REMOVED***
 ...
 *
 * See {@link https://github.com/FirebasePrivate/firebase-js-sdk/blob/master/packages/firebase/index.d.ts|interface documentation***REMOVED*** for method descriptions.
 */
class RemoteConfig {
    constructor(
  ...
  ***REMOVED***
    /**
     * @throws a {@link ErrorCode.FETCH_CLIENT_TIMEOUT***REMOVED*** if the request takes longer than
     * {@link Settings.fetchTimeoutInSeconds***REMOVED*** or
     * {@link DEFAULT_FETCH_TIMEOUT_SECONDS***REMOVED***.
     */
    async fetch() {
        return new Promise(async (resolve, reject) => {
            ...
            setTimeout(async () => {
                ...
                abortSignal.abort();
          ***REMOVED***, this.settings.fetchTimeoutMillis);
  ...
  ***REMOVED***
    getValue(key) {
        if (!this._isInitializationComplete) {
            this._logger.debug(`A value was requested for key "${key***REMOVED***" before SDK initialization completed.` +
      ...
      ***REMOVED***
        this._logger.debug(`Returning static value for key "${key***REMOVED***".` +
 ...
 */
function getAllKeys(obj1 = {***REMOVED***, obj2 = {***REMOVED***) {
    return Object.keys(Object.assign(Object.assign({***REMOVED***, obj1), obj2));
***REMOVED***
 ...
 */
/**
 * Converts an error event associated with a {@link IDBRequest***REMOVED*** to a {@link FirebaseError***REMOVED***.
 */
 ...
 * ProjectNamespaceKeyFieldValue***REMOVED***.
 *
 * <p>The Remote Config SDK can be used with multiple app installations, and each app can interact
 * with multiple namespaces, so this store uses app (ID + name) and namespace as common parent keys
 * for a set of key-value pairs. See {@link Storage#createCompositeKey***REMOVED***.
 *
 * <p>Visible for testing.
 */
...
***REMOVED***
/**
 * Returns true if the {@link Error***REMOVED*** indicates a fetch request may succeed later.
 */
...
class RetryingClient {
  ...
  ***REMOVED***
     ...
     */
    async attemptFetch(request, { throttleEndTimeMillis, backoffCount ***REMOVED***) {
...
function registerRemoteConfig(firebaseInstance) {
  ...
  ***REMOVED***, undefined, undefined, true /* allowMultipleInstances */);
***REMOVED***
registerRemoteConfig(firebase);

export { registerRemoteConfig ***REMOVED***;
