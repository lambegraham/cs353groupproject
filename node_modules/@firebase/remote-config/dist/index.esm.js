...
import { __awaiter, __generator, __assign ***REMOVED*** from 'tslib';
...
var ERROR_DESCRIPTION_MAP = (_a = {***REMOVED***,
    ...
    _a["storage-open" /* STORAGE_OPEN */] = 'Error thrown when opening storage. Original error: {$originalErrorMessage***REMOVED***.',
    _a["storage-get" /* STORAGE_GET */] = 'Error thrown when reading from storage. Original error: {$originalErrorMessage***REMOVED***.',
    _a["storage-set" /* STORAGE_SET */] = 'Error thrown when writing to storage. Original error: {$originalErrorMessage***REMOVED***.',
    _a["storage-delete" /* STORAGE_DELETE */] = 'Error thrown when deleting from storage. Original error: {$originalErrorMessage***REMOVED***.',
    ...
    _a["fetch-client-parse" /* FETCH_PARSE */] = 'Fetch client could not parse response.' +
        ' Original error: {$originalErrorMessage***REMOVED***.',
    _a["fetch-status" /* FETCH_STATUS */] = 'Fetch server returned an HTTP error status. HTTP status: {$httpStatus***REMOVED***.',
    _a);
...
function getUserLanguage(navigatorLanguage) {
    if (navigatorLanguage === void 0) { navigatorLanguage = navigator; ***REMOVED***
    return (
                    ...
                    case 11:
                      ...
                      ***REMOVED***
                        ...
                        if (status !== 304 && status !== 200) {
                          ...
                          ***REMOVED***);
                      ***REMOVED***
                        return [2 /*return*/, { status: status, eTag: responseEtag, config: config ***REMOVED***];
              ***REMOVED***
          ***REMOVED***);
      ***REMOVED***);
  ***REMOVED***
...
var RemoteConfigAbortSignal = /** @class */ (function () {
  ...
  ***REMOVED***
    RemoteConfigAbortSignal.prototype.abort = function () {
        this.listeners.forEach(function (listener) { return listener(); ***REMOVED***);
  ***REMOVED***
...
var Value = /** @class */ (function () {
    function Value(_source, _value) {
        if (_value === void 0) { _value = DEFAULT_VALUE_FOR_STRING; ***REMOVED***
                                ...
                                case 0:
                                    ...
                                    setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
                                        return __generator(this, function (_a) {
                                            ...
                                            return [2 /*return*/];
                                      ***REMOVED***);
                                  ***REMOVED***); ***REMOVED***, this.settings.fetchTimeoutMillis);
                                    _a.label = 1;
                                case 1:
                                    _a.trys.push([1, 4, , 6]);
...
function getAllKeys(obj1, obj2) {
    if (obj1 === void 0) { obj1 = {***REMOVED***; ***REMOVED***
    if (obj2 === void 0) { obj2 = {***REMOVED***; ***REMOVED***
    return Object.keys(__assign(__assign({***REMOVED***, obj1), obj2));
***REMOVED***
...
var Storage = /** @class */ (function () {
    ...
    function Storage(appId, appName, namespace, openDbPromise) {
        if (openDbPromise === void 0) { openDbPromise = openDatabase(); ***REMOVED***
        this.appId = appId;
