 ...
 *
 * <p>Modeled after the native {@link GlobalFetch***REMOVED*** interface, which is relatively modern and
 * convenient, but simplified for Remote Config's use case.
 *
 * Disambiguation: {@link GlobalFetch***REMOVED*** interface and the Remote Config service define "fetch"
 ...
 *
 * <p>Modeled after the native {@link Request***REMOVED*** interface, but simplified for Remote Config's
 * use case.
 */
export interface FetchRequest {
     ...
     *
     * <p>Comparable to passing `headers = { 'Cache-Control': max-age <maxAge> ***REMOVED***` to the native
     * Fetch API.
     */
     ...
     *
     * <p>Comparable to passing `headers = { 'If-None-Match': <eTag> ***REMOVED***` to the native Fetch API.
     */
    eTag?: string;
***REMOVED***
/**
 ...
 *
 * <p>Modeled after the native {@link Response***REMOVED*** interface, but simplified for Remote Config's
 * use case.
 */
export interface FetchResponse {
     ...
     * those without.
     *
     * <p>{@link RemoteConfigClient***REMOVED*** is modeled after the native {@link GlobalFetch***REMOVED*** interface, so
