...
import { __spreadArrays, __assign ***REMOVED*** from 'tslib';
...
var ERROR_DESCRIPTION_MAP = (_a = {***REMOVED***,
    _a["trace started" /* TRACE_STARTED_BEFORE */] = 'Trace {$traceName***REMOVED*** was started before.',
    _a["trace stopped" /* TRACE_STOPPED_BEFORE */] = 'Trace {$traceName***REMOVED*** is not running.',
    ...
    _a["invalid attribute name" /* INVALID_ATTRIBUTE_NAME */] = 'Attribute name {$attributeName***REMOVED*** is invalid.',
    _a["invalid attribute value" /* INVALID_ATTRIBUTE_VALUE */] = 'Attribute value {$attributeValue***REMOVED*** is invalid.',
    _a["invalide custom metric name" /* INVALID_CUSTOM_METRIC_NAME */] = 'Custom metric name {$customMetricName***REMOVED*** is invalid',
    _a);
...
***REMOVED***)(VisibilityState || (VisibilityState = {***REMOVED***));
...
function getConfig(iid) {
  ...
  ***REMOVED***
    return getRemoteConfig(iid)
        .then(function (config) { return processConfig(config); ***REMOVED***)
        .then(function (config) { return storeConfig(config); ***REMOVED***, 
    /** Do nothing for error, use defaults set in settings service. */ function () { ***REMOVED***);
***REMOVED***
...
function initializePerf() {
    return getDocumentReadyComplete()
        .then(function () { return getIidPromise(); ***REMOVED***)
        .then(function (iid) { return getConfig(iid); ***REMOVED***)
        .then(function () { return changeInitializationStatus(); ***REMOVED***, function () { return changeInitializationStatus(); ***REMOVED***);
***REMOVED***
/**
...
function logTrace(trace) {
  ...
  ***REMOVED***
        ...
        getInitializationPromise().then(function () { return sendTraceLog(trace); ***REMOVED***, function () { return sendTraceLog(trace); ***REMOVED***);
  ***REMOVED***
***REMOVED***
function sendTraceLog(trace) {
    if (getIid()) {
        setTimeout(function () { return getLogger().log(trace, 1 /* Trace */); ***REMOVED***, 0);
  ***REMOVED***
***REMOVED***
function logNetworkRequest(networkRequest) {
  ...
  ***REMOVED***
    if (!settingsService.loggingEnabled ||
        ...
        return;
  ***REMOVED***
    setTimeout(function () { return getLogger().log(networkRequest, 0 /* NetworkRequest */); ***REMOVED***, 0);
***REMOVED***
...
function convertToKeyValueArray(obj) {
    ...
    return keys.map(function (key) { return ({ key: key, value: obj[key] ***REMOVED***); ***REMOVED***);
***REMOVED***
...
var Trace = /** @class */ (function () {
    ...
    function Trace(name, isAuto, traceMeasureName) {
        if (isAuto === void 0) { isAuto = false; ***REMOVED***
        this.name = name;
        this.isAuto = isAuto;
  ...
  ***REMOVED***
    ...
    Trace.createOobTrace = function (navigationTimings, paintTimings, firstInputDelay) {
      ...
      ***REMOVED***
        ...
        if (paintTimings) {
            var firstPaint = paintTimings.find(function (paintObject) { return paintObject.name === FIRST_PAINT; ***REMOVED***);
            if (firstPaint && firstPaint.startTime) {
                trace.putMetric(FIRST_PAINT_COUNTER_NAME, Math.floor(firstPaint.startTime * 1000));
          ***REMOVED***
            var firstContentfulPaint = paintTimings.find(function (paintObject) { return paintObject.name === FIRST_CONTENTFUL_PAINT; ***REMOVED***);
...
function setupOobResources() {
  ...
  ***REMOVED***
    ...
    setTimeout(function () { return setupOobTraces(); ***REMOVED***, 0);
    setTimeout(function () { return setupNetworkRequests(); ***REMOVED***, 0);
    setTimeout(function () { return setupUserTimingTraces(); ***REMOVED***, 0);
***REMOVED***
...
export { registerPerformance ***REMOVED***;
