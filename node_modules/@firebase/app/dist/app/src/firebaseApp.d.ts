 ...
 */
import { FirebaseApp, FirebaseOptions, FirebaseAppConfig ***REMOVED*** from '@firebase/app-types';
import { _FirebaseNamespace, FirebaseService, FirebaseAppInternals ***REMOVED*** from '@firebase/app-types/private';
/**
