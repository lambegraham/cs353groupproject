import { __assign ***REMOVED*** from 'tslib';
import { ErrorFactory, deepExtend, deepCopy, contains, createSubscribe, isBrowser, isNode ***REMOVED*** from '@firebase/util';
...
var ERRORS = (_a = {***REMOVED***,
    _a["no-app" /* NO_APP */] = "No Firebase App '{$appName***REMOVED***' has been created - " +
        'call Firebase App.initializeApp()',
    _a["bad-app-name" /* BAD_APP_NAME */] = "Illegal App name: '{$appName***REMOVED***",
    _a["duplicate-app" /* DUPLICATE_APP */] = "Firebase App named '{$appName***REMOVED***' already exists",
    _a["app-deleted" /* APP_DELETED */] = "Firebase App named '{$appName***REMOVED***' already deleted",
    _a["invalid-app-argument" /* INVALID_APP_ARGUMENT */] = 'firebase.{$appName***REMOVED***() takes either no argument or a ' +
...
var FirebaseAppImpl = /** @class */ (function () {
    function FirebaseAppImpl(options, config, firebase_) {
        ...
        var self = this;
        this.INTERNAL = {
            getUid: function () { return null; ***REMOVED***,
            getToken: function () { return Promise.resolve(null); ***REMOVED***,
            addAuthTokenListener: function (callback) {
                _this.tokenListeners_.push(callback);
                // Make sure callback is called, asynchronously, in the absence of the auth module
                setTimeout(function () { return callback(null); ***REMOVED***, 0);
          ***REMOVED***,
            removeAuthTokenListener: function (callback) {
                _this.tokenListeners_ = _this.tokenListeners_.filter(function (listener) { return listener !== callback; ***REMOVED***);
          ***REMOVED***,
            analytics: {
                logEvent: function () {
      ...
      ***REMOVED***)
          ...
          ***REMOVED***
            return Promise.all(services
                .filter(function (service) { return 'INTERNAL' in service; ***REMOVED***)
                .map(function (service) { return service.INTERNAL.delete(); ***REMOVED***));
      ***REMOVED***)
            .then(function () {
            _this.isDeleted_ = true;
            _this.services_ = {***REMOVED***;
      ***REMOVED***);
  ***REMOVED***
    /**
    ...
    FirebaseAppImpl.prototype._getService = function (name, instanceIdentifier) {
        if (instanceIdentifier === void 0) { instanceIdentifier = DEFAULT_ENTRY_NAME; ***REMOVED***
        this.checkDestroyed_();
...
function createFirebaseNamespaceCore(firebaseAppImpl) {
  ...
  ***REMOVED***
    ...
    function initializeApp(options, rawConfig) {
        if (rawConfig === void 0) { rawConfig = {***REMOVED***; ***REMOVED***
        if (typeof rawConfig !== 'object' || rawConfig === null) {
            var name_1 = rawConfig;
            rawConfig = { name: name_1 ***REMOVED***;
      ***REMOVED***
  ...
  ***REMOVED***
    ...
    function getApps() {
        ...
        return Object.keys(apps).map(function (name) { return apps[name]; ***REMOVED***);
  ***REMOVED***
    /*
    ...
    function registerService(name, createService, serviceProperties, appHook, allowMultipleInstances) {
        if (allowMultipleInstances === void 0) { allowMultipleInstances = false; ***REMOVED***
      ...
      ***REMOVED***
        ...
        function serviceNamespace(appArg) {
            if (appArg === void 0) { appArg = app(); ***REMOVED***
            // @ts-ignore
...
function createFirebaseNamespace() {
    ...
    namespace.INTERNAL = __assign(__assign({***REMOVED***, namespace.INTERNAL), { createFirebaseNamespace: createFirebaseNamespace,
        extendNamespace: extendNamespace,
        createSubscribe: createSubscribe,
        ErrorFactory: ErrorFactory,
        deepExtend: deepExtend ***REMOVED***);
    /**
