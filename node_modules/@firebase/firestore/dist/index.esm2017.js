...
class IndexedDbRemoteDocumentCache {
  ...
  ***REMOVED***
    ...
    getLastDocumentChange(transaction) {
        ...
        let changedDoc;
        return documentsStore
            .iterate({ index: DbRemoteDocument.readTimeIndex, reverse: true ***REMOVED***, (key, dbRemoteDoc, control) => {
      ...
      ***REMOVED***)
            .next(() => {
            return { changedDoc, readTime ***REMOVED***;
      ***REMOVED***);
  ***REMOVED***
    ...
    notifyLocalViewChanges(viewChanges) {
        for (const viewChange of viewChanges) {
            ...
            if (!viewChange.fromCache) {
                ...
                assert(queryData !== null, `Can't set limbo-free snapshot version for unknown target: ${targetId***REMOVED***`);
  ...
  ***REMOVED***
    ...
    getNewDocumentChanges() {
        return this.persistence
            ...
            .then(({ changedDocs, readTime ***REMOVED***) => {
  ...
  ***REMOVED***
    ...
    toTimestamp(timestamp) {
        if (this.options.useProto3Json) {
            ...
            return `${strUntilSeconds***REMOVED***.${nanoStr***REMOVED***Z`;
      ***REMOVED***
        else {
            return {
