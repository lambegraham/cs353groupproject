...
import { Logger, LogLevel as LogLevel$1 ***REMOVED*** from '@firebase/logger';
import { getUA, isReactNative ***REMOVED*** from '@firebase/util';
import { XhrIo, EventType, ErrorCode, createWebChannelTransport, WebChannel ***REMOVED*** from '@firebase/webchannel-wrapper';
...
***REMOVED***)(LogLevel || (LogLevel = {***REMOVED***));
...
function setLogLevel(newLevel) {
    ...
    switch (newLevel) {
        ...
        case LogLevel.SILENT:
            ...
            break;
        default:
            logClient.error(`Firestore (${SDK_VERSION***REMOVED***): Invalid value passed to \`setLogLevel\``);
  ***REMOVED***
***REMOVED***
function debug(tag, msg, ...obj) {
    if (logClient.logLevel <= LogLevel$1.DEBUG) {
        const args = obj.map(argToString);
        logClient.debug(`Firestore (${SDK_VERSION***REMOVED***) [${tag***REMOVED***]: ${msg***REMOVED***`, ...args);
  ***REMOVED***
***REMOVED***
function error(msg, ...obj) {
    if (logClient.logLevel <= LogLevel$1.ERROR) {
        const args = obj.map(argToString);
        logClient.error(`Firestore (${SDK_VERSION***REMOVED***): ${msg***REMOVED***`, ...args);
  ***REMOVED***
***REMOVED***
/**
...
function fail(failure) {
    ...
    const message = `FIRESTORE (${SDK_VERSION***REMOVED***) INTERNAL ASSERTION FAILED: ` + failure;
    error(message);
...
class FirestoreError extends Error {
    constructor(code, message) {
        ...
        this.toString = () => `${this.name***REMOVED***: [code=${this.code***REMOVED***]: ${this.message***REMOVED***`;
  ***REMOVED***
***REMOVED***
...
function validateNoArgs(functionName, args) {
    if (args.length !== 0) {
        throw new FirestoreError(Code.INVALID_ARGUMENT, `Function ${functionName***REMOVED***() does not support arguments, ` +
            'but was called with ' +
...
function validateExactNumberOfArgs(functionName, args, numberOfArgs) {
    if (args.length !== numberOfArgs) {
        throw new FirestoreError(Code.INVALID_ARGUMENT, `Function ${functionName***REMOVED***() requires ` +
...
function validateAtLeastNumberOfArgs(functionName, args, minNumberOfArgs) {
    if (args.length < minNumberOfArgs) {
        throw new FirestoreError(Code.INVALID_ARGUMENT, `Function ${functionName***REMOVED***() requires at least ` +
...
function validateBetweenNumberOfArgs(functionName, args, minNumberOfArgs, maxNumberOfArgs) {
    if (args.length < minNumberOfArgs || args.length > maxNumberOfArgs) {
        throw new FirestoreError(Code.INVALID_ARGUMENT, `Function ${functionName***REMOVED***() requires between ${minNumberOfArgs***REMOVED*** and ` +
            `${maxNumberOfArgs***REMOVED*** arguments, but was called with ` +
            formatPlural(args.length, 'argument') +
            '.');
  ***REMOVED***
***REMOVED***
...
function validateNamedArrayAtLeastNumberOfElements(functionName, value, name, minNumberOfElements) {
    if (!(value instanceof Array) || value.length < minNumberOfElements) {
        throw new FirestoreError(Code.INVALID_ARGUMENT, `Function ${functionName***REMOVED***() requires its ${name***REMOVED*** argument to be an ` +
            'array with at least ' +
            `${formatPlural(minNumberOfElements, 'element')***REMOVED***.`);
  ***REMOVED***
***REMOVED***
/**
...
function validateArgType(functionName, type, position, argument) {
    validateType(functionName, type, `${ordinal(position)***REMOVED*** argument`, argument);
***REMOVED***
/**
...
function validateNamedType(functionName, type, optionName, argument) {
    validateType(functionName, type, `${optionName***REMOVED*** option`, argument);
***REMOVED***
/**
 * Validates the provided named option has the native JavaScript type using
 * typeof checks or is undefined.
...
function validateArrayElements(functionName, optionName, typeDescription, argument, validator) {
    if (!(argument instanceof Array)) {
        throw new FirestoreError(Code.INVALID_ARGUMENT, `Function ${functionName***REMOVED***() requires its ${optionName***REMOVED*** ` +
            `option to be an array, but it was: ${valueDescription(argument)***REMOVED***`);
  ***REMOVED***
    for (let i = 0; i < argument.length; ++i) {
        if (!validator(argument[i])) {
            throw new FirestoreError(Code.INVALID_ARGUMENT, `Function ${functionName***REMOVED***() requires all ${optionName***REMOVED*** ` +
                `elements to be ${typeDescription***REMOVED***, but the value at index ${i***REMOVED*** ` +
                `was: ${valueDescription(argument[i])***REMOVED***`);
      ***REMOVED***
  ***REMOVED***
***REMOVED***
...
function validateNamedPropertyEquals(functionName, inputName, optionName, input, expected) {
  ...
  ***REMOVED***
    ...
    throw new FirestoreError(Code.INVALID_ARGUMENT, `Invalid value ${actualDescription***REMOVED*** provided to function ${functionName***REMOVED***() for option ` +
        `"${optionName***REMOVED***". Acceptable values: ${expectedDescription.join(', ')***REMOVED***`);
***REMOVED***
/**
...
function validateStringEnum(functionName, enums, position, argument) {
    if (!enums.some(element => element === argument)) {
        throw new FirestoreError(Code.INVALID_ARGUMENT, `Invalid value ${valueDescription(argument)***REMOVED*** provided to function ` +
            `${functionName***REMOVED***() for its ${ordinal(position)***REMOVED*** argument. Acceptable ` +
            `values: ${enums.join(', ')***REMOVED***`);
  ***REMOVED***
***REMOVED***
...
function validateType(functionName, type, inputName, input) {
  ...
  ***REMOVED***
    if (!valid) {
        ...
        throw new FirestoreError(Code.INVALID_ARGUMENT, `Function ${functionName***REMOVED***() requires its ${inputName***REMOVED*** ` +
            `to be of type ${type***REMOVED***, but it was: ${description***REMOVED***`);
  ***REMOVED***
***REMOVED***
/**
...
function valueDescription(input) {
  ...
  ***REMOVED***
        ...
        if (input.length > 20) {
            input = `${input.substring(0, 20)***REMOVED***...`;
      ***REMOVED***
  ...
  ***REMOVED***
      ...
      ***REMOVED***
            ...
            if (customObjectName) {
                return `a custom ${customObjectName***REMOVED*** object`;
          ***REMOVED***
            else {
                return 'an object';
          ***REMOVED***
...
function validateDefined(functionName, position, argument) {
    if (argument === undefined) {
        throw new FirestoreError(Code.INVALID_ARGUMENT, `Function ${functionName***REMOVED***() requires a valid ${ordinal(position)***REMOVED*** ` +
...
function validateOptionNames(functionName, options, optionNames) {
    forEach(options, (key, _) => {
        if (optionNames.indexOf(key) < 0) {
            throw new FirestoreError(Code.INVALID_ARGUMENT, `Unknown option '${key***REMOVED***' passed to function ${functionName***REMOVED***(). ` +
                'Available options: ' +
                optionNames.join(', '));
      ***REMOVED***
  ***REMOVED***);
...
function invalidClassError(functionName, type, position, argument) {
    ...
    return new FirestoreError(Code.INVALID_ARGUMENT, `Function ${functionName***REMOVED***() requires its ${ordinal(position)***REMOVED*** ` +
        `argument to be a ${type***REMOVED***, but it was: ${description***REMOVED***`);
***REMOVED***
...
function formatPlural(num, str) {
    return `${num***REMOVED*** ${str***REMOVED***` + (num === 1 ? '' : 's');
***REMOVED***
...
class ResourcePath extends BasePath {
  ...
  ***REMOVED***
    ...
    static fromString(path) {
        ...
        // for legacy reasons and should not be used frequently).
        if (path.indexOf('//') >= 0) {
            throw new FirestoreError(Code.INVALID_ARGUMENT, `Invalid path (${path***REMOVED***). Paths must not contain // in them.`);
      ***REMOVED***
  ...
  ***REMOVED***
    ...
    static fromServerFormat(path) {
        ...
        const addCurrentSegment = () => {
            if (current.length === 0) {
                throw new FirestoreError(Code.INVALID_ARGUMENT, `Invalid field path (${path***REMOVED***). Paths must not be empty, begin ` +
...
***REMOVED***)(TimerId || (TimerId = {***REMOVED***));
/**
...
class AsyncQueue {
  ...
  ***REMOVED***
    ...
    enqueueAfterDelay(timerId, delayMs, op) {
        this.verifyNotFailed();
        assert(delayMs >= 0, `Attempted to schedule an operation with a negative delay of ${delayMs***REMOVED***`);
    ...
    runDelayedOperationsEarly(lastTimerId) {
        ...
        return this.drain().then(() => {
            assert(lastTimerId === TimerId.All ||
                this.containsDelayedOperation(lastTimerId), `Attempted to drain to missing operation ${lastTimerId***REMOVED***`);
...
class SortedMap {
  ...
  ***REMOVED***
    toString() {
        const descriptions = [];
        this.inorderTraversal((k, v) => {
            descriptions.push(`${k***REMOVED***:${v***REMOVED***`);
            return false;
      ***REMOVED***);
        return `{${descriptions.join(', ')***REMOVED******REMOVED***`;
  ***REMOVED***
...
class SortedMapIterator {
  ...
  ***REMOVED***
    getNext() {
        ...
        const result = { key: node.key, value: node.value ***REMOVED***;
        if (this.isReverse) {
            node = node.left;
            while (!node.isEmpty()) {
                this.nodeStack.push(node);
...
class MutationBatch {
  ...
  ***REMOVED***
    ...
    applyToRemoteDocument(docKey, maybeDoc, batchResult) {
        if (maybeDoc) {
            assert(maybeDoc.key.isEqual(docKey), `applyToRemoteDocument: key ${docKey***REMOVED*** should match maybeDoc key
        ${maybeDoc.key***REMOVED***`);
      ***REMOVED***
        const mutationResults = batchResult.mutationResults;
        assert(mutationResults.length === this.mutations.length, `Mismatch between mutations length
      (${this.mutations.length***REMOVED***) and mutation results length
      (${mutationResults.length***REMOVED***).`);
  ...
  ***REMOVED***
    ...
    applyToLocalView(docKey, maybeDoc) {
        if (maybeDoc) {
            assert(maybeDoc.key.isEqual(docKey), `applyToLocalDocument: key ${docKey***REMOVED*** should match maybeDoc key
        ${maybeDoc.key***REMOVED***`);
      ***REMOVED***
...
class IndexedDbMutationQueue {
    ...
    userId, serializer, indexManager, referenceDelegate) {
        ...
        this.documentKeysByBatchId = {***REMOVED***;
  ***REMOVED***
    /**
  ...
  ***REMOVED***
    checkEmpty(transaction) {
        ...
        return mutationsStore(transaction)
            .iterate({ index: DbMutationBatch.userMutationsIndex, range ***REMOVED***, (key, value, control) => {
            empty = false;
            control.done();
      ***REMOVED***)
            .next(() => empty);
  ...
  ***REMOVED***
    addMutationBatch(transaction, localWriteTime, baseMutations, mutations) {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        return mutationStore.add({***REMOVED***).next(batchId => {
  ...
  ***REMOVED***
    lookupMutationBatch(transaction, batchId) {
        return mutationsStore(transaction)
            ...
            .next(dbBatch => {
            if (dbBatch) {
                assert(dbBatch.userId === this.userId, `Unexpected user '${dbBatch.userId***REMOVED***' for mutation batch ${batchId***REMOVED***`);
  ...
  ***REMOVED***
    getNextMutationBatchAfterBatchId(transaction, batchId) {
        ...
        let foundBatch = null;
        return mutationsStore(transaction)
            .iterate({ index: DbMutationBatch.userMutationsIndex, range ***REMOVED***, (key, dbBatch, control) => {
  ...
  ***REMOVED***
    getHighestUnacknowledgedBatchId(transaction) {
        ...
        return mutationsStore(transaction)
            .iterate({ index: DbMutationBatch.userMutationsIndex, range, reverse: true ***REMOVED***, (key, dbBatch, control) => {
  ...
  ***REMOVED***
    getAllMutationBatchesAffectingDocumentKey(transaction, documentKey) {
        ...
        return documentMutationsStore(transaction)
            .iterate({ range: indexStart ***REMOVED***, (indexKey, _, control) => {
            ...
            return mutationsStore(transaction)
                ...
                if (!mutation) {
                    throw fail('Dangling document-mutation reference found: ' +
                        ...
                        batchId);
              ***REMOVED***
                assert(mutation.userId === this.userId, `Unexpected user '${mutation.userId***REMOVED***' for mutation batch ${batchId***REMOVED***`);
  ...
  ***REMOVED***
    getAllMutationBatchesAffectingDocumentKeys(transaction, documentKeys) {
        ...
        documentKeys.forEach(documentKey => {
            ...
            const promise = documentMutationsStore(transaction).iterate({ range ***REMOVED***, (indexKey, _, control) => {
                const [userID, encodedPath, batchID] = indexKey;
                // Only consider rows matching exactly the specific key of
                // interest. Note that because we order by path first, and we
                // order terminators before path separators, we'll encounter all
        ...
        return this.checkEmpty(txn).next(empty => {
          ...
          ***REMOVED***
            ...
            return documentMutationsStore(txn)
                .iterate({ range: startRange ***REMOVED***, (key, _, control) => {
                const userID = key[0];
...
function mutationQueueContainsKey(txn, userId, key) {
    ...
    return documentMutationsStore(txn)
        .iterate({ range: startRange, keysOnly: true ***REMOVED***, (key, value, control) => {
...
function removeMutationBatch(txn, userId, batch) {
    ...
    let numDeleted = 0;
    const removePromise = mutationStore.iterate({ range ***REMOVED***, (key, value, control) => {
        numDeleted++;
...
***REMOVED***)(GeneratorIds || (GeneratorIds = {***REMOVED***));
/**
...
class TargetIdGenerator {
    ...
    constructor(generatorId, seed) {
        ...
        assert((generatorId & RESERVED_BITS) === generatorId, `Generator ID ${generatorId***REMOVED*** contains more than ${RESERVED_BITS***REMOVED*** reserved bits`);
  ...
  ***REMOVED***
    runTransaction(mode, objectStores, transactionFn) {
      ...
      ***REMOVED***)
        ...
        transactionFnResult.catch(() => { ***REMOVED***);
...
class SimpleDbStore {
  ...
  ***REMOVED***
    ...
    iterateSerial(callback) {
        const cursorRequest = this.cursor({***REMOVED***);
        return new PersistencePromise((resolve, reject) => {
  ...
  ***REMOVED***
    options(indexOrRange, range) {
        ...
        if (indexOrRange !== undefined) {
          ...
          ***REMOVED***
      ***REMOVED***
        return { index: indexName, range ***REMOVED***;
  ***REMOVED***
    cursor(options) {
        let direction = 'next';
        if (options.reverse) {
...
function checkForAndReportiOSError(error) {
    ...
    if (iOSVersion >= 12.2 && iOSVersion < 13) {
        ...
        if (error.message.indexOf(IOS_ERROR) >= 0) {
            ...
            const newError = new FirestoreError('internal', `IOS_INDEXEDDB_BUG1: IndexedDb has thrown '${IOS_ERROR***REMOVED***'. This is likely ` +
...
class IndexedDbQueryCache {
  ...
  ***REMOVED***
    getQueryData(transaction, query) {
        ...
        return targetsStore(transaction)
            .iterate({ range, index: DbTarget.queryTargetsIndexName ***REMOVED***, (key, value, control) => {
  ...
  ***REMOVED***
    getMatchingKeysForTargetId(txn, targetId) {
        ...
        return store
            .iterate({ range, keysOnly: true ***REMOVED***, (key, _, control) => {
            const path = decode(key[1]);
  ...
  ***REMOVED***
    containsKey(txn, key) {
        ...
        return documentTargetStore(txn)
            ...
            keysOnly: true,
            range
      ***REMOVED***, ([targetId, path], _, control) => {
...
***REMOVED***)(MutationType || (MutationType = {***REMOVED***));
/**
...
class TransformMutation extends Mutation {
  ...
  ***REMOVED***
    ...
    serverTransformResults(baseDoc, serverTransformResults) {
        ...
        assert(this.fieldTransforms.length === serverTransformResults.length, `server transform result count (${serverTransformResults.length***REMOVED***) ` +
            `should match field transform count (${this.fieldTransforms.length***REMOVED***)`);
...
***REMOVED***)(TypeOrder || (TypeOrder = {***REMOVED***));
...
***REMOVED***)(ServerTimestampBehavior || (ServerTimestampBehavior = {***REMOVED***));
...
class ArrayValue extends FieldValue {
  ...
  ***REMOVED***
    toString() {
        ...
        return `[${descriptions.join(',')***REMOVED***]`;
  ***REMOVED***
***REMOVED***
...
class Document extends MaybeDocument {
  ...
  ***REMOVED***
    data() {
        if (!this.objectValue) {
            ...
            forEach(this.proto.fields || {***REMOVED***, (key, value) => {
  ...
  ***REMOVED***
    toString() {
        return (`Document(${this.key***REMOVED***, ${this.version***REMOVED***, ${this.data().toString()***REMOVED***, ` +
            `{hasLocalMutations: ${this.hasLocalMutations***REMOVED******REMOVED***), ` +
            `{hasCommittedMutations: ${this.hasCommittedMutations***REMOVED******REMOVED***)`);
  ***REMOVED***
...
class NoDocument extends MaybeDocument {
  ...
  ***REMOVED***
    toString() {
        return `NoDocument(${this.key***REMOVED***, ${this.version***REMOVED***)`;
  ***REMOVED***
    get hasPendingWrites() {
...
class UnknownDocument extends MaybeDocument {
    toString() {
        return `UnknownDocument(${this.key***REMOVED***, ${this.version***REMOVED***)`;
  ***REMOVED***
    get hasPendingWrites() {
        return true;
  ***REMOVED***
...
class IndexedDbRemoteDocumentCache {
    /**
     * @param {LocalSerializer***REMOVED*** serializer The document serializer.
     * @param {IndexManager***REMOVED*** indexManager The query indexes that need to be maintained.
     */
  ...
  ***REMOVED***
    ...
    getSizedEntries(transaction, documentKeys) {
        ...
        return this.forEachDbEntry(transaction, documentKeys, (key, dbRemoteDoc) => {
          ...
          ***REMOVED***
      ***REMOVED***).next(() => {
            return { maybeDocuments: results, sizeMap ***REMOVED***;
      ***REMOVED***);
  ***REMOVED***
    forEachDbEntry(transaction, documentKeys, callback) {
      ...
      ***REMOVED***
        ...
        return remoteDocumentsStore(transaction)
            .iterate({ range ***REMOVED***, (potentialKeyRaw, dbRemoteDoc, control) => {
  ...
  ***REMOVED***
    getDocumentsMatchingQuery(transaction, query, sinceReadTime) {
        ...
        const iterationOptions = {***REMOVED***;
  ...
  ***REMOVED***
    getNewDocumentChanges(transaction) {
        ...
        const lastReadTime = this.serializer.toDbTimestampKey(this.lastProcessedReadTime);
        const documentsStore = remoteDocumentsStore(transaction);
        const range = IDBKeyRange.lowerBound(lastReadTime, true);
        return documentsStore
            .iterate({ index: DbRemoteDocument.readTimeIndex, range ***REMOVED***, (_, dbRemoteDoc) => {
            // Unlike `getEntry()` and others, `getNewDocumentChanges()` parses
            // the documents directly since we want to keep sentinel deletes.
            const doc = this.serializer.fromDbRemoteDocument(dbRemoteDoc);
            changedDocs = changedDocs.insert(doc.key, doc);
            this.lastProcessedReadTime = this.serializer.fromDbTimestampKey(dbRemoteDoc.readTime);
      ***REMOVED***)
            .next(() => changedDocs);
  ***REMOVED***
    /**
     ...
     * changes.
     */
    synchronizeLastProcessedReadTime(transaction) {
        const documentsStore = SimpleDb.getStore(transaction, DbRemoteDocument.store);
        ...
        return documentsStore.iterate({ index: DbRemoteDocument.readTimeIndex, reverse: true ***REMOVED***, (key, value, control) => {
            if (value.readTime) {
...
IndexedDbRemoteDocumentCache.RemoteDocumentChangeBuffer = class extends RemoteDocumentChangeBuffer {
  ...
  ***REMOVED***
    applyChanges(transaction) {
        ...
        this.changes.forEach((key, maybeDocument) => {
            ...
            assert(previousSize !== undefined, `Cannot modify a document that wasn't read (for ${key***REMOVED***)`);
            if (maybeDocument) {
  ...
  ***REMOVED***
    getAllFromCache(transaction, documentKeys) {
        ...
        return this.documentCache
            .getSizedEntries(transaction, documentKeys)
            .next(({ maybeDocuments, sizeMap ***REMOVED***) => {
  ...
  ***REMOVED***
    ...
    createOrUpgrade(db, txn, fromVersion, toVersion) {
        assert(fromVersion < toVersion &&
            fromVersion >= 0 &&
            toVersion <= SCHEMA_VERSION, `Unexpected schema upgrade from v${fromVersion***REMOVED*** to v{toVersion***REMOVED***.`);
            ...
            return PersistencePromise.forEach(queues, (queue) => {
                ...
                return mutationsStore
                    ...
                    return PersistencePromise.forEach(dbBatches, (dbBatch) => {
                        assert(dbBatch.userId === queue.userId, `Cannot process batch ${dbBatch.batchId***REMOVED*** from unexpected user`);
                        const batch = this.serializer.fromDbMutationBatch(dbBatch);
                        return removeMutationBatch(txn, queue.userId, batch).next(() => { ***REMOVED***);
                  ***REMOVED***);
              ***REMOVED***);
          ***REMOVED***);
      ***REMOVED***);
  ...
  ***REMOVED***
    createCollectionParentIndex(db, txn) {
      ...
      ***REMOVED***
        ...
        return txn
            .store(DbRemoteDocument.store)
            .iterate({ keysOnly: true ***REMOVED***, (pathSegments, _) => {
      ...
      ***REMOVED***)
            ...
            return txn
                ...
                .iterate({ keysOnly: true ***REMOVED***, ([userID, encodedPath, batchId], _) => {
                const path = decode(encodedPath);
                return addEntry(path.popLast());
          ***REMOVED***);
      ***REMOVED***);
...
function createMutationQueue(db) {
  ...
  ***REMOVED***);
    const mutationBatchesStore = db.createObjectStore(DbMutationBatch.store, {
        ...
        autoIncrement: true
  ***REMOVED***);
    mutationBatchesStore.createIndex(DbMutationBatch.userMutationsIndex, DbMutationBatch.userMutationsKeyPath, { unique: true ***REMOVED***);
...
function upgradeMutationBatchSchemaAndMigrateData(db, txn) {
    ...
    return v1MutationsStore.loadAll().next(existingMutations => {
        ...
        const mutationsStore = db.createObjectStore(DbMutationBatch.store, {
            ...
            autoIncrement: true
      ***REMOVED***);
        mutationsStore.createIndex(DbMutationBatch.userMutationsIndex, DbMutationBatch.userMutationsKeyPath, { unique: true ***REMOVED***);
...
function createQueryCache(db) {
  ...
  ***REMOVED***);
    targetDocumentsStore.createIndex(DbTargetDocument.documentTargetsIndex, DbTargetDocument.documentTargetsKeyPath, { unique: true ***REMOVED***);
    const targetStore = db.createObjectStore(DbTarget.store, {
        keyPath: DbTarget.keyPath
  ***REMOVED***);
    // NOTE: This is unique only because the TargetId is the suffix.
    targetStore.createIndex(DbTarget.queryTargetsIndexName, DbTarget.queryTargetsKeyPath, { unique: true ***REMOVED***);
 ...
 *
 * @param {IDBTransaction***REMOVED*** txn The version upgrade transaction for indexeddb
 */
...
function createRemoteDocumentReadTimeIndex(txn) {
    ...
    remoteDocumentStore.createIndex(DbRemoteDocument.readTimeIndex, DbRemoteDocument.readTimeIndexPath, { unique: false ***REMOVED***);
    remoteDocumentStore.createIndex(DbRemoteDocument.collectionReadTimeIndex, DbRemoteDocument.collectionReadTimeIndexPath, { unique: false ***REMOVED***);
***REMOVED***
/**
...
***REMOVED***)(QueryPurpose || (QueryPurpose = {***REMOVED***));
/**
...
class LruScheduler {
  ...
  ***REMOVED***
    scheduleGC() {
        ...
        debug('LruGarbageCollector', `Garbage collection scheduled in ${delay***REMOVED***ms`);
      ...
      ***REMOVED***
        return this.getCacheSize(txn).next(cacheSize => {
            if (cacheSize < this.params.cacheSizeCollectionThreshold) {
                debug('LruGarbageCollector', `Garbage collection skipped; Cache size ${cacheSize***REMOVED*** ` +
                    `is lower than threshold ${this.params.cacheSizeCollectionThreshold***REMOVED***`);
        ...
        return this.calculateTargetCount(txn, this.params.percentileToCollect)
            ...
            if (sequenceNumbers > this.params.maximumSequenceNumbersToCollect) {
                debug('LruGarbageCollector', 'Capping sequence numbers to collect down ' +
                    `to the maximum of ${this.params.maximumSequenceNumbersToCollect***REMOVED*** ` +
                    `from ${sequenceNumbers***REMOVED***`);
      ...
      ***REMOVED***)
            ...
            if (getLogLevel() <= LogLevel.DEBUG) {
                const desc = 'LRU Garbage Collection\n' +
                    `\tCounted targets in ${countedTargetsTs - startTs***REMOVED***ms\n` +
                    `\tDetermined least recently used ${sequenceNumbersToCollect***REMOVED*** in ` +
                    `${foundUpperBoundTs - countedTargetsTs***REMOVED***ms\n` +
                    `\tRemoved ${targetsRemoved***REMOVED*** targets in ` +
                    `${removedTargetsTs - foundUpperBoundTs***REMOVED***ms\n` +
                    `\tRemoved ${documentsRemoved***REMOVED*** documents in ` +
                    `${removedDocumentsTs - removedTargetsTs***REMOVED***ms\n` +
                    `Total Duration: ${removedDocumentsTs - startTs***REMOVED***ms`;
 ...
 * `enablePersistence()` with `{synchronizeTabs:true***REMOVED***`.
 *
...
class IndexedDbPersistence {
  ...
  ***REMOVED***
     ...
     *
     * @return {Promise<void>***REMOVED*** Whether persistence was enabled.
     */
    start() {
    ...
    canActAsPrimary(txn) {
      ...
      ***REMOVED***)
            ...
            if (this.isPrimary !== canActAsPrimary) {
                debug(LOG_TAG$1, `Client ${canActAsPrimary ? 'is' : 'is not'***REMOVED*** eligible for a primary lease.`);
          ***REMOVED***
        ...
        return this.simpleDb.runTransaction(mode === 'readonly' ? 'readonly' : 'readwrite', ALL_STORES, simpleDbTxn => {
            if (mode === 'readwrite-primary') {
                ...
                return this.verifyPrimaryLease(simpleDbTxn)
                    .next(success => {
                    if (!success) {
                        error(`Failed to obtain primary lease for action '${action***REMOVED***'.`);
                        this.isPrimary = false;
                        this.queue.enqueueAndForget(() => this.primaryStateListener(false));
  ...
  ***REMOVED***
    ...
    isWithinAge(updateTimeMs, maxAgeMs) {
      ...
      ***REMOVED***
            ...
            error(`Detected an update time that is in the future: ${updateTimeMs***REMOVED*** > ${maxAcceptable***REMOVED***`);
            return false;
      ***REMOVED***
        return true;
  ***REMOVED***
    ...
    isClientZombied(clientId) {
        try {
            const isZombied = this.webStorage.getItem(this.zombiedClientLocalStorageKey(clientId)) !==
                null;
            debug(LOG_TAG$1, `Client '${clientId***REMOVED***' ${isZombied ? 'is' : 'is not'***REMOVED*** zombied in LocalStorage`);
            return isZombied;
      ***REMOVED***
        catch (e) {
  ...
  ***REMOVED***
    zombiedClientLocalStorageKey(clientId) {
        return `${ZOMBIED_CLIENTS_KEY_PREFIX***REMOVED***_${this.persistenceKey***REMOVED***_${clientId***REMOVED***`;
  ***REMOVED***
***REMOVED***
/**
  ...
  ***REMOVED***
    ...
    forEachOrphanedDocument(txn, f) {
        ...
        return store
            .iterate({
            index: DbTargetDocument.documentTargetsIndex
      ***REMOVED***, ([targetId, docKey], { path, sequenceNumber ***REMOVED***) => {
            if (targetId === 0) {
...
class LocalStore {
    ...
    persistence, queryEngine, initialUser) {
        ...
        this.queryDataByTarget = {***REMOVED***;
            ...
            return this.localDocuments
              ...
              ***REMOVED***
                return this.mutationQueue
                    ...
                    return { batchId: batch.batchId, changes ***REMOVED***;
              ***REMOVED***);
          ***REMOVED***);
      ***REMOVED***);
  ***REMOVED***
        ...
        return this.persistence.runTransaction('notifyLocalViewChanges', 'readwrite', txn => {
            return PersistencePromise.forEach(viewChanges, (viewChange) => {
                ...
                if (!viewChange.fromCache) {
                    ...
                    assert(queryData !== undefined, `Can't set limbo-free snapshot version for unknown target: ${targetId***REMOVED***`);
    ...
    executeQuery(query, usePreviousResults) {
        ...
        return this.persistence.runTransaction('Execute query', 'readonly', txn => {
          ...
          ***REMOVED***)
                ...
                .next(documents => {
                return { documents, remoteKeys ***REMOVED***;
          ***REMOVED***);
      ***REMOVED***);
  ***REMOVED***
    /**
  ...
  ***REMOVED***
    getDocumentsMatchingQuery(transaction, query, sinceReadTime) {
        ...
        while (iterator.hasNext()) {
            const { key, value: { maybeDocument, readTime ***REMOVED*** ***REMOVED*** = iterator.getNext();
  ...
  ***REMOVED***
    ...
    backoffAndRun(op) {
        ...
        if (this.currentBaseMs > 0) {
            debug(LOG_TAG$4, `Backing off for ${remainingDelayMs***REMOVED*** ms ` +
                `(base delay: ${this.currentBaseMs***REMOVED*** ms, ` +
                `delay with jitter: ${desiredDelayWithJitterMs***REMOVED*** ms, ` +
                `last attempt: ${delaySoFarMs***REMOVED*** ms ago)`);
      ***REMOVED***
...
***REMOVED***)(PersistentStreamState || (PersistentStreamState = {***REMOVED***));
...
class PersistentStream {
  ...
  ***REMOVED***
    ...
    handleStreamClose(error) {
        ...
        debug(LOG_TAG$5, `close with error: ${error***REMOVED***`);
        this.stream = null;
...
***REMOVED***)(OnlineState || (OnlineState = {***REMOVED***));
...
***REMOVED***)(OnlineStateSource || (OnlineStateSource = {***REMOVED***));
...
class OnlineStateTracker {
    ...
    handleWatchStreamStart() {
        if (this.watchStreamFailures === 0) {
            ...
            this.onlineStateTimer = this.asyncQueue.enqueueAfterDelay(TimerId.OnlineStateTimeout, ONLINE_STATE_TIMEOUT_MS, () => {
                ...
                this.logClientOfflineWarningIfNecessary(`Backend didn't respond within ${ONLINE_STATE_TIMEOUT_MS / 1000***REMOVED*** ` +
                    `seconds.`);
    ...
    handleWatchStreamFailure(error) {
      ...
      ***REMOVED***
            ...
            if (this.watchStreamFailures >= MAX_WATCH_STREAM_FAILURES) {
                ...
                this.logClientOfflineWarningIfNecessary(`Connection failed ${MAX_WATCH_STREAM_FAILURES***REMOVED*** ` +
                    `times. Most recent error: ${error.toString()***REMOVED***`);
                this.setAndBroadcast(OnlineState.Offline);
          ***REMOVED***
      ***REMOVED***
  ***REMOVED***
  ...
  ***REMOVED***
    logClientOfflineWarningIfNecessary(details) {
        const message = `Could not reach Cloud Firestore backend. ${details***REMOVED***\n` +
...
***REMOVED***)(RpcCode || (RpcCode = {***REMOVED***));
/**
...
***REMOVED***)(SyncState || (SyncState = {***REMOVED***));
/**
  ...
  ***REMOVED***
    ...
    static fromInitialDocuments(query, documents, mutatedKeys, fromCache) {
        ...
        documents.forEach(doc => {
            changes.push({ type: ChangeType.Added, doc ***REMOVED***);
      ***REMOVED***);
...
***REMOVED***)(WatchTargetChangeState || (WatchTargetChangeState = {***REMOVED***));
...
class RemoteStore {
  ...
  ***REMOVED***
    async disableNetworkInternal() {
        ...
        if (this.writePipeline.length > 0) {
            debug(LOG_TAG$8, `Stopping write stream with ${this.writePipeline.length***REMOVED*** pending writes`);
            this.writePipeline = [];
      ***REMOVED***
  ...
  ***REMOVED***
    ...
    unlisten(targetId) {
      ...
      ***REMOVED***
  ***REMOVED***
    /** {@link TargetMetadataProvider.getQueryDataForTarget***REMOVED*** */
    getQueryDataForTarget(targetId) {
        return this.listenTargets[targetId] || null;
  ***REMOVED***
    /** {@link TargetMetadataProvider.getRemoteKeysForTarget***REMOVED*** */
    ...
    toString() {
      ...
      ***REMOVED***
        if (this.filters.length > 0) {
            str += `, filters: [${this.filters.join(', ')***REMOVED***]`;
      ***REMOVED***
        if (!isNullOrUndefined(this.limit)) {
            str += ', limit: ' + this.limit;
      ***REMOVED***
        if (this.explicitOrderBy.length > 0) {
            str += `, orderBy: [${this.explicitOrderBy.join(', ')***REMOVED***]`;
      ***REMOVED***
        if (this.startAt) {
...
class FieldFilter extends Filter {
    ...
    static create(field, op, value) {
        if (field.isKeyField()) {
            if (op === Operator.IN) {
              ...
              ***REMOVED***), 'Comparing on key with IN, but an array value was not a RefValue');
                return new KeyFieldInFilter(field, value);
          ***REMOVED***
            else {
                assert(value instanceof RefValue, 'Comparing on key, but filter value not a RefValue');
                assert(op !== Operator.ARRAY_CONTAINS && op !== Operator.ARRAY_CONTAINS_ANY, `'${op.toString()***REMOVED***' queries don't make sense on document keys.`);
  ...
  ***REMOVED***
    toString() {
        return `${this.field.canonicalString()***REMOVED*** ${this.op***REMOVED*** ${this.value.value()***REMOVED***`;
  ***REMOVED***
***REMOVED***
...
class OrderBy {
  ...
  ***REMOVED***
    toString() {
        return `${this.field.canonicalString()***REMOVED*** (${this.dir***REMOVED***)`;
  ***REMOVED***
    isEqual(other) {
...
const ISO_REG_EXP = new RegExp(/^\d{4***REMOVED***-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);
...
class JsonProtoSerializer {
  ...
  ***REMOVED***
     ...
     * expects a { value: <number> ***REMOVED*** struct.
     */
    toInt32Value(val) {
  ...
  ***REMOVED***
     ...
     * accepts { value: number ***REMOVED*** to match our serialization in toInt32Value().
     */
    fromInt32Value(val) {
        let result;
      ...
      ***REMOVED***
            ...
            // We accept raw numbers (without the {value: ... ***REMOVED*** wrapper) for
  ...
  ***REMOVED***
    toValue(val) {
        if (val instanceof NullValue) {
            return { nullValue: 'NULL_VALUE' ***REMOVED***;
      ***REMOVED***
        else if (val instanceof BooleanValue) {
            return { booleanValue: val.value() ***REMOVED***;
      ***REMOVED***
        else if (val instanceof IntegerValue) {
            return { integerValue: '' + val.value() ***REMOVED***;
      ***REMOVED***
            ...
            if (this.options.useProto3Json) {
                ...
                if (isNaN(doubleValue)) {
                    return { doubleValue: 'NaN' ***REMOVED***;
              ***REMOVED***
                else if (doubleValue === Infinity) {
                    return { doubleValue: 'Infinity' ***REMOVED***;
              ***REMOVED***
                else if (doubleValue === -Infinity) {
                    return { doubleValue: '-Infinity' ***REMOVED***;
              ***REMOVED***
          ***REMOVED***
            return { doubleValue: val.value() ***REMOVED***;
      ***REMOVED***
        else if (val instanceof StringValue) {
            return { stringValue: val.value() ***REMOVED***;
      ***REMOVED***
        else if (val instanceof ObjectValue) {
            return { mapValue: this.toMapValue(val) ***REMOVED***;
      ***REMOVED***
        else if (val instanceof ArrayValue) {
            return { arrayValue: this.toArrayValue(val) ***REMOVED***;
      ***REMOVED***
  ...
  ***REMOVED***
    fromValue(obj) {
      ...
      ***REMOVED***
            ...
            return this.fromFields(obj.mapValue.fields || {***REMOVED***);
      ***REMOVED***
  ...
  ***REMOVED***
    fromDocument(document, hasCommittedMutations) {
        ...
        return new Document(key, version, { hasCommittedMutations: !!hasCommittedMutations ***REMOVED***, undefined, document, v => this.fromValue(v));
  ***REMOVED***
    toFields(fields) {
        const result = {***REMOVED***;
  ...
  ***REMOVED***
    fromFound(doc) {
        ...
        return new Document(key, version, {***REMOVED***, undefined, doc.found, v => this.fromValue(v));
  ***REMOVED***
    fromMissing(result) {
  ...
  ***REMOVED***
    fromWatchChange(change) {
      ...
      ***REMOVED***
            ...
            const doc = new Document(key, version, {***REMOVED***, undefined, entityChange.document, v => this.fromValue(v));
  ...
  ***REMOVED***
    toMutation(mutation) {
      ...
      ***REMOVED***
            ...
            result = { delete: this.toName(mutation.key) ***REMOVED***;
      ***REMOVED***
  ...
  ***REMOVED***
    fromMutation(proto) {
        ...
        if (proto.update) {
            ...
            const value = this.fromFields(proto.update.fields || {***REMOVED***);
            if (proto.updateMask) {
  ...
  ***REMOVED***
    toPrecondition(precondition) {
      ...
      ***REMOVED***
            ...
            return { exists: precondition.exists ***REMOVED***;
      ***REMOVED***
        else {
  ...
  ***REMOVED***
    toDocumentsTarget(query) {
        return { documents: [this.toQueryPath(query.path)] ***REMOVED***;
  ***REMOVED***
  ...
  ***REMOVED***
    toQueryTarget(query) {
        ...
        const result = { structuredQuery: {***REMOVED*** ***REMOVED***;
      ...
      ***REMOVED***
            ...
            result.structuredQuery.from = [{ collectionId: path.lastSegment() ***REMOVED***];
      ***REMOVED***
  ...
  ***REMOVED***
    toTarget(queryData) {
        ...
        const query = queryData.query;
        if (query.isDocumentQuery()) {
            result = { documents: this.toDocumentsTarget(query) ***REMOVED***;
      ***REMOVED***
        else {
            result = { query: this.toQueryTarget(query) ***REMOVED***;
      ***REMOVED***
    ...
    toFilter(filters) {
      ...
      ***REMOVED***);
        if (protos.length === 1) {
            return protos[0];
      ***REMOVED***
        return { compositeFilter: { op: 'AND', filters: protos ***REMOVED*** ***REMOVED***;
  ***REMOVED***
    fromFilter(filter) {
        if (!filter) {
            return [];
  ...
  ***REMOVED***
    toFieldPathReference(path) {
        return { fieldPath: path.canonicalString() ***REMOVED***;
  ***REMOVED***
          ...
          ***REMOVED***
            ...
            if (oldDoc && newDoc) {
              ...
              ***REMOVED***
                    ...
                    changeSet.track({ type: ChangeType.Metadata, doc: newDoc ***REMOVED***);
                    changeApplied = true;
              ***REMOVED***
          ***REMOVED***
            else if (!oldDoc && newDoc) {
                changeSet.track({ type: ChangeType.Added, doc: newDoc ***REMOVED***);
                changeApplied = true;
          ***REMOVED***
            else if (oldDoc && !newDoc) {
                changeSet.track({ type: ChangeType.Removed, doc: oldDoc ***REMOVED***);
                changeApplied = true;
                if (lastDocInLimit) {
  ...
  ***REMOVED***
    ...
    applyTargetChange(targetChange) {
        if (targetChange) {
            ...
            targetChange.modifiedDocuments.forEach(key => assert(this._syncedDocuments.has(key), `Modified document ${key***REMOVED*** not found in view.`));
...
class SyncEngine {
    ...
    sharedClientState, currentUser) {
        ...
        this.queryViewsByTarget = {***REMOVED***;
        this.limboTargetsByKey = new SortedMap(DocumentKey.comparator);
        this.limboResolutionsByTarget = {***REMOVED***;
        this.limboDocumentRefs = new ReferenceSet();
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.mutationUserCallbacks = {***REMOVED***;
  ...
  ***REMOVED***
    ...
    async applyBatchState(batchId, batchState, error) {
      ...
      ***REMOVED***
            ...
            fail(`Unknown batchState: ${batchState***REMOVED***`);
      ***REMOVED***
    ...
    async synchronizeQueryViewsAndRaiseSnapshots(targets) {
        ...
        for (const targetId of targets) {
          ...
          ***REMOVED***
                ...
                assert(!!query, `Query data for target ${targetId***REMOVED*** not found`);
    ...
    async applyActiveTargetsChange(added, removed) {
      ...
      ***REMOVED***
        for (const targetId of added) {
            ...
            const query = await this.localStore.getQueryForTarget(targetId);
            assert(!!query, `Query data for active target ${targetId***REMOVED*** not found`);
            const queryData = await this.localStore.allocateQuery(query);
            await this.initializeViewAndComputeSnapshot(queryData, 
            /*current=*/ false);
            this.remoteStore.listen(queryData);
  ...
  ***REMOVED***
    ...
    static fromWebStorageEntry(user, batchId, value) {
      ...
      ***REMOVED***
            ...
            error(LOG_TAG$a, `Failed to parse mutation state for ID '${batchId***REMOVED***': ${value***REMOVED***`);
            return null;
      ***REMOVED***
  ***REMOVED***
    toWebStorageJSON() {
  ...
  ***REMOVED***
    ...
    static fromWebStorageEntry(targetId, value) {
      ...
      ***REMOVED***
            ...
            error(LOG_TAG$a, `Failed to parse target state for ID '${targetId***REMOVED***': ${value***REMOVED***`);
            return null;
      ***REMOVED***
  ***REMOVED***
    toWebStorageJSON() {
  ...
  ***REMOVED***
    ...
    static fromWebStorageEntry(clientId, value) {
      ...
      ***REMOVED***
            ...
            error(LOG_TAG$a, `Failed to parse client data for instance '${clientId***REMOVED***': ${value***REMOVED***`);
            return null;
      ***REMOVED***
  ***REMOVED***
***REMOVED***
  ...
  ***REMOVED***
    ...
    static fromWebStorageEntry(value) {
      ...
      ***REMOVED***
            ...
            error(LOG_TAG$a, `Failed to parse online state: ${value***REMOVED***`);
            return null;
      ***REMOVED***
  ***REMOVED***
***REMOVED***
...
class LocalClientState {
  ...
  ***REMOVED***
    addQueryTarget(targetId) {
        assert(!this.activeTargetIds.has(targetId), `Target with ID '${targetId***REMOVED***' already active.`);
...
class WebStorageSharedClientState {
    constructor(queue, platform, persistenceKey, localClientId, initialUser) {
      ...
      ***REMOVED***
        ...
        const escapedPersistenceKey = persistenceKey.replace(/[.*+?^${***REMOVED***()|[\]\\]/g, '\\$&');
        ...
        this.sequenceNumberKey = `${SEQUENCE_NUMBER_KEY_PREFIX***REMOVED***_${persistenceKey***REMOVED***`;
        this.activeClients[this.localClientId] = new LocalClientState();
        this.clientStateKeyRe = new RegExp(`^${CLIENT_STATE_KEY_PREFIX***REMOVED***_${escapedPersistenceKey***REMOVED***_([^_]*)$`);
        this.mutationBatchKeyRe = new RegExp(`^${MUTATION_BATCH_KEY_PREFIX***REMOVED***_${escapedPersistenceKey***REMOVED***_(\\d+)(?:_(.*))?$`);
        this.queryTargetKeyRe = new RegExp(`^${QUERY_TARGET_KEY_PREFIX***REMOVED***_${escapedPersistenceKey***REMOVED***_(\\d+)$`);
        this.onlineStateKey = `${ONLINE_STATE_KEY_PREFIX***REMOVED***_${persistenceKey***REMOVED***`;
  ...
  ***REMOVED***
    ...
    toWebStorageClientStateKey(clientId) {
        assert(clientId.indexOf('_') === -1, `Client key cannot contain '_', but was '${clientId***REMOVED***'`);
        return `${CLIENT_STATE_KEY_PREFIX***REMOVED***_${this.persistenceKey***REMOVED***_${clientId***REMOVED***`;
  ***REMOVED***
    /** Assembles the key for a query state in WebStorage */
    toWebStorageQueryTargetMetadataKey(targetId) {
        return `${QUERY_TARGET_KEY_PREFIX***REMOVED***_${this.persistenceKey***REMOVED***_${targetId***REMOVED***`;
  ***REMOVED***
    /** Assembles the key for a mutation batch in WebStorage */
    toWebStorageMutationBatchKey(batchId) {
        let mutationKey = `${MUTATION_BATCH_KEY_PREFIX***REMOVED***_${this.persistenceKey***REMOVED***_${batchId***REMOVED***`;
        if (this.currentUser.isAuthenticated()) {
            mutationKey += `_${this.currentUser.uid***REMOVED***`;
      ***REMOVED***
        return mutationKey;
  ***REMOVED***
    /**
  ...
  ***REMOVED***
    ...
    fromWebStorageClientState(key, value) {
        ...
        assert(clientId !== null, `Cannot parse client state key '${key***REMOVED***'`);
  ...
  ***REMOVED***
    ...
    fromWebStorageMutationMetadata(key, value) {
        ...
        assert(match !== null, `Cannot parse mutation batch key '${key***REMOVED***'`);
  ...
  ***REMOVED***
    ...
    fromWebStorageQueryTargetMetadata(key, value) {
        ...
        assert(match !== null, `Cannot parse query target key '${key***REMOVED***'`);
  ...
  ***REMOVED***
    async handleMutationBatchEvent(mutationBatch) {
        if (mutationBatch.user.uid !== this.currentUser.uid) {
            debug(LOG_TAG$a, `Ignoring mutation for non-active user ${mutationBatch.user.uid***REMOVED***`);
            return;
      ***REMOVED***
...
class MemorySharedClientState {
  ...
  ***REMOVED***
    shutdown() { ***REMOVED***
    writeSequenceNumber(sequenceNumber) { ***REMOVED***
***REMOVED***
...
function fromDotSeparatedString(path) {
    ...
    if (found >= 0) {
        throw new FirestoreError(Code.INVALID_ARGUMENT, `Invalid field path (${path***REMOVED***). Paths must not contain ` +
            `'~', '*', '/', '[', or ']'`);
  ***REMOVED***
    try {
  ...
  ***REMOVED***
        ...
        throw new FirestoreError(Code.INVALID_ARGUMENT, `Invalid field path (${path***REMOVED***). Paths must not be empty, ` +
...
class OAuthToken {
    constructor(value, user) {
        this.user = user;
        this.type = 'OAuth';
        this.authHeaders = { Authorization: `Bearer ${value***REMOVED***` ***REMOVED***;
  ***REMOVED***
***REMOVED***
...
***REMOVED***)(UserDataSource || (UserDataSource = {***REMOVED***));
function isWrite(dataSource) {
    switch (dataSource) {
        ...
        case UserDataSource.Argument:
            return false;
        default:
            throw fail(`Unexpected case for UserDataSource: ${dataSource***REMOVED***`);
  ***REMOVED***
***REMOVED***
  ...
  ***REMOVED***
    createError(reason) {
        const fieldDescription = this.path === null || this.path.isEmpty()
            ? ''
            : ` (found in field ${this.path.toString()***REMOVED***)`;
        return new FirestoreError(Code.INVALID_ARGUMENT, `Function ${this.methodName***REMOVED***() called with invalid data. ` +
            reason +
            fieldDescription);
  ***REMOVED***
...
class UserDataConverter {
  ...
  ***REMOVED***
    /** Parse document data from a set() call with '{merge:true***REMOVED***'. */
            ...
            for (const stringOrFieldPath of fieldPaths) {
              ...
              ***REMOVED***
                if (!context.contains(fieldPath)) {
                    throw new FirestoreError(Code.INVALID_ARGUMENT, `Field '${fieldPath***REMOVED***' is specified in your field mask but missing from your input data.`);
              ***REMOVED***
  ...
  ***REMOVED***
    ...
    parseUpdateVarargs(methodName, field, value, moreFieldsAndValues) {
        ...
        if (moreFieldsAndValues.length % 2 !== 0) {
            throw new FirestoreError(Code.INVALID_ARGUMENT, `Function ${methodName***REMOVED***() needs to be called with an even number ` +
  ...
  ***REMOVED***
    ...
    parseSentinelFieldValue(value, context) {
        ...
        if (!isWrite(context.dataSource)) {
            throw context.createError(`${value._methodName***REMOVED***() can only be used with update() and set()`);
      ***REMOVED***
        if (context.path === null) {
            throw context.createError(`${value._methodName***REMOVED***() is not currently supported inside arrays`);
      ***REMOVED***
        if (value instanceof DeleteFieldValueImpl) {
  ...
  ***REMOVED***
    ...
    parseScalarValue(value, context) {
      ...
      ***REMOVED***
            ...
            throw context.createError(`Unsupported field value: ${valueDescription(value)***REMOVED***`);
      ***REMOVED***
  ***REMOVED***
...
function fieldPathFromArgument(methodName, path) {
  ...
  ***REMOVED***
        ...
        throw new FirestoreError(Code.INVALID_ARGUMENT, `Function ${methodName***REMOVED***() called with invalid data. ${message***REMOVED***`);
  ***REMOVED***
***REMOVED***
/**
  ...
  behavior.`);
      ...
      ***REMOVED***
            ...
            if (settings.cacheSizeBytes !== CACHE_SIZE_UNLIMITED &&
                ...
                throw new FirestoreError(Code.INVALID_ARGUMENT, `cacheSizeBytes must be at least ${LruParams.MINIMUM_CACHE_SIZE_BYTES***REMOVED***`);
          ***REMOVED***
            else {
...
class Firestore {
    constructor(databaseIdOrApp) {
      ...
      ***REMOVED***
        this._settings = new FirestoreSettings({***REMOVED***);
            ...
            if (value instanceof DocumentReference) {
                ...
                if (!otherDb.isEqual(thisDb)) {
                    throw new FirestoreError(Code.INVALID_ARGUMENT, 'Document reference is for database ' +
                        `${otherDb.projectId***REMOVED***/${otherDb.database***REMOVED*** but should be ` +
                        `for database ${thisDb.projectId***REMOVED***/${thisDb.database***REMOVED***`);
              ***REMOVED***
  ...
  ***REMOVED***
    collectionGroup(collectionId) {
        ...
        if (collectionId.indexOf('/') >= 0) {
            throw new FirestoreError(Code.INVALID_ARGUMENT, `Invalid collection ID '${collectionId***REMOVED***' passed to function ` +
    ...
    get(documentRef) {
        ...
        return this._transaction
          ...
          ***REMOVED***
                ...
                throw fail(`BatchGetDocumentsRequest returned unexpected document type: ${doc.constructor.name***REMOVED***`);
          ***REMOVED***
      ***REMOVED***);
  ***REMOVED***
    ...
    static forPath(path, firestore) {
        if (path.length % 2 !== 0) {
            throw new FirestoreError(Code.INVALID_ARGUMENT, 'Invalid document reference. Document ' +
                ...
                `${path.canonicalString()***REMOVED*** has ${path.length***REMOVED***`);
      ***REMOVED***
    ...
    convertValue(value, options) {
      ...
      ***REMOVED***
            ...
            if (!value.databaseId.isEqual(database)) {
                ...
                error(`Document ${this._key.path***REMOVED*** contains a document ` +
                    `reference within a different database (` +
                    `${value.databaseId.projectId***REMOVED***/${value.databaseId.database***REMOVED***) which is not ` +
                    `supported. It will be treated as a reference in the current ` +
                    `database (${database.projectId***REMOVED***/${database.database***REMOVED***) ` +
                    `instead.`);
          ***REMOVED***
...
class Query$1 {
      ...
      ***REMOVED***
        ...
        if (fieldPath.isKeyField()) {
            if (operator === Operator.ARRAY_CONTAINS ||
                ...
                throw new FirestoreError(Code.INVALID_ARGUMENT, `Invalid Query. You can't perform '${operator.toString()***REMOVED***' ` +
  ...
  ***REMOVED***
    orderBy(field, directionStr) {
      ...
      ***REMOVED***
            ...
            throw new FirestoreError(Code.INVALID_ARGUMENT, `Function Query.orderBy() has unknown direction '${directionStr***REMOVED***', ` +
  ...
  ***REMOVED***
    limit(n) {
        ...
        if (n <= 0) {
            throw new FirestoreError(Code.INVALID_ARGUMENT, `Invalid Query. Query limit (${n***REMOVED***) is invalid. Limit must be ` +
                'positive.');
      ***REMOVED***
  ...
  ***REMOVED***
    ...
    boundFromDocOrFields(methodName, docOrField, fields, before) {
        ...
        if (docOrField instanceof DocumentSnapshot) {
            if (fields.length > 0) {
                throw new FirestoreError(Code.INVALID_ARGUMENT, `Too many arguments provided to ${methodName***REMOVED***().`);
          ***REMOVED***
        ...
        for (const orderBy of this._query.orderBy) {
          ...
          ***REMOVED***
              ...
              ***REMOVED***
                    ...
                    throw new FirestoreError(Code.INVALID_ARGUMENT, `Invalid query. You are trying to start or end a query using a ` +
                        `document for which the field '${field***REMOVED***' (used as the ` +
            ...
            if (orderByComponent.field.isKeyField()) {
                if (typeof rawValue !== 'string') {
                    throw new FirestoreError(Code.INVALID_ARGUMENT, `Invalid query. Expected a string for document ID in ` +
                        `${methodName***REMOVED***(), but got a ${typeof rawValue***REMOVED***`);
              ***REMOVED***
                if (!this._query.isCollectionGroupQuery() &&
                    ...
                    throw new FirestoreError(Code.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by FieldPath.documentId(), ` +
                        `the value passed to ${methodName***REMOVED***() must be a plain document ID, but ` +
                        `'${rawValue***REMOVED***' contains a slash.`);
              ***REMOVED***
                const path = this._query.path.child(ResourcePath.fromString(rawValue));
                if (!DocumentKey.isDocumentKey(path)) {
                    throw new FirestoreError(Code.INVALID_ARGUMENT, `Invalid query. When querying a collection group and ordering by ` +
                        `FieldPath.documentId(), the value passed to ${methodName***REMOVED***() must result in a ` +
                        `valid document path, but '${path***REMOVED***' is not because it contains an odd number ` +
                        `of segments.`);
              ***REMOVED***
    ...
    parseDocumentIdValue(documentIdValue) {
          ...
          ***REMOVED***
            if (!this._query.isCollectionGroupQuery() &&
                ...
                throw new FirestoreError(Code.INVALID_ARGUMENT, `Invalid query. When querying a collection by ` +
                    ...
                    `'${documentIdValue***REMOVED***' contains a '/' character.`);
          ***REMOVED***
            const path = this._query.path.child(ResourcePath.fromString(documentIdValue));
            if (!DocumentKey.isDocumentKey(path)) {
                throw new FirestoreError(Code.INVALID_ARGUMENT, `Invalid query. When querying a collection group by ` +
                    `FieldPath.documentId(), the value provided must result in a valid document path, ` +
                    `but '${path***REMOVED***' is not because it has an odd number of segments (${path.length***REMOVED***).`);
          ***REMOVED***
      ...
      ***REMOVED***
            ...
            throw new FirestoreError(Code.INVALID_ARGUMENT, `Invalid query. When querying with FieldPath.documentId(), you must provide a valid ` +
                ...
                `${valueDescription(documentIdValue)***REMOVED***.`);
      ***REMOVED***
  ***REMOVED***
    /**
    ...
    validateDisjunctiveFilterElements(value, operator) {
        if (!Array.isArray(value) || value.length === 0) {
            throw new FirestoreError(Code.INVALID_ARGUMENT, 'Invalid Query. A non-empty array is required for ' +
                `'${operator.toString()***REMOVED***' filters.`);
      ***REMOVED***
        if (value.length > 10) {
            throw new FirestoreError(Code.INVALID_ARGUMENT, `Invalid Query. '${operator.toString()***REMOVED***' filters support a ` +
                'maximum of 10 elements in the value array.');
      ***REMOVED***
        if (value.indexOf(null) >= 0) {
            throw new FirestoreError(Code.INVALID_ARGUMENT, `Invalid Query. '${operator.toString()***REMOVED***' filters cannot contain 'null' ` +
                'in the value array.');
      ***REMOVED***
        if (value.filter(element => Number.isNaN(element)).length > 0) {
            throw new FirestoreError(Code.INVALID_ARGUMENT, `Invalid Query. '${operator.toString()***REMOVED***' filters cannot contain 'NaN' ` +
                'in the value array.');
      ***REMOVED***
  ***REMOVED***
            ...
            if (filter.isInequality()) {
                ...
                if (existingField !== null && !existingField.isEqual(filter.field)) {
                    throw new FirestoreError(Code.INVALID_ARGUMENT, 'Invalid query. All where filters with an inequality' +
                        ...
                        ` inequality filters on '${existingField.toString()***REMOVED***'` +
                        ` and '${filter.field.toString()***REMOVED***'`);
              ***REMOVED***
                ...
                if (conflictingOp != null) {
                    ...
                    if (conflictingOp === filter.op) {
                        throw new FirestoreError(Code.INVALID_ARGUMENT, 'Invalid query. You cannot use more than one ' +
                            `'${filter.op.toString()***REMOVED***' filter.`);
                  ***REMOVED***
                    else {
                        throw new FirestoreError(Code.INVALID_ARGUMENT, `Invalid query. You cannot use '${filter.op.toString()***REMOVED***' filters ` +
                            `with '${conflictingOp.toString()***REMOVED***' filters.`);
                  ***REMOVED***
              ***REMOVED***
          ***REMOVED***
      ***REMOVED***
    ...
    validateOrderByAndInequalityMatch(inequality, orderBy) {
        if (!orderBy.isEqual(inequality)) {
            throw new FirestoreError(Code.INVALID_ARGUMENT, `Invalid query. You have a where filter with an inequality ` +
                `(<, <=, >, or >=) on field '${inequality.toString()***REMOVED***' ` +
                `and so you must also use '${inequality.toString()***REMOVED***' ` +
                `as your first Query.orderBy(), but your first Query.orderBy() ` +
                `is on field '${orderBy.toString()***REMOVED***' instead.`);
      ***REMOVED***
  ***REMOVED***
***REMOVED***
class QuerySnapshot {
      ...
      ***REMOVED***
        ...
        if (includeMetadataChanges && this._snapshot.excludesMetadataChanges) {
            throw new FirestoreError(Code.INVALID_ARGUMENT, 'To include metadata changes with your document changes, you must ' +
                'also pass { includeMetadataChanges:true ***REMOVED*** to onSnapshot().');
      ***REMOVED***
...
docChangesPropertiesToOverride.forEach(property => {
     ...
     * `{ configurable: false ***REMOVED***`. So we wrap this in a try/catch to ensure that we
    ...
    try {
      ...
      ***REMOVED***);
  ***REMOVED***
    catch (err) { ***REMOVED*** // Ignore this failure intentionally
***REMOVED***);
...
function validateSetOptions(methodName, options) {
  ...
  ***REMOVED***
    ...
    if (options.mergeFields !== undefined && options.merge !== undefined) {
        throw new FirestoreError(Code.INVALID_ARGUMENT, `Invalid options passed to function ${methodName***REMOVED***(): You cannot specify both "merge" ` +
            `and "mergeFields".`);
  ***REMOVED***
    return options;
***REMOVED***
...
function changesFromSnapshot(firestore, includeMetadataChanges, snapshot) {
  ...
  ***REMOVED***
        ...
        return snapshot.docChanges
          ...
          ***REMOVED***
            return { type: resultChangeType(change.type), doc, oldIndex, newIndex ***REMOVED***;
      ***REMOVED***);
  ***REMOVED***
***REMOVED***
    ...
    invokeRPC(rpcName, request, token) {
        ...
        return new Promise((resolve, reject) => {
          ...
          ***REMOVED***);
            ...
            const jsonObj = Object.assign({***REMOVED***, request);
            ...
            const headers = { 'Content-Type': 'text/plain' ***REMOVED***;
    ...
    openStream(rpcName, token) {
        ...
        const request = {
            ...
            messageUrlParams: {
                ...
                database: `projects/${this.databaseId.projectId***REMOVED***/databases/${this.databaseId.database***REMOVED***`
          ***REMOVED***,
            sendRawJson: true,
...
class BrowserPlatform {
  ...
  ***REMOVED***
    newSerializer(databaseId) {
        return new JsonProtoSerializer(databaseId, { useProto3Json: true ***REMOVED***);
  ***REMOVED***
    formatJSON(value) {
...
export { registerFirestore ***REMOVED***;
