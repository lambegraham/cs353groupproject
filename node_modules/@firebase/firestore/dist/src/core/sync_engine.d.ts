...
import { LocalStore ***REMOVED*** from '../local/local_store';
import { DocumentKeySet ***REMOVED*** from '../model/collections';
import { DocumentKey ***REMOVED*** from '../model/document_key';
import { Mutation ***REMOVED*** from '../model/mutation';
import { MutationBatchResult ***REMOVED*** from '../model/mutation_batch';
import { RemoteEvent ***REMOVED*** from '../remote/remote_event';
import { RemoteStore ***REMOVED*** from '../remote/remote_store';
import { RemoteSyncer ***REMOVED*** from '../remote/remote_syncer';
import { FirestoreError ***REMOVED*** from '../util/error';
import { Deferred ***REMOVED*** from '../util/promise';
import { SortedMap ***REMOVED*** from '../util/sorted_map';
import { ClientId, SharedClientState ***REMOVED*** from '../local/shared_client_state';
import { QueryTargetState, SharedClientStateSyncer ***REMOVED*** from '../local/shared_client_state_syncer';
import { Query ***REMOVED*** from './query';
import { Transaction ***REMOVED*** from './transaction';
import { BatchId, MutationBatchState, OnlineState, OnlineStateSource, TargetId ***REMOVED*** from './types';
import { ViewSnapshot ***REMOVED*** from './view_snapshot';
