 ...
 */
import { DatabaseId ***REMOVED*** from '../core/database_info';
import { Direction, FieldFilter, Filter, Operator, OrderBy, Query ***REMOVED*** from '../core/query';
import { SnapshotVersion ***REMOVED*** from '../core/snapshot_version';
import { QueryData ***REMOVED*** from '../local/query_data';
import { Document, MaybeDocument ***REMOVED*** from '../model/document';
import { DocumentKey ***REMOVED*** from '../model/document_key';
import * as fieldValue from '../model/field_value';
import { FieldMask, Mutation, MutationResult ***REMOVED*** from '../model/mutation';
import { FieldPath, ResourcePath ***REMOVED*** from '../model/path';
import * as api from '../protos/firestore_proto_api';
import { FirestoreError ***REMOVED*** from '../util/error';
import { WatchChange, WatchTargetChangeState ***REMOVED*** from './watch_change';
...
export declare class JsonProtoSerializer {
  ...
  ***REMOVED***
    fromFields(object: {***REMOVED***): fieldValue.ObjectValue;
