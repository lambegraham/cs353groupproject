 ...
 */
import { CredentialsProvider, Token ***REMOVED*** from '../api/credentials';
import { SnapshotVersion ***REMOVED*** from '../core/snapshot_version';
import { ProtoByteString, TargetId ***REMOVED*** from '../core/types';
import { QueryData ***REMOVED*** from '../local/query_data';
import { Mutation, MutationResult ***REMOVED*** from '../model/mutation';
import * as api from '../protos/firestore_proto_api';
import { AsyncQueue, TimerId ***REMOVED*** from '../util/async_queue';
import { FirestoreError ***REMOVED*** from '../util/error';
import { ExponentialBackoff ***REMOVED*** from './backoff';
import { Connection, Stream ***REMOVED*** from './connection';
import { JsonProtoSerializer ***REMOVED*** from './serializer';
import { WatchChange ***REMOVED*** from './watch_change';
