 ...
 */
import { Blob ***REMOVED*** from '../api/blob';
import { SnapshotOptions ***REMOVED*** from '../api/database';
import { GeoPoint ***REMOVED*** from '../api/geo_point';
import { Timestamp ***REMOVED*** from '../api/timestamp';
import { DatabaseId ***REMOVED*** from '../core/database_info';
import { DocumentKey ***REMOVED*** from './document_key';
import { FieldMask ***REMOVED*** from './mutation';
import { FieldPath ***REMOVED*** from './path';
 ...
 * (instead of using {***REMOVED***), but there's little benefit.
 *
 ...
 */
export declare type FieldType = null | boolean | number | string | {***REMOVED***;
/**
