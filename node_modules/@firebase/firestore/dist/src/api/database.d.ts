...
import { FirestoreClient ***REMOVED*** from '../core/firestore_client';
import { Query as InternalQuery ***REMOVED*** from '../core/query';
import { Transaction as InternalTransaction ***REMOVED*** from '../core/transaction';
import { ViewSnapshot ***REMOVED*** from '../core/view_snapshot';
import { Document ***REMOVED*** from '../model/document';
import { DocumentKey ***REMOVED*** from '../model/document_key';
import { ResourcePath ***REMOVED*** from '../model/path';
import { AsyncQueue ***REMOVED*** from '../util/async_queue';
import { FieldPath as ExternalFieldPath ***REMOVED*** from './field_path';
import { CompleteFn, ErrorFn, NextFn, PartialObserver, Unsubscribe ***REMOVED*** from './observer';
import { UserDataConverter ***REMOVED*** from './user_data_converter';
/**
