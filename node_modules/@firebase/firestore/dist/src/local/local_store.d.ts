...
import { BatchId, ProtoByteString, TargetId ***REMOVED*** from '../core/types';
import { DocumentKeySet, DocumentMap, MaybeDocumentMap ***REMOVED*** from '../model/collections';
...
import { MutationBatch, MutationBatchResult ***REMOVED*** from '../model/mutation_batch';
import { RemoteEvent ***REMOVED*** from '../remote/remote_event';
import { LocalViewChanges ***REMOVED*** from './local_view_changes';
import { LruGarbageCollector, LruResults ***REMOVED*** from './lru_garbage_collector';
import { Persistence, PersistenceTransaction ***REMOVED*** from './persistence';
import { PersistencePromise ***REMOVED*** from './persistence_promise';
import { QueryData ***REMOVED*** from './query_data';
import { QueryEngine ***REMOVED*** from './query_engine';
