 ...
 */
import { User ***REMOVED*** from '../auth/user';
import { DatabaseInfo ***REMOVED*** from '../core/database_info';
import { SequenceNumberSyncer ***REMOVED*** from '../core/listen_sequence';
import { ListenSequenceNumber ***REMOVED*** from '../core/types';
import { DocumentKey ***REMOVED*** from '../model/document_key';
import { Platform ***REMOVED*** from '../platform/platform';
import { JsonProtoSerializer ***REMOVED*** from '../remote/serializer';
import { AsyncQueue ***REMOVED*** from '../util/async_queue';
import { FirestoreError ***REMOVED*** from '../util/error';
import { IndexedDbIndexManager ***REMOVED*** from './indexeddb_index_manager';
import { IndexedDbQueryCache ***REMOVED*** from './indexeddb_query_cache';
import { IndexedDbRemoteDocumentCache ***REMOVED*** from './indexeddb_remote_document_cache';
import { ActiveTargets, LruDelegate, LruGarbageCollector, LruParams ***REMOVED*** from './lru_garbage_collector';
import { MutationQueue ***REMOVED*** from './mutation_queue';
import { Persistence, PersistenceTransaction, PersistenceTransactionMode, PrimaryStateListener, ReferenceDelegate ***REMOVED*** from './persistence';
import { PersistencePromise ***REMOVED*** from './persistence_promise';
import { QueryData ***REMOVED*** from './query_data';
import { ReferenceSet ***REMOVED*** from './reference_set';
import { ClientId ***REMOVED*** from './shared_client_state';
import { SimpleDbStore, SimpleDbTransaction ***REMOVED*** from './simple_db';
...
export declare class IndexedDbPersistence implements Persistence {
  ...
  ***REMOVED***): Promise<IndexedDbPersistence>;
