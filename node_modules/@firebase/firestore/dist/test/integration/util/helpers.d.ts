...
import { EmptyCredentialsProvider, CredentialChangeListener ***REMOVED*** from '../../../src/api/credentials';
import { User ***REMOVED*** from '../../../src/auth/user';
...
***REMOVED***, fn: (collection: firestore.CollectionReference) => Promise<void>): Promise<void>;
