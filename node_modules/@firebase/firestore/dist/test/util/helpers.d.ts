...
import { Blob ***REMOVED*** from '../../src/api/blob';
import { DocumentKeyReference ***REMOVED*** from '../../src/api/user_data_converter';
import { DatabaseId ***REMOVED*** from '../../src/core/database_info';
import { Bound, FieldFilter, OrderBy ***REMOVED*** from '../../src/core/query';
import { SnapshotVersion ***REMOVED*** from '../../src/core/snapshot_version';
import { ProtoByteString, TargetId ***REMOVED*** from '../../src/core/types';
import { LimboDocumentChange, View, ViewChange ***REMOVED*** from '../../src/core/view';
import { LocalViewChanges ***REMOVED*** from '../../src/local/local_view_changes';
import { QueryData, QueryPurpose ***REMOVED*** from '../../src/local/query_data';
import { DocumentKeySet, MaybeDocumentMap ***REMOVED*** from '../../src/model/collections';
import { Document, DocumentOptions, MaybeDocument, NoDocument, UnknownDocument ***REMOVED*** from '../../src/model/document';
import { DocumentComparator ***REMOVED*** from '../../src/model/document_comparator';
import { DocumentKey ***REMOVED*** from '../../src/model/document_key';
import { DocumentSet ***REMOVED*** from '../../src/model/document_set';
import { FieldValue, JsonObject, ObjectValue ***REMOVED*** from '../../src/model/field_value';
import { DeleteMutation, FieldMask, MutationResult, PatchMutation, Precondition, SetMutation, TransformMutation ***REMOVED*** from '../../src/model/mutation';
import { FieldPath, ResourcePath ***REMOVED*** from '../../src/model/path';
import { RemoteEvent, TargetChange ***REMOVED*** from '../../src/remote/remote_event';
import { Dict ***REMOVED*** from '../../src/util/obj';
import { SortedMap ***REMOVED*** from '../../src/util/sorted_map';
import { SortedSet ***REMOVED*** from '../../src/util/sorted_set';
 ...
 * (i.e. { "foo.bar": FieldValue.foo() ***REMOVED*** and must not contain any non-sentinel
 * data.
 */
...
export declare function bound(values: Array<[string, {***REMOVED***, firestore.OrderByDirection]>, before: boolean): Bound;
