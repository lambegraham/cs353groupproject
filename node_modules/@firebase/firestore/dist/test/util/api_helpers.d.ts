 ...
 */
import { CollectionReference, DocumentReference, DocumentSnapshot, Firestore, Query, QuerySnapshot ***REMOVED*** from '../../src/api/database';
...
***REMOVED***, docsToAdd: {
    [key: string]: JsonObject<unknown>;
***REMOVED***, mutatedKeys: DocumentKeySet, fromCache: boolean, syncStateChanged: boolean): QuerySnapshot;
