 ...
 */
import { Query ***REMOVED*** from '../../../src/core/query';
import { TargetIdGenerator ***REMOVED*** from '../../../src/core/target_id_generator';
import { TargetId ***REMOVED*** from '../../../src/core/types';
import { Document, MaybeDocument, NoDocument ***REMOVED*** from '../../../src/model/document';
import { DocumentKey ***REMOVED*** from '../../../src/model/document_key';
import { JsonObject ***REMOVED*** from '../../../src/model/field_value';
import { Code ***REMOVED*** from '../../../src/util/error';
import { TestSnapshotVersion ***REMOVED*** from '../../util/helpers';
import { TimerId ***REMOVED*** from '../../../src/util/async_queue';
import { RpcError ***REMOVED*** from './spec_rpc_error';
import { SpecConfig, SpecQuery, SpecStep ***REMOVED*** from './spec_test_runner';
...
export declare class SpecBuilder {
  ...
  ***REMOVED***): this;
    ...
    watchSends(targets: {
        affects?: Query[];
        removed?: Query[];
  ***REMOVED***, ...docs: MaybeDocument[]): this;
