...
import { ListResult ***REMOVED*** from '../list';
import { AuthWrapper ***REMOVED*** from './authwrapper';
import { FbsBlob ***REMOVED*** from './blob';
import { FirebaseStorageError ***REMOVED*** from './error';
import { Location ***REMOVED*** from './location';
import * as MetadataUtils from './metadata';
import { RequestInfo ***REMOVED*** from './requestinfo';
import { XhrIo ***REMOVED*** from './xhrio';
/**
