...
import { StringFormat ***REMOVED*** from './implementation/string';
import { Metadata ***REMOVED*** from './metadata';
import { Service ***REMOVED*** from './service';
import { UploadTask ***REMOVED*** from './task';
import { ListOptions, ListResult ***REMOVED*** from './list';
/**
