...
import { __awaiter, __generator, __spreadArrays ***REMOVED*** from 'tslib';
  ...
  ***REMOVED***
    Location.makeFromUrl = function (url) {
      ...
      ***REMOVED***
        ...
        var gsIndices = { bucket: 1, path: 3 ***REMOVED***;
      ...
      ***REMOVED***
        ...
        var httpIndices = { bucket: 1, path: 3 ***REMOVED***;
        var groups = [
...
function child(path, childPath) {
    var canonicalChildPath = childPath
        .split('/')
        .filter(function (component) { return component.length > 0; ***REMOVED***)
        .join('/');
    if (path.length === 0) {
...
function updateMetadata(authWrapper, location, metadata, mappings) {
    ...
    var headers = { 'Content-Type': 'application/json; charset=utf-8' ***REMOVED***;
    var timeout = authWrapper.maxOperationRetryTime();
    var requestInfo = new RequestInfo(url, method, metadataHandler(authWrapper, mappings), timeout);
...
function multipartUpload(authWrapper, location, mappings, blob, metadata) {
  ...
  ***REMOVED***
    var urlParams = { name: metadata_['fullPath'] ***REMOVED***;
    var url = makeUrl(urlPart);
    var method = 'POST';
...
function createResumableUpload(authWrapper, location, mappings, blob, metadata) {
    ...
    var urlParams = { name: metadataForUpload['fullPath'] ***REMOVED***;
    var url = makeUrl(urlPart);
    var method = 'POST';
    var headers = {
...
function getResumableUploadStatus(authWrapper, location, url, blob) {
    var headers = { 'X-Goog-Upload-Command': 'query' ***REMOVED***;
    function handler(xhr) {
...
function async(f) {
    return function () {
      ...
      ***REMOVED***
        ...
        Promise.resolve().then(function () { return f.apply(void 0, argsToForward); ***REMOVED***);
  ***REMOVED***
***REMOVED***
...
var UploadTask = /** @class */ (function () {
    ...
    function UploadTask(ref, authWrapper, location, mappings, blob, metadata) {
        var _this = this;
        if (metadata === void 0) { metadata = null; ***REMOVED***
        this.transferred_ = 0;
      ...
      ***REMOVED***);
        ...
        this.promise_.then(null, function () { ***REMOVED***);
  ***REMOVED***
    UploadTask.prototype.makeProgressCallback_ = function () {
        var _this = this;
        var sizeBefore = this.transferred_;
        return function (loaded) { return _this.updateProgress_(sizeBefore + loaded); ***REMOVED***;
  ***REMOVED***
...
var Reference = /** @class */ (function () {
  ...
  ***REMOVED***
    ...
    Reference.prototype.putString = function (value, format, metadata) {
        if (format === void 0) { format = StringFormat.RAW; ***REMOVED***
  ...
  ***REMOVED***
    ...
    Reference.prototype.listAll = function () {
        ...
        var accumulator = {
            ...
            items: []
      ***REMOVED***
        return this.listAllHelper(accumulator).then(function () { return accumulator; ***REMOVED***);
  ***REMOVED***
...
var RequestMap = /** @class */ (function () {
  ...
  ***REMOVED***
    ...
    RequestMap.prototype.addRequest = function (request) {
        ...
        request
            .getPromise()
            .then(function () { return _this.map.delete(id); ***REMOVED***, function () { return _this.map.delete(id); ***REMOVED***);
  ***REMOVED***
    /**
        ...
        if (this.app_ !== null &&
            ...
            return this.app_.INTERNAL.getToken().then(function (response) {
              ...
              ***REMOVED***
                    ...
                    return null;
              ***REMOVED***
          ***REMOVED***, function () { return null; ***REMOVED***);
      ***REMOVED***
        else {
