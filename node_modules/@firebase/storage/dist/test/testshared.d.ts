...
import { Code, FirebaseStorageError ***REMOVED*** from '../src/implementation/error';
import { Headers, XhrIo ***REMOVED*** from '../src/implementation/xhrio';
import { XhrIoPool ***REMOVED*** from '../src/implementation/xhriopool';
import { SendHook ***REMOVED*** from './xhrio';
...
export declare function makeFakeApp(token: {***REMOVED*** | null, bucketArg?: string): FirebaseApp;
