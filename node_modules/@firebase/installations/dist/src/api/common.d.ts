...
import { CompletedAuthToken, RegisteredInstallationEntry ***REMOVED*** from '../interfaces/installation-entry';
export declare function getInstallationsEndpoint({ projectId ***REMOVED***: AppConfig): string;
...
export declare function getHeaders({ apiKey ***REMOVED***: AppConfig): Headers;
export declare function getHeadersWithAuth(appConfig: AppConfig, { refreshToken ***REMOVED***: RegisteredInstallationEntry): Headers;
