...
import { __awaiter, __generator, __spread, __assign ***REMOVED*** from 'tslib';
...
var ERROR_DESCRIPTION_MAP = (_a = {***REMOVED***,
    ...
    _a["request-failed" /* REQUEST_FAILED */] = '{$requestName***REMOVED*** request failed with error "{$serverCode***REMOVED*** {$serverStatus***REMOVED***: {$serverMessage***REMOVED***"',
...
function extractAppConfig(app) {
  ...
  ***REMOVED***
    ...
    if (!appName || !projectId || !apiKey || !appId) {
        throw ERROR_FACTORY.create("missing-app-config-values" /* MISSING_APP_CONFIG_VALUES */);
  ***REMOVED***
    return { appName: appName, projectId: projectId, apiKey: apiKey, appId: appId ***REMOVED***;
***REMOVED***
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                  ...
                  ***REMOVED***
                    return [4 /*yield*/, retryIfServerError(function () { return fetch(endpoint, request); ***REMOVED***)];
                case 1:
                    response = _b.sent();
 ...
 * limitations under the License.
 */
var VALID_FID_PATTERN = /^[cdef][\w-]{21***REMOVED***$/;
var INVALID_FID = '';
/**
...
function triggerRegistrationIfNecessary(appConfig, installationEntry) {
    if (installationEntry.registrationStatus === 0 /* NOT_STARTED */) {
      ...
      ***REMOVED***
        ...
        return { installationEntry: inProgressEntry, registrationPromise: registrationPromise ***REMOVED***;
  ***REMOVED***
  ...
  ***REMOVED***
        ...
        return { installationEntry: installationEntry ***REMOVED***;
  ***REMOVED***
***REMOVED***
...
function refreshAuthToken(appConfig, forceRefresh) {
    if (forceRefresh === void 0) { forceRefresh = false; ***REMOVED***
    return __awaiter(this, void 0, void 0, function () {
    ...
    return update(appConfig, function (oldEntry) {
      ...
      ***REMOVED***
        ...
        if (hasAuthTokenRequestTimedOut(oldAuthToken)) {
            return __assign(__assign({***REMOVED***, oldEntry), { authToken: { requestStatus: 0 /* NOT_STARTED */ ***REMOVED*** ***REMOVED***);
      ***REMOVED***
        return oldEntry;
  ***REMOVED***);
***REMOVED***
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    authToken = _a.sent();
                    updatedInstallationEntry = __assign(__assign({***REMOVED***, installationEntry), { authToken: authToken ***REMOVED***);
                ...
                case 4:
                    ...
                    return [3 /*break*/, 7];
                case 5:
                    updatedInstallationEntry = __assign(__assign({***REMOVED***, installationEntry), { authToken: { requestStatus: 0 /* NOT_STARTED */ ***REMOVED*** ***REMOVED***);
                    return [4 /*yield*/, set(appConfig, updatedInstallationEntry)];
                case 6:
                    _a.sent();
                    _a.label = 7;
...
function makeAuthTokenRequestInProgressEntry(oldEntry) {
  ...
  ***REMOVED***
    return __assign(__assign({***REMOVED***, oldEntry), { authToken: inProgressAuthToken ***REMOVED***);
***REMOVED***
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (registrationPromise) {
                        ...
                        registrationPromise.catch(function () { ***REMOVED***);
                  ***REMOVED***
                    if (installationEntry.registrationStatus === 2 /* COMPLETED */) {
                        ...
                        refreshAuthToken(appConfig).catch(function () { ***REMOVED***);
                  ***REMOVED***
...
function registerInstallations(instance) {
    ...
    var factoryMethod = function (app) {
        ...
        return {
            app: app,
            getId: function () { return getId(app); ***REMOVED***,
            getToken: function (forceRefresh) { return getToken(app, forceRefresh); ***REMOVED***,
            delete: function () { return deleteInstallation$1(app); ***REMOVED***
      ***REMOVED***
  ***REMOVED***
