...
function getElement(id) {
  ...
  if (!element) {
    throw new Error(`Element not found: ${id***REMOVED***`);
***REMOVED***
  return element;
***REMOVED***
...
***REMOVED*** catch (e) {
    result = e.toString();
***REMOVED***
  requestLogs.unshift(`<p><b>${requestInfo***REMOVED***:</b><br>${result***REMOVED***</p>`);
  requestsElement.innerHTML = requestLogs.join('');
***REMOVED***

function format(o) {
  const escapedString = JSON.stringify(o, null, 2);
  return `<span class="formatted-content">${escapedString***REMOVED***</span>`;
***REMOVED***
...
function getApp() {
  ...
  return {
    name: appName,
    options: { projectId, apiKey, appId ***REMOVED***
***REMOVED***
***REMOVED***
