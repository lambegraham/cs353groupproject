...
import { clear, get, remove, set, update ***REMOVED*** from './idb-manager';
import {
  InstallationEntry,
  RequestStatus
...
&nbsp;
  beforeEach(() =&gt; {
    appConfig1 = { ...getFakeAppConfig(), appName: 'appName1' ***REMOVED***;
    appConfig2 = { ...getFakeAppConfig(), appName: 'appName2' ***REMOVED***;
***REMOVED***);
&nbsp;
  describe('get / set', () =&gt; {
