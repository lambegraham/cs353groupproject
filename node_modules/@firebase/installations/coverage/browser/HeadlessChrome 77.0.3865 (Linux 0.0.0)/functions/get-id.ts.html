...
<span class="cstat-no" title="statement not covered" >    registrationPromise.catch(<span class="fstat-no" title="function not covered" >() =&gt; {***REMOVED***</span>);</span>
***REMOVED***
&nbsp;
  if (installationEntry.registrationStatus === RequestStatus.COMPLETED) {
    ...
    refreshAuthToken(appConfig).catch(<span class="fstat-no" title="function not covered" >() =&gt; {***REMOVED***</span>);
***REMOVED***
&nbsp;
