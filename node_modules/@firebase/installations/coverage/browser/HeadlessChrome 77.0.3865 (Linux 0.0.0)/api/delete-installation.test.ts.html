...
import { deleteInstallation ***REMOVED*** from './delete-installation';
&nbsp;
...
&nbsp;
    ...
    ***REMOVED***
      const expectedEndpoint = `${INSTALLATIONS_API_URL***REMOVED***/projects/projectId/installations/${FID***REMOVED***`;
&nbsp;
