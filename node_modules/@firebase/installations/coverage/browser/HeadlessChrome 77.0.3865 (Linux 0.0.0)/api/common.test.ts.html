...
import { retryIfServerError ***REMOVED*** from './common';
&nbsp;
describe('common', () =&gt; {
...
&nbsp;
    it('retries once if the server returns a 5xx error', async () =&gt; {
      ...
      fetchStub.onCall(0).resolves(new Response(null, { status: 500 ***REMOVED***));
...
&nbsp;
    it('does not retry again if the server returns a 5xx error twice', async () =&gt; {
      const expectedResponse = new Response(null, { status: 500 ***REMOVED***);
      fetchStub.onCall(0).resolves(new Response(null, { status: 500 ***REMOVED***));
      fetchStub.onCall(1).resolves(expectedResponse);
...
&nbsp;
    it('does not retry if the error is not 5xx', async () =&gt; {
      const expectedResponse = new Response(null, { status: 404 ***REMOVED***);
