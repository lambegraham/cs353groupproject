...
import { CompleteChildSource ***REMOVED*** from '../CompleteChildSource';
...
export interface NodeFilter {
     ...
     * @param {!Node***REMOVED*** newChild
     * @param {!Path***REMOVED*** affectedPath
     * @param {!CompleteChildSource***REMOVED*** source
     * @param {?ChildChangeAccumulator***REMOVED*** optChangeAccumulator
     * @return {!Node***REMOVED***
     */
     ...
     *
     * @param {!Node***REMOVED*** oldSnap
     * @param {!Node***REMOVED*** newSnap
     * @param {?ChildChangeAccumulator***REMOVED*** optChangeAccumulator
     * @return {!Node***REMOVED***
     */
     ...
     *
     * @param {!Node***REMOVED*** oldSnap
     * @param {!Node***REMOVED*** newPriority
     * @return {!Node***REMOVED***
     */
