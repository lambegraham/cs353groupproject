 ...
 * @param {Array<Array>***REMOVED*** pathAndEvents an array of tuples of [Firebase, [event type strings]]
 * @param {string=***REMOVED*** helperName
 * @return {{waiter: waiter, watchesInitializedWaiter: watchesInitializedWaiter, unregister: unregister, addExpectedEvents: addExpectedEvents***REMOVED******REMOVED***
 */
