...
const fatal = function (...var_args) {
    const message = `FIREBASE FATAL ERROR: ${buildLogMessage_(...var_args)***REMOVED***`;
    logClient.error(message);
 ...
 * @private
 */
const INTEGER_REGEXP_ = new RegExp('^-?(0*)\\d{1,10***REMOVED***$');
/**
  ...
  ***REMOVED***
    for (const segment of queryString.split('&')) {
      ...
      ***REMOVED***
            ...
            warn(`Invalid query segment '${segment***REMOVED***' in query '${queryString***REMOVED***'`);
      ***REMOVED***
  ***REMOVED***
    return results;
***REMOVED***
...
class ChildEventRegistration {
  ...
  ***REMOVED***
    ...
    createEvent(change, query) {
        ...
        const ref = query.getRef().child(/** @type {!string***REMOVED*** */ change.childName);
        const index = query.getQueryParams().getIndex();
...
class Query {
  ...
  ***REMOVED***
    ...
    once(eventType, userCallback, failureCallbackOrContext, context) {
        ...
        deferred.promise.catch(() => { ***REMOVED***);
  ...
  ***REMOVED***
    ...
    static getCancelAndContextArgs_(fnName, cancelOrContext, context) {
        const ret = { cancel: null, context: null ***REMOVED***;
...
class EventEmitter {
  ...
  ***REMOVED***
    on(eventType, callback, context) {
        ...
        this.listeners_[eventType].push({ callback, context ***REMOVED***);
    ...
    open(onMessage, onDisconnect) {
        ...
        try {
            if (isNodeSdk()) {
                ...
                const options = {
                    headers: {
                        'User-Agent': `Firebase/${PROTOCOL_VERSION***REMOVED***/${SDK_VERSION***REMOVED***/${process.platform***REMOVED***/${device***REMOVED***`
                  ***REMOVED***
              ***REMOVED***
  ...
  ***REMOVED***
    static isAvailable() {
        ...
        if (typeof navigator !== 'undefined' && navigator.userAgent) {
            const oldAndroidRegex = /Android ([0-9]{0,***REMOVED***\.[0-9]{0,***REMOVED***)/;
...
class Connection {
  ...
  ***REMOVED***
    ...
    sendRequest(dataMsg) {
        ...
        const msg = { t: 'd', d: dataMsg ***REMOVED***;
        this.sendData_(msg);
  ***REMOVED***
...
class PersistentConnection extends ServerActions {
  ...
  ***REMOVED***
    sendRequest(action, body, onResponse) {
        ...
        const msg = { r: curReqNum, a: action, b: body ***REMOVED***;
  ...
  ***REMOVED***
    sendListen_(listenSpec) {
        ...
        const req = { /*path*/ p: pathString ***REMOVED***;
        const action = 'q';
        ...
        if (payload && typeof payload === 'object' && contains(payload, 'w')) {
            ...
            if (Array.isArray(warnings) && ~warnings.indexOf('no_index')) {
                ...
                warn(`Using an unspecified index. Your data will be downloaded and ` +
                    `filtered on the client. Consider adding ${indexSpec***REMOVED*** at ` +
                    `${indexPath***REMOVED*** to your security rules for better performance.`);
          ***REMOVED***
      ***REMOVED***
  ***REMOVED***
    /**
  ...
  ***REMOVED***
    ...
    tryAuth() {
        if (this.connected_ && this.authToken_) {
            ...
            const requestData = { cred: token ***REMOVED***;
  ...
  ***REMOVED***
    sendOnDisconnect_(action, pathString, data, onComplete) {
        const request = { /*path*/ p: pathString, /*data*/ d: data ***REMOVED***;
  ...
  ***REMOVED***
    ...
    reportStats(stats) {
        ...
        if (this.connected_) {
            const request = { /*counters*/ c: stats ***REMOVED***;
...
class ReadonlyRestClient extends ServerActions {
  ...
  ***REMOVED***
     ...
     * @private
     */
    restRequest_(pathString, queryStringParameters = {***REMOVED***, callback) {
...
Repo.prototype.startTransaction = function (path, transactionUpdate, onComplete, applyLocally) {
    ...
    const valueCallback = function () { ***REMOVED***;
          ...
          ***REMOVED***)(queue[i].unwatcher);
            if (queue[i].onComplete) {
                if (abortReason === 'nodata') {
                    ...
                    const lastInput /** @type {!Node***REMOVED*** */ = queue[i].currentInputSnapshot;
...
class RepoManager {
  ...
  ***REMOVED***
    ...
    databaseFromApp(app, url) {
      ...
      ***REMOVED***
        if (dbEmulatorHost) {
            dbUrl = `http://${dbEmulatorHost***REMOVED***?ns=${repoInfo.namespace***REMOVED***`;
  ...
  ***REMOVED***
    ...
    deleteRepo(repo) {
        ...
        if (!appRepos || safeGet(appRepos, repo.repoInfo_.toURLString()) !== repo) {
            fatal(`Database ${repo.app.name***REMOVED***(${repo.repoInfo_***REMOVED***) has already been deleted.`);
      ***REMOVED***
        repo.interrupt();
