...
declare namespace firebase {
  ...
  interface FirebaseError {
     ...
     * {@link https://firebase.google.com/support/ Firebase Support***REMOVED*** to help
...
***REMOVED***
  ...
  interface User extends firebase.UserInfo {
     ...
     * {@link firebase.User.reauthenticateWithCredential***REMOVED***.
     *
     * <h4>Error Codes</h4>
     * <dl>
     * <dt>auth/requires-recent-login</dt>
     * <dd>Thrown if the user's last sign-in time does not meet the security
     *     threshold. Use {@link firebase.User.reauthenticateWithCredential***REMOVED*** to
     ...
     *     <code>error.credential</code> ({@link firebase.auth.AuthCredential***REMOVED***)
     ...
     *     via {@link firebase.auth.Auth.signInWithCredential***REMOVED***.</dd>
     ...
     *     ({@link firebase.auth.AuthCredential***REMOVED***) fields are also provided.
     *     You have to link the credential to the existing user with that email if
     *     you wish to continue signing in with that credential. To do so, call
     *     {@link firebase.auth.Auth.fetchSignInMethodsForEmail***REMOVED***, sign in to
     *     <code>error.email</code> via one of the providers returned and then
     *     {@link firebase.User.linkWithCredential***REMOVED*** the original credential to that
     ...
     *     {@link firebase.auth.EmailAuthProvider.credential***REMOVED*** is invalid.</dd>
     * <dt>auth/wrong-password</dt>
     * <dd>Thrown if the password used in a
     *     {@link firebase.auth.EmailAuthProvider.credential***REMOVED*** is not correct or
     ...
     *     {@link firebase.auth.PhoneAuthProvider.credential***REMOVED*** and the verification
     ...
     * {@link firebase.User.linkWithCredential***REMOVED*** instead.
     *
     ...
     *     {@link firebase.auth.Auth.signInWithCredential***REMOVED***.</dd>
     * <dt>auth/operation-not-allowed</dt>
     ...
     *     ({@link firebase.auth.AuthCredential***REMOVED***) fields are also provided. You can
     ...
     * such as {@link firebase.User.updatePassword***REMOVED*** that require tokens from recent
     * sign-in attempts.
     *
     * <h4>Error Codes</h4>
     * <dl>
     ...
     * <dt>auth/wrong-password</dt>
     * <dd>Thrown if the password used in a
     *     {@link firebase.auth.EmailAuthProvider.credential***REMOVED*** is not correct or when
     ...
     * {@link firebase.User.reauthenticateWithCredential***REMOVED*** instead.
     *
     * @param credential
     */
     ...
     * {@link firebase.auth.Auth.applyActionCode***REMOVED***
     *
     * <h4>Error Codes</h4>
     * <dl>
     ...
     * user.updateProfile({photoURL: null***REMOVED***).then(function() {
     *   // Profile updated successfully!
...
***REMOVED***
  ...
  /**
   * Retrieves a Firebase {@link firebase.app.App app***REMOVED*** instance.
   *
  ...
  /**
   * Gets the {@link firebase.auth.Auth `Auth`***REMOVED*** service for the default app or a
   * given app.
   *
   * `firebase.auth()` can be called with no arguments to access the default app's
   * {@link firebase.auth.Auth `Auth`***REMOVED*** service or as `firebase.auth(app)` to
   * access the {@link firebase.auth.Auth `Auth`***REMOVED*** service associated with a
   * specific app.
   *
   * @example
   * ```javascript
  ...
  /**
   * Gets the {@link firebase.database.Database `Database`***REMOVED*** service for the
   * default app or a given app.
   *
   * `firebase.database()` can be called with no arguments to access the default
   * app's {@link firebase.database.Database `Database`***REMOVED*** service or as
   * `firebase.database(app)` to access the
   * {@link firebase.database.Database `Database`***REMOVED*** service associated with a
   * specific app.
   *
  ...
  /**
   * Creates and initializes a Firebase {@link firebase.app.App app***REMOVED*** instance.
   *
   * See
   * {@link
   *   https://firebase.google.com/docs/web/setup#add_firebase_to_your_app
   *   Add Firebase to your app***REMOVED*** and
   * {@link
   *   https://firebase.google.com/docs/web/setup#multiple-projects
   *   Initialize multiple projects***REMOVED*** for detailed documentation.
   *
   * @example
   * ```javascript
   *
   ...
   *
   * @return {!firebase.app.App***REMOVED*** The initialized app.
   */
  function initializeApp(options: Object, name?: string): firebase.app.App;

  /**
   * Gets the {@link firebase.messaging.Messaging `Messaging`***REMOVED*** service for the
   * default app or a given app.
   *
   * `firebase.messaging()` can be called with no arguments to access the default
   * app's {@link firebase.messaging.Messaging `Messaging`***REMOVED*** service or as
   * `firebase.messaging(app)` to access the
   * {@link firebase.messaging.Messaging `Messaging`***REMOVED*** service associated with a
   * specific app.
   *
  ...
  /**
   * Gets the {@link firebase.storage.Storage `Storage`***REMOVED*** service for the default
   * app or a given app.
   *
   * `firebase.storage()` can be called with no arguments to access the default
   * app's {@link firebase.storage.Storage `Storage`***REMOVED*** service or as
   * `firebase.storage(app)` to access the
   * {@link firebase.storage.Storage `Storage`***REMOVED*** service associated with a
   * specific app.
   *
   * @webonly
   *
  ...
  /**
   * Gets the {@link firebase.performance.Performance `Performance`***REMOVED*** service.
   *
   * `firebase.performance()` can be called with no arguments to access the default
   * app's {@link firebase.performance.Performance `Performance`***REMOVED*** service.
   * The {@link firebase.performance.Performance `Performance`***REMOVED*** service does not work with
   * any other app.
   *
   * @webonly
   *
  ...
  /**
   * Gets the {@link firebase.remoteConfig.RemoteConfig `RemoteConfig`***REMOVED*** instance.
   *
   * @webonly
   *
   * @example
  ...
  /**
   * Gets the {@link firebase.analytics.Analytics `Analytics`***REMOVED*** service.
   *
   * `firebase.analytics()` can be called with no arguments to access the default
   * app's {@link firebase.analytics.Analytics `Analytics`***REMOVED*** service.
   *
   * @webonly
   *
   * @example
...
declare namespace firebase.app {
   ...
   * {@link firebase.initializeApp|`firebase.initializeApp()`***REMOVED*** to create an app.
   *
   */
  interface App {
    /**
     * Gets the {@link firebase.auth.Auth `Auth`***REMOVED*** service for the current app.
     *
     * @example
     * ```javascript
     * var auth = app.auth();
    ...
    delete(): Promise<any>;
    /**
     * Gets the {@link firebase.installations.Installations `Installations`***REMOVED*** service for the
     * current app.
     *
     * @webonly
     *
     ...
     * parameters given in
     * {@link firebase.initializeApp `firebase.initializeApp()`***REMOVED***.
     *
     * @example
     * ```javascript
    ...
    options: Object;
    /**
     * Gets the {@link firebase.storage.Storage `Storage`***REMOVED*** service for the current
    ...
    /**
     * Gets the {@link firebase.performance.Performance `Performance`***REMOVED*** service for the
    ...
    /**
     * Gets the {@link firebase.analytics.Analytics `Analytics`***REMOVED*** service for the
     * current app. If the current app is not the default one, throws an error.
     *
     * @webonly
     *
...
declare namespace firebase.installations {
   ...
   *
   * Do not call this constructor directly. Instead, use
   * {@link firebase.installations `firebase.installations()`***REMOVED***.
   */
...
declare namespace firebase.performance {
   ...
   *
   * Do not call this constructor directly. Instead, use
   * {@link firebase.performance `firebase.performance()`***REMOVED***.
   */
  export interface Performance {
    /**
     * Creates an uninitialized instance of {@link firebase.performance.Trace `trace`***REMOVED*** and returns
     * it.
     *
...
***REMOVED***
  ...
  export interface Trace {
    /**
     * Starts the timing for the {@link firebase.performance.Trace `trace`***REMOVED*** instance.
     */
    start(): void;
    /**
     * Stops the timing of the {@link firebase.performance.Trace `trace`***REMOVED*** instance and logs the
     * data of the instance.
     */
    stop(): void;
    /**
     * Records a {@link firebase.performance.Trace `trace`***REMOVED*** from given parameters. This provides a
     * direct way to use {@link firebase.performance.Trace `trace`***REMOVED*** without a need to start/stop.
     * This is useful for use cases in which the {@link firebase.performance.Trace `trace`***REMOVED*** cannot
    ...
    ***REMOVED***
     ...
     * a metric with that name already exists on the {@link firebase.performance.Trace `trace`***REMOVED***
     * instance or not.
     *
    ...
    /**
     * Set a custom attribute of a {@link firebase.performance.Trace `trace`***REMOVED*** to a certain value.
     *
    ...
    /**
     * Removes the specified custom attribute from a {@link firebase.performance.Trace `trace`***REMOVED***
     * instance.
     *
     * @param attr Name of the custom attribute.
     */
    ...
    /**
     * Returns a map of all custom attributes of a {@link firebase.performance.Trace `trace`***REMOVED***
     * instance.
     */
...
declare namespace firebase.remoteConfig {
   ...
   *
   * Do not call this constructor directly. Instead, use
   * {@link firebase.remoteConfig `firebase.remoteConfig()`***REMOVED***.
   */
  export interface RemoteConfig {
     ...
     */
    defaultConfig: { [key: string]: string | number | boolean ***REMOVED***;

    /**
     * The Unix timestamp in milliseconds of the last <i>successful</i> fetch, or negative one if
     * the {@link RemoteConfig***REMOVED*** instance either hasn't fetched or initialization
     * is incomplete.
     */
     ...
     * Gets all config.
     */
    getAll(): { [key: string]: Value ***REMOVED***;
    ...
    /**
     * Gets the {@link Value***REMOVED*** for the given key.
     */
...
***REMOVED***
  ...
  export interface Value {
    ...
    /**
     * Gets the {@link ValueSource***REMOVED*** for the given key.
     */
...
***REMOVED***
   ...
   *
   * <ul>
   *   <li>"no-fetch-yet" indicates the {@link RemoteConfig***REMOVED*** instance has not yet attempted
...
***REMOVED***
   ...
   *
   * Do not call this constructor directly. Instead, use
   * {@link firebase.functions `firebase.functions()`***REMOVED***.
   */
...
declare namespace firebase.auth {
  ...
  class ActionCodeURL {
     ...
     * of the types from {@link firebase.auth.ActionCodeInfo***REMOVED***.
     */
...
***REMOVED***
  /**
   * A response from {@link firebase.auth.Auth.checkActionCode***REMOVED***.
   */
  ...
  ***REMOVED***
     ...
     *     {@link firebase.auth.Auth.sendPasswordResetEmail***REMOVED***.</li>
     * <li><code>VERIFY_EMAIL</code>: email verification code generated via
     *     {@link firebase.User.sendEmailVerification***REMOVED***.</li>
     * <li><code>RECOVER_EMAIL</code>: email change revocation code generated via
     *     {@link firebase.User.updateEmail***REMOVED***.</li>
     * <li><code>EMAIL_SIGNIN</code>: email sign in code generated via
     *     {@link firebase.auth.Auth.sendSignInLinkToEmail***REMOVED***.</li>
     * </ul>
     */
    operation: string;
***REMOVED***
...
***REMOVED***
   ...
   * only implementation is {@link firebase.auth.RecaptchaVerifier***REMOVED***.
   */
...
***REMOVED***
  ...
  interface AuthSettings {
     ...
     * whitelist your phone number***REMOVED*** via the
     * Firebase Console.
     *
...
***REMOVED***
   ...
   *
   * Do not call this constructor directly. Instead, use
   * {@link firebase.auth `firebase.auth()`***REMOVED***.
   *
   * See
   * {@link https://firebase.google.com/docs/auth/ Firebase Authentication***REMOVED***
   * for a full guide on how to use the Firebase Auth service.
   *
   */
  interface Auth {
    /**
     * The {@link firebase.app.App app***REMOVED*** associated with the `Auth` service
     * instance.
     *
     * @example
     * ```javascript
     ...
     *     {@link firebase.auth.Auth.fetchSignInMethodsForEmail***REMOVED*** with the error.email
     ...
     *     {@link firebase.User.linkWithCredential***REMOVED*** to prevent the user from signing
     ...
     *     {@link firebase.auth.GoogleAuthProvider.credential***REMOVED*** depending on the
     ...
     *
     * To keep the old behavior, see {@link firebase.auth.Auth.onIdTokenChanged***REMOVED***.
     *
     * @example
     * ```javascript
     ...
     * behavior as {@link firebase.auth.Auth.onAuthStateChanged***REMOVED*** had prior to 4.0.0.
     *
     * @example
     * ```javascript
     ...
     * {@link firebase.auth.Auth.signInWithEmailLink***REMOVED*** with the email address and
     ...
     * {@link firebase.auth.Auth.confirmPasswordReset***REMOVED*** with the code supplied in the
     ...
     * <dd>Thrown if there already exists an account with the email address
     *     asserted by the credential. Resolve this by calling
     *     {@link firebase.auth.Auth.fetchSignInMethodsForEmail***REMOVED*** and then asking the
     ...
     *     {@link firebase.User.linkWithCredential***REMOVED***.</dd>
     * <dt>auth/invalid-credential</dt>
     ...
     *     {@link firebase.auth.EmailAuthProvider.credential***REMOVED*** and there is no user
     *     corresponding to the given email. </dd>
     * <dt>auth/wrong-password</dt>
     * <dd>Thrown if signing in with a credential from
     *     {@link firebase.auth.EmailAuthProvider.credential***REMOVED*** and the password is
     ...
     * @deprecated
     * This method is deprecated. Use
     * {@link firebase.auth.Auth.signInWithCredential***REMOVED*** instead.
     *
     * @example
     * ```javascript
     ...
     *
     * See also: {@link firebase.auth.Auth.createUserWithEmailAndPassword***REMOVED***.
     *
     * <h4>Error Codes</h4>
     * <dl>
     * <dt>auth/invalid-email</dt>
     ...
     * {@link firebase.auth.ConfirmationResult***REMOVED***. After the user provides the code
     * sent to their phone, call {@link firebase.auth.ConfirmationResult.confirm***REMOVED***
     * with the code to sign the user in.
     *
     * For abuse prevention, this method also requires a
     * {@link firebase.auth.ApplicationVerifier***REMOVED***. The Firebase Auth SDK includes
     * a reCAPTCHA-based implementation, {@link firebase.auth.RecaptchaVerifier***REMOVED***.
     *
     * <h4>Error Codes</h4>
     * <dl>
     * <dt>auth/captcha-check-failed</dt>
     ...
     * {@link firebase.auth.Auth.isSignInWithEmailLink***REMOVED***.
     *
     * <h4>Error Codes</h4>
     * <dl>
     * <dt>auth/expired-action-code</dt>
     ...
     * `currentUser`.
     *
     * This will trigger {@link firebase.auth.Auth.onAuthStateChanged***REMOVED*** and
     * {@link firebase.auth.Auth.onIdTokenChanged***REMOVED*** listeners like other sign in
     * methods.
     *
...
***REMOVED***
  ...
  abstract class AuthCredential {
     ...
     * {@link firebase.auth.Auth.fetchSignInMethodsForEmail***REMOVED***.
     */
    signInMethod: string;
    /**
     * Returns a JSON-serializable representation of this object.
     ...
     * {@link firebase.auth.AuthCredential***REMOVED***. Input can be either Object or the
...
***REMOVED***
   ...
   *
   * To authenticate: {@link firebase.auth.Auth.createUserWithEmailAndPassword***REMOVED***
   * and {@link firebase.auth.Auth.signInWithEmailAndPassword***REMOVED***.
   */
...
***REMOVED***
   ...
   * message, use {@link firebase.auth.Error.message***REMOVED***.
   ...
   * specific errors. Refer to {@link firebase.auth.Auth.signInWithPopup***REMOVED*** for more
   * information.
   *
...
***REMOVED***
   ...
   * Refer to {@link firebase.auth.Auth.signInWithPopup***REMOVED*** for more information.
   *
   * <h4>Common Error Codes</h4>
   * <dl>
   * <dt>auth/account-exists-with-different-credential</dt>
  ...
  interface AuthError extends firebase.auth.Error {
    /**
     * The {@link firebase.auth.AuthCredential***REMOVED*** that can be used to resolve the
     * error.
     */
    credential?: firebase.auth.AuthCredential;
    /**
     ...
     * {@link firebase.auth.signInWithRedirect***REMOVED*** to sign in, you have to
...
***REMOVED***
   ...
   * ```
   *
   * @see {@link firebase.auth.Auth.onAuthStateChanged***REMOVED*** to receive sign in state
   * changes.
   */
...
***REMOVED***
  ...
  class FacebookAuthProvider_Instance implements firebase.auth.AuthProvider {
     ...
     * {@link https://goo.gl/pve4fo Facebook***REMOVED***
     * documentation.
...
***REMOVED***
  ...
  class GithubAuthProvider extends GithubAuthProvider_Instance {
     ...
     * @return {!firebase.auth.OAuthCredential***REMOVED*** The auth provider credential.
     */
    static credential(token: string): firebase.auth.OAuthCredential;
***REMOVED***
  /**
  ...
  class GithubAuthProvider_Instance implements firebase.auth.AuthProvider {
     ...
     * For a detailed list, check the
     * {@link https://developer.github.com/v3/oauth/ GitHub***REMOVED*** documentation.
     * Reserved required OAuth 2.0 parameters such as 'client_id', 'redirect_uri',
     * 'scope', 'response_type' and 'state' are not allowed and will be ignored.
     * @param customOAuthParameters The custom OAuth parameters to pass
     *     in the OAuth request.
...
***REMOVED***
  ...
  class GoogleAuthProvider_Instance implements firebase.auth.AuthProvider {
     ...
     * and 'prompt'.
     * For a detailed list, check the
     * {@link https://goo.gl/Xo01Jm Google***REMOVED***
     * documentation.
     * Reserved required OAuth 2.0 parameters such as 'client_id', 'redirect_uri',
     * 'scope', 'response_type' and 'state' are not allowed and will be ignored.
     * @param customOAuthParameters The custom OAuth parameters to pass
...
***REMOVED***
   ...
   * {@link firebase.User.getIdTokenResult***REMOVED***. It contains the ID token JWT string
...
***REMOVED***
  ...
  class PhoneAuthProvider extends PhoneAuthProvider_Instance {
     ...
     * {@link firebase.auth.PhoneAuthProvider.verifyPhoneNumber***REMOVED*** and the code
     * that was sent to the user's mobile device.
     *
     * <h4>Error Codes</h4>
     * <dl>
     ...
     *     {@link firebase.auth.PhoneAuthProvider.verifyPhoneNumber***REMOVED***.
...
***REMOVED***
  ...
  class PhoneAuthProvider_Instance implements firebase.auth.AuthProvider {
     ...
     * {@link firebase.auth.PhoneAuthProvider.credential***REMOVED*** to identify this flow.
     *
     * For abuse prevention, this method also requires a
     * {@link firebase.auth.ApplicationVerifier***REMOVED***. The Firebase Auth SDK includes
     * a reCAPTCHA-based implementation, {@link firebase.auth.RecaptchaVerifier***REMOVED***.
...
***REMOVED***
  ...
  /**
   * An {@link https://www.google.com/recaptcha/ reCAPTCHA***REMOVED***-based application
   * verifier.
   *
   * @webonly
   *
...
declare namespace firebase.analytics {
   ...
   *
   * Do not call this constructor directly. Instead, use
   * {@link firebase.analytics `firebase.analytics()`***REMOVED***.
   */
  export interface Analytics {
    /**
     * The {@link firebase.app.App app***REMOVED*** associated with the `Analytics` service
     * instance.
     *
     * @example
     * ```javascript
     ...
     * the gtag.js reference documentation***REMOVED***.
     */
    logEvent(
    ...
    ***REMOVED***,
    ...
    logEvent<T extends string>(
      ...
      eventParams?: { [key: string]: any ***REMOVED***,
      options?: firebase.analytics.AnalyticsCallOptions
    ): void;
...
***REMOVED***
   ...
   * the gtag.js documentation on parameters***REMOVED***.
   */
...
declare namespace firebase.database {
  ...
  interface DataSnapshot {
     ...
     *     var name = snapshot.child("name").val(); // {first:"Ada",last:"Lovelace"***REMOVED***
     ...
     * ref.set({ name: "Ada", age: 36 ***REMOVED***)
     *   .then(function() {
     *    return ref.once("value");
     * ***REMOVED***)
     *   .then(function(snapshot) {
     *     var data = snapshot.val();
     *     // data is { "name": "Ada", "age": 36 ***REMOVED***
     *     // data.name === "Ada"
     *     // data.age === 36
     * ***REMOVED***);
     * ```
...
***REMOVED***
   ...
   *
   * Do not call this constructor directly. Instead, use
   * {@link firebase.database `firebase.database()`***REMOVED***.
   *
   * See
   * {@link
  ...
  interface Database {
    /**
     * The {@link firebase.app.App app***REMOVED*** associated with the `Database` service
     * instance.
     *
     * @example
     * ```javascript
...
***REMOVED***
  ...
  interface OnDisconnect {
     ...
     * {@link firebase.database.Reference.update `update()`***REMOVED***.
     *
     * @example
     * ```javascript
     * var ref = firebase.database().ref("users/ada");
...
***REMOVED***
  ...
  interface Query {
     ...
     * listening.
     *
     * This is equivalent to calling {@link firebase.database.Query.on `on()`***REMOVED***, and
     * then calling {@link firebase.database.Query.off `off()`***REMOVED*** inside the callback
     * function. See {@link firebase.database.Query.on `on()`***REMOVED*** for details on the
     * event types.
     *
     * @example
     * ```javascript
...
***REMOVED***
  ...
  interface Reference extends firebase.database.Query {
     ...
     * @example
     * ```javascript
     * adaNameRef.set({ first: 'Ada', last: 'Lovelace' ***REMOVED***);
     ...
     *   if (currentData === null) {
     *     return { name: { first: 'Ada', last: 'Lovelace' ***REMOVED*** ***REMOVED***;
     * ***REMOVED*** else {
     *     console.log('User ada already exists.');
     *     return; // Abort the transaction.
     * ***REMOVED***
     * ***REMOVED***, function(error, committed, snapshot) {
     *   if (error) {
     *     console.log('Transaction failed abnormally!', error);
     * ***REMOVED*** else if (!committed) {
     ...
     * adaNameRef.update({ first: 'Ada', last: 'Lovelace' ***REMOVED***);
     * ```
     *
     * @param values Object containing multiple values.
     * @param onComplete Callback called when write to server is
...
declare namespace firebase.messaging {
   ...
   *
   * Do not call this constructor directly. Instead, use
   * {@link firebase.messaging `firebase.messaging()`***REMOVED***.
   *
   * See
   * {@link
...
declare namespace firebase.storage {
  ...
  interface FullMetadata extends firebase.storage.UploadMetadata {
     ...
     * @see {@link https://cloud.google.com/storage/docs/generations-preconditions***REMOVED***
     */
    generation: string;
    /**
...
***REMOVED***
   ...
   *
   * Do not call this constructor directly. Instead, use
   * {@link firebase.storage `firebase.storage()`***REMOVED***.
   *
   * See
   * {@link
  ...
  interface Storage {
    /**
     * The {@link firebase.app.App app***REMOVED*** associated with the `Storage` service
     * instance.
     *
     * @example
     * ```javascript
     ...
     *     @see {@link firebase.storage.FullMetadata.prototype.downloadURLs***REMOVED***
     * @return A reference for the given URL.
     */
    refFromURL(url: string): firebase.storage.Reference;
    /**
     * @param time The new maximum operation retry time in milliseconds.
     * @see {@link firebase.storage.Storage.prototype.maxOperationRetryTime***REMOVED***
     */
    setMaxOperationRetryTime(time: number): any;
    /**
     * @param time The new maximum upload retry time in milliseconds.
     * @see {@link firebase.storage.Storage.prototype.maxUploadRetryTime***REMOVED***
     */
...
***REMOVED***
   ...
   * @enum {string***REMOVED***
   * @see {@link firebase.storage.UploadTask.prototype.on***REMOVED***
   */
  ...
  var TaskEvent: {
     ...
     *       {@link firebase.storage.UploadTaskSnapshot***REMOVED*** as the first
     *       argument.</li>
...
declare namespace firebase.firestore {
   ...
   * mapped to values.
   */
  export type DocumentData = { [field: string]: any ***REMOVED***;
   ...
   */
  export type UpdateData = { [fieldPath: string]: any ***REMOVED***;
...
***REMOVED***
   ...
   *
   * Do not call this constructor directly. Instead, use
   * {@link firebase.firestore `firebase.firestore()`***REMOVED***.
   */
  export class Firestore {
    ...
    /**
     * The {@link firebase.app.App app***REMOVED*** associated with this `Firestore` service
     * instance.
     */
    app: firebase.app.App;
     ...
     * {@link firebase.firestore.Firestore.enableNetwork `enableNetwork()`***REMOVED***. While
  ...
  ***REMOVED***): () => void;
     ...
     * @hidden
     */
    INTERNAL: { delete: () => Promise<void> ***REMOVED***;
***REMOVED***
...
***REMOVED***
   ...
   * {@link firebase.firestore.DocumentReference.set DocumentReference***REMOVED***, {@link
   * firebase.firestore.WriteBatch.set WriteBatch***REMOVED*** and {@link
   * firebase.firestore.Transaction.set Transaction***REMOVED***. These calls can be
...
***REMOVED***
  ...
  export class DocumentReference {
    ...
    /**
     * The {@link firebase.firestore.Firestore***REMOVED*** the document is in.
