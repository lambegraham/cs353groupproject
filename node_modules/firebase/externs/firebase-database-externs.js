 ...
 *
 * @namespace
 * @param {!firebase.app.App=***REMOVED*** app Optional app whose Database service to
 *   return. If not provided, the default Database service will be returned.
 * @return {!firebase.database.Database***REMOVED*** The default Database service if no app
 *   is provided or the Database service associated with the provided app.
 */
firebase.database = function(app) {***REMOVED***;
 ...
 *
 * @return {!firebase.database.Database***REMOVED***
 */
firebase.app.App.prototype.database = function() {***REMOVED***;
 ...
 * @interface
 */
firebase.database.Database = function() {***REMOVED***;
 ...
 * ***REMOVED***);
 *
 * @param {(boolean|function(string))=***REMOVED*** logger Enables logging if `true`;
 *   disables logging if `false`. You can also provide a custom logger function
 *   to control how things get logged.
 * @param {boolean=***REMOVED*** persistent Remembers the logging state between page
 *   refreshes if `true`.
 */
firebase.database.enableLogging = function(logger, persistent) {***REMOVED***;

/**
 * @namespace
 */
firebase.database.ServerValue = {***REMOVED***;
 ...
 *
 * @param {string=***REMOVED*** path Optional path representing the location the returned
 *   `Reference` will point. If not provided, the returned `Reference` will
 *   point to the root of the Database.
 * @return {!firebase.database.Reference***REMOVED*** If a path is provided, a `Reference`
 *   pointing to the provided path. Otherwise, a `Reference` pointing to the
 *   root of the Database.
 */
firebase.database.Database.prototype.ref = function(path) {***REMOVED***;
 ...
 *
 * @param {string***REMOVED*** url The Firebase URL at which the returned `Reference` will
 *   point.
 * @return {!firebase.database.Reference***REMOVED*** A `Reference` pointing to the provided
 *   Firebase URL.
 */
firebase.database.Database.prototype.refFromURL = function(url) {***REMOVED***;
 ...
 */
firebase.database.Database.prototype.goOffline = function() {***REMOVED***;
 ...
 */
firebase.database.Database.prototype.goOnline = function() {***REMOVED***;
 ...
 *
 * @interface
 * @extends {firebase.database.Query***REMOVED***
 */
firebase.database.Reference = function() {***REMOVED***;
 ...
 *
 * @param {string***REMOVED*** path A relative path from this location to the desired child
 *   location.
 * @return {!firebase.database.Reference***REMOVED*** The specified child location.
 */
firebase.database.Reference.prototype.child = function(path) {***REMOVED***;
 ...
 *
 * @type {?firebase.database.Reference***REMOVED***
 */
 ...
 *
 * @param {****REMOVED*** value The value to be written (string, number, boolean, object,
 *   array, or null).
 * @param {function(?Error)=***REMOVED*** onComplete Callback called when write to server is
 *   complete.
 * @return {!firebase.Promise<void>***REMOVED*** Resolves when write to server is complete.
 */
firebase.database.Reference.prototype.set = function(value, onComplete) {***REMOVED***;
 ...
 *
 * @param {!Object***REMOVED*** values Object containing multiple values.
 * @param {function(?Error)=***REMOVED*** onComplete Callback called when write to server is
 *   complete.
 * @return {!firebase.Promise<void>***REMOVED*** Resolves when update on server is complete.
 */
firebase.database.Reference.prototype.update = function(values, onComplete) {***REMOVED***;
 ...
 * @param {function(?Error)=***REMOVED*** onComplete Callback called when write to server is
 *   complete.
 * @return {!firebase.Promise<void>***REMOVED*** Resolves when remove on server is complete.
 */
firebase.database.Reference.prototype.remove = function(onComplete) {***REMOVED***;
 ...
 *
 *
 * @param {function(*): ****REMOVED*** transactionUpdate A developer-supplied function which
 ...
 * @param {boolean=***REMOVED*** applyLocally By default, events are raised each time the
...
/**
 * @interface
 * @extends {firebase.database.Reference***REMOVED***
 * @extends {firebase.Thenable<void>***REMOVED***
 */
firebase.database.ThenableReference = function() {***REMOVED***;
 ...
 *
 * @param {*=***REMOVED*** value Optional value to be written at the generated location.
 * @param {function(?Error)=***REMOVED*** onComplete Callback called when write to server is
 *   complete.
 * @return {!firebase.database.ThenableReference***REMOVED*** Combined `Promise` and
 *   `Reference`; resolves when write is complete, but can be used immediately
 *   as the `Reference` to the child location.
 */
firebase.database.Reference.prototype.push = function(value, onComplete) {***REMOVED***;
 ...
 * to use it.
 *
 * @return {!firebase.database.OnDisconnect***REMOVED***
 */
firebase.database.Reference.prototype.onDisconnect = function() {***REMOVED***;
 ...
 * @interface
 */
firebase.database.Query = function() {***REMOVED***;
 ...
 *
 * @param {firebase.database.Query***REMOVED*** other The query to compare against.
 * @return {boolean***REMOVED*** Whether or not the current and provided queries are
 *   equivalent.
 */
firebase.database.Query.prototype.isEqual = function(other) {***REMOVED***;
 ...
 * ***REMOVED***);
 *
 * @param {string***REMOVED*** eventType One of the following strings: "value",
 *   "child_added", "child_changed", "child_removed", or "child_moved."
 * @param {!function(firebase.database.DataSnapshot, string=)***REMOVED*** callback A
 ...
 *   first child.
 * @param {(function(Error)|Object)=***REMOVED*** cancelCallbackOrContext An optional
 ...
 * @param {Object=***REMOVED*** context If provided, this object will be used as `this`
 *   when calling your callback(s).
 * @return {!function(firebase.database.DataSnapshot, string=)***REMOVED*** The provided
 ...
 * @param {string=***REMOVED*** eventType One of the following strings: "value",
 *   "child_added", "child_changed", "child_removed", or "child_moved."
 * @param {function(!firebase.database.DataSnapshot, ?string=)=***REMOVED*** callback The
 *   callback function that was passed to `on()`.
 * @param {Object=***REMOVED*** context The context that was passed to `on()`.
 */
 ...
 * @param {string***REMOVED*** eventType One of the following strings: "value",
 *   "child_added", "child_changed", "child_removed", or "child_moved."
 * @param {function(!firebase.database.DataSnapshot, string=)=***REMOVED*** successCallback A
 *   callback that fires when the specified event occurs. The callback will be
 *   passed a DataSnapshot. For ordering purposes, "child_added",
 *   "child_changed", and "child_moved" will also be passed a string containing
 *   the key of the previous child by sort order, or `null` if it is the
 *   first child.
 * @param {(function(Error)|Object)=***REMOVED*** failureCallbackOrContext An optional
 ...
 * ***REMOVED***);
 *
 * @param {number***REMOVED*** limit The maximum number of nodes to include in this query.
 * @return {!firebase.database.Query***REMOVED***
 */
firebase.database.Query.prototype.limitToFirst = function(limit) {***REMOVED***;
 ...
 * @return {!firebase.database.Query***REMOVED***
 */
firebase.database.Query.prototype.limitToLast = function(limit) {***REMOVED***;
 ...
 * @return {!firebase.database.Query***REMOVED***
 */
firebase.database.Query.prototype.orderByChild = function(path) {***REMOVED***;
 ...
 * @return {!firebase.database.Query***REMOVED***
 */
firebase.database.Query.prototype.orderByKey = function() {***REMOVED***;
 ...
 * @return {!firebase.database.Query***REMOVED***
 */
firebase.database.Query.prototype.orderByPriority = function() {***REMOVED***;
 ...
 * @return {!firebase.database.Query***REMOVED***
 */
firebase.database.Query.prototype.orderByValue = function() {***REMOVED***;
 ...
 * ***REMOVED***);
 *
 * @param {number|string|boolean|null***REMOVED*** value The value to start at. The argument
 ...
 * @param {string=***REMOVED*** key The child key to start at. This argument is only allowed
 *   if ordering by child, value, or priority.
 * @return {!firebase.database.Query***REMOVED***
 */
firebase.database.Query.prototype.startAt = function(value, key) {***REMOVED***;
 ...
 * ***REMOVED***);
 *
 * @param {number|string|boolean|null***REMOVED*** value The value to end at. The argument
 *   type depends on which `orderBy*()` function was used in this query.
 *   Specify a value that matches the `orderBy*()` type. When used in
 *   combination with `orderByKey()`, the value must be a string.
 * @param {string=***REMOVED*** key The child key to end at, among the children with the
 *   previously specified priority. This argument is only allowed if ordering by
 *   child, value, or priority.
 * @return {!firebase.database.Query***REMOVED***
 */
firebase.database.Query.prototype.endAt = function(value, key) {***REMOVED***;
 ...
 * ***REMOVED***);
 *
 * @param {number|string|boolean|null***REMOVED*** value The value to match for. The
 ...
 *   combination with `orderByKey()`, the value must be a string.
 * @param {string=***REMOVED*** key The child key to start at, among the children with the
 *   previously specified priority. This argument is only allowed if ordering by
 *   child, value, or priority.
 * @return {!firebase.database.Query***REMOVED***
 */
firebase.database.Query.prototype.equalTo = function(value, key) {***REMOVED***;
 ...
 *
 * @return {string***REMOVED*** The absolute URL for this location.
 * @override
 */
firebase.database.Query.prototype.toString = function() {***REMOVED***;

/**
 * Returns a JSON-serializable representation of this object.
 *
 * @return {!Object***REMOVED*** A JSON-serializable representation of this object.
 */
firebase.database.Query.prototype.toJSON = function() {***REMOVED***;
 ...
 * @interface
 */
firebase.database.DataSnapshot = function() {***REMOVED***;
 ...
 * ***REMOVED***);
 *
 * @return {****REMOVED*** The DataSnapshot's contents as a JavaScript value (Object,
 *   Array, string, number, boolean, or `null`).
 */
firebase.database.DataSnapshot.prototype.val = function() {***REMOVED***;
 ...
 *   Array, string, number, boolean, or `null`).
 */
firebase.database.DataSnapshot.prototype.exportVal = function() {***REMOVED***;
 ...
 */
firebase.database.DataSnapshot.prototype.exists = function() {***REMOVED***;
 ...
 * ***REMOVED***);
 *
 * @param {string***REMOVED*** path A relative path to the location of child data.
 * @return {!firebase.database.DataSnapshot***REMOVED***
 */
firebase.database.DataSnapshot.prototype.child = function(path) {***REMOVED***;
 ...
 * ***REMOVED***);
 *
 * @param {string***REMOVED*** path A relative path to the location of a potential child.
 * @return {boolean***REMOVED*** `true` if data exists at the specified child path; else
 *  `false`.
 */
firebase.database.DataSnapshot.prototype.hasChild = function(path) {***REMOVED***;
 ...
 *  Sorting and filtering data***REMOVED***).
 *
 * @return {string|number|null***REMOVED***
 */
firebase.database.DataSnapshot.prototype.getPriority = function() {***REMOVED***;
 ...
 * ***REMOVED***);
 *
 * @param {function(!firebase.database.DataSnapshot): boolean***REMOVED*** action A function
 *   that will be called for each child DataSnapshot. The callback can return
 *   true to cancel further enumeration.
 * @return {boolean***REMOVED*** true if enumeration was canceled due to your callback
 *   returning true.
 */
firebase.database.DataSnapshot.prototype.forEach = function(action) {***REMOVED***;
 ...
 * ***REMOVED***);
 *
 * @return {boolean***REMOVED*** true if this snapshot has any children; else false.
 */
firebase.database.DataSnapshot.prototype.hasChildren = function() {***REMOVED***;
 ...
 */
firebase.database.DataSnapshot.prototype.numChildren = function() {***REMOVED***;
 ...
 * @return {?Object***REMOVED*** A JSON-serializable representation of this object.
 */
firebase.database.DataSnapshot.prototype.toJSON = function() {***REMOVED***;
 ...
 * @interface
 */
firebase.database.OnDisconnect = function() {***REMOVED***;
 ...
 *
 * @param {function(?Error)=***REMOVED*** onComplete An optional callback function that will
 ...
 * @return {!firebase.Promise<void>***REMOVED*** Resolves when synchronization to the server
 *   is complete.
 */
firebase.database.OnDisconnect.prototype.cancel = function(onComplete) {***REMOVED***;
 ...
 *   is complete.
 */
firebase.database.OnDisconnect.prototype.remove = function(onComplete) {***REMOVED***;
 ...
 *
 * @param {****REMOVED*** value The value to be written to this location on
 *   disconnect (can be an object, array, string, number, boolean, or null).
 * @param {function(?Error)=***REMOVED*** onComplete An optional callback function that
 ...
 * @return {!firebase.Promise<void>***REMOVED*** Resolves when synchronization to the
 *   Database is complete.
 */
firebase.database.OnDisconnect.prototype.set = function(value, onComplete) {***REMOVED***;
