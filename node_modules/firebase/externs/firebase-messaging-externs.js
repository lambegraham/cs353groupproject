 ...
 *
 * @namespace
 * @param {!firebase.app.App=***REMOVED*** app The app to create a Messaging service for.
 *     If not passed, uses the default app.
 *
 * @return {!firebase.messaging.Messaging***REMOVED***
 */
firebase.messaging = function(app) {***REMOVED***;
 ...
 * @return {!firebase.messaging.Messaging***REMOVED***
 */
firebase.app.App.prototype.messaging = function() {***REMOVED***;
 ...
 * @interface
 */
firebase.messaging.Messaging = function() {***REMOVED***;
 ...
 *
 * @return {firebase.Promise***REMOVED*** The promise resolves if permission is
 *   granted. Otherwise, the promise is rejected with an error.
 */
firebase.messaging.Messaging.prototype.requestPermission = function() {***REMOVED***;
 ...
 *
 * @return {firebase.Promise<string>***REMOVED*** The promise resolves if an FCM token can
 *   be retrieved. This method returns null if the current origin does not have
 *   permission to show notifications.
 */
firebase.messaging.Messaging.prototype.getToken = function() {***REMOVED***;
 ...
 * to get a new token.
 *
 * @param {!firebase.Observer<Object, void>|!function(!Object)***REMOVED***
 *     nextOrObserver This function, or observer object with `next` defined,
 *     is called when a token refresh has occurred.
 * @return {firebase.Unsubscribe***REMOVED*** To stop listening for token
 ...
 * @return {firebase.Unsubscribe***REMOVED*** To stop listening for messages
 *    execute this returned function.
 */
firebase.messaging.Messaging.prototype.onMessage = function(nextOrObserver) {***REMOVED***;

/**
 * To forceably stop a registration token from being used, delete it
 * by calling this method.
 *
 * @param {!string***REMOVED*** token The token to delete.
 * @return {firebase.Promise***REMOVED*** The promise resolves when the token has been
 *   successfully deleted.
 */
firebase.messaging.Messaging.prototype.deleteToken = function(token) {***REMOVED***;
 ...
 *
 * @param {!ServiceWorkerRegistration***REMOVED*** registration The service worker
 ...
 *
 * @param {!function(!Object)***REMOVED*** callback The function to handle the push message.
 */
