 ...
 *     {@link firebase.auth.Auth#fetchProvidersForEmail***REMOVED***, sign in to
 ...
 * ***REMOVED***);
 *
 * @param {!firebase.auth.AuthProvider***REMOVED*** provider The provider to authenticate.
 ...
 * @return {!firebase.Promise<!firebase.auth.UserCredential>***REMOVED***
 */
firebase.User.prototype.linkWithPopup = function(provider) {***REMOVED***;
 ...
 */
firebase.User.prototype.linkWithRedirect = function(provider) {***REMOVED***;
 ...
 *     {@link firebase.auth.Auth#fetchProvidersForEmail***REMOVED*** with the error.email
 ...
 * @return {!firebase.Promise<!firebase.auth.UserCredential>***REMOVED***
 */
firebase.auth.Auth.prototype.signInWithPopup = function(provider) {***REMOVED***;
 ...
 * @return {!firebase.Promise<void>***REMOVED***
 */
firebase.auth.Auth.prototype.signInWithRedirect = function(provider) {***REMOVED***;
 ...
 * @return {!firebase.Promise<!firebase.auth.UserCredential>***REMOVED***
 */
firebase.User.prototype.reauthenticateWithPopup = function(provider) {***REMOVED***;
 ...
 * @return {!firebase.Promise<void>***REMOVED***
 */
firebase.User.prototype.reauthenticateWithRedirect = function(provider) {***REMOVED***;
 ...
 * @return {!firebase.Promise<!firebase.auth.UserCredential>***REMOVED***
 */
firebase.auth.Auth.prototype.getRedirectResult = function() {***REMOVED***;

/**
 * An {@link https://www.google.com/recaptcha/ reCAPTCHA***REMOVED***-based application
 * verifier.
 * @param {!Element|string***REMOVED*** container The reCAPTCHA container parameter. This
 ...
 * @param {?Object=***REMOVED*** parameters The optional reCAPTCHA parameters. Check the
 ...
 * @param {?firebase.app.App=***REMOVED*** app The corresponding Firebase app. If none is
 ...
 */
firebase.auth.RecaptchaVerifier = function(container, parameters, app) {***REMOVED***;
 ...
 */
firebase.auth.RecaptchaVerifier.prototype.clear = function() {***REMOVED***;

/**
 * Renders the reCAPTCHA widget on the page.
 * @return {!firebase.Promise<number>***REMOVED*** A Promise that resolves with the
 *     reCAPTCHA widget ID.
 */
firebase.auth.RecaptchaVerifier.prototype.render = function() {***REMOVED***;

/**
 * Waits for the user to solve the reCAPTCHA and resolves with the reCAPTCHA
 * token.
 * @return {!firebase.Promise<string>***REMOVED*** A Promise for the reCAPTCHA token.
 */
firebase.auth.RecaptchaVerifier.prototype.verify = function() {***REMOVED***;
