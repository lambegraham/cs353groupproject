 ...
 *
 * @return {!firebase.firestore.Firestore***REMOVED*** Firestore
 */
firebase.firestore = function(app) {***REMOVED***;
 ...
 * @interface
 */
firebase.firestore.Firestore = function() {***REMOVED***;
 ...
 * @interface
 */
firebase.firestore.Settings = function() {***REMOVED***;
 ...
 *   </ul>
 */
firebase.firestore.Firestore.prototype.setLogLevel = function(logLevel) {***REMOVED***;

/**
 * Specifies custom settings to be used to configure the `Firestore`
 * instance. Must be set before invoking any other methods.
 *
 * @param {!firebase.firestore.Settings***REMOVED*** settings
 *   The settings for your Cloud Firestore instance.
 */
firebase.firestore.Firestore.prototype.settings = function(settings) {***REMOVED***;
 ...
 *
 * @return {!Promise<void>***REMOVED*** A promise that represents
 *   successfully enabling persistent storage.
 */
firebase.firestore.Firestore.prototype.enablePersistence = function() {***REMOVED***;
 ...
 *
 * @return {!Promise<void>***REMOVED*** A promise that is resolved once the network has been
 *   enabled.
 */
firebase.firestore.Firestore.prototype.enableNetwork = function() {***REMOVED***;
 ...
 *   disabled.
 */
firebase.firestore.Firestore.prototype.disableNetwork = function() {***REMOVED***;

/**
 * Gets a `CollectionReference` instance that refers to the collection at
 * the specified path.
 *
 * @param {string***REMOVED*** collectionPath
 *   A slash-separated path to a collection.
 *
 * @return {!firebase.firestore.CollectionReference***REMOVED***
 *   The `CollectionReference` instance.
 */
firebase.firestore.Firestore.prototype.collection = function(collectionPath) {***REMOVED***;
 ...
 *
 * @return {!firebase.firestore.DocumentReference***REMOVED***
 *   The `DocumentReference` instance.
 */
firebase.firestore.Firestore.prototype.doc = function(documentPath) {***REMOVED***;
 ...
 *
 * @param {function(!firebase.firestore.Transaction)***REMOVED*** updateFunction
 ...
 * atomic operation.
 *
 * @return {!firebase.firestore.WriteBatch***REMOVED***
 *   A `WriteBatch` that can be used to atomically execute multiple writes.
 */
firebase.firestore.Firestore.prototype.batch = function() {***REMOVED***;
 ...
 * @constructor
 *
 * @param {number***REMOVED*** latitude
 *   Latitude values are in the range of -90 to 90.
 *
 * @param {number***REMOVED*** longitude
 *   Longitude values are in the range of -180 to 180.
 */
firebase.firestore.GeoPoint = function(latitude, longitude) {***REMOVED***;
 ...
 *
 * @param {!firebase.firestore.GeoPoint***REMOVED*** other
 *   The `GeoPoint` to compare against.
 *
 * @return {boolean***REMOVED*** 'true' if this `GeoPoint` is equal to the provided one.
 */
firebase.firestore.GeoPoint.prototype.isEqual = function(other) {***REMOVED***;

/**
 * An immutable object representing an array of bytes.
 * @interface
 */
firebase.firestore.Blob = function() {***REMOVED***;

/**
 * Returns 'true' if this `Blob` is equal to the provided one.
 *
 * @param {!firebase.firestore.Blob***REMOVED*** other
 *   The `Blob` to compare against.
 *
 * @return {boolean***REMOVED*** 'true' if this `Blob` is equal to the provided one.
 */
firebase.firestore.Blob.prototype.isEqual = function(other) {***REMOVED***;

/**
 * Creates a new Blob from the given Base64 string, converting it to bytes.
 *
 * @param {string***REMOVED*** base64
 *   The Base64 string used to create the Blob object.
 *
 * @return {!firebase.firestore.Blob***REMOVED***
 *   The Blob created from the Base64 string.
 */
firebase.firestore.Blob.fromBase64String = function(base64) {***REMOVED***;

/**
 * Creates a new Blob from the given Uint8Array.
 *
 * @param {!Uint8Array***REMOVED*** array
 *   The Uint8Array used to create the Blob object.
 *
 * @return {!firebase.firestore.Blob***REMOVED***
 *   The Blob created from the Uint8Array.
 */
firebase.firestore.Blob.fromUint8Array = function(array) {***REMOVED***;
 ...
 */
firebase.firestore.Blob.prototype.toBase64 = function() {***REMOVED***;

/**
 * Returns the bytes of a Blob in a new Uint8Array.
 *
 * @return {!Uint8Array***REMOVED***
 *   The Uint8Array created from the Blob object.
 */
firebase.firestore.Blob.prototype.toUint8Array = function() {***REMOVED***;
 ...
 * @interface
 */
firebase.firestore.Transaction = function() {***REMOVED***;

/**
 * Reads the document referenced by the provided `DocumentReference.`
 *
 * @param {!firebase.firestore.DocumentReference***REMOVED*** documentRef
 *   A reference to the document to be retrieved.
 *
 * @return {!Promise<!firebase.firestore.DocumentSnapshot>***REMOVED***
 *   A promise of the read data in a `DocumentSnapshot`.
 */
firebase.firestore.Transaction.prototype.get = function(documentRef) {***REMOVED***;
 ...
 *
 * @param {!firebase.firestore.SetOptions=***REMOVED*** options
 *   An object to configure the set behavior. Pass `{merge: true***REMOVED***` to only
 *   replace the values specified in the data argument. Fields omitted
 *   will remain untouched.
 *
 * @return {!firebase.firestore.Transaction***REMOVED***
 ...
 *   {@link firebase.firestore.FieldPath***REMOVED*** objects) and values.
 *
 * @return {!firebase.firestore.Transaction***REMOVED***
 *   This `Transaction` instance. Used for chaining method calls.
 */
 ...
 *   This `Transaction` instance. Used for chaining method calls.
 */
firebase.firestore.Transaction.prototype.delete = function(documentRef) {***REMOVED***;
 ...
 * @interface
 */
firebase.firestore.WriteBatch = function() {***REMOVED***;
 ...
 *   This `WriteBatch` instance. Used for chaining method calls.
 */
firebase.firestore.WriteBatch.prototype.delete = function(documentRef) {***REMOVED***;
 ...
 */
firebase.firestore.WriteBatch.prototype.commit = function() {***REMOVED***;
 ...
 * @interface
 */
firebase.firestore.SetOptions = function() {***REMOVED***;
 ...
 * untouched.
 *
 * @typedef {Array<string>|Array<firebase.firestore.FieldPath>***REMOVED***
 */
 ...
 * @interface
 */
firebase.firestore.DocumentReference = function() {***REMOVED***;
 ...
 * @type {!firebase.firestore.Firestore***REMOVED***
 */
firebase.firestore.DocumentReference.prototype.firestore;

/**
 * The Collection this `DocumentReference` belongs to.
 * @type {!firebase.firestore.CollectionReference***REMOVED***
 */
 ...
 */
firebase.firestore.DocumentReference.prototype.set = function(data, options) {***REMOVED***;
 ...
 */
firebase.firestore.DocumentReference.prototype.update = function(var_args) {***REMOVED***;
 ...
 */
firebase.firestore.DocumentReference.prototype.delete = function() {***REMOVED***;

/**
 * Reads the document referred to by this `DocumentReference`.
 *
 * @param {!firebase.firestore.GetOptions=***REMOVED*** options An options object to
 ...
 *   document contents.
 */
firebase.firestore.DocumentReference.prototype.get = function(options) {***REMOVED***;
 ...
 * @param {!firebase.firestore.SnapshotListenOptions|!Object|
           function(!firebase.firestore.DocumentSnapshot)***REMOVED***
 ...
 *   { includeMetadataChanges: true ***REMOVED*** to opt into events even when only metadata
 *   changed.
 ...
 * @param {function(!Error)=***REMOVED*** onError If you didn't provide
 *   options and didn't use an observer object, this is the optional onError
 *   callback.
 * @return {!function()***REMOVED*** An unsubscribe function that can be called to cancel
 ...
 * @interface
 */
firebase.firestore.SnapshotOptions = function() {***REMOVED***;
 ...
 *
 * @typedef {string|undefined***REMOVED***
 */
 ...
 * @interface
 */
firebase.firestore.GetOptions = function() {***REMOVED***;
 ...
 * @interface
 */
firebase.firestore.SnapshotMetadata = function() {***REMOVED***;
 ...
 *
 * @param {!firebase.firestore.SnapshotMetadata***REMOVED*** other
 *   The `SnapshotMetadata` to compare against.
 *
 * @return {boolean***REMOVED***
 *   'true' if this `SnapshotMetadata` is equal to the provided one.
 */
firebase.firestore.SnapshotMetadata.prototype.isEqual = function(other) {***REMOVED***;
 ...
 * @constructor
 */
firebase.firestore.DocumentSnapshot = function() {***REMOVED***;
 ...
 *
 * @typedef {!firebase.firestore.DocumentReference***REMOVED***
 */
 ...
 *
 * @typedef {!firebase.firestore.SnapshotMetadata***REMOVED***
 */
 ...
 *
 * @param {!firebase.firestore.SnapshotOptions=***REMOVED*** options An options object to
 ...
 *   value).
 *
 * @return {(!firebase.firestore.DocumentData|undefined)***REMOVED***
 *   An object containing all fields in the specified document or 'undefined'
 *   if the document doesn't exist.
 */
firebase.firestore.DocumentSnapshot.prototype.data = function(options) {***REMOVED***;
 ...
 *
 * @param {(string|!firebase.firestore.FieldPath)***REMOVED*** fieldPath
 ...
 *
 * @param {!firebase.firestore.DocumentSnapshot***REMOVED*** other
 *   The `DocumentSnapshot` to compare against.
 *
 * @return {boolean***REMOVED***
 *   'true' if this `DocumentSnapshot` is equal to the provided one.
 */
firebase.firestore.DocumentSnapshot.prototype.isEqual = function(other) {***REMOVED***;
 ...
 *
 * @constructor
 * @extends {firebase.firestore.DocumentSnapshot***REMOVED***
 */
firebase.firestore.QueryDocumentSnapshot = function() {***REMOVED***;
 ...
 *   final value).
 *
 * @return {!firebase.firestore.DocumentData***REMOVED***
 *   An object containing all fields in the specified document.
 */
firebase.firestore.QueryDocumentSnapshot.prototype.data = function(options) {***REMOVED***;
 ...
 *
 */
firebase.firestore.SnapshotListenOptions = function() {***REMOVED***;
 ...
 * @constructor
 */
firebase.firestore.Query = function() {***REMOVED***;
 ...
 *   The path to compare.
 *
 * @param {string***REMOVED*** opStr
 *   The operation string (e.g "<", "<=", "==", ">", ">=").
 *
 * @param {****REMOVED*** value
 *   The value for comparison.
 *
 * @return {!firebase.firestore.Query***REMOVED***
 *   The created query.
 */
firebase.firestore.Query.prototype.where = function(fieldPath, opStr, value) {***REMOVED***;
 ...
 *
 * @param {string=***REMOVED*** directionStr
 ...
 *   The created query.
 */
firebase.firestore.Query.prototype.limit = function(limit) {***REMOVED***;
 ...
 * the query.
 *
 * @param {...****REMOVED*** snapshotOrVarArgs
 ...
 *   The created query.
 */
firebase.firestore.Query.prototype.startAt = function(snapshotOrVarArgs) {***REMOVED***;
 ...
 *   The created query.
 */
firebase.firestore.Query.prototype.startAfter = function(snapshotOrVarArgs) {***REMOVED***;
 ...
 *   The created query.
 */
firebase.firestore.Query.prototype.endBefore = function(snapshotOrVarArgs) {***REMOVED***;
 ...
 *   The created query.
 */
firebase.firestore.Query.prototype.endAt = function(snapshotOrVarArgs) {***REMOVED***;
 ...
 *   configure how the data is retrieved.
 *
 * @return {!firebase.firestore.QuerySnapshot***REMOVED***
 *   A promise that will be resolved with the results of the query.
 */
firebase.firestore.Query.prototype.get = function(options) {***REMOVED***;
 ...
 * @interface
 */
firebase.firestore.QuerySnapshot = function() {***REMOVED***;

/**
 * The query you called `get` or `onSnapshot` on to get the `QuerySnapshot`.
 * @type {!firebase.firestore.Query***REMOVED***
 */
 ...
 * modifications.
 * @type {!firebase.firestore.SnapshotMetadata***REMOVED***
 */
 ...
 *
 * @param {firebase.firestore.SnapshotOptions=***REMOVED*** options Options that control
 * whether metadata-only changes (i.e. only `DocumentSnapshot.metadata` changed)
 * should be included.
 */
firebase.firestore.QuerySnapshot.prototype.docChanges = function(options) {***REMOVED***;

/**
 * An array of all the documents in the `QuerySnapshot`.
 * @type {!Array<!firebase.firestore.QueryDocumentSnapshot>***REMOVED***
 */
 ...
 *
 * @param {function(!firebase.firestore.QueryDocumentSnapshot)***REMOVED*** callback
 * @param {*=***REMOVED*** thisArg
 ...
 *
 * @param {!firebase.firestore.QuerySnapshot***REMOVED*** other
 *   The `QuerySnapshot` to compare against.
 *
 * @return {boolean***REMOVED***
 *   'true' if this `QuerySnapshot` is equal to the provided one.
 */
firebase.firestore.QuerySnapshot.prototype.isEqual = function(other) {***REMOVED***;
 ...
 * @interface
 */
firebase.firestore.DocumentChange = function() {***REMOVED***;
 ...
 * @type {!firebase.firestore.QueryDocumentSnapshot***REMOVED***
 */
 ...
 * @constructor
 * @extends {firebase.firestore.Query***REMOVED***
 */
firebase.firestore.CollectionReference = function() {***REMOVED***;
 ...
 *
 * @type {?firebase.firestore.DocumentReference***REMOVED***
 */
 ...
 *
 * @param {!firebase.firestore.DocumentData***REMOVED*** data
 * @return {!Promise<!firebase.firestore.DocumentReference>***REMOVED***
 ...
 */
firebase.firestore.CollectionReference.prototype.add = function(data) {***REMOVED***;

/**
 * Returns 'true' if this `CollectionReference` is equal to the provided one.
 *
 * @param {!firebase.firestore.CollectionReference***REMOVED*** other
 *   The `CollectionReference` to compare against.
 *
 * @return {boolean***REMOVED***
 *   'true' if this `CollectionReference` is equal to the provided one.
 */
firebase.firestore.CollectionReference.prototype.isEqual = function(other) {***REMOVED***;
 ...
 * @interface
 */
firebase.firestore.FieldValue = function() {***REMOVED***;

/**
 * Returns a sentinel used with `set()` or `update()` to include a
 * server-generated timestamp in the written data.
 * @return {!firebase.firestore.FieldValue***REMOVED***
 */
firebase.firestore.FieldValue.serverTimestamp = function() {***REMOVED***;

/**
 * Returns a sentinel for use with `update()` to mark a field for deletion.
 * @return {!firebase.firestore.FieldValue***REMOVED***
 */
firebase.firestore.FieldValue.delete = function() {***REMOVED***;

/**
 * Returns 'true' if this `FieldValue` is equal to the provided one.
 *
 * @param {!firebase.firestore.FieldValue***REMOVED*** other
 *   The `FieldValue` to compare against.
 *
 * @return {boolean***REMOVED***
 *   'true' if this `FieldValue` is equal to the provided one.
 */
firebase.firestore.FieldValue.prototype.isEqual = function(other) {***REMOVED***;
 ...
 * @constructor
 */
firebase.firestore.FieldPath = function(var_args) {***REMOVED***;

/**
 * Returns a special sentinel `FieldPath` to refer to the ID of a document.
 * It can be used in queries to sort or filter by the document ID.
 *
 * @return {!firebase.firestore.FieldPath***REMOVED***
 */
firebase.firestore.FieldPath.documentId = function() {***REMOVED***;

/**
 * Returns 'true' if this `FieldPath` is equal to the provided one.
 *
 * @param {!firebase.firestore.FieldPath***REMOVED*** other
 *   The `FieldPath` to compare against.
 *
 * @return {boolean***REMOVED***
 *   'true' if this `FieldPath` is equal to the provided one.
 */
firebase.firestore.FieldPath.prototype.isEqual = function(other) {***REMOVED***;
 ...
 * @interface
 */
firebase.firestore.FirestoreError = function() {***REMOVED***;
 ...
 *
 * @param {number***REMOVED*** seconds The number of seconds of UTC time since Unix epoch
 *     1970-01-01T00:00:00Z. Must be from 0001-01-01T00:00:00Z to
 *     9999-12-31T23:59:59Z inclusive.
 * @param {number***REMOVED*** nanoseconds The non-negative fractions of a second at
 ...
 * @constructor
 */
firebase.firestore.Timestamp = function(seconds, nanoseconds) {***REMOVED***;

/**
 * Get the current time as a Timestamp object.
 *
 * @return {!firebase.firestore.Timestamp***REMOVED*** a new Timestamp.
 */
firebase.firestore.Timestamp.now = function() {***REMOVED***;

/**
 * Creates a new timestamp from the given date.
 *
 * @param {!Date***REMOVED*** date The date to initialize the `Timestamp` from.
 * @return {!firebase.firestore.Timestamp***REMOVED*** A new `Timestamp` representing
 *     the same point in time as the given date.
 */
firebase.firestore.Timestamp.fromDate = function(date) {***REMOVED***;

/**
 * Creates a new timestamp from the given number of milliseconds.
 *
 * @param {number***REMOVED*** milliseconds Number of milliseconds since Unix epoch
 *     1970-01-01T00:00:00Z.
 * @return {!firebase.firestore.Timestamp***REMOVED*** A new `Timestamp` representing the
 *     same point in time as the given number of milliseconds.
 */
firebase.firestore.Timestamp.fromMillis = function(milliseconds) {***REMOVED***;

/**
 * Convert a Timestamp to a JavaScript `Date` object. This conversion causes
 * a loss of precision since `Date` objects only support millisecond precision.
 *
 * @return {!Date***REMOVED*** a JavaScript date object.
 */
firebase.firestore.Timestamp.prototype.toDate = function() {***REMOVED***;

/**
 * Convert a timestamp to a numeric timestamp (in milliseconds since epoch).
 * This operation causes a loss of precision.
 *
 * @return {!number***REMOVED*** a numeric timestamp.
 */
firebase.firestore.Timestamp.prototype.toMillis = function() {***REMOVED***;
