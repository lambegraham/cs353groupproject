...
message Binding {
  ...
  //
  // * `user:{emailid***REMOVED***`: An email address that represents a specific Google
  //    account. For example, `alice@example.com` .
  //
  //
  // * `serviceAccount:{emailid***REMOVED***`: An email address that represents a service
  //    account. For example, `my-other-app@appspot.gserviceaccount.com`.
  //
  // * `group:{emailid***REMOVED***`: An email address that represents a Google group.
  //    For example, `admins@example.com`.
  //
  //
  // * `domain:{domain***REMOVED***`: The G Suite domain (primary) that represents all the
