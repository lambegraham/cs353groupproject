...
service AlertPolicyService {
  ...
  rpc ListAlertPolicies(ListAlertPoliciesRequest)
    ...
    option (google.api.http) = {
      get: "/v3/{name=projects/****REMOVED***/alertPolicies"
  ***REMOVED***
***REMOVED***
  ...
  rpc GetAlertPolicy(GetAlertPolicyRequest) returns (AlertPolicy) {
    option (google.api.http) = {
      get: "/v3/{name=projects/*/alertPolicies/****REMOVED***"
  ***REMOVED***
***REMOVED***
  ...
  rpc CreateAlertPolicy(CreateAlertPolicyRequest) returns (AlertPolicy) {
    option (google.api.http) = {
      post: "/v3/{name=projects/****REMOVED***/alertPolicies"
      body: "alert_policy"
  ***REMOVED***
***REMOVED***
  ...
  rpc DeleteAlertPolicy(DeleteAlertPolicyRequest)
    ...
    option (google.api.http) = {
      delete: "/v3/{name=projects/*/alertPolicies/****REMOVED***"
  ***REMOVED***
***REMOVED***
  ...
  rpc UpdateAlertPolicy(UpdateAlertPolicyRequest) returns (AlertPolicy) {
    option (google.api.http) = {
      patch: "/v3/{alert_policy.name=projects/*/alertPolicies/****REMOVED***"
      body: "alert_policy"
  ***REMOVED***
***REMOVED***
***REMOVED***
