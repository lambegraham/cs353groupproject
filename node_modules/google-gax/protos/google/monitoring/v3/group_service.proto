...
service GroupService {
  ...
  rpc ListGroups(ListGroupsRequest) returns (ListGroupsResponse) {
    option (google.api.http) = {
      get: "/v3/{name=projects/****REMOVED***/groups"
  ***REMOVED***
***REMOVED***
  ...
  rpc GetGroup(GetGroupRequest) returns (Group) {
    option (google.api.http) = {
      get: "/v3/{name=projects/*/groups/****REMOVED***"
  ***REMOVED***
***REMOVED***
  ...
  rpc CreateGroup(CreateGroupRequest) returns (Group) {
    option (google.api.http) = {
      post: "/v3/{name=projects/****REMOVED***/groups"
      body: "group"
  ***REMOVED***
***REMOVED***
  ...
  rpc UpdateGroup(UpdateGroupRequest) returns (Group) {
    option (google.api.http) = {
      put: "/v3/{group.name=projects/*/groups/****REMOVED***"
      body: "group"
  ***REMOVED***
***REMOVED***
  ...
  rpc DeleteGroup(DeleteGroupRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = {
      delete: "/v3/{name=projects/*/groups/****REMOVED***"
  ***REMOVED***
***REMOVED***
  ...
  rpc ListGroupMembers(ListGroupMembersRequest)
    ...
    option (google.api.http) = {
      get: "/v3/{name=projects/*/groups/****REMOVED***/members"
  ***REMOVED***
***REMOVED***
***REMOVED***
...
message ListGroupsRequest {
  ...
  oneof filter {
    // A group name: `"projects/{project_id_or_number***REMOVED***/groups/{group_id***REMOVED***"`.
...
message GetGroupRequest {
  ...
  // `"projects/{project_id_or_number***REMOVED***/groups/{group_id***REMOVED***"`.
  string name = 3;
***REMOVED***
