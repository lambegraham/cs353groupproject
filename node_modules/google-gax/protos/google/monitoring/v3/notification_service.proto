...
service NotificationChannelService {
  ...
  rpc ListNotificationChannelDescriptors(
    ...
    option (google.api.http) = {
      get: "/v3/{name=projects/****REMOVED***/notificationChannelDescriptors"
  ***REMOVED***
***REMOVED***
  ...
  rpc GetNotificationChannelDescriptor(GetNotificationChannelDescriptorRequest)
    ...
    option (google.api.http) = {
      get: "/v3/{name=projects/*/notificationChannelDescriptors/****REMOVED***"
  ***REMOVED***
***REMOVED***
  ...
  rpc ListNotificationChannels(ListNotificationChannelsRequest)
    ...
    option (google.api.http) = {
      get: "/v3/{name=projects/****REMOVED***/notificationChannels"
  ***REMOVED***
***REMOVED***
  ...
  rpc GetNotificationChannel(GetNotificationChannelRequest)
    ...
    option (google.api.http) = {
      get: "/v3/{name=projects/*/notificationChannels/****REMOVED***"
  ***REMOVED***
***REMOVED***
  ...
  rpc CreateNotificationChannel(CreateNotificationChannelRequest)
      returns (NotificationChannel) {
    option (google.api.http) = {
      post: "/v3/{name=projects/****REMOVED***/notificationChannels"
...
***REMOVED***
  ...
  rpc UpdateNotificationChannel(UpdateNotificationChannelRequest)
      returns (NotificationChannel) {
    option (google.api.http) = {
      patch: "/v3/{notification_channel.name=projects/*/notificationChannels/****REMOVED***"
      body: "notification_channel"
  ***REMOVED***
***REMOVED***
  ...
  rpc DeleteNotificationChannel(DeleteNotificationChannelRequest)
    ...
    option (google.api.http) = {
      delete: "/v3/{name=projects/*/notificationChannels/****REMOVED***"
  ***REMOVED***
***REMOVED***
  ...
  rpc SendNotificationChannelVerificationCode(
      ...
      returns (google.protobuf.Empty) {
    option (google.api.http) = {
      post: "/v3/{name=projects/*/notificationChannels/****REMOVED***:sendVerificationCode"
      body: "*"
  ***REMOVED***
***REMOVED***
  ...
  rpc GetNotificationChannelVerificationCode(
    ...
    option (google.api.http) = {
      post: "/v3/{name=projects/*/notificationChannels/****REMOVED***:getVerificationCode"
      body: "*"
  ***REMOVED***
***REMOVED***
  ...
  rpc VerifyNotificationChannel(VerifyNotificationChannelRequest)
      returns (NotificationChannel) {
    option (google.api.http) = {
      post: "/v3/{name=projects/*/notificationChannels/****REMOVED***:verify"
      body: "*"
  ***REMOVED***
***REMOVED***
***REMOVED***
...
message GetNotificationChannelDescriptorRequest {
  ...
  // `projects/[PROJECT_ID]/notificationChannelDescriptors/{channel_type***REMOVED***`.
  string name = 3;
***REMOVED***
