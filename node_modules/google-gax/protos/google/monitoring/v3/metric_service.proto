...
service MetricService {
  ...
  rpc ListMonitoredResourceDescriptors(ListMonitoredResourceDescriptorsRequest)
    ...
    option (google.api.http) = {
      get: "/v3/{name=projects/****REMOVED***/monitoredResourceDescriptors"
  ***REMOVED***
***REMOVED***
  ...
  rpc GetMonitoredResourceDescriptor(GetMonitoredResourceDescriptorRequest)
    ...
    option (google.api.http) = {
      get: "/v3/{name=projects/*/monitoredResourceDescriptors/****REMOVED***"
  ***REMOVED***
***REMOVED***
  ...
  rpc ListMetricDescriptors(ListMetricDescriptorsRequest)
    ...
    option (google.api.http) = {
      get: "/v3/{name=projects/****REMOVED***/metricDescriptors"
  ***REMOVED***
***REMOVED***
  ...
  rpc GetMetricDescriptor(GetMetricDescriptorRequest)
    ...
    option (google.api.http) = {
      get: "/v3/{name=projects/*/metricDescriptors/*****REMOVED***"
  ***REMOVED***
***REMOVED***
  ...
  rpc CreateMetricDescriptor(CreateMetricDescriptorRequest)
      returns (google.api.MetricDescriptor) {
    option (google.api.http) = {
      post: "/v3/{name=projects/****REMOVED***/metricDescriptors"
...
***REMOVED***
  ...
  rpc DeleteMetricDescriptor(DeleteMetricDescriptorRequest)
    ...
    option (google.api.http) = {
      delete: "/v3/{name=projects/*/metricDescriptors/*****REMOVED***"
  ***REMOVED***
***REMOVED***
  ...
  rpc ListTimeSeries(ListTimeSeriesRequest) returns (ListTimeSeriesResponse) {
    option (google.api.http) = {
      get: "/v3/{name=projects/****REMOVED***/timeSeries"
  ***REMOVED***
***REMOVED***
  ...
  rpc CreateTimeSeries(CreateTimeSeriesRequest)
      returns (google.protobuf.Empty) {
    option (google.api.http) = {
      post: "/v3/{name=projects/****REMOVED***/timeSeries"
      body: "*"
  ***REMOVED***
***REMOVED***
***REMOVED***
...
message ListMonitoredResourceDescriptorsRequest {
  ...
  // `"projects/{project_id_or_number***REMOVED***"`.
  string name = 5;
...
message GetMonitoredResourceDescriptorRequest {
  ...
  // `"projects/{project_id_or_number***REMOVED***/monitoredResourceDescriptors/{resource_type***REMOVED***"`.
  // The `{resource_type***REMOVED***` is a predefined type, such as
  // `cloudsql_database`.
  string name = 3;
***REMOVED***
...
message GetMetricDescriptorRequest {
  ...
  // `"projects/{project_id_or_number***REMOVED***/metricDescriptors/{metric_id***REMOVED***"`.
  // An example value of `{metric_id***REMOVED***` is
...
message DeleteMetricDescriptorRequest {
  // The metric descriptor on which to execute the request. The format is
  // `"projects/{project_id_or_number***REMOVED***/metricDescriptors/{metric_id***REMOVED***"`.
  // An example of `{metric_id***REMOVED***` is:
