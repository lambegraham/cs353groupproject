...
***REMOVED***
  ...
  rpc GetService(GetServiceRequest) returns (ManagedService) {
    option (google.api.http) = {
      get: "/v1/services/{service_name***REMOVED***"
  ***REMOVED***
***REMOVED***
...
***REMOVED***
  ...
  rpc DeleteService(DeleteServiceRequest)
      returns (google.longrunning.Operation) {
    option (google.api.http) = {
      delete: "/v1/services/{service_name***REMOVED***"
  ***REMOVED***
***REMOVED***
  ...
  rpc UndeleteService(UndeleteServiceRequest)
      returns (google.longrunning.Operation) {
    option (google.api.http) = {
      post: "/v1/services/{service_name***REMOVED***:undelete"
  ***REMOVED***
***REMOVED***
  ...
  rpc ListServiceConfigs(ListServiceConfigsRequest)
    ...
    option (google.api.http) = {
      get: "/v1/services/{service_name***REMOVED***/configs"
  ***REMOVED***
***REMOVED***
  ...
  rpc GetServiceConfig(GetServiceConfigRequest) returns (google.api.Service) {
    option (google.api.http) = {
      get: "/v1/services/{service_name***REMOVED***/configs/{config_id***REMOVED***"
      additional_bindings { get: "/v1/services/{service_name***REMOVED***/config" ***REMOVED***
  ***REMOVED***
***REMOVED***
  ...
  rpc CreateServiceConfig(CreateServiceConfigRequest)
    ...
    option (google.api.http) = {
      post: "/v1/services/{service_name***REMOVED***/configs"
      body: "service_config"
  ***REMOVED***
***REMOVED***
  ...
  rpc SubmitConfigSource(SubmitConfigSourceRequest)
      returns (google.longrunning.Operation) {
    option (google.api.http) = {
      post: "/v1/services/{service_name***REMOVED***/configs:submit"
      body: "*"
  ***REMOVED***
***REMOVED***
  ...
  rpc ListServiceRollouts(ListServiceRolloutsRequest)
    ...
    option (google.api.http) = {
      get: "/v1/services/{service_name***REMOVED***/rollouts"
  ***REMOVED***
***REMOVED***
  ...
  rpc GetServiceRollout(GetServiceRolloutRequest) returns (Rollout) {
    option (google.api.http) = {
      get: "/v1/services/{service_name***REMOVED***/rollouts/{rollout_id***REMOVED***"
  ***REMOVED***
***REMOVED***
  ...
  rpc CreateServiceRollout(CreateServiceRolloutRequest)
      returns (google.longrunning.Operation) {
    option (google.api.http) = {
      post: "/v1/services/{service_name***REMOVED***/rollouts"
      body: "rollout"
  ***REMOVED***
***REMOVED***
...
***REMOVED***
  ...
  rpc EnableService(EnableServiceRequest)
      returns (google.longrunning.Operation) {
    option (google.api.http) = {
      post: "/v1/services/{service_name***REMOVED***:enable"
      body: "*"
  ***REMOVED***
***REMOVED***
  ...
  rpc DisableService(DisableServiceRequest)
      returns (google.longrunning.Operation) {
    option (google.api.http) = {
      post: "/v1/services/{service_name***REMOVED***:disable"
      body: "*"
  ***REMOVED***
***REMOVED***
***REMOVED***
