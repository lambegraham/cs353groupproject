...
#### Simple Post
```js
fetch('https://httpbin.org/post', { method: 'POST', body: 'a=1' ***REMOVED***)
...
```js
const { URLSearchParams ***REMOVED*** = require('url');

const params = new URLSearchParams();
params.append('a', 1);

fetch('https://httpbin.org/post', { method: 'POST', body: params ***REMOVED***)
    .then(res => res.json())
    .then(json => console.log(json));
```
...
```js
const { createReadStream ***REMOVED*** = require('fs');

const stream = createReadStream('input.txt');

fetch('https://httpbin.org/post', { method: 'POST', body: stream ***REMOVED***)
    .then(res => res.json())
    .then(json => console.log(json));
```
...
fetch('https://httpbin.org/post', { method: 'POST', body: form ***REMOVED***)
    .then(res => res.json())
    .then(json => console.log(json));
...
fetch(url, { signal: controller.signal ***REMOVED***)
  .then(res => res.json())
  .then(
    data => {
      useData(data)
