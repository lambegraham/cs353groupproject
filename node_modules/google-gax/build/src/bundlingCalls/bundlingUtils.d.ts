import { RequestType ***REMOVED*** from '../apitypes';
/**
 * Compute the identifier of the `obj`. The objects of the same ID
 * will be bundled together.
 *
 * @param {RequestType***REMOVED*** obj - The request object.
 * @param {String[]***REMOVED*** discriminatorFields - The array of field names.
 *   A field name may include '.' as a separator, which is used to
 *   indicate object traversal.
 * @return {String|undefined***REMOVED*** - the identifier string, or undefined if any
