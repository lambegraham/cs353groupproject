import { APICallback, RequestType, ResultTuple, SimpleCallbackFunction ***REMOVED*** from './apitypes';
export declare class OngoingCall {
     ...
     * of the API calls.
     * @param {APICallback=***REMOVED*** callback
     *   The callback to be called asynchronously when the API call
     *   finishes.
     * @constructor
     * @property {APICallback***REMOVED*** callback
     ...
     * the promise.
     *
     * @param {SimpleCallbackFunction***REMOVED*** func
     *   A function for an API call.
     * @param {Object***REMOVED*** argument
     *   A request object.
     */
...
export declare class OngoingCallPromise extends OngoingCall {
     ...
     * @param {Function***REMOVED*** PromiseCtor - A constructor for a promise that implements
