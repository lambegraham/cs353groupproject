 ...
 * @namespace
 */
var firebaseui = {***REMOVED***;

/**
 * The FirebaseUI auth namespace.
 * @namespace
 */
firebaseui.auth = {***REMOVED***;
 ...
 * @constructor
 */
firebaseui.auth.AnonymousAuthProvider = {***REMOVED***;
...
/**
 * @param {!firebase.auth.Auth***REMOVED*** auth The Firebase Auth instance.
 * @param {string=***REMOVED*** appId The optional app id.
 * @constructor
 */
firebaseui.auth.AuthUI = function(auth, appId) {***REMOVED***;

/**
 * Returns the AuthUI instance corresponding to the appId provided.
 *
 * @param {?string=***REMOVED*** appId The optional app ID whose instance is to be
 *     provided.
 * @return {?firebaseui.auth.AuthUI***REMOVED*** The AuthUI instance corresponding to the
 *     app ID provided.
 */
firebaseui.auth.AuthUI.getInstance = function(appId) {***REMOVED***;

/**
 * Disables One-Tap auto sign-in.
 */
firebaseui.auth.AuthUI.prototype.disableAutoSignIn = function() {***REMOVED***;
 ...
 * more than once.
 *
 * @param {string|!Element***REMOVED*** element The container element or the query selector.
 * @param {!firebaseui.auth.Config***REMOVED*** config The configuration for the rendered
 *     UI.
 */
firebaseui.auth.AuthUI.prototype.start = function(element, config) {***REMOVED***;

/**
 * Sets the app configuration.
 *
 * @param {!firebaseui.auth.Config***REMOVED*** config The application configuration.
 */
firebaseui.auth.AuthUI.prototype.setConfig = function(config) {***REMOVED***;

/**
 * Triggers the sign-in flow.
 */
firebaseui.auth.AuthUI.prototype.signIn = function() {***REMOVED***;

/** Reset rendered widget and removes it from display. */
firebaseui.auth.AuthUI.prototype.reset = function() {***REMOVED***;

/**
 * Destroys the AuthUI instance.
 *
 * @return {!Promise<void>***REMOVED*** The promise that resolves when the instance is
 *     successfully deleted.
 */
firebaseui.auth.AuthUI.prototype.delete = function() {***REMOVED***;

/**
 * Returns true if there is any pending redirect operation to be resolved by
 * the widget.
 *
 * @return {boolean***REMOVED*** Whether the app has pending redirect operations to be
 *     performed or there is a pending incoming sign in with email link
 *     operation waiting to be completed.
 */
firebaseui.auth.AuthUI.prototype.isPendingRedirect = function() {***REMOVED***;
 ...
 *
 * @interface
 * @extends {Error***REMOVED***
 */
firebaseui.auth.AuthUIError = function() {***REMOVED***;
 ...
 * error.
 *
 * @type {?firebase.auth.AuthCredential***REMOVED***
 */
firebaseui.auth.AuthUIError.prototype.credential;

/**
 * @return {!Object***REMOVED*** The plain object representation of the error.
 */
firebaseui.auth.AuthUIError.prototype.toJSON = function() {***REMOVED***;
 ...
 *
 * @type {!firebaseui.auth.Callbacks|undefined***REMOVED***
 */
 ...
 *
 * @type {!firebaseui.auth.CredentialHelper|undefined***REMOVED***
 */
 ...
 *
 * @type {!Array<!firebaseui.auth.SignInOption|string>|undefined***REMOVED***
 */
 ...
 *
 * @type {string|function()|undefined***REMOVED***
 */
 ...
 * @interface
 */
firebaseui.auth.Callbacks = function() {***REMOVED***;

/**
 * Defines the sign-in success callback which will get triggered on successful
 * sign-in.
 *
 * @param {!firebase.auth.UserCredential***REMOVED*** authResult The
 *     `firebase.auth.UserCredential` corresponding to the signed in user.
 * @param {string=***REMOVED*** redirectUrl The redirect URL if it was previously appended
 *     to the page URL.
 * @return {boolean***REMOVED*** Whether to automatically redirect to the
 *     `signInSuccessUrl`.
 */
firebaseui.auth.Callbacks.prototype.signInSuccessWithAuthResult =
    function(authResult, redirectUrl) {***REMOVED***;
 ...
 *
 * @param {!firebaseui.auth.AuthUIError***REMOVED*** error The FirebaseUI error identifying
 *     the reason behind the failure.
 * @return {!Promise<void>***REMOVED*** A promise that resolves when the merge conflict
 *     is completed.
 */
firebaseui.auth.Callbacks.prototype.signInFailure = function(error) {***REMOVED***;

/**
 * Defines the callback which gets triggered when the initial UI is rendered.
 */
firebaseui.auth.Callbacks.prototype.uiShown = function() {***REMOVED***;
 ...
 * @interface
 */
firebaseui.auth.SignInOption = function() {***REMOVED***;
 ...
 *
 * @interface
 * @extends {firebaseui.auth.SignInOption***REMOVED***
 */
firebaseui.auth.FederatedSignInOption = function() {***REMOVED***;
 ...
 * ];
 *
 * @type {!Array<string>|undefined***REMOVED***
 */
 ...
 * @extends {firebaseui.auth.SignInOption***REMOVED***
 */
firebaseui.auth.SamlSignInOption = function() {***REMOVED***;
 ...
 * @extends {firebaseui.auth.SignInOption***REMOVED***
 */
firebaseui.auth.OAuthSignInOption = function() {***REMOVED***;
 ...
 * @extends {firebaseui.auth.SignInOption***REMOVED***
 */
firebaseui.auth.OidcSignInOption = function() {***REMOVED***;
 ...
 * @extends {firebaseui.auth.SignInOption***REMOVED***
 */
firebaseui.auth.EmailSignInOption = function() {***REMOVED***;
 ...
 *
 * @type {(function():!firebase.auth.ActionCodeSettings)|undefined***REMOVED***
 */
 ...
 * @extends {firebaseui.auth.SignInOption***REMOVED***
 */
firebaseui.auth.PhoneSignInOption = function() {***REMOVED***;
