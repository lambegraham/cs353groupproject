...
interface RequireResolve {
    (id: string, options?: { paths?: string[]; ***REMOVED***): string;
...
interface Buffer extends NodeBuffer { ***REMOVED***
...
declare namespace NodeJS {
  ...
  ***REMOVED***
    ...
    export interface ReadableStream extends EventEmitter {
        ...
        resume(): this;
        isPaused(): boolean;
        pipe<T extends WritableStream>(destination: T, options?: { end?: boolean; ***REMOVED***): T;
  ...
  ***REMOVED***
    ...
    export interface ReadWriteStream extends ReadableStream, WritableStream { ***REMOVED***

    export interface Events extends EventEmitter { ***REMOVED***
  ...
  ***REMOVED***
    ...
    type UnhandledRejectionListener = (reason: {***REMOVED*** | null | undefined, promise: Promise<any>) => void;
...
declare module "buffer" {
    ...
    export { BuffType as Buffer, SlowBuffType as SlowBuffer ***REMOVED***;
***REMOVED***
...
declare module "querystring" {
  ...
  ***REMOVED***
    ...
    interface ParsedUrlQuery { [key: string]: string | string[] | undefined; ***REMOVED***

    export function stringify<T>(obj: T, sep?: string, eq?: string, options?: StringifyOptions): string;
    export function parse(str: string, sep?: string, eq?: string, options?: ParseOptions): ParsedUrlQuery;
    export function parse<T extends {***REMOVED***>(str: string, sep?: string, eq?: string, options?: ParseOptions): T;
    export function escape(str: string): string;
    export function unescape(str: string): string;
***REMOVED***

declare module "events" {
    class internal extends NodeJS.EventEmitter { ***REMOVED***
...
declare module "http" {
  ...
  ***REMOVED***
    ...
    export class IncomingMessage extends stream.Readable {
        ...
        rawHeaders: string[];
        trailers: { [key: string]: string | undefined ***REMOVED***;
        rawTrailers: string[];
        setTimeout(msecs: number, callback: () => void): this;
        /**
  ...
  ***REMOVED***
     ...
     * @deprecated Use IncomingMessage
     */
    export class ClientResponse extends IncomingMessage { ***REMOVED***
  ...
  ***REMOVED***
    ...
    export interface RequestOptions extends ClientRequestArgs { ***REMOVED***
...
declare module "zlib" {
  ...
  ***REMOVED***
    ...
    export interface Gzip extends stream.Transform, Zlib { ***REMOVED***
    export interface Gunzip extends stream.Transform, Zlib { ***REMOVED***
    export interface Deflate extends stream.Transform, Zlib, ZlibReset, ZlibParams { ***REMOVED***
    export interface Inflate extends stream.Transform, Zlib, ZlibReset { ***REMOVED***
    export interface DeflateRaw extends stream.Transform, Zlib, ZlibReset, ZlibParams { ***REMOVED***
    export interface InflateRaw extends stream.Transform, Zlib, ZlibReset { ***REMOVED***
    export interface Unzip extends stream.Transform, Zlib { ***REMOVED***
...
declare module "os" {
  ...
  ***REMOVED***
    ...
    export function networkInterfaces(): { [index: string]: NetworkInterfaceInfo[] ***REMOVED***;
    export function homedir(): string;
    export function userInfo(options?: { encoding: string ***REMOVED***): { username: string, uid: number, gid: number, shell: any, homedir: string ***REMOVED***;
...
declare module "repl" {
  ...
  ***REMOVED***
    ...
    export interface REPLServer extends readline.ReadLine {
        ...
        defineCommand(keyword: string, cmd: Function | { help: string, action: Function ***REMOVED***): void;
...
declare module "child_process" {
  ...
  ***REMOVED***
    ...
    export function exec(command: string, options: { encoding: "buffer" | null ***REMOVED*** & ExecOptions, callback?: (error: Error | null, stdout: Buffer, stderr: Buffer) => void): ChildProcess;

    // `options` with well known `encoding` means stdout/stderr are definitely `string`.
    export function exec(command: string, options: { encoding: BufferEncoding ***REMOVED*** & ExecOptions, callback?: (error: Error | null, stdout: string, stderr: string) => void): ChildProcess;

    // `options` with an `encoding` whose type is `string` means stdout/stderr could either be `Buffer` or `string`.
    // There is no guarantee the `encoding` is unknown as `string` is a superset of `BufferEncoding`.
    export function exec(command: string, options: { encoding: string ***REMOVED*** & ExecOptions, callback?: (error: Error | null, stdout: string | Buffer, stderr: string | Buffer) => void): ChildProcess;
    ...
    export function exec(command: string, options: ({ encoding?: string | null ***REMOVED*** & ExecOptions) | undefined | null, callback?: (error: Error | null, stdout: string | Buffer, stderr: string | Buffer) => void): ChildProcess;

    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace exec {
        export function __promisify__(command: string): Promise<{ stdout: string, stderr: string ***REMOVED***>;
        export function __promisify__(command: string, options: { encoding: "buffer" | null ***REMOVED*** & ExecOptions): Promise<{ stdout: Buffer, stderr: Buffer ***REMOVED***>;
        export function __promisify__(command: string, options: { encoding: BufferEncoding ***REMOVED*** & ExecOptions): Promise<{ stdout: string, stderr: string ***REMOVED***>;
        export function __promisify__(command: string, options: ExecOptions): Promise<{ stdout: string, stderr: string ***REMOVED***>;
        export function __promisify__(command: string, options?: ({ encoding?: string | null ***REMOVED*** & ExecOptions) | null): Promise<{ stdout: string | Buffer, stderr: string | Buffer ***REMOVED***>;
  ***REMOVED***
  ...
  ***REMOVED***
    ...
    export function execFile(file: string, options: ({ encoding?: string | null ***REMOVED*** & ExecFileOptions) | undefined | null): ChildProcess;
    export function execFile(file: string, args: string[] | undefined | null): ChildProcess;
    export function execFile(file: string, args: string[] | undefined | null, options: ({ encoding?: string | null ***REMOVED*** & ExecFileOptions) | undefined | null): ChildProcess;
    ...
    // fallback if nothing else matches. Worst case is always `string | Buffer`.
    export function execFile(file: string, options: ({ encoding?: string | null ***REMOVED*** & ExecFileOptions) | undefined | null, callback: ((error: Error | null, stdout: string | Buffer, stderr: string | Buffer) => void) | undefined | null): ChildProcess;
    export function execFile(file: string, args: string[] | undefined | null, options: ({ encoding?: string | null ***REMOVED*** & ExecFileOptions) | undefined | null, callback: ((error: Error | null, stdout: string | Buffer, stderr: string | Buffer) => void) | undefined | null): ChildProcess;

    // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
    export namespace execFile {
        export function __promisify__(file: string): Promise<{ stdout: string, stderr: string ***REMOVED***>;
        export function __promisify__(file: string, args: string[] | undefined | null): Promise<{ stdout: string, stderr: string ***REMOVED***>;
        export function __promisify__(file: string, options: ExecFileOptionsWithBufferEncoding): Promise<{ stdout: Buffer, stderr: Buffer ***REMOVED***>;
        export function __promisify__(file: string, args: string[] | undefined | null, options: ExecFileOptionsWithBufferEncoding): Promise<{ stdout: Buffer, stderr: Buffer ***REMOVED***>;
        export function __promisify__(file: string, options: ExecFileOptionsWithStringEncoding): Promise<{ stdout: string, stderr: string ***REMOVED***>;
        export function __promisify__(file: string, args: string[] | undefined | null, options: ExecFileOptionsWithStringEncoding): Promise<{ stdout: string, stderr: string ***REMOVED***>;
        export function __promisify__(file: string, options: ExecFileOptionsWithOtherEncoding): Promise<{ stdout: string | Buffer, stderr: string | Buffer ***REMOVED***>;
        export function __promisify__(file: string, args: string[] | undefined | null, options: ExecFileOptionsWithOtherEncoding): Promise<{ stdout: string | Buffer, stderr: string | Buffer ***REMOVED***>;
        export function __promisify__(file: string, options: ExecFileOptions): Promise<{ stdout: string, stderr: string ***REMOVED***>;
        export function __promisify__(file: string, args: string[] | undefined | null, options: ExecFileOptions): Promise<{ stdout: string, stderr: string ***REMOVED***>;
        export function __promisify__(file: string, options: ({ encoding?: string | null ***REMOVED*** & ExecFileOptions) | undefined | null): Promise<{ stdout: string | Buffer, stderr: string | Buffer ***REMOVED***>;
        export function __promisify__(file: string, args: string[] | undefined | null, options: ({ encoding?: string | null ***REMOVED*** & ExecFileOptions) | undefined | null): Promise<{ stdout: string | Buffer, stderr: string | Buffer ***REMOVED***>;
  ***REMOVED***
...
declare module "url" {
    import { ParsedUrlQuery ***REMOVED*** from 'querystring';
  ...
  ***REMOVED***
    ...
    export interface UrlObject extends UrlObjectCommon {
        port?: string | number;
        query?: string | null | { [key: string]: any ***REMOVED***;
  ***REMOVED***
  ...
  ***REMOVED***
    ...
    export class URLSearchParams implements Iterable<[string, string]> {
        constructor(init?: URLSearchParams | string | { [key: string]: string | string[] | undefined ***REMOVED*** | Iterable<[string, string]> | Array<[string, string]>);
...
declare module "dns" {
  ...
  ***REMOVED***
    ...
    export namespace lookup {
        export function __promisify__(hostname: string, options: LookupAllOptions): Promise<{ address: LookupAddress[] ***REMOVED***>;
        export function __promisify__(hostname: string, options?: LookupOneOptions | number): Promise<{ address: string, family: number ***REMOVED***>;
        export function __promisify__(hostname: string, options?: LookupOptions | number): Promise<{ address: string | LookupAddress[], family?: number ***REMOVED***>;
  ***REMOVED***

    export function lookupService(address: string, port: number, callback: (err: NodeJS.ErrnoException | null, hostname: string, service: string) => void): void;

    export namespace lookupService {
        export function __promisify__(address: string, port: number): Promise<{ hostname: string, service: string ***REMOVED***>;
  ***REMOVED***
...
declare module "net" {
  ...
  ***REMOVED***
    ...
    export class Socket extends stream.Duplex {
        ...
        address(): { port: number; family: string; address: string; ***REMOVED***;
        unref(): void;
        ref(): void;
  ...
  ***REMOVED***
    ...
    export class Server extends events.EventEmitter {
        ...
        constructor(options?: { allowHalfOpen?: boolean, pauseOnConnect?: boolean ***REMOVED***, connectionListener?: (socket: Socket) => void);
  ...
  ***REMOVED***
    ...
    export function createServer(options?: { allowHalfOpen?: boolean, pauseOnConnect?: boolean ***REMOVED***, connectionListener?: (socket: Socket) => void): Server;
...
declare module "fs" {
  ...
  ***REMOVED***
     ...
     */
    export function readlink(path: PathLike, options: { encoding?: BufferEncoding | null ***REMOVED*** | BufferEncoding | undefined | null, callback: (err: NodeJS.ErrnoException | null, linkString: string) => void): void;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function readlink(path: PathLike, options: { encoding: "buffer" ***REMOVED*** | "buffer", callback: (err: NodeJS.ErrnoException | null, linkString: Buffer) => void): void;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function readlink(path: PathLike, options: { encoding?: string | null ***REMOVED*** | string | undefined | null, callback: (err: NodeJS.ErrnoException | null, linkString: string | Buffer) => void): void;
    ...
    export namespace readlink {
         ...
         * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
         */
        export function __promisify__(path: PathLike, options?: { encoding?: BufferEncoding | null ***REMOVED*** | BufferEncoding | null): Promise<string>;
         ...
         * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
         */
        export function __promisify__(path: PathLike, options: { encoding: "buffer" ***REMOVED*** | "buffer"): Promise<Buffer>;
         ...
         * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
         */
        export function __promisify__(path: PathLike, options?: { encoding?: string | null ***REMOVED*** | string | null): Promise<string | Buffer>;
  ***REMOVED***
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function readlinkSync(path: PathLike, options?: { encoding?: BufferEncoding | null ***REMOVED*** | BufferEncoding | null): string;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function readlinkSync(path: PathLike, options: { encoding: "buffer" ***REMOVED*** | "buffer"): Buffer;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function readlinkSync(path: PathLike, options?: { encoding?: string | null ***REMOVED*** | string | null): string | Buffer;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function realpath(path: PathLike, options: { encoding?: BufferEncoding | null ***REMOVED*** | BufferEncoding | undefined | null, callback: (err: NodeJS.ErrnoException | null, resolvedPath: string) => void): void;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function realpath(path: PathLike, options: { encoding: "buffer" ***REMOVED*** | "buffer", callback: (err: NodeJS.ErrnoException | null, resolvedPath: Buffer) => void): void;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function realpath(path: PathLike, options: { encoding?: string | null ***REMOVED*** | string | undefined | null, callback: (err: NodeJS.ErrnoException | null, resolvedPath: string | Buffer) => void): void;
  ...
  ***REMOVED***
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function realpathSync(path: PathLike, options?: { encoding?: BufferEncoding | null ***REMOVED*** | BufferEncoding | null): string;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function realpathSync(path: PathLike, options: { encoding: "buffer" ***REMOVED*** | "buffer"): Buffer;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function realpathSync(path: PathLike, options?: { encoding?: string | null ***REMOVED*** | string | null): string | Buffer;
  ...
  ***REMOVED***
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function mkdtemp(prefix: string, options: { encoding?: BufferEncoding | null ***REMOVED*** | BufferEncoding | undefined | null, callback: (err: NodeJS.ErrnoException | null, folder: string) => void): void;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function mkdtemp(prefix: string, options: "buffer" | { encoding: "buffer" ***REMOVED***, callback: (err: NodeJS.ErrnoException | null, folder: Buffer) => void): void;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function mkdtemp(prefix: string, options: { encoding?: string | null ***REMOVED*** | string | undefined | null, callback: (err: NodeJS.ErrnoException | null, folder: string | Buffer) => void): void;
    ...
    export namespace mkdtemp {
         ...
         * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
         */
        export function __promisify__(prefix: string, options?: { encoding?: BufferEncoding | null ***REMOVED*** | BufferEncoding | null): Promise<string>;
         ...
         * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
         */
        export function __promisify__(prefix: string, options: { encoding: "buffer" ***REMOVED*** | "buffer"): Promise<Buffer>;
         ...
         * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
         */
        export function __promisify__(prefix: string, options?: { encoding?: string | null ***REMOVED*** | string | null): Promise<string | Buffer>;
  ***REMOVED***
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function mkdtempSync(prefix: string, options?: { encoding?: BufferEncoding | null ***REMOVED*** | BufferEncoding | null): string;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function mkdtempSync(prefix: string, options: { encoding: "buffer" ***REMOVED*** | "buffer"): Buffer;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function mkdtempSync(prefix: string, options?: { encoding?: string | null ***REMOVED*** | string | null): string | Buffer;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function readdir(path: PathLike, options: { encoding: BufferEncoding | null ***REMOVED*** | BufferEncoding | undefined | null, callback: (err: NodeJS.ErrnoException | null, files: string[]) => void): void;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function readdir(path: PathLike, options: { encoding: "buffer" ***REMOVED*** | "buffer", callback: (err: NodeJS.ErrnoException | null, files: Buffer[]) => void): void;
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function readdir(path: PathLike, options: { encoding?: string | null ***REMOVED*** | string | undefined | null, callback: (err: NodeJS.ErrnoException | null, files: string[] | Buffer[]) => void): void;
    ...
    export namespace readdir {
         ...
         * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
         */
        export function __promisify__(path: PathLike, options: "buffer" | { encoding: "buffer" ***REMOVED***): Promise<Buffer[]>;
  ...
  ***REMOVED***
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function readdirSync(path: PathLike, options?: { encoding: BufferEncoding | null ***REMOVED*** | BufferEncoding | null): string[];
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function readdirSync(path: PathLike, options: { encoding: "buffer" ***REMOVED*** | "buffer"): Buffer[];
     ...
     * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
     */
    export function readdirSync(path: PathLike, options?: { encoding?: string | null ***REMOVED*** | string | null): string[] | Buffer[];
  ...
  ***REMOVED***
    ...
    export namespace write {
         ...
         * @param position The offset from the beginning of the file where this data should be written. If not supplied, defaults to the current position.
         */
        export function __promisify__<TBuffer extends Buffer | Uint8Array>(fd: number, buffer?: TBuffer, offset?: number, length?: number, position?: number | null): Promise<{ bytesWritten: number, buffer: TBuffer ***REMOVED***>;
         ...
         * @param encoding The expected string encoding.
         */
        export function __promisify__(fd: number, string: any, position?: number | null, encoding?: string | null): Promise<{ bytesWritten: number, buffer: string ***REMOVED***>;
  ***REMOVED***
    ...
    export namespace read {
         ...
         * @param position The offset from the beginning of the file from which data should be read. If `null`, data will be read from the current position.
         */
        export function __promisify__<TBuffer extends Buffer | Uint8Array>(fd: number, buffer: TBuffer, offset: number, length: number, position: number | null): Promise<{ bytesRead: number, buffer: TBuffer ***REMOVED***>;
  ***REMOVED***
     ...
     */
    export function readFile(path: PathLike | number, options: { encoding?: null; flag?: string; ***REMOVED*** | undefined | null, callback: (err: NodeJS.ErrnoException | null, data: Buffer) => void): void;
     ...
     * If a flag is not provided, it defaults to `'r'`.
     */
    export function readFile(path: PathLike | number, options: { encoding: string; flag?: string; ***REMOVED*** | string, callback: (err: NodeJS.ErrnoException | null, data: string) => void): void;
     ...
     * If a flag is not provided, it defaults to `'r'`.
     */
    export function readFile(path: PathLike | number, options: { encoding?: string | null; flag?: string; ***REMOVED*** | string | undefined | null, callback: (err: NodeJS.ErrnoException | null, data: string | Buffer) => void): void;
    ...
    export namespace readFile {
         ...
         * If a flag is not provided, it defaults to `'r'`.
         */
        export function __promisify__(path: PathLike | number, options?: { encoding?: null; flag?: string; ***REMOVED*** | null): Promise<Buffer>;
         ...
         * If a flag is not provided, it defaults to `'r'`.
         */
        export function __promisify__(path: PathLike | number, options: { encoding: string; flag?: string; ***REMOVED*** | string): Promise<string>;
         ...
         * If a flag is not provided, it defaults to `'r'`.
         */
        export function __promisify__(path: PathLike | number, options?: { encoding?: string | null; flag?: string; ***REMOVED*** | string | null): Promise<string | Buffer>;
  ***REMOVED***
     ...
     */
    export function readFileSync(path: PathLike | number, options?: { encoding?: null; flag?: string; ***REMOVED*** | null): Buffer;
     ...
     * If a flag is not provided, it defaults to `'r'`.
     */
    export function readFileSync(path: PathLike | number, options: { encoding: string; flag?: string; ***REMOVED*** | string): string;
     ...
     * If a flag is not provided, it defaults to `'r'`.
     */
    export function readFileSync(path: PathLike | number, options?: { encoding?: string | null; flag?: string; ***REMOVED*** | string | null): string | Buffer;
     ...
     */
    export function writeFile(path: PathLike | number, data: any, options: { encoding?: string | null; mode?: number | string; flag?: string; ***REMOVED*** | string | undefined | null, callback: (err: NodeJS.ErrnoException | null) => void): void;
    ...
    export namespace writeFile {
         ...
         * If `flag` is not supplied, the default of `'w'` is used.
         */
        export function __promisify__(path: PathLike | number, data: any, options?: { encoding?: string | null; mode?: number | string; flag?: string; ***REMOVED*** | string | null): Promise<void>;
  ***REMOVED***
     ...
     * If `flag` is not supplied, the default of `'w'` is used.
     */
    export function writeFileSync(path: PathLike | number, data: any, options?: { encoding?: string | null; mode?: number | string; flag?: string; ***REMOVED*** | string | null): void;
     ...
     */
    export function appendFile(file: PathLike | number, data: any, options: { encoding?: string | null, mode?: string | number, flag?: string ***REMOVED*** | string | undefined | null, callback: (err: NodeJS.ErrnoException | null) => void): void;
    ...
    export namespace appendFile {
         ...
         * If `flag` is not supplied, the default of `'a'` is used.
         */
        export function __promisify__(file: PathLike | number, data: any, options?: { encoding?: string | null, mode?: string | number, flag?: string ***REMOVED*** | string | null): Promise<void>;
  ***REMOVED***
     ...
     * If `flag` is not supplied, the default of `'a'` is used.
     */
    export function appendFileSync(file: PathLike | number, data: any, options?: { encoding?: string | null; mode?: number | string; flag?: string; ***REMOVED*** | string | null): void;

    /**
     * Watch for changes on `filename`. The callback `listener` will be called each time the file is accessed.
     */
    export function watchFile(filename: PathLike, options: { persistent?: boolean; interval?: number; ***REMOVED*** | undefined, listener: (curr: Stats, prev: Stats) => void): void;
     ...
     */
    export function watch(filename: PathLike, options: { encoding?: BufferEncoding | null, persistent?: boolean, recursive?: boolean ***REMOVED*** | BufferEncoding | undefined | null, listener?: (event: string, filename: string) => void): FSWatcher;
     ...
     * If `recursive` is not supplied, the default of `false` is used.
     */
    export function watch(filename: PathLike, options: { encoding: "buffer", persistent?: boolean, recursive?: boolean ***REMOVED*** | "buffer", listener?: (event: string, filename: Buffer) => void): FSWatcher;
     ...
     * If `recursive` is not supplied, the default of `false` is used.
     */
    export function watch(filename: PathLike, options: { encoding?: string | null, persistent?: boolean, recursive?: boolean ***REMOVED*** | string | null, listener?: (event: string, filename: string | Buffer) => void): FSWatcher;
...
declare module "tls" {
  ...
  ***REMOVED***
    ...
    export interface PeerCertificate {
        ...
        infoAccess: { [index: string]: string[] | undefined ***REMOVED***;
        modulus: string;
        exponent: string;
        valid_from: string;
        valid_to: string;
  ...
  ***REMOVED***
    ...
    export class TLSSocket extends net.Socket {
      ...
      ***REMOVED***);
         ...
         */
        renegotiate(options: { rejectUnauthorized?: boolean, requestCert?: boolean ***REMOVED***, callback: (err: Error | null) => void): any;
        /**
...
declare module "crypto" {
  ...
  ***REMOVED***
    ...
    export interface CredentialDetails {
        ...
        ciphers: string;
  ***REMOVED***
    export interface Credentials { context?: any; ***REMOVED***
  ...
  ***REMOVED***
    ...
    export interface Signer extends NodeJS.WritableStream {
        ...
        sign(private_key: string | { key: string; passphrase?: string ***REMOVED***): Buffer;
        sign(private_key: string | { key: string; passphrase?: string ***REMOVED***, output_format: HexBase64Latin1Encoding): string;
  ***REMOVED***
...
declare module "stream" {
    ...
    class internal extends events.EventEmitter {
        pipe<T extends NodeJS.WritableStream>(destination: T, options?: { end?: boolean; ***REMOVED***): T;
  ***REMOVED***

    namespace internal {
        export class Stream extends internal { ***REMOVED***
      ...
      ***REMOVED***
        ...
        export interface WritableOptions {
            ...
            writev?: (chunks: Array<{ chunk: any, encoding: string ***REMOVED***>, callback: Function) => any;
            destroy?: (error: Error | null, callback: (error?: Error) => void) => void;
      ...
      ***REMOVED***
        ...
        export class Writable extends Stream implements NodeJS.WritableStream {
            ...
            _writev?(chunks: Array<{ chunk: any, encoding: string ***REMOVED***>, callback: (err?: Error) => void): void;
            _destroy(error: Error | null, callback: (error?: Error) => void): void;
            _final(callback: Function): void;
      ...
      ***REMOVED***
        ...
        export class PassThrough extends Transform { ***REMOVED***
  ***REMOVED***
...
declare module "util" {
    export interface InspectOptions extends NodeJS.InspectOptions { ***REMOVED***
  ...
  ***REMOVED***
    ...
    export class TextDecoder {
        ...
        constructor(
          encoding?: string,
          options?: { fatal?: boolean; ignoreBOM?: boolean ***REMOVED***
        );
        decode(
          input?:
            Int8Array
            ...
            | ArrayBuffer
            | null,
          options?: { stream?: boolean ***REMOVED***
        ): string;
  ***REMOVED***
...
declare module "http2" {
    ...
    import { IncomingHttpHeaders, OutgoingHttpHeaders ***REMOVED*** from "http";
    export { IncomingHttpHeaders, OutgoingHttpHeaders ***REMOVED*** from "http";
...
declare module "perf_hooks" {
  ...
  ***REMOVED***
    ...
    export class PerformanceObserver {
         ...
         * @param options
         */
        observe(options: { entryTypes: string[], buffered?: boolean ***REMOVED***): void;
  ***REMOVED***
