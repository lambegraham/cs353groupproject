...
var AndroidApp = /** @class */ (function () {
  ...
  ***REMOVED***
    /**
     * @return {Promise<string>***REMOVED*** A promise that resolves to a UTF-8 JSON string, typically intended to
...
var ShaCertificate = /** @class */ (function () {
    ...
    function ShaCertificate(shaHash, resourceName) {
        ...
        if (/^[a-fA-F0-9]{40***REMOVED***$/.test(shaHash)) {
            this.certType = 'sha1';
      ***REMOVED***
        else if (/^[a-fA-F0-9]{64***REMOVED***$/.test(shaHash)) {
