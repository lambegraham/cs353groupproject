...
var ProjectManagementRequestHandler = /** @class */ (function () {
  ...
  ***REMOVED***
    /**
     * @param {string***REMOVED*** parentResourceName Fully-qualified resource name of the project whose Android
  ...
  ***REMOVED***
    /**
     * @param {string***REMOVED*** parentResourceName Fully-qualified resource name of the project whose iOS apps
     *     you want to list.
     */
  ...
  ***REMOVED***
    /**
     * @param {string***REMOVED*** parentResourceName Fully-qualified resource name of the project that you want
  ...
  ***REMOVED***
    /**
     * @param {string***REMOVED*** resourceName Fully-qualified resource name of the entity whose display name you
     *     want to set.
     */
    ProjectManagementRequestHandler.prototype.setDisplayName = function (resourceName, newDisplayName) {
      ...
      ***REMOVED***
        return this
            ...
            .then(function () { return null; ***REMOVED***);
  ***REMOVED***
    /**
     * @param {string***REMOVED*** parentResourceName Fully-qualified resource name of the Android app whose SHA
  ...
  ***REMOVED***
    /**
     * @param {string***REMOVED*** parentResourceName Fully-qualified resource name of the Android app that you
  ...
  ***REMOVED***
    /**
     * @param {string***REMOVED*** parentResourceName Fully-qualified resource name of the app whose config you
     *     want to get.
     */
  ...
  ***REMOVED***
    /**
     * @param {string***REMOVED*** parentResourceName Fully-qualified resource name of the entity that you want to
     *     get.
     */
  ...
  ***REMOVED***
    /**
     * @param {string***REMOVED*** resourceName Fully-qualified resource name of the entity that you want to
     *     delete.
     */
  ...
  ***REMOVED***
    ...
    ProjectManagementRequestHandler.prototype.invokeRequestHandler = function (method, path, requestData, apiVersion) {
        if (apiVersion === void 0) { apiVersion = 'v1'; ***REMOVED***
