...
import { Bucket ***REMOVED*** from '@google-cloud/storage';
import * as _firestore from '@google-cloud/firestore';
import { Agent ***REMOVED*** from 'http';
...
***REMOVED***
  ...
  interface AppOptions {
    ...
    /**
     * A {@link admin.credential.Credential `Credential`***REMOVED*** object used to
...
***REMOVED***
  ...
  /**
   * Gets the {@link admin.auth.Auth `Auth`***REMOVED*** service for the default app or a
   * given app.
   *
   * `admin.auth()` can be called with no arguments to access the default app's
   * {@link admin.auth.Auth `Auth`***REMOVED*** service or as `admin.auth(app)` to access the
   * {@link admin.auth.Auth `Auth`***REMOVED*** service associated with a specific app.
   *
   * @example
   * ```javascript
  ...
  /**
   * Gets the {@link admin.database.Database `Database`***REMOVED*** service for the default
   * app or a given app.
   *
   * `admin.database()` can be called with no arguments to access the default
   * app's {@link admin.database.Database `Database`***REMOVED*** service or as
   * `admin.database(app)` to access the
   * {@link admin.database.Database `Database`***REMOVED*** service associated with a specific
   * app.
   *
  ...
  /**
   * Gets the {@link admin.messaging.Messaging `Messaging`***REMOVED*** service for the
   * default app or a given app.
   *
   * `admin.messaging()` can be called with no arguments to access the default
   * app's {@link admin.messaging.Messaging `Messaging`***REMOVED*** service or as
   * `admin.messaging(app)` to access the
   * {@link admin.messaging.Messaging `Messaging`***REMOVED*** service associated with a
   * specific app.
   *
   * @example
   * ```javascript
  ...
  /**
   * Gets the {@link admin.storage.Storage `Storage`***REMOVED*** service for the
   * default app or a given app.
   *
   * `admin.storage()` can be called with no arguments to access the default
   * app's {@link admin.storage.Storage `Storage`***REMOVED*** service or as
   * `admin.storage(app)` to access the
   * {@link admin.storage.Storage `Storage`***REMOVED*** service associated with a
   * specific app.
   *
   * @example
   * ```javascript
  ...
  /**
   * Gets the {@link admin.instanceId.InstanceId `InstanceId`***REMOVED*** service for the
   * default app or a given app.
   *
   * `admin.instanceId()` can be called with no arguments to access the default
   * app's {@link admin.instanceId.InstanceId `InstanceId`***REMOVED*** service or as
   * `admin.instanceId(app)` to access the
   * {@link admin.instanceId.InstanceId `InstanceId`***REMOVED*** service associated with a
   * specific app.
   *
   * @example
   * ```javascript
  ...
  * `ProjectManagement`***REMOVED*** service for the default app or a given app.
  *
  ...
  * `ProjectManagement`***REMOVED*** service, or as `admin.projectManagement(app)` to access
  * the {@link admin.projectManagement.ProjectManagement `ProjectManagement`***REMOVED***
  ...
  * `SecurityRules`***REMOVED*** service for the default app or a given app.
  *
  * `admin.securityRules()` can be called with no arguments to access the
  * default app's {@link admin.securityRules.SecurityRules
  * `SecurityRules`***REMOVED*** service, or as `admin.securityRules(app)` to access
  * the {@link admin.securityRules.SecurityRules `SecurityRules`***REMOVED***
  * service associated with a specific app.
  *
  * @example
  * ```javascript
...
***REMOVED***
  ...
  interface UserRecord {
     ...
     * {@link https://firebase.google.com/docs/reference/admin/node/admin.auth.Auth#listUsers `listUsers()`***REMOVED***.
     *
     */
    passwordHash?: string;
     ...
     * This is set via
     * {@link https://firebase.google.com/docs/reference/admin/node/admin.auth.Auth#setCustomUserClaims `setCustomUserClaims()`***REMOVED***
     */
    customClaims?: Object;
     ...
     * from the {@link https://firebase.google.com/docs/reference/admin/node/admin.auth.Auth#revokeRefreshTokens `revokeRefreshTokens()`***REMOVED***
...
***REMOVED***
   ...
   * {@link https://firebase.google.com/docs/reference/admin/node/admin.auth.Auth#verifyIdToken `verifyIdToken()`***REMOVED*** method.
   *
...
***REMOVED***
   ...
   * {@link https://firebase.google.com/docs/reference/admin/node/admin.auth.Auth#listUsers `listUsers()`***REMOVED*** operation. Contains the list
   * of users for the current batch and the next page token if available.
   */
  interface ListUsersResult {

    /**
     * The list of {@link admin.auth.UserRecord `UserRecord`***REMOVED*** objects for the
...
***REMOVED***
   ...
   * {@link https://firebase.google.com/docs/reference/admin/node/admin.auth.Auth#importUsers `importUsers()`***REMOVED*** method. This is used to
...
***REMOVED***
   ...
   * {@link https://firebase.google.com/docs/reference/admin/node/admin.auth.Auth#importUsers `importUsers()`***REMOVED*** method for batch
...
***REMOVED***
   ...
   * {@link https://firebase.google.com/docs/reference/admin/node/admin.auth.Auth#importUsers `importUsers()`***REMOVED*** method.
   */
  interface UserImportRecord {
     ...
     * {@link admin.auth.UserImportOptions `UserImportOptions`***REMOVED*** are required to be
...
***REMOVED***
   ...
   * {@link https://firebase.google.com/docs/reference/admin/node/admin.auth.Auth#createSessionCookie `createSessionCookie()`***REMOVED*** method.
   */
...
***REMOVED***
  ...
  /**
   * Interface representing the object returned from a
   * {@link https://firebase.google.com/docs/reference/admin/node/admin.auth.Auth#listTenants `listTenants()`***REMOVED***
   * operation. 
  ...
  interface ListTenantsResult {
    ...
    /**
     * The list of {@link admin.auth.Tenant `Tenant`***REMOVED*** objects for the downloaded batch.
     */
...
***REMOVED***
   ...
   * {@link https://firebase.google.com/docs/reference/admin/node/admin.auth.Auth#listProviderConfigs `listProviderConfigs()`***REMOVED***.
   */
...
***REMOVED***
   ...
   * {@link https://firebase.google.com/docs/reference/admin/node/admin.auth.Auth#createProviderConfig `createProviderConfig()`***REMOVED***.
   */
...
***REMOVED***
   ...
   * {@link https://firebase.google.com/docs/reference/admin/node/admin.auth.Auth#updateProviderConfig `updateProviderConfig()`***REMOVED***.
   */
...
***REMOVED***
  ...
  interface BaseAuth {
     ...
     * {@link admin.auth.UserRecord#tokensValidAfterTime `tokensValidAfterTime`***REMOVED*** to
     ...
     * {@link admin.auth.Auth#verifyIdToken `verifyIdToken(idToken, true)`***REMOVED***
    ...
    */
     ...
     * optional  {@link admin.auth.ActionCodeSettings `ActionCodeSettings`***REMOVED*** object
     ...
     * {@link admin.auth.ActionCodeSettings `ActionCodeSettings`***REMOVED*** object provided
...
declare namespace admin.credential {
   ...
   * {@link admin.credential `admin.credential`***REMOVED***.
   */
...
***REMOVED***
   ...
   * {@link
    ...
    *    Google Application Default Credentials***REMOVED***
    ...
    * ```
    *
    * @param {!Object=***REMOVED*** httpAgent Optional [HTTP Agent](https://nodejs.org/api/http.html#http_class_http_agent)
    *   to be used when retrieving access tokens from Google token servers.
    *
    * @return {!admin.credential.Credential***REMOVED*** A credential authenticated via Google
...
declare namespace admin.database {
   ...
   *   Introduction to the Admin Database API***REMOVED***
...
***REMOVED***
  ...
  interface OnDisconnect {
     ...
     *
     * See {@link https://firebase.google.com/docs/reference/admin/node/admin.database.Reference#update***REMOVED***
...
***REMOVED***
  ...
  interface Query {
     ...
     * @param context If provided, this object will be used as `this`
     *   when calling your callback(s).
     * @return {!Promise<admin.database.DataSnapshot>***REMOVED***
     */
    once(
      eventType: admin.database.EventType,
...
***REMOVED***
  ...
  /**
   * @extends {admin.database.Reference***REMOVED***
   */
  interface ThenableReference extends admin.database.Reference, Promise<admin.database.Reference> { ***REMOVED***
...
***REMOVED***
   ...
   * {@link admin.messaging.Message***REMOVED***.
   */
  interface AndroidConfig {
     ...
     * `admin.messaging.Message`.***REMOVED***
     */
    data?: { [key: string]: string ***REMOVED***;
...
***REMOVED***
   ...
   * {@link admin.messaging.AndroidConfig***REMOVED***.
   */
...
***REMOVED***
   ...
   * {@link admin.messaging.Message***REMOVED***. Refer to
  ...
  interface ApnsConfig {
     ...
     */
    headers?: { [key: string]: string ***REMOVED***;
...
***REMOVED***
  ...
  /**
   * A notification that can be included in {@link admin.messaging.Message***REMOVED***.
   */
...
***REMOVED***
   ...
   * {@link admin.messaging.WebpushConfig***REMOVED***. This supports most of the standard
...
***REMOVED***
   ...
   * {@link https://firebase.google.com/docs/reference/admin/node/admin.messaging.Messaging#sendToDevice `sendToDevice()`***REMOVED*** method.
   *
   * See
   * [Send to individual devices](/docs/cloud-messaging/admin/send-messages#send_to_individual_devices)
   * for code samples and detailed documentation.
...
***REMOVED***
   ...
   * {@link https://firebase.google.com/docs/reference/admin/node/admin.messaging.Messaging#sendToDeviceGroup `sendToDeviceGroup()`***REMOVED***
   * method.
   *
   * See
...
***REMOVED***
  ...
  /**
   * Interface representing the server response from the legacy
   * {@link https://firebase.google.com/docs/reference/admin/node/admin.messaging.Messaging#sendToTopic `sendToTopic()`***REMOVED*** method.
   *
   * See
...
***REMOVED***
  ...
  /**
   * Interface representing the server response from the legacy
   * {@link https://firebase.google.com/docs/reference/admin/node/admin.messaging.Messaging#sendToCondition `sendToCondition()`***REMOVED*** method.
   *
   * See
...
***REMOVED***
  ...
  /**
   * Interface representing the server response from the
   * {@link https://firebase.google.com/docs/reference/admin/node/admin.messaging.Messaging#subscribeToTopic `subscribeToTopic()`***REMOVED*** and
   * {@link
   *   admin.messaging.Messaging#unsubscribeFromTopic
   *   `unsubscribeFromTopic()`***REMOVED***
   * methods.
   *
   * See
...
***REMOVED***
  ...
  /**
   * Interface representing the server response from the
   * {@link https://firebase.google.com/docs/reference/admin/node/admin.messaging.Messaging#sendAll `sendAll()`***REMOVED*** and
   * {@link https://firebase.google.com/docs/reference/admin/node/admin.messaging.Messaging#sendMulticast `sendMulticast()`***REMOVED*** methods.
   */
...
***REMOVED***
  ...
  interface Messaging {
    /**
     * The {@link admin.app.App app***REMOVED*** associated with the current `Messaging` service
     * instance.
     *
     * @example
     * ```javascript
...
***REMOVED***
  ...
  interface IosApp {
     ...
     *
     * @return {!Promise<admin.projectManagement.IosAppMetadata>***REMOVED*** A promise that
...
***REMOVED***
  ...
  interface SecurityRules {
    ...
    /**
     * Creates a {@link admin.securityRules.RulesFile `RuleFile`***REMOVED*** with the given name
    ...
    /**
     * Creates a new {@link admin.securityRules.Ruleset `Ruleset`***REMOVED*** from the given
     * {@link admin.securityRules.RulesFile `RuleFile`***REMOVED***.
     *
    ...
    /**
     * Gets the {@link admin.securityRules.Ruleset `Ruleset`***REMOVED*** identified by the given
    ...
    /**
     * Deletes the {@link admin.securityRules.Ruleset `Ruleset`***REMOVED*** identified by the given
     * name. The input name should be the short name string without the project ID
    ...
    /**
     * Gets the {@link admin.securityRules.Ruleset `Ruleset`***REMOVED*** currently applied to
    ...
    /**
     * Applies the specified {@link admin.securityRules.Ruleset `Ruleset`***REMOVED*** ruleset
     * to Cloud Firestore.
     *
    ...
    /**
     * Gets the {@link admin.securityRules.Ruleset `Ruleset`***REMOVED*** currently applied to a
     ...
     *   {@link admin.AppOptions `AppOptions`***REMOVED***.
     * @return A promise that fulfills when the ruleset is created and released.
     */
