 ...
 *
 * @param {object***REMOVED*** response The raw FCM server response to map.
 *
 * @return {MessagingDeviceGroupResponse***REMOVED*** The mapped MessagingDevicesResponse object.
 */
 ...
 * @param {object***REMOVED*** response The raw FCM server response to map.
 *
 * @return {MessagingDeviceGroupResponse***REMOVED*** The mapped MessagingDeviceGroupResponse object.
 */
 ...
 * @param {object***REMOVED*** response The raw FCM server response to map.
 *
 * @return {MessagingTopicManagementResponse***REMOVED*** The mapped MessagingTopicManagementResponse object.
 */
...
var Messaging = /** @class */ (function () {
    /**
     * @param {FirebaseApp***REMOVED*** app The app for this Messaging service.
     * @constructor
     */
  ...
  ***REMOVED***
    Object.defineProperty(Messaging.prototype, "app", {
         ...
         *
         * @return {FirebaseApp***REMOVED*** The app associated with this Messaging instance.
         */
        get: function () {
  ...
  ***REMOVED***);
     ...
     *
     * @param {Message***REMOVED*** message The message to be sent.
     * @param {boolean=***REMOVED*** dryRun Whether to send the message in the dry-run (validation only) mode.
     *
     * @return {Promise<string>***REMOVED*** A Promise fulfilled with a message ID string.
     */
    Messaging.prototype.send = function (message, dryRun) {
      ...
      ***REMOVED***
        return Promise.resolve()
            .then(function () {
            var request = { message: copy ***REMOVED***;
            if (dryRun) {
  ...
  ***REMOVED***
     ...
     *
     * @param {Message[]***REMOVED*** messages A non-empty array containing up to 100 messages.
     * @param {boolean=***REMOVED*** dryRun Whether to send the message in the dry-run (validation only) mode.
     *
     * @return {Promise<BatchResponse>***REMOVED*** A Promise fulfilled with an object representing the result
    ...
    Messaging.prototype.sendAll = function (messages, dryRun) {
      ...
      ***REMOVED***
        var requests = copy.map(function (message) {
            ...
            var request = { message: message ***REMOVED***;
            if (dryRun) {
                request.validate_only = true;
          ***REMOVED***
            return {
  ...
  ***REMOVED***
     ...
     *
     * @param {MulticastMessage***REMOVED*** message A multicast message containing up to 100 tokens.
     * @param {boolean=***REMOVED*** dryRun Whether to send the message in the dry-run (validation only) mode.
     *
     * @return {Promise<BatchResponse>***REMOVED*** A Promise fulfilled with an object representing the result
     *     of the send operation.
  ...
  ***REMOVED***
     ...
     *
     * @param {string|string[]***REMOVED*** registrationTokenOrTokens The registration token or an array of
     *     registration tokens for the device(s) to which to send the message.
     * @param {MessagingPayload***REMOVED*** payload The message payload.
     * @param {MessagingOptions***REMOVED*** [options = {***REMOVED***] Optional options to alter the message.
     *
     * @return {Promise<MessagingDevicesResponse|MessagingDeviceGroupResponse>***REMOVED*** A Promise fulfilled
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** notificationKey The notification key representing the device group to which to
     *     send the message.
     * @param {MessagingPayload***REMOVED*** payload The message payload.
     * @param {MessagingOptions***REMOVED*** [options = {***REMOVED***] Optional options to alter the message.
     *
     * @return {Promise<MessagingDeviceGroupResponse|MessagingDevicesResponse>***REMOVED*** A Promise fulfilled
     *     with the server's response after the message has been sent.
     */
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** topic The name of the topic to which to send the message.
     * @param {MessagingPayload***REMOVED*** payload The message payload.
     * @param {MessagingOptions***REMOVED*** [options = {***REMOVED***] Optional options to alter the message.
     *
     * @return {Promise<MessagingTopicResponse>***REMOVED*** A Promise fulfilled with the server's response after
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** condition The condition to which to send the message.
     * @param {MessagingPayload***REMOVED*** payload The message payload.
     * @param {MessagingOptions***REMOVED*** [options = {***REMOVED***] Optional options to alter the message.
     *
     * @return {Promise<MessagingConditionResponse>***REMOVED*** A Promise fulfilled with the server's response
  ...
  ***REMOVED***
     ...
     * @param {string***REMOVED*** topic The topic to which to subscribe.
     *
     * @return {Promise<MessagingTopicManagementResponse>***REMOVED*** A Promise fulfilled with the parsed FCM
     *   server response.
     */
  ...
  ***REMOVED***
     ...
     *     registration tokens to unsubscribe from the topic.
     * @param {string***REMOVED*** topic The topic to which to subscribe.
     * @param {string***REMOVED*** methodName The name of the original method called.
     * @param {string***REMOVED*** path The endpoint path to use for the request.
     *
     * @return {Promise<MessagingTopicManagementResponse>***REMOVED*** A Promise fulfilled with the parsed server
     *   response.
     */
  ...
  ***REMOVED***
     ...
     *
     * @param {MessagingPayload***REMOVED*** payload The messaging payload to validate.
     * @param {MessagingOptions***REMOVED*** options The messaging options to validate.
     */
  ...
  ***REMOVED***
     ...
     * @param {MessagingPayload***REMOVED*** payload The messaging payload to validate.
     *
     * @return {MessagingPayload***REMOVED*** A copy of the provided payload with whitelisted properties switched
  ...
  ***REMOVED***
     ...
     * @param {MessagingOptions***REMOVED*** options The messaging options to validate.
     *
     * @return {MessagingOptions***REMOVED*** A copy of the provided options with whitelisted properties switched
     *   from camelCase to underscore_case.
     */
  ...
  ***REMOVED***
     ...
     *
     * @param {string|string[]***REMOVED*** registrationTokenOrTokens The registration token(s) to validate.
     * @param {string***REMOVED*** method The method name to use in error messages.
     * @param {ErrorInfo?***REMOVED*** [errorInfo] The error info to use if the registration tokens are invalid.
     */
    Messaging.prototype.validateRegistrationTokensType = function (registrationTokenOrTokens, methodName, errorInfo) {
        if (errorInfo === void 0) { errorInfo = error_1.MessagingClientErrorCode.INVALID_ARGUMENT; ***REMOVED***
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** topic The topic to validate.
     * @param {string***REMOVED*** method The method name to use in error messages.
     * @param {ErrorInfo?***REMOVED*** [errorInfo] The error info to use if the topic is invalid.
     */
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** topic The topic name to normalize.
     *
     * @return {string***REMOVED*** The normalized topic name.
     */
