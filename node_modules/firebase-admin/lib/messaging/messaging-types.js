 ...
 *
 * @param {Message***REMOVED*** Message An object to be validated.
 */
function validateMessage(message) {
  ...
  ***REMOVED***
    ...
    if (targets.filter(function (v) { return validator.isNonEmptyString(v); ***REMOVED***).length !== 1) {
 ...
 *
 * @param {object***REMOVED*** map An object to be validated.
 * @param {string***REMOVED*** label A label to be included in the errors thrown.
 */
 ...
 *
 * @param {WebpushConfig***REMOVED*** config An object to be validated.
 */
 ...
 * payload.
 *
 * @param {ApnsConfig***REMOVED*** config An object to be validated.
 */
 ...
 *
 * @param {ApnsFcmOptions***REMOVED*** fcmOptions An object to be validated.
 */
 ...
 *
 * @param {FcmOptions***REMOVED*** fcmOptions An object to be validated.
 */
 ...
 *
 * @param {Notification***REMOVED*** notification An object to be validated.
 */
 ...
 *
 * @param {ApnsPayload***REMOVED*** payload An object to be validated.
 */
 ...
 *
 * @param {Aps***REMOVED*** aps An object to be validated.
 */
 ...
 *
 * @param {string | ApsAlert***REMOVED*** alert An alert string or an object to be validated.
 */
 ...
 *
 * @param {AndroidConfig***REMOVED*** config An object to be validated.
 */
 ...
 * Android keys.
 *
 * @param {AndroidNotification***REMOVED*** notification An object to be validated.
 */
function validateAndroidNotification(notification) {
  ...
  ***REMOVED***
    if (typeof notification.color !== 'undefined' && !/^#[0-9a-fA-F]{6***REMOVED***$/.test(notification.color)) {
 ...
 *
 * @param {AndroidFcmOptions***REMOVED*** fcmOptions An object to be validated.
 */
