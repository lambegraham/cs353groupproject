...
var BatchRequestClient = /** @class */ (function () {
    /**
     * @param {HttpClient***REMOVED*** httpClient The client that will be used to make HTTP calls.
     * @param {string***REMOVED*** batchUrl The URL that accepts batch requests.
     * @param {object=***REMOVED*** commonHeaders Optional headers that will be included in all requests.
     *
     * @constructor
     */
  ...
  ***REMOVED***
     ...
     *
     * @param {SubRequest[]***REMOVED*** requests An array of sub requests to send.
     * @return {Promise<HttpResponse[]>***REMOVED*** A promise that resolves when the send operation is complete.
     */
    BatchRequestClient.prototype.send = function (requests) {
        var _this = this;
        requests = requests.map(function (req) {
            req.headers = Object.assign({***REMOVED***, _this.commonHeaders, req.headers);
            return req;
      ***REMOVED***);
        var requestHeaders = {
 ...
 * binary.
 *
 * @param {SubRequest***REMOVED*** request A sub request that will be used to populate the part.
 * @param {string***REMOVED*** boundary Multipart boundary string.
 * @param {number***REMOVED*** idx An index number that is used to set the content-id header.
 * @return {string***REMOVED*** The part as a string that can be included in the HTTP body.
 */
 ...
 * body.
 *
 * @param request {SubRequest***REMOVED*** The sub request to be serialized.
 * @return {string***REMOVED*** String representation of the SubRequest.
 */
