 ...
 *
 * @param {any***REMOVED*** time The unix timestamp string or number in milliseconds.
 * @return {string***REMOVED*** The corresponding date as a UTC string, if valid.
 */
 ...
 *
 * @param {object***REMOVED*** response The server side response returned from the getAccountInfo
 *     endpoint.
 * @constructor
 */
var UserMetadata = /** @class */ (function () {
  ...
  ***REMOVED***
    /** @return {object***REMOVED*** The plain object representation of the user's metadata. */
...
var UserInfo = /** @class */ (function () {
  ...
  ***REMOVED***
    /** @return {object***REMOVED*** The plain object representation of the current provider data. */
 ...
 *
 * @param {any***REMOVED*** response The server side response returned from the getAccountInfo
 *     endpoint.
 * @constructor
 */
var UserRecord = /** @class */ (function () {
  ...
  ***REMOVED***
    /** @return {object***REMOVED*** The plain object representation of the user record. */
