...
/**
 * @param {any***REMOVED*** obj The object to check for number field within.
 * @param {string***REMOVED*** key The entry key.
 * @return {number|undefined***REMOVED*** The corresponding number if available.
 */
 ...
 * fields are provided.
 * @param {UserImportRecord***REMOVED*** user The UserImportRecord to conver to UploadAccountUser.
 * @param {ValidatorFunction=***REMOVED*** userValidator The user validator function.
 * @return {UploadAccountUser***REMOVED*** The corresponding UploadAccountUser to return.
 */
...
var UserImportBuilder = /** @class */ (function () {
    /**
     * @param {UserImportRecord[]***REMOVED*** users The list of user records to import.
     * @param {UserImportOptions=***REMOVED*** options The import options which includes hashing
     *     algorithm details.
     * @param {ValidatorFunction=***REMOVED*** userRequestValidator The user request validator function.
     * @constructor
     */
  ...
  ***REMOVED***
     ...
     * @return {UploadAccountRequest***REMOVED*** The constructed uploadAccount request.
     */
    UserImportBuilder.prototype.buildRequest = function () {
      ...
      ***REMOVED***);
        return deep_copy_1.deepExtend({ users: users ***REMOVED***, deep_copy_1.deepCopy(this.validatedOptions));
  ***REMOVED***
    /**
     * Populates the UserImportResult using the client side detected errors and the server
     * side returned errors.
     * @return {UserImportResult***REMOVED*** The user import result based on the returned failed
  ...
  ***REMOVED***
     ...
     * @param {UserImportOptions***REMOVED*** options The UserImportOptions.
     * @param {boolean***REMOVED*** requiresHashOptions Whether to require hash options.
     * @return {UploadAccountOptions***REMOVED*** The populated UploadAccount options.
     */
  ...
  ***REMOVED***
     ...
     * @param {UserImportRecord[]***REMOVED*** users The UserImportRecords to convert to UnploadAccountUser
     *     objects.
     * @param {ValidatorFunction=***REMOVED*** userValidator The user validator function.
     * @return {UploadAccountUser[]***REMOVED*** The populated uploadAccount users.
     */
