...
var BaseAuth = /** @class */ (function () {
     ...
     *
     * @param {string***REMOVED*** projectId The corresponding project ID.
     * @param {T***REMOVED*** authRequestHandler The RPC request handler
     *     for this instance.
     * @param {CryptoSigner***REMOVED*** cryptoSigner The instance crypto signer used for custom token
     *     minting.
     * @constructor
     */
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** uid The uid to use as the JWT subject.
     * @param {object=***REMOVED*** developerClaims Optional additional claims to include in the JWT payload.
     *
     * @return {Promise<string>***REMOVED*** A JWT for the provided payload.
     */
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** idToken The JWT to verify.
     * @param {boolean=***REMOVED*** checkRevoked Whether to check if the ID token is revoked.
     * @return {Promise<DecodedIdToken>***REMOVED*** A Promise that will be fulfilled after a successful
     *     verification.
     */
    BaseAuth.prototype.verifyIdToken = function (idToken, checkRevoked) {
        var _this = this;
        if (checkRevoked === void 0) { checkRevoked = false; ***REMOVED***
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** uid The uid of the user to look up.
     * @return {Promise<UserRecord>***REMOVED*** A promise that resolves with the corresponding user record.
     */
  ...
  ***REMOVED***
     ...
     * fulfilled with a user record for the given user if that user is found.
     *
     * @param {string***REMOVED*** email The email of the user to look up.
     * @return {Promise<UserRecord>***REMOVED*** A promise that resolves with the corresponding user record.
     */
  ...
  ***REMOVED***
     ...
     * fulfilled with a user record for the given user if that user is found.
     *
     * @param {string***REMOVED*** phoneNumber The phone number of the user to look up.
     * @return {Promise<UserRecord>***REMOVED*** A promise that resolves with the corresponding user record.
     */
  ...
  ***REMOVED***
     ...
     *     without any offset.
     * @return {Promise<{users: UserRecord[], pageToken?: string***REMOVED***>***REMOVED*** A promise that resolves with
  ...
  ***REMOVED***
     ...
     *
     * @param {CreateRequest***REMOVED*** properties The properties to set on the new user record to be created.
     * @return {Promise<UserRecord>***REMOVED*** A promise that resolves with the newly created user record.
     */
  ...
  ***REMOVED***
     ...
     * @return {Promise<void>***REMOVED*** A promise that resolves when the user is successfully deleted.
     */
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** uid The uid identifier of the user to update.
     * @param {UpdateRequest***REMOVED*** properties The properties to update on the existing user.
     * @return {Promise<UserRecord>***REMOVED*** A promise that resolves with the modified user record.
     */
  ...
  ***REMOVED***
     ...
     * @return {Promise<void>***REMOVED*** A promise that resolves when the operation completes
     *     successfully.
     */
  ...
  ***REMOVED***
     ...
     * @param {SessionCookieOptions***REMOVED*** sessionCookieOptions The session cookie options which includes
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** sessionCookie The session cookie to verify.
     * @param {boolean=***REMOVED*** checkRevoked Whether to check if the session cookie is revoked.
     * @return {Promise<DecodedIdToken>***REMOVED*** A Promise that will be fulfilled after a successful
     *     verification.
     */
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** email The email of the user whose password is to be reset.
     ...
     *     deep link, etc.
     * @return {Promise<string>***REMOVED*** A promise that resolves with the password reset link.
     */
  ...
  ***REMOVED***
     ...
     * Returns a promise that resolves with the generated link.
     *
     * @param {string***REMOVED*** email The email of the user to be verified.
     * @param {ActionCodeSettings=***REMOVED*** actionCodeSettings The optional action code setings which defines whether
     *     the link is to be handled by a mobile app and the additional state information to be passed in the
     *     deep link, etc.
     * @return {Promise<string>***REMOVED*** A promise that resolves with the email verification link.
     */
  ...
  ***REMOVED***
     ...
     * Returns a promise that resolves with the generated link.
     *
     * @param {string***REMOVED*** email The email of the user signing in.
     * @param {ActionCodeSettings***REMOVED*** actionCodeSettings The required action code setings which defines whether
     *     the link is to be handled by a mobile app and the additional state information to be passed in the
     *     deep link, etc.
     * @return {Promise<string>***REMOVED*** A promise that resolves with the email sign-in link.
     */
  ...
  ***REMOVED***
     ...
     *
     * @param {AuthProviderConfigFilter***REMOVED*** options The provider config filter to apply.
     * @return {Promise<ListProviderConfigResults>***REMOVED*** A promise that resolves with the list of provider configs
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** providerId  The provider ID corresponding to the provider config to return.
     * @return {Promise<AuthProviderConfig>***REMOVED***
     */
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** providerId The provider ID corresponding to the provider config to delete.
     * @return {Promise<void>***REMOVED*** A promise that resolves on completion.
     */
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** providerId The provider ID corresponding to the provider config to update.
     * @param {UpdateAuthProviderRequest***REMOVED*** updatedConfig The updated configuration.
     * @return {Promise<AuthProviderConfig>***REMOVED*** A promise that resolves with the updated provider configuration.
     */
  ...
  ***REMOVED***
     ...
     * created.
     * @param {AuthProviderConfig***REMOVED*** config The provider configuration to create.
     * @return {Promise<AuthProviderConfig>***REMOVED*** A promise that resolves with the created provider configuration.
     */
  ...
  ***REMOVED***
     ...
     *
     * @param {DecodedIdToken***REMOVED*** decodedIdToken The JWT's decoded claims.
     * @param {ErrorInfo***REMOVED*** revocationErrorInfo The revocation error info to throw on revocation
     *     detection.
     * @return {Promise<DecodedIdToken>***REMOVED*** A Promise that will be fulfilled after a successful
     *     verification.
     */
...
var TenantAwareAuth = /** @class */ (function (_super) {
     ...
     *
     * @param {object***REMOVED*** app The app that created this tenant.
...
var Auth = /** @class */ (function (_super) {
    ...
    /**
     * @param {object***REMOVED*** app The app for this Auth service.
     * @constructor
     */
    function Auth(app) {
  ...
  ***REMOVED***
     ...
     *
     * @param {FirebaseApp***REMOVED*** app The project ID for an app.
     * @return {string***REMOVED*** The FirebaseApp's project ID.
     */
  ...
  ***REMOVED***
    Object.defineProperty(Auth.prototype, "app", {
         ...
         *
         * @return {FirebaseApp***REMOVED*** The app associated with this Auth instance.
         */
        get: function () {
            return this.app_;
      ***REMOVED***,
