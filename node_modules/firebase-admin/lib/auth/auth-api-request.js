...
var FIREBASE_AUTH_BASE_URL_FORMAT = 'https://identitytoolkit.googleapis.com/{version***REMOVED***/projects/{projectId***REMOVED***{api***REMOVED***';
/** The Firebase Auth backend multi-tenancy base URL format. */
var FIREBASE_AUTH_TENANT_URL_FORMAT = FIREBASE_AUTH_BASE_URL_FORMAT.replace('projects/{projectId***REMOVED***', 'projects/{projectId***REMOVED***/tenants/{tenantId***REMOVED***');
...
var AuthResourceUrlBuilder = /** @class */ (function () {
     ...
     *
     * @param {string***REMOVED*** projectId The resource project ID.
     * @param {string***REMOVED*** version The endpoint API version.
     * @constructor
     */
    function AuthResourceUrlBuilder(projectId, version) {
        if (version === void 0) { version = 'v1'; ***REMOVED***
  ...
  ***REMOVED***
     ...
     *
     * @param {string=***REMOVED*** api The backend API name.
     * @param {object=***REMOVED*** params The optional additional parameters to substitute in the
     *     URL path.
     * @return {string***REMOVED*** The corresponding resource URL.
     */
...
var TenantAwareAuthResourceUrlBuilder = /** @class */ (function (_super) {
     ...
     * @param {string***REMOVED*** projectId The resource project ID.
     * @param {string***REMOVED*** version The endpoint API version.
     * @param {string***REMOVED*** tenantId The tenant ID.
     * @constructor
     */
  ...
  ***REMOVED***
    ...
    TenantAwareAuthResourceUrlBuilder.prototype.getUrl = function (api, params) {
        return utils.formatString(_super.prototype.getUrl.call(this, api, params), { tenantId: this.tenantId ***REMOVED***);
  ***REMOVED***
    return TenantAwareAuthResourceUrlBuilder;
***REMOVED***(AuthResourceUrlBuilder));
/**
 * Validates a providerUserInfo object. All unsupported parameters
 * are removed from the original request. If an invalid field is passed
 * an error is thrown.
 *
 * @param {any***REMOVED*** request The providerUserInfo request object.
 */
 ...
 * an error is thrown.
 *
 * @param {any***REMOVED*** request The create/edit request object.
 * @param {boolean=***REMOVED*** uploadAccountRequest Whether to validate as an uploadAccount request.
 */
function validateCreateEditRequest(request, uploadAccountRequest) {
    if (uploadAccountRequest === void 0) { uploadAccountRequest = false; ***REMOVED***
...
var GET_OAUTH_IDP_CONFIG = new api_request_1.ApiSettings('/oauthIdpConfigs/{providerId***REMOVED***', 'GET')
    // Set response validator.
    .setResponseValidator(function (response) {
...
var DELETE_OAUTH_IDP_CONFIG = new api_request_1.ApiSettings('/oauthIdpConfigs/{providerId***REMOVED***', 'DELETE');
/** Instantiates the create OIDC configuration endpoint settings. */
var CREATE_OAUTH_IDP_CONFIG = new api_request_1.ApiSettings('/oauthIdpConfigs?oauthIdpConfigId={providerId***REMOVED***', 'POST')
    // Set response validator.
    .setResponseValidator(function (response) {
    // Response should always contain the OIDC provider resource name.
    if (!validator.isNonEmptyString(response.name)) {
...
var UPDATE_OAUTH_IDP_CONFIG = new api_request_1.ApiSettings('/oauthIdpConfigs/{providerId***REMOVED***?updateMask={updateMask***REMOVED***', 'PATCH')
    // Set response validator.
    .setResponseValidator(function (response) {
...
var GET_INBOUND_SAML_CONFIG = new api_request_1.ApiSettings('/inboundSamlConfigs/{providerId***REMOVED***', 'GET')
    // Set response validator.
    .setResponseValidator(function (response) {
...
var DELETE_INBOUND_SAML_CONFIG = new api_request_1.ApiSettings('/inboundSamlConfigs/{providerId***REMOVED***', 'DELETE');
/** Instantiates the create SAML configuration endpoint settings. */
var CREATE_INBOUND_SAML_CONFIG = new api_request_1.ApiSettings('/inboundSamlConfigs?inboundSamlConfigId={providerId***REMOVED***', 'POST')
    // Set response validator.
    .setResponseValidator(function (response) {
    // Response should always contain the SAML provider resource name.
    if (!validator.isNonEmptyString(response.name)) {
...
var UPDATE_INBOUND_SAML_CONFIG = new api_request_1.ApiSettings('/inboundSamlConfigs/{providerId***REMOVED***?updateMask={updateMask***REMOVED***', 'PATCH')
    // Set response validator.
    .setResponseValidator(function (response) {
    // Response should always contain the configuration resource name.
    if (!validator.isNonEmptyString(response.name)) {
...
var AbstractAuthRequestHandler = /** @class */ (function () {
    /**
     * @param {FirebaseApp***REMOVED*** app The app used to fetch access tokens to sign API requests.
     * @constructor
     */
  ...
  ***REMOVED***
    /**
     * @param {any***REMOVED*** response The response to check for errors.
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** idToken The Firebase ID token to exchange for a session cookie.
     * @param {number***REMOVED*** expiresIn The session cookie duration in milliseconds.
     *
     * @return {Promise<string>***REMOVED*** A promise that resolves on success with the created session cookie.
     */
    AbstractAuthRequestHandler.prototype.createSessionCookie = function (idToken, expiresIn) {
      ...
      ***REMOVED***
        return this.invokeRequestHandler(this.getAuthUrlBuilder(), exports.FIREBASE_AUTH_CREATE_SESSION_COOKIE, request)
            .then(function (response) { return response.sessionCookie; ***REMOVED***);
  ***REMOVED***
    /**
     * Looks up a user by uid.
     *
     * @param {string***REMOVED*** uid The uid of the user to lookup.
     * @return {Promise<object>***REMOVED*** A promise that resolves with the user information.
     */
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** email The email of the user to lookup.
     * @return {Promise<object>***REMOVED*** A promise that resolves with the user information.
     */
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** phoneNumber The phone number of the user to lookup.
     * @return {Promise<object>***REMOVED*** A promise that resolves with the user information.
     */
  ...
  ***REMOVED***
     ...
     *
     * @param {number=***REMOVED*** maxResults The page size, 1000 if undefined. This is also the maximum
     *     allowed limit.
     * @param {string=***REMOVED*** pageToken The next page token. If not specified, returns users starting
     *     without any offset. Users are returned in the order they were created from oldest to
     *     newest, relative to the page token offset.
     * @return {Promise<object>***REMOVED*** A promise that resolves with the current batch of downloaded
     *     users and the next page token if available. For the last page, an empty list of users
     *     and no page token are returned.
     */
    AbstractAuthRequestHandler.prototype.downloadAccount = function (maxResults, pageToken) {
        if (maxResults === void 0) { maxResults = MAX_DOWNLOAD_ACCOUNT_PAGE_SIZE; ***REMOVED***
        // Construct request.
        var request = {
  ...
  ***REMOVED***
     ...
     *
     * @param {UserImportRecord[]***REMOVED*** users The list of user records to import to Firebase Auth.
     * @param {UserImportOptions=***REMOVED*** options The user import options, required when the users provided
     *     include password credentials.
     * @return {Promise<UserImportResult>***REMOVED*** A promise that resolves when the operation completes
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** uid The uid of the user to delete.
     * @return {Promise<object>***REMOVED*** A promise that resolves when the user is deleted.
     */
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** uid The user to edit.
     * @param {object***REMOVED*** customUserClaims The developer claims to set.
     * @return {Promise<string>***REMOVED*** A promise that resolves when the operation completes
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** uid The user to edit.
     * @param {object***REMOVED*** properties The properties to set on the user.
     * @return {Promise<string>***REMOVED*** A promise that resolves when the operation completes
     *     with the user id that was edited.
     */
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** uid The user whose tokens are to be revoked.
     * @return {Promise<string>***REMOVED*** A promise that resolves when the operation completes
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** requestType The request type. This could be either used for password reset,
     *     email verification, email link sign-in.
     * @param {string***REMOVED*** email The email of the user the link is being sent to.
     * @param {ActionCodeSettings=***REMOVED*** actionCodeSettings The optional action code setings which defines whether
     *     the link is to be handled by a mobile app and the additional state information to be passed in the
     *     deep link, etc.
     * @return {Promise<string>***REMOVED*** A promise that resolves with the email action link.
     */
    AbstractAuthRequestHandler.prototype.getEmailActionLink = function (requestType, email, actionCodeSettings) {
        var request = { requestType: requestType, email: email, returnOobLink: true ***REMOVED***;
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** providerId The provider identifier of the configuration to lookup.
     * @return {Promise<OIDCConfigServerResponse>***REMOVED*** A promise that resolves with the provider configuration information.
     */
    AbstractAuthRequestHandler.prototype.getOAuthIdpConfig = function (providerId) {
        if (!auth_config_1.OIDCConfig.isProviderId(providerId)) {
            return Promise.reject(new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_PROVIDER_ID));
      ***REMOVED***
        return this.invokeRequestHandler(this.getProjectConfigUrlBuilder(), GET_OAUTH_IDP_CONFIG, {***REMOVED***, { providerId: providerId ***REMOVED***);
  ***REMOVED***
    /**
     * Lists the OIDC configurations (single batch only) with a size of maxResults and starting from
     * the offset as specified by pageToken.
     *
     * @param {number=***REMOVED*** maxResults The page size, 100 if undefined. This is also the maximum
     *     allowed limit.
     * @param {string=***REMOVED*** pageToken The next page token. If not specified, returns OIDC configurations
    ...
    AbstractAuthRequestHandler.prototype.listOAuthIdpConfigs = function (maxResults, pageToken) {
        if (maxResults === void 0) { maxResults = MAX_LIST_PROVIDER_CONFIGURATION_PAGE_SIZE; ***REMOVED***
        var request = {
            pageSize: maxResults,
      ***REMOVED***
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** providerId The identifier of the OIDC configuration to delete.
     * @return {Promise<void>***REMOVED*** A promise that resolves when the OIDC provider is deleted.
     */
    AbstractAuthRequestHandler.prototype.deleteOAuthIdpConfig = function (providerId) {
        if (!auth_config_1.OIDCConfig.isProviderId(providerId)) {
            return Promise.reject(new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_PROVIDER_ID));
      ***REMOVED***
        return this.invokeRequestHandler(this.getProjectConfigUrlBuilder(), DELETE_OAUTH_IDP_CONFIG, {***REMOVED***, { providerId: providerId ***REMOVED***)
            .then(function (response) {
            // Return nothing.
      ***REMOVED***);
  ***REMOVED***
     ...
     *
     * @param {AuthProviderConfig***REMOVED*** options The properties to set on the new OIDC provider configuration to be created.
     * @return {Promise<OIDCConfigServerResponse>***REMOVED*** A promise that resolves with the newly created OIDC
     *     configuration.
     */
    AbstractAuthRequestHandler.prototype.createOAuthIdpConfig = function (options) {
      ...
      ***REMOVED***
        ...
        return this.invokeRequestHandler(this.getProjectConfigUrlBuilder(), CREATE_OAUTH_IDP_CONFIG, request, { providerId: providerId ***REMOVED***)
            .then(function (response) {
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** providerId The provider identifier of the OIDC configuration to update.
     * @param {OIDCUpdateAuthProviderRequest***REMOVED*** options The properties to update on the existing configuration.
     * @return {Promise<OIDCConfigServerResponse>***REMOVED*** A promise that resolves with the modified provider
     *     configuration.
     */
    AbstractAuthRequestHandler.prototype.updateOAuthIdpConfig = function (providerId, options) {
      ...
      ***REMOVED***
        ...
        return this.invokeRequestHandler(this.getProjectConfigUrlBuilder(), UPDATE_OAUTH_IDP_CONFIG, request, { providerId: providerId, updateMask: updateMask.join(',') ***REMOVED***)
            .then(function (response) {
            if (!auth_config_1.OIDCConfig.getProviderIdFromResourceName(response.name)) {
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** providerId The provider identifier of the configuration to lookup.
     * @return {Promise<SAMLConfigServerResponse>***REMOVED*** A promise that resolves with the provider configuration information.
     */
    AbstractAuthRequestHandler.prototype.getInboundSamlConfig = function (providerId) {
        if (!auth_config_1.SAMLConfig.isProviderId(providerId)) {
            return Promise.reject(new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_PROVIDER_ID));
      ***REMOVED***
        return this.invokeRequestHandler(this.getProjectConfigUrlBuilder(), GET_INBOUND_SAML_CONFIG, {***REMOVED***, { providerId: providerId ***REMOVED***);
  ***REMOVED***
    /**
     ...
     * @param {number=***REMOVED*** maxResults The page size, 100 if undefined. This is also the maximum
     *     allowed limit.
     * @param {string=***REMOVED*** pageToken The next page token. If not specified, returns SAML configurations starting
     *     without any offset. Configurations are returned in the order they were created from oldest to
     *     newest, relative to the page token offset.
     * @return {Promise<object>***REMOVED*** A promise that resolves with the current batch of downloaded
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** providerId The identifier of the SAML configuration to delete.
     * @return {Promise<void>***REMOVED*** A promise that resolves when the SAML provider is deleted.
     */
    AbstractAuthRequestHandler.prototype.deleteInboundSamlConfig = function (providerId) {
        if (!auth_config_1.SAMLConfig.isProviderId(providerId)) {
            return Promise.reject(new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_PROVIDER_ID));
      ***REMOVED***
        return this.invokeRequestHandler(this.getProjectConfigUrlBuilder(), DELETE_INBOUND_SAML_CONFIG, {***REMOVED***, { providerId: providerId ***REMOVED***)
            .then(function (response) {
            // Return nothing.
      ***REMOVED***);
  ***REMOVED***
     ...
     *
     * @param {AuthProviderConfig***REMOVED*** options The properties to set on the new SAML provider configuration to be created.
     * @return {Promise<SAMLConfigServerResponse>***REMOVED*** A promise that resolves with the newly created SAML
     *     configuration.
     */
    AbstractAuthRequestHandler.prototype.createInboundSamlConfig = function (options) {
      ...
      ***REMOVED***
        var providerId = options.providerId;
        return this.invokeRequestHandler(this.getProjectConfigUrlBuilder(), CREATE_INBOUND_SAML_CONFIG, request, { providerId: providerId ***REMOVED***)
            .then(function (response) {
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** providerId The provider identifier of the SAML configuration to update.
     * @param {SAMLUpdateAuthProviderRequest***REMOVED*** options The properties to update on the existing configuration.
     * @return {Promise<SAMLConfigServerResponse>***REMOVED*** A promise that resolves with the modified provider
     *     configuration.
     */
    AbstractAuthRequestHandler.prototype.updateInboundSamlConfig = function (providerId, options) {
      ...
      ***REMOVED***
        var updateMask = utils.generateUpdateMask(request);
        return this.invokeRequestHandler(this.getProjectConfigUrlBuilder(), UPDATE_INBOUND_SAML_CONFIG, request, { providerId: providerId, updateMask: updateMask.join(',') ***REMOVED***)
            .then(function (response) {
            if (!auth_config_1.SAMLConfig.getProviderIdFromResourceName(response.name)) {
  ...
  ***REMOVED***
     ...
     *
     * @param {AuthResourceUrlBuilder***REMOVED*** urlBuilder The URL builder for Auth endpoints.
     * @param {ApiSettings***REMOVED*** apiSettings The API endpoint settings to apply to request and response.
     * @param {object***REMOVED*** requestData The request data.
     * @param {object=***REMOVED*** additionalResourceParams Additional resource related params if needed.
     * @return {Promise<object>***REMOVED*** A promise that resolves with the response.
     */
  ...
  ***REMOVED***
    /**
     * @return {AuthResourceUrlBuilder***REMOVED*** The current Auth user management resource URL builder.
     */
  ...
  ***REMOVED***
    /**
     * @return {AuthResourceUrlBuilder***REMOVED*** The current project config resource URL builder.
     */
...
var GET_TENANT = new api_request_1.ApiSettings('/tenants/{tenantId***REMOVED***', 'GET')
    // Set response validator.
    .setResponseValidator(function (response) {
...
var DELETE_TENANT = new api_request_1.ApiSettings('/tenants/{tenantId***REMOVED***', 'DELETE');
/** Instantiates the updateTenant endpoint settings. */
var UPDATE_TENANT = new api_request_1.ApiSettings('/tenants/{tenantId***REMOVED***?updateMask={updateMask***REMOVED***', 'PATCH')
    // Set response validator.
    .setResponseValidator(function (response) {
    // Response should always contain at least the tenant name.
    if (!validator.isNonEmptyString(response.name) ||
...
var AuthRequestHandler = /** @class */ (function (_super) {
  ...
  ***REMOVED***
    /**
     * @return {AuthResourceUrlBuilder***REMOVED*** A new Auth user management resource URL builder instance.
     */
    AuthRequestHandler.prototype.newAuthUrlBuilder = function () {
        return new AuthResourceUrlBuilder(this.projectId, 'v1');
  ***REMOVED***
    /**
     * @return {AuthResourceUrlBuilder***REMOVED*** A new project config resource URL builder instance.
     */
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** tenantId The tenant identifier of the tenant to lookup.
     * @return {Promise<TenantServerResponse>***REMOVED*** A promise that resolves with the tenant information.
     */
    AuthRequestHandler.prototype.getTenant = function (tenantId) {
      ...
      ***REMOVED***
        return this.invokeRequestHandler(this.tenantMgmtResourceBuilder, GET_TENANT, {***REMOVED***, { tenantId: tenantId ***REMOVED***)
            .then(function (response) {
            return response;
      ***REMOVED***);
  ***REMOVED***
     ...
     * @param {number=***REMOVED*** maxResults The page size, 1000 if undefined. This is also the maximum
     *     allowed limit.
     * @param {string=***REMOVED*** pageToken The next page token. If not specified, returns tenants starting
    ...
    AuthRequestHandler.prototype.listTenants = function (maxResults, pageToken) {
        if (maxResults === void 0) { maxResults = MAX_LIST_TENANT_PAGE_SIZE; ***REMOVED***
        var request = {
            pageSize: maxResults,
            pageToken: pageToken,
      ***REMOVED***
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** tenantId The identifier of the tenant to delete.
     * @return {Promise<void>***REMOVED*** A promise that resolves when the tenant is deleted.
     */
    AuthRequestHandler.prototype.deleteTenant = function (tenantId) {
        if (!validator.isNonEmptyString(tenantId)) {
            return Promise.reject(new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_TENANT_ID));
      ***REMOVED***
        return this.invokeRequestHandler(this.tenantMgmtResourceBuilder, DELETE_TENANT, {***REMOVED***, { tenantId: tenantId ***REMOVED***)
            .then(function (response) {
            // Return nothing.
      ***REMOVED***);
  ***REMOVED***
     ...
     *
     * @param {TenantOptions***REMOVED*** tenantOptions The properties to set on the new tenant to be created.
     * @return {Promise<TenantServerResponse>***REMOVED*** A promise that resolves with the newly created tenant object.
     */
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** tenantId The tenant identifier of the tenant to update.
     * @param {TenantOptions***REMOVED*** tenantOptions The properties to update on the existing tenant.
     * @return {Promise<TenantServerResponse>***REMOVED*** A promise that resolves with the modified tenant object.
     */
    AuthRequestHandler.prototype.updateTenant = function (tenantId, tenantOptions) {
      ...
      ***REMOVED***
        try {
            ...
            var updateMask = utils.generateUpdateMask(request);
            return this.invokeRequestHandler(this.tenantMgmtResourceBuilder, UPDATE_TENANT, request, { tenantId: tenantId, updateMask: updateMask.join(',') ***REMOVED***)
                .then(function (response) {
                return response;
          ***REMOVED***);
      ***REMOVED***
...
***REMOVED***(AbstractAuthRequestHandler));
...
var TenantAwareAuthRequestHandler = /** @class */ (function (_super) {
     ...
     *
     * @param {FirebaseApp***REMOVED*** app The app used to fetch access tokens to sign API requests.
     * @param {string***REMOVED*** tenantId The request handler's tenant ID.
     * @constructor
     */
