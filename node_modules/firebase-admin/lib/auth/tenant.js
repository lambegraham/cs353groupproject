...
var Tenant = /** @class */ (function () {
     ...
     *
     * @param {any***REMOVED*** response The server side response used to initialize the Tenant object.
     * @constructor
     */
  ...
  ***REMOVED***
     ...
     *
     * @param {TenantOptions***REMOVED*** tenantOptions The properties to convert to a server request.
     * @param {boolean***REMOVED*** createRequest Whether this is a create request.
     * @return {object***REMOVED*** The equivalent server request.
     */
  ...
  ***REMOVED***
     ...
     * @return {?string***REMOVED*** The tenant ID corresponding to the resource, null otherwise.
     */
  ...
  ***REMOVED***
     ...
     *
     * @param {any***REMOVED*** request The tenant options object to validate.
     * @param {boolean***REMOVED*** createRequest Whether this is a create request.
     */
    Tenant.validate = function (request, createRequest) {
      ...
      ***REMOVED***
  ***REMOVED***
    /** @return {object***REMOVED*** The plain object representation of the tenant. */
