...
var EmailSignInConfig = /** @class */ (function () {
     ...
     *
     * @param {any***REMOVED*** response The server side response used to initialize the
  ...
  ***REMOVED***
     ...
     *
     * @param {any***REMOVED*** options The options object to convert to a server request.
     * @return {EmailSignInConfigServerRequest***REMOVED*** The resulting server request.
     */
  ...
  ***REMOVED***
     ...
     *
     * @param {any***REMOVED*** options The options object to validate.
     */
    EmailSignInConfig.validate = function (options) {
      ...
      ***REMOVED***
  ***REMOVED***
    /** @return {object***REMOVED*** The plain object representation of the email sign-in config. */
...
var SAMLConfig = /** @class */ (function () {
     ...
     *
     * @param {any***REMOVED*** response The server side response used to initialize the SAMLConfig object.
     * @constructor
     */
  ...
  ***REMOVED***
     ...
     * returns null.
     *
     * @param {SAMLAuthProviderRequest***REMOVED*** options The options object to convert to a server request.
     * @param {boolean=***REMOVED*** ignoreMissingFields Whether to ignore missing fields.
     * @return {?SAMLConfigServerRequest***REMOVED*** The resulting server request or null if not valid.
     */
    SAMLConfig.buildServerRequest = function (options, ignoreMissingFields) {
        if (ignoreMissingFields === void 0) { ignoreMissingFields = false; ***REMOVED***
          ...
          ***REMOVED***
            if (options.x509Certificates) {
                for (var _i = 0, _a = (options.x509Certificates || []); _i < _a.length; _i++) {
                    var cert = _a[_i];
                    request.idpConfig.idpCertificates.push({ x509Certificate: cert ***REMOVED***);
              ***REMOVED***
          ***REMOVED***
      ***REMOVED***
        // RP config.
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** resourceName The server side resource name.
     * @return {?string***REMOVED*** The provider ID corresponding to the resource, null otherwise.
     */
  ...
  ***REMOVED***
    /**
     * @param {any***REMOVED*** providerId The provider ID to check.
     * @return {boolean***REMOVED*** Whether the provider ID corresponds to a SAML provider.
     */
  ...
  ***REMOVED***
     ...
     *
     * @param {SAMLAuthProviderRequest***REMOVED*** options The options object to validate.
     * @param {boolean=***REMOVED*** ignoreMissingFields Whether to ignore missing fields.
     */
    SAMLConfig.validate = function (options, ignoreMissingFields) {
      ...
      ***REMOVED***
  ***REMOVED***
    /** @return {SAMLAuthProviderConfig***REMOVED*** The plain object representation of the SAMLConfig. */
...
var OIDCConfig = /** @class */ (function () {
     ...
     *
     * @param {any***REMOVED*** response The server side response used to initialize the OIDCConfig object.
     * @constructor
     */
  ...
  ***REMOVED***
     ...
     * returns null.
     *
     * @param {OIDCAuthProviderRequest***REMOVED*** options The options object to convert to a server request.
     * @param {boolean=***REMOVED*** ignoreMissingFields Whether to ignore missing fields.
     * @return {?OIDCConfigServerRequest***REMOVED*** The resulting server request or null if not valid.
     */
  ...
  ***REMOVED***
    /**
     * @param {any***REMOVED*** providerId The provider ID to check.
     * @return {boolean***REMOVED*** Whether the provider ID corresponds to an OIDC provider.
     */
  ...
  ***REMOVED***
     ...
     *
     * @param {OIDCAuthProviderRequest***REMOVED*** options The options object to validate.
     * @param {boolean=***REMOVED*** ignoreMissingFields Whether to ignore missing fields.
     */
    OIDCConfig.validate = function (options, ignoreMissingFields) {
      ...
      ***REMOVED***
  ***REMOVED***
    /** @return {OIDCAuthProviderConfig***REMOVED*** The plain object representation of the OIDCConfig. */
