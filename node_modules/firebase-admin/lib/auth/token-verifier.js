...
var FirebaseTokenVerifier = /** @class */ (function () {
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** jwtToken The Firebase Auth JWT token to verify.
     * @return {Promise<object>***REMOVED*** A promise fulfilled with the decoded claims of the Firebase Auth ID
     *                           token.
     */
  ...
  ***REMOVED***
     ...
     * @param {string***REMOVED*** jwtToken The JWT token to verify.
     * @param {string***REMOVED*** publicKey The public key certificate.
     * @return {Promise<object>***REMOVED*** A promise that resolves with the decoded JWT claims on successful
     *     verification.
     */
    FirebaseTokenVerifier.prototype.verifyJwtSignatureWithKey = function (jwtToken, publicKey) {
        ...
        return new Promise(function (resolve, reject) {
          ...
          ***REMOVED***, function (error, decodedToken) {
                if (error) {
  ...
  ***REMOVED***
     ...
     *
     * @return {Promise<object>***REMOVED*** A promise fulfilled with public keys for the Google certs.
     */
 ...
 *
 * @param {string***REMOVED*** projectId Project ID string.
 * @return {FirebaseTokenVerifier***REMOVED***
 */
