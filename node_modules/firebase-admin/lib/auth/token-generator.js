...
var ServiceAccountSigner = /** @class */ (function () {
     ...
     *
     * @param {Certificate***REMOVED*** certificate A service account certificate.
     */
    ...
    IAMSigner.prototype.sign = function (buffer) {
        ...
        return this.getAccountId().then(function (serviceAccount) {
            var request = {
                ...
                data: { bytesToSign: buffer.toString('base64') ***REMOVED***,
          ***REMOVED***
 ...
 *
 * @param {FirebaseApp***REMOVED*** app A FirebaseApp instance.
 * @return {CryptoSigner***REMOVED*** A CryptoSigner instance.
 */
...
var FirebaseTokenGenerator = /** @class */ (function () {
  ...
  ***REMOVED***
     ...
     *
     * @param {string***REMOVED*** uid The user ID to use for the generated Firebase Auth Custom token.
     * @param {object***REMOVED*** [developerClaims] Optional developer claims to include in the generated Firebase
     *                 Auth Custom token.
     * @return {Promise<string>***REMOVED*** A Promise fulfilled with a Firebase Auth Custom token signed with a
  ...
  ***REMOVED***
     ...
     *
     * @param {object***REMOVED*** [developerClaims] Optional developer claims to validate.
     * @return {boolean***REMOVED*** True if the provided claims are valid; otherwise, false.
     */
