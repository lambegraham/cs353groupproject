...
var HttpClient = /** @class */ (function () {
    function HttpClient(retry) {
        if (retry === void 0) { retry = defaultRetryConfig(); ***REMOVED***
        this.retry = retry;
        if (this.retry) {
  ...
  ***REMOVED***
     ...
     *
     * @param {HttpRequest***REMOVED*** config HTTP request to be sent.
     * @return {Promise<HttpResponse>***REMOVED*** A promise that resolves with the response details.
     */
  ...
  ***REMOVED***
     ...
     *
     * @param {HttpRequestConfig***REMOVED*** config HTTP request to be sent.
     * @param {number***REMOVED*** retryAttempts Number of retries performed up to now.
     * @return {Promise<HttpResponse>***REMOVED*** A promise that resolves with the response details.
     */
    HttpClient.prototype.sendWithRetry = function (config, retryAttempts) {
        var _this = this;
        if (retryAttempts === void 0) { retryAttempts = 0; ***REMOVED***
  ...
  ***REMOVED***
     ...
     * the retry.
     *
     * @param {number***REMOVED*** retryAttempts Number of retries completed up to now.
     * @param {LowLevelError***REMOVED*** err The last encountered error.
     * @returns {[number, boolean]***REMOVED*** A 2-tuple where the 1st element is the duration to wait before another retry, and the
 ...
 *
 * @param {string|Buffer***REMOVED*** response The HTTP response to be parsed.
 * @param {HttpRequestConfig***REMOVED*** config The request configuration that resulted in the HTTP response.
 * @return {HttpResponse***REMOVED*** An object containing the parsed HTTP status, headers and the body.
 */
...
var AsyncHttpCall = /** @class */ (function () {
  ...
  ***REMOVED***
    AsyncHttpCall.prototype.handleMultipartResponse = function (response, respStream, boundary) {
        ...
        var multipartParser = new dicer({ boundary: boundary ***REMOVED***);
        var responseBuffer = [];
  ...
  ***REMOVED***
    AuthorizedHttpClient.prototype.send = function (request) {
        ...
        return this.app.INTERNAL.getToken().then(function (accessTokenObj) {
            var requestCopy = Object.assign({***REMOVED***, request);
 ...
 *
 * @param {string***REMOVED*** endpoint The Firebase Auth backend endpoint.
 * @param {HttpMethod***REMOVED*** httpMethod The http method for that endpoint.
 * @constructor
 */
var ApiSettings = /** @class */ (function () {
    function ApiSettings(endpoint, httpMethod) {
        if (httpMethod === void 0) { httpMethod = 'POST'; ***REMOVED***
        this.endpoint = endpoint;
        this.httpMethod = httpMethod;
        this.setRequestValidator(null)
            .setResponseValidator(null);
  ***REMOVED***
    /** @return {string***REMOVED*** The backend API endpoint. */
    ApiSettings.prototype.getEndpoint = function () {
        return this.endpoint;
  ***REMOVED***
    /** @return {HttpMethod***REMOVED*** The request HTTP method. */
    ApiSettings.prototype.getHttpMethod = function () {
        return this.httpMethod;
  ***REMOVED***
    /**
     * @param {ApiCallbackFunction***REMOVED*** requestValidator The request validator.
     * @return {ApiSettings***REMOVED*** The current API settings instance.
     */
    ApiSettings.prototype.setRequestValidator = function (requestValidator) {
        var nullFunction = function (_) { return undefined; ***REMOVED***;
        this.requestValidator = requestValidator || nullFunction;
        return this;
  ***REMOVED***
    /** @return {ApiCallbackFunction***REMOVED*** The request validator. */
    ApiSettings.prototype.getRequestValidator = function () {
        return this.requestValidator;
  ***REMOVED***
    /**
     * @param {ApiCallbackFunction***REMOVED*** responseValidator The response validator.
     * @return {ApiSettings***REMOVED*** The current API settings instance.
     */
    ApiSettings.prototype.setResponseValidator = function (responseValidator) {
        ...
        return this;
  ***REMOVED***
    /** @return {ApiCallbackFunction***REMOVED*** The response validator. */
 ...
 *   ***REMOVED***)
 *     .then((responseData: any) => {
 *       console.log(`Final response: ${responseData***REMOVED***`);
 *   ***REMOVED***);
 * ```
 */
var ExponentialBackoffPoller = /** @class */ (function (_super) {
    ...
    function ExponentialBackoffPoller(initialPollingDelayMillis, maxPollingDelayMillis, masterTimeoutMillis) {
        if (initialPollingDelayMillis === void 0) { initialPollingDelayMillis = 1000; ***REMOVED***
        if (maxPollingDelayMillis === void 0) { maxPollingDelayMillis = 10000; ***REMOVED***
        if (masterTimeoutMillis === void 0) { masterTimeoutMillis = 60000; ***REMOVED***
        var _this = _super.call(this) || this;
  ...
  ***REMOVED***
     ...
     *
     * @param {() => Promise<object>***REMOVED*** callback The callback to be called for each poll. If the
     *     callback resolves to a falsey value, polling will continue. Otherwise, the truthy
     *     resolution will be used to resolve the promise returned by this method.
     * @return {Promise<object>***REMOVED*** A Promise which resolves to the truthy value returned by the provided
    ...
    ExponentialBackoffPoller.prototype.repoll = function () {
        ...
        this.pollCallback()
          ...
          ***REMOVED***
            if (!result) {
                _this.repollTimer =
                    setTimeout(function () { return _this.emit('poll'); ***REMOVED***, _this.getPollingDelayMillis());
                _this.numTries++;
                return;
          ***REMOVED***
            _this.markCompleted();
