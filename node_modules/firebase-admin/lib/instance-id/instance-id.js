...
var InstanceId = /** @class */ (function () {
    /**
     * @param {FirebaseApp***REMOVED*** app The app for this InstanceId service.
     * @constructor
     */
  ...
  ***REMOVED***
     ...
     * Regulation (GDPR).
     *
     * @param {string***REMOVED*** instanceId The instance ID to be deleted
     * @return {Promise<void>***REMOVED*** A promise that resolves when the instance ID is successfully deleted.
     */
  ...
  ***REMOVED***
    Object.defineProperty(InstanceId.prototype, "app", {
         ...
         *
         * @return {FirebaseApp***REMOVED*** The app associated with this InstanceId instance.
         */
        get: function () {
            return this.app_;
      ***REMOVED***,
