...
class GoogleAuth {
  ...
  ***REMOVED***
    getApplicationDefault(optionsOrCallback = {***REMOVED***, callback) {
        let options;
      ...
      ***REMOVED***
  ***REMOVED***
    async getApplicationDefaultAsync(options = {***REMOVED***) {
      ...
      ***REMOVED***
        ...
        if (credential) {
          ...
          ***REMOVED***
            ...
            return { credential, projectId ***REMOVED***;
      ***REMOVED***
      ...
      ***REMOVED***
            ...
            e.message = `Unexpected error determining execution environment: ${e.message***REMOVED***`;
            throw e;
      ***REMOVED***
        if (!isGCE) {
      ...
      ***REMOVED***
        ...
        projectId = await this.getProjectId();
        return { projectId, credential: this.cachedCredential ***REMOVED***;
  ***REMOVED***
    /**
  ...
  ***REMOVED***
    ...
    async _tryGetApplicationCredentialsFromEnvironmentVariable(options) {
      ...
      ***REMOVED***
            ...
            e.message = `Unable to read the credential file specified by the GOOGLE_APPLICATION_CREDENTIALS environment variable: ${e.message***REMOVED***`;
            throw e;
      ***REMOVED***
  ***REMOVED***
    /**
  ...
  ***REMOVED***
     ...
     * @api private
     */
    async _getApplicationCredentialsFromFilePath(filePath, options = {***REMOVED***) {
      ...
      ***REMOVED***
            ...
            err.message = `The file at ${filePath***REMOVED*** does not exist, or it is not a file. ${err.message***REMOVED***`;
            throw err;
      ***REMOVED***
  ...
  ***REMOVED***
    fromStream(inputStream, optionsOrCallback = {***REMOVED***, callback) {
        let options = {***REMOVED***;
        if (typeof optionsOrCallback === 'function') {
            callback = optionsOrCallback;
      ***REMOVED***
    ...
    async getCredentialsAsync() {
      ...
      ***REMOVED***
        ...
        const data = await gcpMetadata.instance({
            ...
            params: { recursive: 'true' ***REMOVED***,
      ***REMOVED***);
        if (!data || !data.default || !data.default.email) {
            throw new Error('Failure from metadata server.');
      ***REMOVED***
        return { client_email: data.default.email ***REMOVED***;
  ***REMOVED***
    /**
  ...
  ***REMOVED***
    ...
    async sign(data) {
      ...
      ***REMOVED***
        const id = `projects/${projectId***REMOVED***/serviceAccounts/${creds.client_email***REMOVED***`;
        const res = await this.request({
            method: 'POST',
            url: `https://iam.googleapis.com/v1/${id***REMOVED***:signBlob`,
            data: { bytesToSign: crypto.encodeBase64StringUtf8(data) ***REMOVED***,
      ***REMOVED***);
