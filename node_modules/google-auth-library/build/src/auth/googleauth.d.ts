...
import { GaxiosOptions, GaxiosResponse ***REMOVED*** from 'gaxios';
import * as stream from 'stream';
import { DefaultTransporter, Transporter ***REMOVED*** from '../transporters';
import { Compute ***REMOVED*** from './computeclient';
import { CredentialBody, JWTInput ***REMOVED*** from './credentials';
import { GCPEnv ***REMOVED*** from './envDetect';
import { JWT, JWTOptions ***REMOVED*** from './jwtclient';
import { Headers, OAuth2Client, OAuth2ClientOptions, RefreshOptions ***REMOVED*** from './oauth2client';
import { UserRefreshClient, UserRefreshClientOptions ***REMOVED*** from './refreshclient';
