...
class JWTAccess {
    ...
    constructor(email, key, keyId) {
        this.cache = new LRU({ max: 500, maxAge: 60 * 60 * 1000 ***REMOVED***);
        this.email = email;
        this.key = key;
        this.keyId = keyId;
  ***REMOVED***
  ...
  ***REMOVED***
    ...
    getRequestMetadata(url, additionalClaims) {
        ...
        return { headers: this.getRequestHeaders(url, additionalClaims) ***REMOVED***;
  ***REMOVED***
    /**
     * Get a non-expired access token, after refreshing if necessary.
     *
        ...
        if (additionalClaims) {
            for (const claim in defaultClaims) {
                if (additionalClaims[claim]) {
                    throw new Error(`The '${claim***REMOVED***' property is not allowed when passing additionalClaims. This claim is included in the JWT by default.`);
              ***REMOVED***
          ***REMOVED***
      ***REMOVED***
        const header = this.keyId
            ? Object.assign(Object.assign({***REMOVED***, DEFAULT_HEADER), { kid: this.keyId ***REMOVED***) : DEFAULT_HEADER;
        const payload = Object.assign(defaultClaims, additionalClaims);
        // Sign the jwt and add it to the cache
        const signedJWT = jws.sign({ header, payload, secret: this.key ***REMOVED***);
        const headers = { Authorization: `Bearer ${signedJWT***REMOVED***` ***REMOVED***;
