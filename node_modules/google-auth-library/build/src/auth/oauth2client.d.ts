 ...
 */
import { GaxiosError, GaxiosOptions, GaxiosPromise, GaxiosResponse ***REMOVED*** from 'gaxios';
import { JwkCertificate ***REMOVED*** from '../crypto/crypto';
import { BodyResponseCallback ***REMOVED*** from '../transporters';
import { AuthClient ***REMOVED*** from './authclient';
import { Credentials ***REMOVED*** from './credentials';
import { LoginTicket ***REMOVED*** from './loginticket';
...
export declare class OAuth2Client extends AuthClient {
  ...
  ***REMOVED***>;
     ...
     * { Authorization: 'Bearer <access_token_value>' ***REMOVED***
