...
class Compute extends oauth2client_1.OAuth2Client {
    ...
    constructor(options = {***REMOVED***) {
        ...
        this.credentials = { expiry_date: 1, refresh_token: 'compute-placeholder' ***REMOVED***;
  ...
  ***REMOVED***
    ...
    async refreshTokenNoCache(refreshToken) {
        const tokenPath = `service-accounts/${this.serviceAccountEmail***REMOVED***/token`;
        let data;
        try {
      ...
      ***REMOVED***
            ...
            e.message = `Could not refresh access token: ${e.message***REMOVED***`;
            this.wrapError(e);
            throw e;
      ***REMOVED***
        const tokens = data;
      ...
      ***REMOVED***
        ...
        return { tokens, res: null ***REMOVED***;
  ***REMOVED***
    wrapError(e) {
