...
if (!semver.satisfies(process.version, supportedNodeVersions)) {
    throw new Error(`@grpc/grpc-js only works on Node ${supportedNodeVersions***REMOVED***`);
***REMOVED***
...
exports.credentials = mixin({
  ...
  ***REMOVED***,
***REMOVED***, channel_credentials_1.ChannelCredentials, call_credentials_1.CallCredentials);
/**
