...
const { version: clientVersion ***REMOVED*** = require('../../package.json');
...
const { HTTP2_HEADER_AUTHORITY, HTTP2_HEADER_CONTENT_TYPE, HTTP2_HEADER_METHOD, HTTP2_HEADER_PATH, HTTP2_HEADER_TE, HTTP2_HEADER_USER_AGENT, ***REMOVED*** = http2.constants;
/**
...
class Subchannel {
    ...
    constructor(channelTarget, subchannelAddress, options, credentials) {
        ...
        this.userAgent = [
            ...
            `grpc-node-js/${clientVersion***REMOVED***`,
      ...
      ***REMOVED***
        ...
        switch (newState) {
            ...
            case channel_1.ConnectivityState.IDLE:
                ...
                break;
            default:
                throw new Error(`Invalid state: unknown ConnectivityState ${newState***REMOVED***`);
      ***REMOVED***
