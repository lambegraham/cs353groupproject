 ...
 */
const IPV4_REGEX = /^(\d{1,3***REMOVED***(?:\.\d{1,3***REMOVED***){3***REMOVED***)(?::(\d+))?$/;
/**
 ...
 */
const IPV6_REGEX = /^([0-9a-f]{0,4***REMOVED***(?::{1,2***REMOVED***[0-9a-f]{0,4***REMOVED***)+)$/i;
/**
 * Matches the same as the IPv6_REGEX, surrounded by square brackets, and
 * optionally followed by a colon and a number.
 */
const IPV6_BRACKET_REGEX = /^\[([0-9a-f]{0,4***REMOVED***(?::{1,2***REMOVED***[0-9a-f]{0,4***REMOVED***)+)\](?::(\d+))?$/i;
/**
...
function parseIP(target) {
  ...
  ***REMOVED***
        ...
        port = DEFAULT_PORT;
  ***REMOVED***
    return [`${addr***REMOVED***:${port***REMOVED***`];
***REMOVED***
/**
    ...
    constructor(target, listener) {
      ...
      ***REMOVED***
        ...
        this.defaultResolutionError = {
            ...
            details: `Name resolution failed for target ${this.target***REMOVED***`,
    ...
    startResolution() {
      ...
      ***REMOVED***
        if (this.dnsHostname !== null) {
            ...
            const addressResult = dnsLookupPromise(hostname, { all: true ***REMOVED***);
            ...
            this.pendingResultPromise.then(([addressList, txtRecord]) => {
                ...
                const ip4Addresses = addressList
                    ...
                    .map(addr => `${addr.address***REMOVED***:${this.port***REMOVED***`);
                let ip6Addresses;
    ...
    static getDefaultAuthority(target) {
      ...
      ***REMOVED***
        ...
        if (dnsMatch) {
            return dnsMatch[1];
      ***REMOVED***
        throw new Error(`Failed to parse target ${target***REMOVED***`);
  ***REMOVED***
***REMOVED***
/**
