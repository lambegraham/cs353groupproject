...
***REMOVED***)(ConnectivityState = exports.ConnectivityState || (exports.ConnectivityState = {***REMOVED***));
class ChannelImplementation {
    constructor(target, credentials, options) {
        ...
        const channelControlHelper = {
            createSubchannel: (subchannelAddress, subchannelArgs) => {
                return this.subchannelPool.getOrCreateSubchannel(this.target, subchannelAddress, Object.assign({***REMOVED***, this.options, subchannelArgs), this.credentials);
          ***REMOVED***,
            updateState: (connectivityState, picker) => {
                this.currentPicker = picker;
                const queueCopy = this.pickQueue.slice();
                this.pickQueue = [];
                for (const { callStream, callMetadata ***REMOVED*** of queueCopy) {
  ...
  ***REMOVED***
    ...
    tryPick(callStream, callMetadata) {
        const pickResult = this.currentPicker.pick({ metadata: callMetadata ***REMOVED***);
        switch (pickResult.pickResultType) {
            case picker_1.PickResultType.COMPLETE:
              ...
              ***REMOVED***
                  ...
                  ***REMOVED***, (error) => {
                        ...
                        callStream.cancelWithStatus(error.code || constants_1.Status.UNKNOWN, `Getting metadata from plugin failed with error: ${error.message***REMOVED***`);
                  ***REMOVED***);
              ***REMOVED***
                break;
            case picker_1.PickResultType.QUEUE:
                this.pickQueue.push({ callStream, callMetadata ***REMOVED***);
                break;
            case picker_1.PickResultType.TRANSIENT_FAILURE:
              ...
              ***REMOVED***
                break;
            default:
                throw new Error(`Invalid state: unknown pickResultType ${pickResult.pickResultType***REMOVED***`);
      ***REMOVED***
  ***REMOVED***
